(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["maintenance-work-order-work-order-module"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogEditDurationComponent", function() { return DialogEditDurationComponent; });
...
var DialogEditDurationComponent = /** @class */ (function (_super) {
    ...
    function DialogEditDurationComponent(sessionService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__["ComponentOpenMode"].Write, 'DialogEditDurationComponent') || this;
    ...
    ], DialogEditDurationComponent.prototype, "existingDuration", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], DialogEditDurationComponent.prototype, "existingElapsed", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogEditDurationComponent.prototype, "onValidated", void 0);
    DialogEditDurationComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-edit-duration',
            template: __webpack_require__(/*! ./dialog-edit-duration.component.html */ "./src/app/main/maintenance/work-order/form/popups/dialog-edit-duration/dialog-edit-duration.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogImportWorkOrderDocumentComponent", function() { return DialogImportWorkOrderDocumentComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_utils_bidm_document_utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../../../shared/utils/bidm-document-utils */ "./src/app/shared/utils/bidm-document-utils.ts");
/* harmony import */ var _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../../../shared/utils/file-utils */ "./src/app/shared/utils/file-utils.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DialogImportWorkOrderDocumentComponent = /** @class */ (function (_super) {
    ...
    function DialogImportWorkOrderDocumentComponent(sessionService, messageService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__["ComponentOpenMode"].Write, _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_2__["ComponentConstants"].MAI_DIALOG_IMPORT_ORDER_DOCUMENT) || this;
        _this.sessionService = sessionService;
    ...
    DialogImportWorkOrderDocumentComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_2__["ComponentConstants"].MAI_DIALOG_IMPORT_ORDER_DOCUMENT;
    };
    ...
    DialogImportWorkOrderDocumentComponent.prototype.uploadDocument = function (event, fileUploader) {
        ...
        if (!!event.files) {
            ...
            var fileExists = this.woDocumentList.some(function (document) { return document.documentName === file_1.name; });
            if (fileExists) {
                this.messageService.showWarningMessage('global.warningOnFileExists');
            }
            else {
                _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_8__["FileUtils"].getFileContentAsBase64(file_1, function (fileContent) {
                    if (!!fileContent) {
                        _this.woDocument = {
                            ...
                            documentType: _shared_utils_bidm_document_utils__WEBPACK_IMPORTED_MODULE_7__["BidmDocumentUtils"].typeFile(file_1.name),
    ...
    ], DialogImportWorkOrderDocumentComponent.prototype, "openMode", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogImportWorkOrderDocumentComponent.prototype, "woDocument", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], DialogImportWorkOrderDocumentComponent.prototype, "woDocumentList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogImportWorkOrderDocumentComponent.prototype, "workOrder", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogImportWorkOrderDocumentComponent.prototype, "onUpdatedWODoc", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogImportWorkOrderDocumentComponent.prototype, "onAddedWODoc", void 0);
    DialogImportWorkOrderDocumentComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-import-work-order-document',
            template: __webpack_require__(/*! ./dialog-import-work-order-document.component.html */ "./src/app/main/maintenance/work-order/form/popups/dialog-import-work-order-document/dialog-import-work-order-document.component.html")
        }),
        __metadata("design:paramtypes", [_shared_services_session_service__WEBPACK_IMPORTED_MODULE_5__["SessionService"], _shared_services_message_service__WEBPACK_IMPORTED_MODULE_4__["MessageService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogJobCardTimeTrackingEntriesComponent", function() { return DialogJobCardTimeTrackingEntriesComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _work_order_form_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../work-order-form.service */ "./src/app/main/maintenance/work-order/form/work-order-form.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DialogJobCardTimeTrackingEntriesComponent = /** @class */ (function (_super) {
    ...
    function DialogJobCardTimeTrackingEntriesComponent(confirmationService, woFormService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Write, 'DialogJobCardTimeTrackingEntriesComponent') || this;
                    ...
                    if (!!rowData.bidmTimeTrackingDTO.timeTrackingId) {
                        ...
                        _this.woFormService.removeBidmTimeTracking(bidmTimeTrackingDTOId).subscribe(function (res) {
                            if (!!rowData.bidmTimeTrackingDTO) {
                                ...
                                var index = _this.resultList.findIndex(function (row) { return !!row.bidmTimeTrackingDTO && row.bidmTimeTrackingDTO.timeTrackingId === id_1; });
    ...
    DialogJobCardTimeTrackingEntriesComponent.prototype.spliceEntry = function (rowData) {
        var index = this.resultList.findIndex(function (res) {
            return res.operation === rowData.operation &&
    ...
    DialogJobCardTimeTrackingEntriesComponent.prototype.updateEntry = function (rowData) {
        if (!!rowData.bidmTimeTrackingDTO && !!rowData.bidmTimeTrackingDTO.timeTrackingId) {
            this.selectedRowIndex = this.resultList.findIndex(function (res) {
                return !!res.bidmTimeTrackingDTO &&
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogJobCardTimeTrackingEntriesComponent.prototype, "workOrder", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], DialogJobCardTimeTrackingEntriesComponent.prototype, "bidmTimeTrackingList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], DialogJobCardTimeTrackingEntriesComponent.prototype, "addedBidmTimeTracking", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogJobCardTimeTrackingEntriesComponent.prototype, "selectedOperations", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogJobCardTimeTrackingEntriesComponent.prototype, "onValidated", void 0);
    DialogJobCardTimeTrackingEntriesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-job-card-time-tracking-entries',
            template: __webpack_require__(/*! ./dialog-job-card-time-tracking-entries.component.html */ "./src/app/main/maintenance/work-order/form/popups/dialog-job-card-time-tracking-entries/dialog-job-card-time-tracking-entries.component.html"),
            styles: [__webpack_require__(/*! ./dialog-job-card-time-tracking-entries.component.scss */ "./src/app/main/maintenance/work-order/form/popups/dialog-job-card-time-tracking-entries/dialog-job-card-time-tracking-entries.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogOperationCheckFormComponent", function() { return DialogOperationCheckFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var DialogOperationCheckFormComponent = /** @class */ (function (_super) {
    ...
    function DialogOperationCheckFormComponent(translateService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Write, 'DialogOperationCheckFormComponent') || this;
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogOperationCheckFormComponent.prototype, "onValidationOK", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogOperationCheckFormComponent.prototype, "onValidationKO", void 0);
    DialogOperationCheckFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-operation-check-form',
            template: __webpack_require__(/*! ./dialog-operation-check-form.component.html */ "./src/app/main/maintenance/work-order/form/popups/dialog-operation-check/dialog-operation-check-form.component.html"),
            styles: [__webpack_require__(/*! ./dialog-operation-check-form.component.scss */ "./src/app/main/maintenance/work-order/form/popups/dialog-operation-check/dialog-operation-check-form.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogPostponementFormComponent", function() { return DialogPostponementFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../../shared/enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
...
var DialogPostponementFormComponent = /** @class */ (function (_super) {
    ...
    function DialogPostponementFormComponent() {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__["ComponentOpenMode"].Write, 'DialogPostponementFormComponent') || this;
        _this.onValidated = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        return _this;
    }
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogPostponementFormComponent.prototype, "onValidated", void 0);
    DialogPostponementFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-postponement-form',
            template: __webpack_require__(/*! ./dialog-postponement-form.component.html */ "./src/app/main/maintenance/work-order/form/popups/dialog-postponement/dialog-postponement-form.component.html"),
            styles: [__webpack_require__(/*! ./dialog-postponement-form.component.scss */ "./src/app/main/maintenance/work-order/form/popups/dialog-postponement/dialog-postponement-form.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogStakeholderComponent", function() { return DialogStakeholderComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
...
/* harmony import */ var _human_resources_employee_form_employee_form_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../../human-resources/employee-form/employee-form.service */ "./src/app/main/human-resources/employee-form/employee-form.service.ts");
/* harmony import */ var _work_package_form_popups_dialog_work_order_edition_dialog_work_order_edition_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.service */ "./src/app/main/maintenance/work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DialogStakeholderComponent = /** @class */ (function (_super) {
    ...
    function DialogStakeholderComponent(sessionService, messageService, dialogWorkOrderEditService, employeeFormService, translateService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__["ComponentOpenMode"].Write, _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_3__["ComponentConstants"].MAI_DIALOG_IMPORT_ORDER_DOCUMENT) || this;
        _this.sessionService = sessionService;
        _this.messageService = messageService;
    ...
    DialogStakeholderComponent.prototype.ngOnInit = function () {
        this.updateOpenMode(this.openMode);
        if (this.openMode === _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__["ComponentOpenMode"].Create) {
            this.stakeholder = {};
        }
    ...
    DialogStakeholderComponent.prototype.getUsersList = function () {
        var _this = this;
        var param = {
            useCaseCode: _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_2__["BidoFunctionTypeConstants"].UC_AIRM_EXECUTION
        };
        if (!!this.task) {
        ...
        this.dialogWorkOrderEditService.findUsersWithUseCaseForWorkOrder(param).subscribe(function (data) {
            ...
            if (!!_this.stakeholder.woAssignedTo) {
                var inList = _this.stakeholderList.find(function (elem) { return elem.value === _this.stakeholder.woAssignedTo; });
                if (!!inList) {
                    _this.stakeholder.woAssignedTo = inList.value;
                }
            }
            if (_this.openMode !== _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__["ComponentOpenMode"].Read) {
    ...
    DialogStakeholderComponent.prototype.getControllers = function () {
        var _this = this;
        var param = {
            useCaseCode: _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_2__["BidoFunctionTypeConstants"].UC_AIRM_QUALITY_CHECK
        };
        param.projectId = this.workOrder.projectId;
        param.startDate = this.workOrder.woScheduledStartDate;
        this.stakeholderList = [];
        if (this.openMode !== _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__["ComponentOpenMode"].Read) {
    ...
    DialogStakeholderComponent.prototype.isScreenValidated = function () {
        if (this.stakeholder.woAssignedTo === null ||
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Number)
    ], DialogStakeholderComponent.prototype, "openMode", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogStakeholderComponent.prototype, "stakeholder", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogStakeholderComponent.prototype, "onUpdatedStakeholder", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogStakeholderComponent.prototype, "onAddedStakeholder", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogStakeholderComponent.prototype, "task", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogStakeholderComponent.prototype, "workOrder", void 0);
    DialogStakeholderComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-stakeholder',
            template: __webpack_require__(/*! ./dialog-stakeholder.component.html */ "./src/app/main/maintenance/work-order/form/popups/dialog-stakeholder/dialog-stakeholder.component.html")
        }),
        __metadata("design:paramtypes", [_shared_services_session_service__WEBPACK_IMPORTED_MODULE_6__["SessionService"],
            ...
            _work_package_form_popups_dialog_work_order_edition_dialog_work_order_edition_service__WEBPACK_IMPORTED_MODULE_9__["DialogWorkOrderEditService"],
            _human_resources_employee_form_employee_form_service__WEBPACK_IMPORTED_MODULE_8__["EmployeeFormService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WOLastUpdatePopupComponent", function() { return WOLastUpdatePopupComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_constants_bidm_attribute_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../../shared/constants/bidm-attribute-constants */ "./src/app/shared/constants/bidm-attribute-constants.ts");
...
/* harmony import */ var _work_order_form_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../work-order-form.service */ "./src/app/main/maintenance/work-order/form/work-order-form.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var WOLastUpdatePopupComponent = /** @class */ (function (_super) {
    ...
    function WOLastUpdatePopupComponent(sessionService, woFormService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__["ComponentOpenMode"].Read, 'WorkOrderLastUpdateComponent') || this;
        _this.sessionService = sessionService;
        _this.woFormService = woFormService;
        return _this;
    }
    WOLastUpdatePopupComponent.prototype.ngOnInit = function () {
        ...
        if (!!this.workOrder) {
            var bidmWorkOrderDTOId = {
                projectId: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_7__["StringUtils"].isNullOrEmpty(this.workOrder.projectId) ? '' : "" + this.workOrder.projectId,
                woId: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_7__["StringUtils"].isNullOrEmpty(this.workOrder.woId) ? '' : "" + this.workOrder.woId
            };
            this.woFormService.findWorkOrderAttributes(bidmWorkOrderDTOId).subscribe(function (r) {
                _this.attributeList = r;
                var attributeSystemSourceId = _this.attributeList.find(function (attribute) { return attribute.attributeName === _shared_constants_bidm_attribute_constants__WEBPACK_IMPORTED_MODULE_1__["BidmAttributeConstants"].WORK_ORDER_SYSTEM_SOURCE_ID; });
                var attributeSystemSourceReference = _this.attributeList.find(function (attribute) { return attribute.attributeName === _shared_constants_bidm_attribute_constants__WEBPACK_IMPORTED_MODULE_1__["BidmAttributeConstants"].WORK_ORDER_SYSTEM_SOURCE_REFERENCE; });
            ...
            this.woFormService.loadGenProps(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_2__["GenericPropertyConstants"].AIRM_WORK_ORDER_TYPES_MAP).subscribe(function (r) {
                _this.typeList = r;
                _this.type = _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_6__["SelectItemUtils"].formatSelectItem(_this.workOrder.woType, _this.typeList);
            });
            this.woFormService.loadGenProps(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_2__["GenericPropertyConstants"].AIRM_OPERATION_STATUS_MAP).subscribe(function (r) {
                _this.statusList = r;
                _this.status = _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_6__["SelectItemUtils"].formatSelectItem(_this.workOrder.statusState, _this.statusList);
            });
        }
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], WOLastUpdatePopupComponent.prototype, "workOrder", void 0);
    WOLastUpdatePopupComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-wo-last-update-popup',
            template: __webpack_require__(/*! ./wo-last-update-popup.component.html */ "./src/app/main/maintenance/work-order/form/popups/last-update/wo-last-update-popup.component.html"),
            styles: [__webpack_require__(/*! ./wo-last-update-popup.component.scss */ "./src/app/main/maintenance/work-order/form/popups/last-update/wo-last-update-popup.component.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_session_service__WEBPACK_IMPORTED_MODULE_4__["SessionService"], _work_order_form_service__WEBPACK_IMPORTED_MODULE_8__["WorkOrderFormService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WOLastUpdatePopupModule", function() { return WOLastUpdatePopupModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _wo_last_update_popup_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./wo-last-update-popup.component */ "./src/app/main/maintenance/work-order/form/popups/last-update/wo-last-update-popup.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Modules
 *************************************************************************** */
var EXTERNAL_MODULES = [primeng_calendar__WEBPACK_IMPORTED_MODULE_1__["CalendarModule"], primeng_dropdown__WEBPACK_IMPORTED_MODULE_2__["DropdownModule"], primeng_table__WEBPACK_IMPORTED_MODULE_3__["TableModule"], primeng_tooltip__WEBPACK_IMPORTED_MODULE_4__["TooltipModule"]];
...
/* harmony import */ var _modules_purchase_contract_utils_table_data_source_with_history__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../modules/purchase-contract/utils/table-data-source-with-history */ "./src/app/modules/purchase-contract/utils/table-data-source-with-history.ts");
...
/* harmony import */ var _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../shared/components/table/table-data-source */ "./src/app/shared/components/table/table-data-source.ts");
...
/* harmony import */ var _shared_constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../shared/constants/bido-evolution-constants */ "./src/app/shared/constants/bido-evolution-constants.ts");
...
/* harmony import */ var _shared_constants_bido_notification_type_constants__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../../shared/constants/bido-notification-type-constants */ "./src/app/shared/constants/bido-notification-type-constants.ts");
/* harmony import */ var _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../../shared/constants/component-constants */ "./src/app/shared/constants/component-constants.ts");
/* harmony import */ var _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../../shared/constants/control-config-constants */ "./src/app/shared/constants/control-config-constants.ts");
/* harmony import */ var _shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../../shared/constants/generic-property-constants */ "./src/app/shared/constants/generic-property-constants.ts");
/* harmony import */ var _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../../shared/enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
/* harmony import */ var _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../../shared/enums/table-column-filter-mode.enum */ "./src/app/shared/enums/table-column-filter-mode.enum.ts");
/* harmony import */ var _shared_enums_table_selection_mode_enum__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../../shared/enums/table-selection-mode.enum */ "./src/app/shared/enums/table-selection-mode.enum.ts");
/* harmony import */ var _shared_services_confirmation_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../../../shared/services/confirmation.service */ "./src/app/shared/services/confirmation.service.ts");
/* harmony import */ var _shared_services_dassault_field_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../../../shared/services/dassault/field.service */ "./src/app/shared/services/dassault/field.service.ts");
/* harmony import */ var _shared_services_date_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../../../shared/services/date.service */ "./src/app/shared/services/date.service.ts");
/* harmony import */ var _shared_services_favorite_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../../../shared/services/favorite.service */ "./src/app/shared/services/favorite.service.ts");
/* harmony import */ var _shared_services_loader_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../../../../shared/services/loader.service */ "./src/app/shared/services/loader.service.ts");
/* harmony import */ var _shared_services_message_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../../../../shared/services/message.service */ "./src/app/shared/services/message.service.ts");
/* harmony import */ var _shared_services_properties_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../../../../shared/services/properties.service */ "./src/app/shared/services/properties.service.ts");
...
/* harmony import */ var _shared_services_session_service__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../../../../shared/services/session.service */ "./src/app/shared/services/session.service.ts");
/* harmony import */ var _shared_services_tab_service__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../../../../shared/services/tab.service */ "./src/app/shared/services/tab.service.ts");
/* harmony import */ var _shared_types_form_page_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ../../../../shared/types/form-page-component */ "./src/app/shared/types/form-page-component.ts");
/* harmony import */ var _shared_utils_bidm_document_utils__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ../../../../shared/utils/bidm-document-utils */ "./src/app/shared/utils/bidm-document-utils.ts");
/* harmony import */ var _shared_utils_bidm_work_order_utils__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ../../../../shared/utils/bidm-work-order-utils */ "./src/app/shared/utils/bidm-work-order-utils.ts");
/* harmony import */ var _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ../../../../shared/utils/bido-equipment-utils */ "./src/app/shared/utils/bido-equipment-utils.ts");
/* harmony import */ var _shared_utils_bire_item_utils__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ../../../../shared/utils/bire-item-utils */ "./src/app/shared/utils/bire-item-utils.ts");
/* harmony import */ var _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ../../../../shared/utils/file-utils */ "./src/app/shared/utils/file-utils.ts");
/* harmony import */ var _shared_utils_image_utils__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ../../../../shared/utils/image-utils */ "./src/app/shared/utils/image-utils.ts");
/* harmony import */ var _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ../../../../shared/utils/list-utils */ "./src/app/shared/utils/list-utils.ts");
/* harmony import */ var _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ../../../../shared/utils/object-utils */ "./src/app/shared/utils/object-utils.ts");
/* harmony import */ var _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ../../../../shared/utils/string-utils */ "./src/app/shared/utils/string-utils.ts");
/* harmony import */ var _shared_utils_url_utils__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ../../../../shared/utils/url-utils */ "./src/app/shared/utils/url-utils.ts");
/* harmony import */ var _shared_utils_workflow_utils__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ../../../../shared/utils/workflow-utils */ "./src/app/shared/utils/workflow-utils.ts");
/* harmony import */ var _human_resources_employee_form_employee_form_service__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ../../../human-resources/employee-form/employee-form.service */ "./src/app/main/human-resources/employee-form/employee-form.service.ts");
/* harmony import */ var _logistics_logistics_service__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ../../../logistics/logistics.service */ "./src/app/main/logistics/logistics.service.ts");
/* harmony import */ var _overlay_overlay_service__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ../../../overlay/overlay.service */ "./src/app/main/overlay/overlay.service.ts");
/* harmony import */ var _procurement_request_procurement_requests_table_service__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ../../procurement-request/procurement-requests-table.service */ "./src/app/main/maintenance/procurement-request/procurement-requests-table.service.ts");
/* harmony import */ var _work_package_form_work_package_form_service__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! ../../work-package/form/work-package-form.service */ "./src/app/main/maintenance/work-package/form/work-package-form.service.ts");
/* harmony import */ var _status_work_order_status_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./status/work-order-status.component */ "./src/app/main/maintenance/work-order/form/status/work-order-status.component.ts");
/* harmony import */ var _work_order_form_service__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./work-order-form.service */ "./src/app/main/maintenance/work-order/form/work-order-form.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var WorkOrderFormComponent = /** @class */ (function (_super) {
    ...
    function WorkOrderFormComponent(favoriteService, loaderService, messageService, pageTocService, serializationService, tabService, logisticsService, domSanitizer, employeeFormService, translateService, sessionService, woFormService, workPackageFormService, davFieldService, dateService, confirmationService, procurementRequestsTableService, propertiesService, _overlayService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read, favoriteService, loaderService, messageService, serializationService, tabService, pageTocService) || this;
        ...
        _this.TABLE_PAGINATION_DEFAULT_ROWS = _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_9__["AppConstants"].TABLE_PAGINATION_DEFAULT_ROWS;
        _this.workOrder = {};
        _this.workPackage = {};
        ...
        _this.awPropertiesConstants = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"];
        _this.bidoNotificationTypeConstants = _shared_constants_bido_notification_type_constants__WEBPACK_IMPORTED_MODULE_13__["BidoNotificationTypeConstants"];
        _this.controlConfigConstants = _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_15__["ControlConfigConstants"];
        ...
        _this.setLinkLists();
        // Load Status List
        _this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_16__["GenericPropertyConstants"].PROCUREMENT_REQUEST_STATUS_MAP).subscribe(function (res) {
            _this.procurementRequestStatusList = res;
        });
        _this.procurementRequestTypes = [];
        _this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_16__["GenericPropertyConstants"].PROCUREMENT_REQUEST_TYPE_MAP).subscribe(function (res) {
            _this.procurementRequestTypes = res;
        });
        _this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_16__["GenericPropertyConstants"].REMOVAL_REASON_MAP).subscribe(function (results) {
    ...
    WorkOrderFormComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_14__["ComponentConstants"].MAI_WORK_ORDER_FORM;
    };
    ...
    WorkOrderFormComponent.prototype.getStakeholderNameById = function (stakeholderId) {
        var matchingUser = this.userList.find(function (user) { return user.value === stakeholderId; });
    ...
    WorkOrderFormComponent.prototype.initWorkOrderWithQualificationOngoing = function () {
        ...
        if (this.qualificationNeeded && this.findEmployeeQualificationDTO) {
            ...
            var selectedQualificationsNeeded = this.findEmployeeQualificationDTO.filter(function (qualification) { return qualification.qualificationCode === qualificationNeededCode_1[0]; });
            this.isQualificationOngoing = qualificationNeededCode_1.some(function (qualificationCode) {
                var qualification = _this.findEmployeeQualificationDTO.find(function (employeeQualification) { return employeeQualification.qualificationCode === qualificationCode; });
            ...
            this.operationTable.forEach(function (operation) {
                if (operation) {
                    if (operation.opeQualification && !!_this.findEmployeeQualificationDTO) {
                        var qualification = _this.findEmployeeQualificationDTO.find(function (employeeQualification) { return employeeQualification.qualificationCode === operation.opeQualification; });
    ...
    WorkOrderFormComponent.prototype.initBidmDocumentTableData = function () {
        this.woBidmDocumentsTableData = new _modules_purchase_contract_utils_table_data_source_with_history__WEBPACK_IMPORTED_MODULE_6__["TableDataSourceWithHistory"]({
            allowMultiSelect: true,
            columns: [
                {
                    field: 'docName',
                    translateKey: this.getTranslateKey('docName'),
                    alignment: _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_8__["ColumnAlignment"].LEFT,
                    width: '30%'
                },
                {
                    field: 'docType',
    ...
    WorkOrderFormComponent.prototype.initStakeholdersTableDataSource = function () {
        this.stakeholdersTableDataSource = new _modules_purchase_contract_utils_table_data_source_with_history__WEBPACK_IMPORTED_MODULE_6__["TableDataSourceWithHistory"]({
            allowMultiSelect: true,
    ...
    WorkOrderFormComponent.prototype.createDocumentRow = function (document) {
        var documentRow = {
            docExtension: _shared_utils_bidm_document_utils__WEBPACK_IMPORTED_MODULE_31__["BidmDocumentUtils"].formatDocExtension(document),
            docName: document.documentName,
            docPublicationDate: this.dateService.momentToString(moment__WEBPACK_IMPORTED_MODULE_3__(Number(document.documentPublicationDate))),
            docSize: _shared_utils_bidm_document_utils__WEBPACK_IMPORTED_MODULE_31__["BidmDocumentUtils"].formatDocSize(document),
    ...
    WorkOrderFormComponent.prototype.openWOImportDocDialInEditMode = function () {
        this.openModeWOImportDoc = _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Write;
        this.woBidmDocumentsResource = this.woBidmDocumentsTableData.dataSrc.map(function (row) { return row._obj; });
    ...
    WorkOrderFormComponent.prototype.openWOImportDocDialInCreateMode = function () {
        this.openModeWOImportDoc = _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Create;
        this.woBidmDocumentsResource = this.woBidmDocumentsTableData.dataSrc.map(function (row) { return row._obj; });
        this.showAddWODocumentDialog = true;
    };
    WorkOrderFormComponent.prototype.loadBidmDocumentTableData = function () {
        ...
        this.woFormService.findBidmDocumentsByWorkOrder(this.bidmWorkOrderId).subscribe(function (result) {
            ...
            _this.woBidmDocumentsTableData.setData(result.map(function (doc) { return _this.createDocumentRow(doc); }));
        });
    };
    WorkOrderFormComponent.prototype.loadStakeholdersTable = function () {
        ...
        this.woFormService.userList$.subscribe(function (list) {
            ...
            _this.woFormService
                .findBidmWoAssignmentsByWorkOrder(_this.bidmWorkOrderId)
                .subscribe(function (result) {
                result.forEach(function (elt) {
                    ...
                    if (_this.user && elt.woAssignedTo) {
                        _this.woFormService.findUserById({ userId: elt.woAssignedTo.toString() }).subscribe(function (receivingUser) {
                            if (_this.user && receivingUser.userId === _this.user.userId) {
                                _this.updateOpenMode(_shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Write);
                            }
                        });
                    }
                });
                _this.stakeholdersTableDataSource.setData(result.map(function (stakeholder) { return _this.createStakeholderRow(stakeholder); }));
    ...
    WorkOrderFormComponent.prototype.downloadTaskFiles = function () {
        this.selectedDocuments.forEach(function (documentRow) {
            if (!!documentRow._obj) {
                _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_35__["FileUtils"].downloadFile(documentRow._obj.docFile, documentRow._obj.docName);
            }
        });
    };
    WorkOrderFormComponent.prototype.downloadWOFiles = function () {
        this.woBidmDocumentsTableData.dataSelection.forEach(function (documentRow) {
            if (!!documentRow._obj) {
                _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_35__["FileUtils"].downloadFile(documentRow._obj.documentContent, documentRow._obj.documentName);
            }
        });
    };
    WorkOrderFormComponent.prototype.findBidmDocumentByDocumentRow = function (documentRow) {
        return this.woBidmDocumentsResource.find(function (elt) { return elt.documentName === documentRow.docName; });
    };
    WorkOrderFormComponent.prototype.updateWODoc = function (docToUpdate) {
        var _this = this;
        var index = this.woBidmDocumentsResource.findIndex(function (elt) { return elt.documentName === _this.woBidmDocumentsTableData.dataSelection[0].docName; });
        if (index !== -1) {
            this.woBidmDocumentsResource.splice(index, 1, docToUpdate);
        }
        this.woBidmDocumentsTableData.replaceData(this.woBidmDocumentsTableData.dataSelection[0], this.createDocumentRow(docToUpdate));
    ...
    WorkOrderFormComponent.prototype.deleteWODocs = function () {
        var _this = this;
        var partialMessageKey = this.woBidmDocumentsTableData.dataSelectionCount > 1
        ...
        this.confirmationService.confirmDelete({
            ...
            accept: function () {
                _this.woBidmDocumentsTableData.dataSelection.forEach(function (docTodDel) {
                    _this.woBidmDocumentsResource.filter(function (doc) { return docTodDel.docName !== doc.documentName; });
                });
    ...
    WorkOrderFormComponent.prototype.addStakeholder = function () {
        ...
        this.openModeStakeholder = _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Create;
    ...
    WorkOrderFormComponent.prototype.editStakeholder = function () {
        ...
        if (this.stakeholdersTableDataSource.hasDataSelection) {
            this.currentStakeholderIndex = this.stakeholdersTableDataSource.dataSrc.findIndex(function (stakeholder) { return stakeholder === _this.stakeholdersTableDataSource.dataSelection[0]; });
            this.openModeStakeholder = _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read;
            this.showAddStakeholderDialog = true;
        }
    ...
    WorkOrderFormComponent.prototype.deleteStakeholders = function () {
        var _this = this;
        var partialMessageKey = this.stakeholdersTableDataSource.dataSelectionCount > 1
    ...
    WorkOrderFormComponent.prototype.onUpdateStakeholder = function (event) {
        ...
        if (!!event) {
            ...
            var updatedStakeholder = this.stakeholdersTableDataSource.replaceData(this.stakeholdersTableDataSource.dataSelection[0], this.createStakeholderRow(event));
    ...
    WorkOrderFormComponent.prototype.displayWorkOrderScreenEdit = function () {
        ...
        if (this.workOrder.projectId) {
            this.workPackageFormService.getBidmWorkOrdersStructureByProject(this.workOrder.projectId).subscribe(function (woList) {
    ...
    WorkOrderFormComponent.prototype.loadLists = function () {
        var _this = this;
        this.woFormService.woStatusList$.subscribe(function (list) { return (_this.statusList = list); });
        this.woFormService.woTypeList$.subscribe(function (list) { return (_this.woTypeList = list); });
        this.woFormService.loadMROCenterList().subscribe(function (result) { return (_this.mroCenterList = result); });
    };
    WorkOrderFormComponent.prototype.updateWorkflowStatusList = function () {
        this.workflowStatus = _shared_utils_workflow_utils__WEBPACK_IMPORTED_MODULE_41__["WorkflowUtils"].filterWorkflowStatusList(this.userWorkflow, this.statusList, this.woStatus ? this.woStatus.status : undefined);
    };
    ...
    WorkOrderFormComponent.prototype.registerPageTocEntrySelectedObservable = function () {
        var _this = this;
        this.pageTocService.pageTocEntrySelected$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.unsubscribe)).subscribe(function (pageTocEntrySelected) {
    ...
    WorkOrderFormComponent.prototype.onSelectEquipment = function (equipment) {
        this.assetRepresentation = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_39__["StringUtils"].orEmpty(equipment.equipmentCode);
    };
    ...
    WorkOrderFormComponent.prototype.openRequest = function () {
        if (this.woStatus.workPostponementRequestBidoNotificationData &&
    ...
    WorkOrderFormComponent.prototype.onValidateRequest = function (requestReason) {
        ...
        if (this.user && this.user.login) {
            ...
            this.woFormService.createWorkPostponementRequest(workPostponementInput).subscribe(function () {
                ...
                _this.woFormService.calculateWorkOrderStatus(calculateWorkOrderImput).subscribe(function (calculateWorkOrderOutput) {
    ...
    WorkOrderFormComponent.prototype.saveWOBidmDoc = function () {
        ...
        if (missingFields.length > 0) {
            ...
            this.workOrder.bidmDocumentAddedList = this.woBidmDocumentsTableData
                .getAddedList()
                .map(function (elt) { return _this.findBidmDocumentByDocumentRow(elt); });
            this.workOrder.bidmDocumentUpdatedList = this.woBidmDocumentsTableData
                .getUpdatedList()
                .map(function (elt) { return _this.findBidmDocumentByDocumentRow(elt); });
            this.workOrder.bidmDocumentDeletedList = this.woBidmDocumentsTableData.getDeletedList().map(function (elt) {
                return {
    ...
    WorkOrderFormComponent.prototype.callGoodsMovement = function () {
        ...
        var data = {
            ...
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_14__["ComponentConstants"].LOG_GOODS_MOVEMENT_WORK_ORDER_FORM,
    ...
    WorkOrderFormComponent.prototype.openStaffPlanningFormBySite = function (componentData, site) {
        ...
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_14__["ComponentConstants"].HR_EMPLOYEE_PLANNING_FORM,
            openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read
        };
    ...
    WorkOrderFormComponent.prototype.openStaffPlanningSearch = function (componentData) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_14__["ComponentConstants"].HR_EMPLOYEE_PLANNING_SEARCH,
            openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read
        };
        data.objectId = this.serializationService.serialize(componentData);
        var labelKey = 'transaction.' + data.componentId;
    ...
    WorkOrderFormComponent.prototype.callMaterialAvailability = function () {
        ...
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_14__["ComponentConstants"].LOG_MATERIAL_AVAILABILITY_WORK_ORDER_FORM,
            openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read,
            objectId: this.serializationService.serialize(goodsMovementInput)
        };
        var labelKey = 'transaction.' + data.componentId;
    ...
    WorkOrderFormComponent.prototype.openEditDuration = function () {
        var _this = this;
        this.operationSelectedIndex = this.operationTable.findIndex(function (res) { return res.bireOpeCode === _this.selectedOperations[0].bireOpeCode; });
        this.displayEditDuration = true;
    };
    /**
     * Validate duration
    ...
    WorkOrderFormComponent.prototype.onValidateDuration = function (ev, source) {
        if (ev.elapsedTime && ev.performedDuration) {
            ...
            if (this.timeToDisplay(actualDuration) !== DEFAULT_DISPLAY_TIME) {
                ...
                if (!this.operationTable[this.operationSelectedIndex].opeStartDateDisplay ||
                    !this.operationTable[this.operationSelectedIndex].opePerformedBy) {
                    this.operationTable[this.operationSelectedIndex].opeStartDateDisplay = this.getFullDateFormatWithDate(ev.performedDuration);
                    if (!!this.sessionService.loggedUser && !!this.sessionService.loggedUser.login) {
                        this.operationTable[this.operationSelectedIndex].opePerformedOnDisplay = this.sessionService.loggedUser.login;
                    }
                }
                if (source === 0) {
    ...
    WorkOrderFormComponent.prototype.loadWorkOrder = function () {
        ...
        this.woFormService.findBidmWorkOrder(this.bidmWorkOrderId).subscribe(function (result) {
            if (result === null) {
                ...
                _this.displayComponentContext(_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_39__["StringUtils"].orEmpty(result.bidmWorkOrder.woCode), false);
                ...
                if (_this.workPackage) {
                    ...
                    _this.woFormService.findBidoEquipment(equipementId).subscribe(function (wpEquipementDtoDto) {
                        ...
                        if (_this.workPackage && _this.workOrder && _this.wpEquipementDto && _this.wpEquipementDto.equipmentCode) {
                        ...
                        if (_this.woStatus && _this.wpEquipementDto) {
                            _this.woEquipement = _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_33__["BidoEquipmentUtils"].toString(_this.wpEquipementDto);
                        }
                        if (_this.wpEquipementDto &&
                            (_this.wpEquipementDto.equipmentFunction ===
                                _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].ITEM_FAMILY_CODE_GROUND_SUPPORT_EQUIPMENT_KEY ||
                                _this.wpEquipementDto.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].ITEM_FAMILY_CODE_TOOL_KEY ||
                                _this.wpEquipementDto.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].ITEM_FAMILY_CODE_PILOT_EQUIPMENT_KEY)) {
                ...
                if (_this.woStatus.status === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_POSTPONEMENT_REQUESTED) {
                ...
                if (result.woPerformedBy) {
                    ...
                    _this.woFormService.findUserById(userDtoId).subscribe(function (user) {
                        if (user.employeeId) {
                            _this.woFormService.getEmployeeById(Number(user.employeeId)).subscribe(function (employee) {
                                _this.woPerformedBy = _this.getEmployeeText(employee, user) + " (" + moment__WEBPACK_IMPORTED_MODULE_3__(result.bidmWorkOrder.woPerformedOn).format('MM/DD/YYYY hh:mm') + ")";
                            });
                        }
                        else {
                            _this.woPerformedBy = _this.getUserText(user) + " (" + moment__WEBPACK_IMPORTED_MODULE_3__(result.bidmWorkOrder.woPerformedOn).format('MM/DD/YYYY hh:mm') + ")";
                        }
                    });
                }
                if (result.woCheckedBy) {
                    ...
                    _this.woFormService.findUserById(userDtoId).subscribe(function (user) {
                        if (user.employeeId) {
                            _this.woFormService.getEmployeeById(Number(user.employeeId)).subscribe(function (employee) {
                                _this.woCheckedBy = _this.getEmployeeText(employee, user) + " (" + moment__WEBPACK_IMPORTED_MODULE_3__(result.bidmWorkOrder.woCheckedOn).format('MM/DD/YYYY hh:mm') + ")";
                            });
                        }
                        else {
                            _this.woCheckedBy = _this.getUserText(user) + " (" + moment__WEBPACK_IMPORTED_MODULE_3__(result.bidmWorkOrder.woCheckedOn).format('MM/DD/YYYY hh:mm') + ")";
                        }
                    });
                }
    ...
    WorkOrderFormComponent.prototype.calculateWorkOrderStatus = function () {
        ...
        this.woFormService.calculateWorkOrderStatus(calculateWorkOrderImput).subscribe(function (calculateWorkOrderOutput) {
            ...
            if (!!_this.originText &&
                ...
                _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_TASK === _this.workOrder.woType) {
                ...
                _this.woFormService.findWorkOrderOriginDetails(assetWorkOrderOriginInput).subscribe(function (assetOutput) {
            ...
            else if (!!_this.woTask && _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_DEFECT === _this.workOrder.woType) {
                var bireTaskDTO = {
                    taskCode: _shared_utils_bidm_work_order_utils__WEBPACK_IMPORTED_MODULE_32__["BidmWorkOrderUtils"].getTaskCodeFromTaskId(_this.woTask),
                    taskVersion: _shared_utils_bidm_work_order_utils__WEBPACK_IMPORTED_MODULE_32__["BidmWorkOrderUtils"].getTaskVersionFromTaskId(_this.woTask)
                };
                _this.getTask(bireTaskDTO);
            }
            else if (_this.woStatus.bidmOperationDataList && _this.woStatus.bidmOperationDataList.length > 0) {
                if (_this.woStatus.bidmOperationDataList[0].bireTaskCode &&
    ...
    WorkOrderFormComponent.prototype.loadWorkCenter = function () {
        ...
        if (this.workOrder.bidtWarehouseId) {
            this.woFormService.getWarehouseById(this.workOrder.bidtWarehouseId).subscribe(function (warehouse) {
                _this.bidtWorkCenter = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_39__["StringUtils"].orEmpty(warehouse.whName);
    ...
    WorkOrderFormComponent.prototype.updateInterface = function (withChart) {
        ...
        if (withChart) {
            this.opStatusList = this.woStatus.bidmOperationDataList
                ? this.woStatus.bidmOperationDataList.map(function (op) { return op.opeStatus; })
                : [];
            this.updateChart();
        }
        var status = this.statusList.filter(function (s) { return s.value === _this.woStatus.status; }).map(function (s) { return s.label; });
        this.pageTitle = this.workOrder.woCode + " - " + status;
    };
    WorkOrderFormComponent.prototype.initChart = function () {
        this.chartDataset = [
            {
                statusList: [_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_SIMULATED],
                value: 0,
            ...
            {
                statusList: [_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_PLANNED],
                value: 0,
                color: _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_9__["AppConstants"].COLOR_GREY,
                label: this.translateService.instant(this.getTranslateKey('chartPlanned'))
            },
            {
                statusList: [_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_RELEASED],
                value: 0,
                color: _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_9__["AppConstants"].COLOR_GREY,
                label: this.translateService.instant(this.getTranslateKey('chartReleased'))
            },
            {
                statusList: [_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_ONGOING],
                value: 0,
            ...
            {
                statusList: [_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_TO_BE_CONFIRMED],
                value: 0,
                color: _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_9__["AppConstants"].COLOR_BLUE_LIGHT,
                label: this.translateService.instant(this.getTranslateKey('chartToBeConfirmed'))
            },
            {
                statusList: [_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_PERFORMED],
                value: 0,
            ...
            {
                statusList: [_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_CLOSE],
                value: 0,
    ...
    WorkOrderFormComponent.prototype.setChartOptions = function () {
        this.chartOptions = {
            ...
            tooltips: {
                bodyFontColor: _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_9__["AppConstants"].COLOR_BACKGROUND_PRIMARY
            },
            scales: {
                xAxes: [
                    {
        ...
        if (this.workOrder.woId && this.workOrder.projectId) {
            ...
            this.woFormService.generateJobcard(bidmWorkOrderId).subscribe({
                next: function (jobcard) {
                    _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_35__["FileUtils"].downloadFile(jobcard.fileContent, jobcard.fileName);
                    _this.showSaveSpinner = false;
                }
            });
        }
    ...
    WorkOrderFormComponent.prototype.initOperationTable = function () {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["forkJoin"])(observableListCheckBy).subscribe(function (userCheckByList) {
            var _loop_1 = function (i) {
                _this.operationTable[i].opeCheckedBy = userCheckByList[i].userId;
                if (!!userCheckByList[i].employeeId) {
                    _this.woFormService.getEmployeeById(Number(userCheckByList[i].employeeId)).subscribe(function (employee) {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["forkJoin"])(observableListPerformedBy).subscribe(function (userPerformedByList) {
            var _loop_2 = function (i) {
                _this.operationTable[i].opePerformedLastBy = userPerformedByList[i].userId;
                if (!!userPerformedByList[i].employeeId) {
                    _this.woFormService.getEmployeeById(Number(userPerformedByList[i].employeeId)).subscribe(function (employee) {
        ...
        operationsList.forEach(function (ope) {
            ...
            listStatusPercentWrapper[ope[bireOpeRow].ope_CODE] = _this.woFormService.getProgressFromOperationStatus(progressFromOperationStatusInput);
        });
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["forkJoin"])(listStatusPercentWrapper).subscribe(function (statusPercentList) {
            Object.keys(statusPercentList).forEach(function (key) {
                var bireOpeRow = 'bireOperationData';
                var operationRow = _this.operationTable.find(function (row) { return row[bireOpeRow].ope_CODE === key; });
                if (operationRow) {
    ...
    WorkOrderFormComponent.prototype.performOperation = function (row, eSign) {
        ...
        if (!row.isOpeOnElapsed) {
            if (row.opeStatus === this.awPropertiesConstants.AIRM_OPERATION_STATUS_PERFORMED ||
    ...
    WorkOrderFormComponent.prototype.checkWorkOrder = function (eSign) {
        ...
        if (this.woStatus.status === this.awPropertiesConstants.AIRM_OPERATION_STATUS_CLOSE) {
            ...
            this.woCheckedBy = this.userText + " (" + moment__WEBPACK_IMPORTED_MODULE_3__["unix"](currentDate).format('MM/DD/YYYY') + ")";
    ...
    WorkOrderFormComponent.prototype.saveOperation = function (row) {
        ...
        this.woFormService.updateBidmOperation(bidmOperationDtoRow).subscribe(function () {
            _this.woFormService.getProgressFromOperationStatus(progressFromOperationStatusInput).subscribe(function (percent) {
                if (row.opeStatus) {
                ...
                _this.woFormService.calculateAndUpdateBidmWorkOrderStatus(calculateWorkOrderImput).subscribe(function (newStatus) {
    ...
    WorkOrderFormComponent.prototype.startOrEndDuration = function (operationRow) {
        ...
        if (!operationRow.isOpeOnPerformed) {
            ...
            operationRow.opeStatus = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_ONGOING;
        ...
        else if (this.dateStartPerformedDuration &&
            ...
            this.addBidmTimeTrackingData(operationRow, new Date(this.dateStartPerformedDuration), new Date(this.dateEndPerformedDuration), duration, elasped);
    ...
    WorkOrderFormComponent.prototype.startOrEndElapsed = function (operationRow) {
        if (operationRow.isOpeOnElapsed &&
            ...
            if (operationRow.isOpeOnPerformed) {
                ...
                this.addBidmTimeTrackingData(operationRow, new Date(this.dateStartElapsedDuration), new Date(this.dateEndElapsedDuration), 0, elasped);
            }
    ...
    WorkOrderFormComponent.prototype.addBidmTimeTrackingData = function (operationRow, dateIn, dateOut, duration, elapsed) {
        var _this = this;
        // add entry in log table
    ...
    WorkOrderFormComponent.prototype.clickConfirmWorkCompletion = function () {
        var _this = this;
        if (this.woStatus.status === this.awPropertiesConstants.AIRM_OPERATION_STATUS_ONGOING &&
            this.isCriticalWithoutOperation()) {
    ...
    WorkOrderFormComponent.prototype.stratOrRestartWo = function (eSign) {
        ...
        else if (this.woStatus.status === this.awPropertiesConstants.AIRM_OPERATION_STATUS_TO_BE_CONFIRMED ||
            ((this.woStatus.status === this.awPropertiesConstants.AIRM_OPERATION_STATUS_PLANNED ||
                this.woStatus.status === this.awPropertiesConstants.AIRM_OPERATION_STATUS_RELEASED ||
                this.woStatus.status === this.awPropertiesConstants.AIRM_OPERATION_STATUS_ONGOING) &&
                !!this.operationTable)) {
    ...
    WorkOrderFormComponent.prototype.deleteLogbookNotificationFromWorkOrder = function () {
        ...
        if (this.workPackage.projectId && this.workOrder.woId) {
            ...
            this.woFormService.deleteLogbookNotificationFromWorkOrder(proj).subscribe(function () {
                _this.messageService.showSuccessMessage(_this.getTranslateKey('successOnLogbookNotificationDeletion'));
            }, function (err) {
    ...
    WorkOrderFormComponent.prototype.manageUpdateLogbookFromWorkOrder = function () {
        ...
        if (this.workPackage.projectId && this.workOrder.woId) {
            ...
            this.woFormService.initializeUpdateLogbookFromWorkOrderInput(proj).subscribe(function (input) {
    ...
    WorkOrderFormComponent.prototype.updateLogbookFromWorkOrder = function (input) {
        var _this = this;
        this.woFormService.updateLogbookFromWorkOrderInput(input).subscribe(function () {
    ...
    WorkOrderFormComponent.prototype.setPerformed = function (eSign) {
        var currentDate = moment__WEBPACK_IMPORTED_MODULE_3__().unix();
        if (this.user) {
            this.woPerformedBy = this.userText + " (" + moment__WEBPACK_IMPORTED_MODULE_3__["unix"](currentDate).format('MM/DD/YYYY') + ")";
    ...
    WorkOrderFormComponent.prototype.countConfiguration = function (checkPart) {
        ...
        this.outgoinConfiguration.ok += checkPart === _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_15__["ControlConfigConstants"].ICON_GREEN ? 1 : 0;
        this.outgoinConfiguration.warning += checkPart === _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_15__["ControlConfigConstants"].ICON_YELLOW ? 1 : 0;
        this.outgoinConfiguration.nok += checkPart === _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_15__["ControlConfigConstants"].ICON_RED ? 1 : 0;
    };
    WorkOrderFormComponent.prototype.openAppliedConfigurationManagement = function () {
        if (this.workPackage.assetCode) {
            ...
            var data = {
                id: this.tabService.generateId(),
                openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read,
                componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_14__["ComponentConstants"].MAI_CONFIGURATION_CONTROL,
        ...
        if (equipment) {
            switch (equipment.equipmentFunction) {
                case this.awPropertiesConstants.FAMILY_FUNCTION_AIRCRAFT_KEY:
                    this.goToAircraft(equipment.equipmentCode, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read);
                    break;
                case this.awPropertiesConstants.FAMILY_FUNCTION_ENGINE_KEY:
                    this.goToEngine(equipment.equipmentCode, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read);
                    break;
                default:
                    this.goToEquipment(equipment.equipmentCode, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read);
                    break;
            }
        }
    };
    ...
    WorkOrderFormComponent.prototype.openTaskLink = function (task) {
        if (task) {
            if (task.taskCode && task.taskCode.trim().length > 0) {
                this.openTask(task, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read);
            }
            else {
    ...
    WorkOrderFormComponent.prototype.openModification = function (row) {
        ...
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_14__["ComponentConstants"].ENG_MODIFICATION_FORM,
    ...
    WorkOrderFormComponent.prototype.openEvent = function (rowData) {
        ...
        this.woFormService.findBidoNotification(bidoNotificationDTOId).subscribe(function (res) {
            if (!!res.bidoNotificationTypeDTO &&
                ...
                _this.openEventUC(dto, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read);
            }
        });
    };
    WorkOrderFormComponent.prototype.openEventUC = function (objectId, openMode) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_14__["ComponentConstants"].FLE_EVENT_CREATE,
            openMode: openMode
        };
        if (!!objectId) {
            var eventId = {
    ...
    WorkOrderFormComponent.prototype.openDefect = function (eventId) {
        if (eventId) {
            var data = {
                id: this.tabService.generateId(),
                componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_14__["ComponentConstants"].FLE_DEFECT_FORM,
    ...
    WorkOrderFormComponent.prototype.openItemLink = function (item) {
        if (!!item) {
            if (_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_39__["StringUtils"].isNullOrEmpty(item.familyCode)) {
                this.messageService.showWarningMessage(this.getTranslateKey('errorOnMissingCode'));
            }
            else {
                this.openItem(item, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read);
            }
        }
    };
    WorkOrderFormComponent.prototype.openItem = function (objectId, openMode) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_14__["ComponentConstants"].ENG_ITEM_FORM,
            openMode: openMode
        };
        if (!!objectId) {
            var itemFormId = {
    ...
    WorkOrderFormComponent.prototype.openWorkPackageLink = function () {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_14__["ComponentConstants"].MAI_WORK_PACKAGE_FORM,
    ...
    WorkOrderFormComponent.prototype.consultWorkOrderOrigin = function () {
        ...
        if (!!this.originText && this.wpEquipementDto) {
            ...
            this.woFormService.findWorkOrderOriginDetails(assetWorkOrderOriginInput).subscribe(function (result) {
                if (_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_TASK === _this.workOrder.woType) {
                    if (!!result.bireTaskDTOId) {
                        // open task form
                        var bireTaskDTO = result.bireTaskDTOId;
                        _this.openTask(bireTaskDTO, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read);
                    }
                }
                else if (_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_EVOLUTION === _this.workOrder.woType) {
                    if (_shared_constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_11__["BidoEvolutionConstants"].CODE_EVOLUTION === _this.evolutionType) {
                    ...
                    else if (_shared_constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_11__["BidoEvolutionConstants"].CODE_AD === _this.evolutionType) {
                    ...
                    else if (_shared_constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_11__["BidoEvolutionConstants"].CODE_SB === _this.evolutionType) {
                        if (!!result.bireSbDTOId) {
                    ...
                    else if (_shared_constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_11__["BidoEvolutionConstants"].CODE_MODIFICATION === _this.evolutionType) {
                ...
                else if (_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_DEFECT === _this.workOrder.woType) {
                ...
                else if (_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_SN_CHANGE === _this.workOrder.woType) {
                    if (!!result.bidoEquipmentDTO) {
                        if (_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].ITEM_FAMILY_CODE_AIRCRAFT_KEY === result.bidoEquipmentDTO.equipmentFunction) {
                            // open aircraft
                            _this.goToAircraft(result.bidoEquipmentDTO.equipmentCode, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read);
                        }
                        else if (_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].ITEM_FAMILY_CODE_ENGINE_KEY === result.bidoEquipmentDTO.equipmentFunction) {
                            // open engine
                            _this.goToEngine(result.bidoEquipmentDTO.equipmentCode, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read);
                        }
                        else {
                            // open equipment
                            _this.goToEquipment(result.bidoEquipmentDTO.equipmentCode, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_17__["ComponentOpenMode"].Read);
                        }
                    }
                }
            });
        }
        else if (!!this.originText && _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_DEFECT === this.workOrder.woType) {
        ...
        if (this.bireTask.taskCode && this.bireTask.taskVersion) {
            ...
            this.woFormService.findBireDocTaskByTask(bireTaskId).subscribe(function (docTaskList) {
                docTaskList.forEach(function (docTask) {
                    ...
                    var fileSize;
                    if (docTask.docFile) {
                        fileSize = _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_35__["FileUtils"].getFormattedSize(docTask.docFile.length);
                    }
    ...
    WorkOrderFormComponent.prototype.showDocExtension = function (document) {
        return _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_35__["FileUtils"].getExtension(document.docName).toUpperCase();
    };
    WorkOrderFormComponent.prototype.processMaterialIllustration = function (documentRow) {
        if (_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_38__["ObjectUtils"].isDefined(documentRow.docFile) && !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_39__["StringUtils"].isNullOrEmpty(documentRow.docExtension)) {
            documentRow.materialIllustration = this.domSanitizer.bypassSecurityTrustResourceUrl("" + _shared_utils_image_utils__WEBPACK_IMPORTED_MODULE_36__["ImageUtils"].getBase64Prefix(documentRow.docExtension) + documentRow.docFile);
        }
    };
    ...
    WorkOrderFormComponent.prototype.ctrlStock = function () {
        ...
        if (this.workPackage.projectId && this.workOrder.woId) {
            ...
            var input = {
                ...
                mvtStatusExcluded: [
                    _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].MM_MVT_STATUS_EXECUTED_KEY,
                    _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].MM_MVT_STATUS_CANCELED_KEY,
                    _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].MM_MVT_STATUS_CLOSED_KEY
                ],
    ...
    WorkOrderFormComponent.prototype.countStockConfig = function (stock) {
        ...
        this.stockControlConf.ok += stock.status === _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_15__["ControlConfigConstants"].ICON_GREEN_LIGHT_CODE ? 1 : 0;
        this.stockControlConf.warning += stock.status === _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_15__["ControlConfigConstants"].ICON_YELLOW_LIGHT_CODE ? 1 : 0;
        this.stockControlConf.nok += stock.status === _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_15__["ControlConfigConstants"].ICON_RED_LIGHT_CODE ? 1 : 0;
    };
    ...
    WorkOrderFormComponent.prototype.showButtonOpenStaffPlanning = function () {
        return this.sessionService.hasUserRightByUseCase(_shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_12__["BidoFunctionTypeConstants"].UC_HR_EMPLOYEE, _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_12__["BidoFunctionTypeConstants"].DEGREE_DISPLAY);
    };
    ...
    WorkOrderFormComponent.prototype.initInstallRemoveStatuses = function () {
        ...
        var observable = this.isGroundEquipment
            ? this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_16__["GenericPropertyConstants"].GROUND_EQUIPMENT_STATUS_MAP)
            : this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_16__["GenericPropertyConstants"].OPERATIONAL_STATUS_MAP);
        observable.subscribe(function (list) {
            _this.removeOperationalStatuses = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_37__["ListUtils"].orEmpty(list)
                .filter(function (elt) { return elt.value !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].OPERATIONAL_STATUS_IN_OPERATION_KEY; })
                .sort(function (elt1, elt2) { return elt1.label.localeCompare(elt2.label); });
            _this.installOperationalStatuses = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_37__["ListUtils"].orEmpty(list)
                .filter(function (elt) {
                return elt.value !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].OPERATIONAL_STATUS_SPARE_KEY &&
                    elt.value !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__["AWPropertiesConstants"].OPERATIONAL_STATUS_SCRAPPED_KEY;
            })
                .sort(function (elt1, elt2) { return elt1.label.localeCompare(elt2.label); });
        });
    };
    ...
    WorkOrderFormComponent.prototype.loadTransferOrders = function (woAssetManagementDTO, row) {
        if (!!row.selectedBidoEquipmentDTO &&
            !!row.selectedPn &&
    ...
    WorkOrderFormComponent.prototype.addJobCardWoAssetManagementRow = function (woAssetManagementDTO) {
        var row = __assign({}, woAssetManagementDTO, { key: this.woAssetManagementTable.length + "-id", availableDecisions: this.getAvailableDecisions(), availableEquipments: this.getAvailableEquipments(woAssetManagementDTO), availableSuperiorAssets: this.getAvailableSuperiorAssets(woAssetManagementDTO), availableWarehouses: this.getAvailableWarehouses(woAssetManagementDTO), availableItems: this.getAvailableItems(woAssetManagementDTO), availableFunctionCodes: this.getAvailableFunctionCodes(woAssetManagementDTO), availablePNs: this.getAvailablePns(woAssetManagementDTO), availableStatuses: this.getAvailableStatuses(woAssetManagementDTO), availableFls: this.getAvailableFls(woAssetManagementDTO), transferOrders: [], _obj: woAssetManagementDTO });
    ...
    WorkOrderFormComponent.prototype.initWoAssetAlert = function (row) {
        if (!row.alertIcon && !row.bidoNotificationDTO) {
            if (this.woAssetManagementIsReady(row)) {
                row.isReady = true;
                row.alertIcon = _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_15__["ControlConfigConstants"].ICON_GREEN_LIGHT_CODE;
            }
            else {
                row.alertIcon = _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_15__["ControlConfigConstants"].ICON_RED_LIGHT_CODE;
            }
        }
    };
    WorkOrderFormComponent.prototype.getAvailableDecisions = function () {
        ...
        decisionList.push({
            ...
            value: _shared_constants_bido_notification_type_constants__WEBPACK_IMPORTED_MODULE_13__["BidoNotificationTypeConstants"].ASSEMBLY_TYPE_CODE
        });
        decisionList.push({
            label: this.translateService.instant(this.getTranslateKey('remove')),
            value: _shared_constants_bido_notification_type_constants__WEBPACK_IMPORTED_MODULE_13__["BidoNotificationTypeConstants"].DISASSEMBLY_TYPE_CODE
        });
        return decisionList;
    };
    WorkOrderFormComponent.prototype.getAvailableWarehouses = function (woAssetManagementDTO) {
        return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_37__["ListUtils"].orEmpty(woAssetManagementDTO.availableWarehouseList)
            .filter(function (warehouse) { return _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_38__["ObjectUtils"].isDefined(warehouse.whCode); })
            .map(function (warehouse) {
            return {
                label: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_39__["StringUtils"].isNullOrEmpty(warehouse.whName)
                    ? warehouse.whCode
    ...
    WorkOrderFormComponent.prototype.getAvailableSuperiorAssets = function (woAssetManagementDTO) {
        return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_37__["ListUtils"].orEmpty(woAssetManagementDTO.avaialableSuperiorAssetList)
            .filter(function (data) { return _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_38__["ObjectUtils"].isDefined(data.equipmentCode); })
            .map(function (data) {
            return {
                label: _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_33__["BidoEquipmentUtils"].toString(data),
                value: data
            };
        });
    };
    WorkOrderFormComponent.prototype.getAvailableEquipments = function (woAssetManagementDTO) {
        return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_37__["ListUtils"].orEmpty(woAssetManagementDTO.availableBidoEquipmentList)
            .filter(function (data) { return _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_38__["ObjectUtils"].isDefined(data.equipmentCode); })
            .map(function (data) {
            return {
                label: data.sn,
    ...
    WorkOrderFormComponent.prototype.getAvailableItems = function (woAssetManagementDTO) {
        return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_37__["ListUtils"].orEmpty(woAssetManagementDTO.availableItemDTOList).map(function (data) {
            return {
                label: _shared_utils_bire_item_utils__WEBPACK_IMPORTED_MODULE_34__["BireItemUtils"].createItemKey(data) + "-" + data.name,
                value: data
            };
        });
    };
    WorkOrderFormComponent.prototype.getAvailableFunctionCodes = function (woAssetManagementDTO) {
        return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_37__["ListUtils"].orEmpty(woAssetManagementDTO.availableFunctionCodeList).map(function (data) {
            return {
                label: data,
                value: data
            };
    ...
    WorkOrderFormComponent.prototype.getAvailablePns = function (woAssetManagementDTO) {
        return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_37__["ListUtils"].orEmpty(woAssetManagementDTO.availablePNDTOList).map(function (data) {
            return {
                label: "" + data.pnCode,
                value: data.pnCode
            };
    ...
    WorkOrderFormComponent.prototype.getAvailableStatuses = function (woAssetManagementDTO) {
        if (woAssetManagementDTO &&
            woAssetManagementDTO.notificationType === _shared_constants_bido_notification_type_constants__WEBPACK_IMPORTED_MODULE_13__["BidoNotificationTypeConstants"].ASSEMBLY_TYPE_CODE) {
    ...
    WorkOrderFormComponent.prototype.getAvailableFls = function (woAssetManagementDTO) {
        return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_37__["ListUtils"].orEmpty(woAssetManagementDTO.availableFlDTOList).map(function (data) {
            return {
    ...
    WorkOrderFormComponent.prototype.updateWoAssetDecision = function (rowData) {
        ...
        var input = {
            ...
            woAssetManagementDTOs: this.allWoAssetManagements.filter(function (woAssetManagement) { return woAssetManagement !== rowData._obj; }),
    ...
    WorkOrderFormComponent.prototype.woAssetManagementIsReady = function (rowData) {
        if (!!rowData.bidoNotificationDTO ||
    ...
    WorkOrderFormComponent.prototype.openStatusUpdatesPopup = function () {
        ...
        var columns = [
            { field: 'timestamp', width: '200px', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_18__["TableColumnFilterMode"].Input, isDate: true, alignment: 'left' },
            { field: 'opeStatus', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_18__["TableColumnFilterMode"].Input },
            { field: 'opeComment', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_18__["TableColumnFilterMode"].Input },
            { field: 'opeCheckedBy', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_18__["TableColumnFilterMode"].Input },
            {
                field: 'opeCheckedOn',
                alignment: 'left',
                width: '6.25rem',
                filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_18__["TableColumnFilterMode"].Input,
                isDateWithHour: true
            },
            { field: 'opePerformedBy', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_18__["TableColumnFilterMode"].Input },
            {
        ...
        this.updatesKeyMap.set('opeStatus', this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_16__["GenericPropertyConstants"].AIRM_OPERATION_STATUS_MAP));
        ...
        this.tableOperationUpdatesData = {
            ...
            dataKey: undefined,
            selectionMode: _shared_enums_table_selection_mode_enum__WEBPACK_IMPORTED_MODULE_19__["TableSelectionMode"].Multiple,
            globalFilter: false
        };
    };
    /**
    ...
    WorkOrderFormComponent.prototype.showPrintIdLabelButton = function () {
        if (!!this.selectedWoAssetManagements &&
            ...
            this.selectedWoAssetManagements[0]._obj.notificationType ===
                _shared_constants_bido_notification_type_constants__WEBPACK_IMPORTED_MODULE_13__["BidoNotificationTypeConstants"].DISASSEMBLY_TYPE_CODE &&
    ...
    WorkOrderFormComponent.prototype.openTransferOrder = function (transferOrder) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_14__["ComponentConstants"].LOG_TRANSFER_ORDER_FORM,
    ...
    WorkOrderFormComponent.prototype.initWoUserList = function () {
        var _this = this;
        var param = {
            useCaseCode: _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_12__["BidoFunctionTypeConstants"].UC_AIRM_EXECUTION
        };
        if (!!this.bireTask) {
    ...
    ], WorkOrderFormComponent.prototype, "mainAnchor", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('workPackageAnchor'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], WorkOrderFormComponent.prototype, "workPackageAnchor", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('progressAnchor'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], WorkOrderFormComponent.prototype, "workOrderProgressAnchor", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('generalAnchor'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], WorkOrderFormComponent.prototype, "generalAnchor", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('operationsAnchor'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], WorkOrderFormComponent.prototype, "operationsAnchor", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('commentAnchor'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], WorkOrderFormComponent.prototype, "commentAnchor", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('additionalWorkAnchor'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], WorkOrderFormComponent.prototype, "additionalWorkAnchor", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('taskDocumentsAnchor'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], WorkOrderFormComponent.prototype, "taskDocumentsAnchor", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('woDocumentsAnchor'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], WorkOrderFormComponent.prototype, "woDocumentsAnchor", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('defectsAnchor'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], WorkOrderFormComponent.prototype, "defectsAnchor", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('requestManagmentAnchor'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], WorkOrderFormComponent.prototype, "requestManagmentAnchor", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('installRemoveAnchor'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], WorkOrderFormComponent.prototype, "installRemoveAnchor", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('procurementRequestsTable'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], WorkOrderFormComponent.prototype, "procurementRequestTableAnchor", void 0);
    WorkOrderFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-work-order',
            template: __webpack_require__(/*! ./work-order-form.component.html */ "./src/app/main/maintenance/work-order/form/work-order-form.component.html"),
            styles: [__webpack_require__(/*! ./work-order-form.component.scss */ "./src/app/main/maintenance/work-order/form/work-order-form.component.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_favorite_service__WEBPACK_IMPORTED_MODULE_23__["FavoriteService"],
            ...
            _human_resources_employee_form_employee_form_service__WEBPACK_IMPORTED_MODULE_42__["EmployeeFormService"],
            ...
            _procurement_request_procurement_requests_table_service__WEBPACK_IMPORTED_MODULE_45__["ProcurementRequestsTableService"],
...
/* harmony import */ var primeng_fileupload__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! primeng/fileupload */ "./node_modules/primeng/fileupload.js");
/* harmony import */ var primeng_fileupload__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(primeng_fileupload__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var primeng_treetable__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! primeng/treetable */ "./node_modules/primeng/treetable.js");
/* harmony import */ var primeng_treetable__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(primeng_treetable__WEBPACK_IMPORTED_MODULE_12__);
...
/* harmony import */ var _shared_components_create_event_form_create_event_form_module__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../shared/components/create-event-form/create-event-form.module */ "./src/app/shared/components/create-event-form/create-event-form.module.ts");
...
/* harmony import */ var _shared_components_dialog_equipment_list_dialog_equipment_list_module__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../shared/components/dialog-equipment-list/dialog-equipment-list.module */ "./src/app/shared/components/dialog-equipment-list/dialog-equipment-list.module.ts");
/* harmony import */ var _shared_components_dialog_search_equipment_dialog_search_equipment_module__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../../shared/components/dialog-search-equipment/dialog-search-equipment.module */ "./src/app/shared/components/dialog-search-equipment/dialog-search-equipment.module.ts");
/* harmony import */ var _shared_components_dialog_search_pn_dialog_search_pn_module__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../../shared/components/dialog-search-pn/dialog-search-pn.module */ "./src/app/shared/components/dialog-search-pn/dialog-search-pn.module.ts");
/* harmony import */ var _shared_components_dialog_update_logbook_dialog_update_logbook_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../../shared/components/dialog-update-logbook/dialog-update-logbook.component */ "./src/app/shared/components/dialog-update-logbook/dialog-update-logbook.component.ts");
...
/* harmony import */ var _human_resources_employee_form_employee_form_service__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../../human-resources/employee-form/employee-form.service */ "./src/app/main/human-resources/employee-form/employee-form.service.ts");
/* harmony import */ var _logistics_procurement_request_search_procurement_request_popup_procurement_request_popup_module__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../../logistics/procurement-request/search/procurement-request-popup/procurement-request-popup.module */ "./src/app/main/logistics/procurement-request/search/procurement-request-popup/procurement-request-popup.module.ts");
/* harmony import */ var _procurement_request_procurement_requests_table_module__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../procurement-request/procurement-requests-table.module */ "./src/app/main/maintenance/procurement-request/procurement-requests-table.module.ts");
/* harmony import */ var _work_package_form_popups_dialog_work_order_edition_dialog_work_order_edition_module__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ../work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.module */ "./src/app/main/maintenance/work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.module.ts");
...
/* harmony import */ var _form_popups_dialog_edit_duration_dialog_edit_duration_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./form/popups/dialog-edit-duration/dialog-edit-duration.component */ "./src/app/main/maintenance/work-order/form/popups/dialog-edit-duration/dialog-edit-duration.component.ts");
/* harmony import */ var _form_popups_dialog_import_work_order_document_dialog_import_work_order_document_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./form/popups/dialog-import-work-order-document/dialog-import-work-order-document.component */ "./src/app/main/maintenance/work-order/form/popups/dialog-import-work-order-document/dialog-import-work-order-document.component.ts");
/* harmony import */ var _form_popups_dialog_job_card_time_tracking_entries_dialog_job_card_time_tracking_entries_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./form/popups/dialog-job-card-time-tracking-entries/dialog-job-card-time-tracking-entries.component */ "./src/app/main/maintenance/work-order/form/popups/dialog-job-card-time-tracking-entries/dialog-job-card-time-tracking-entries.component.ts");
/* harmony import */ var _form_popups_dialog_operation_check_dialog_operation_check_form_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./form/popups/dialog-operation-check/dialog-operation-check-form.component */ "./src/app/main/maintenance/work-order/form/popups/dialog-operation-check/dialog-operation-check-form.component.ts");
/* harmony import */ var _form_popups_dialog_postponement_dialog_postponement_form_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./form/popups/dialog-postponement/dialog-postponement-form.component */ "./src/app/main/maintenance/work-order/form/popups/dialog-postponement/dialog-postponement-form.component.ts");
/* harmony import */ var _form_popups_dialog_stakeholder_dialog_stakeholder_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./form/popups/dialog-stakeholder/dialog-stakeholder.component */ "./src/app/main/maintenance/work-order/form/popups/dialog-stakeholder/dialog-stakeholder.component.ts");
/* harmony import */ var _form_popups_last_update_wo_last_update_popup_module__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./form/popups/last-update/wo-last-update-popup.module */ "./src/app/main/maintenance/work-order/form/popups/last-update/wo-last-update-popup.module.ts");
/* harmony import */ var _form_work_order_form_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./form/work-order-form.component */ "./src/app/main/maintenance/work-order/form/work-order-form.component.ts");
/* harmony import */ var _form_work_order_form_service__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./form/work-order-form.service */ "./src/app/main/maintenance/work-order/form/work-order-form.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EXTERNAL_MODULES = [
    ...
    _shared_components_dialog_equipment_list_dialog_equipment_list_module__WEBPACK_IMPORTED_MODULE_19__["DialogEquipmentListModule"],
    ...
    _shared_components_dialog_search_equipment_dialog_search_equipment_module__WEBPACK_IMPORTED_MODULE_20__["DialogSearchEquipmentModule"],
    primeng_splitbutton__WEBPACK_IMPORTED_MODULE_9__["SplitButtonModule"],
    _work_package_form_popups_dialog_work_order_edition_dialog_work_order_edition_module__WEBPACK_IMPORTED_MODULE_30__["DialogWorkOrderEditionModule"],
...
var INTERNAL_MODULES = [
    _procurement_request_procurement_requests_table_module__WEBPACK_IMPORTED_MODULE_29__["ProcurementRequestsTableModule"],
    _shared_components_defect_list_defect_list_module__WEBPACK_IMPORTED_MODULE_18__["DefectListModule"],
    _shared_components_create_event_form_create_event_form_module__WEBPACK_IMPORTED_MODULE_17__["CreateEventFormModule"],
    _shared_components_dialog_search_pn_dialog_search_pn_module__WEBPACK_IMPORTED_MODULE_21__["DialogSearchPnModule"],
    _logistics_procurement_request_search_procurement_request_popup_procurement_request_popup_module__WEBPACK_IMPORTED_MODULE_28__["ProcurementRequestPopupModule"],
...
var DYNAMIC_COMPONENTS = [
    ...
    _form_popups_dialog_postponement_dialog_postponement_form_component__WEBPACK_IMPORTED_MODULE_37__["DialogPostponementFormComponent"],
    _form_popups_dialog_job_card_time_tracking_entries_dialog_job_card_time_tracking_entries_component__WEBPACK_IMPORTED_MODULE_35__["DialogJobCardTimeTrackingEntriesComponent"],
    _form_popups_dialog_edit_duration_dialog_edit_duration_component__WEBPACK_IMPORTED_MODULE_33__["DialogEditDurationComponent"],
    _form_popups_dialog_import_work_order_document_dialog_import_work_order_document_component__WEBPACK_IMPORTED_MODULE_34__["DialogImportWorkOrderDocumentComponent"],
    _form_popups_dialog_operation_check_dialog_operation_check_form_component__WEBPACK_IMPORTED_MODULE_36__["DialogOperationCheckFormComponent"],
    _form_popups_dialog_stakeholder_dialog_stakeholder_component__WEBPACK_IMPORTED_MODULE_38__["DialogStakeholderComponent"],
    _shared_components_dialog_update_logbook_dialog_update_logbook_component__WEBPACK_IMPORTED_MODULE_22__["DialogUpdateLogbookComponent"]
];
var SERVICES = [_form_work_order_form_service__WEBPACK_IMPORTED_MODULE_41__["WorkOrderFormService"], _work_package_form_work_package_form_service__WEBPACK_IMPORTED_MODULE_31__["WorkPackageFormService"], _work_package_work_package_service__WEBPACK_IMPORTED_MODULE_32__["WorkPackageService"], _human_resources_employee_form_employee_form_service__WEBPACK_IMPORTED_MODULE_27__["EmployeeFormService"]];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogUpdateLogbookComponent", function() { return DialogUpdateLogbookComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _types_dialog_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../types/dialog-component */ "./src/app/shared/types/dialog-component.ts");
/* harmony import */ var _utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/bido-equipment-utils */ "./src/app/shared/utils/bido-equipment-utils.ts");
/* harmony import */ var _table_table_data_source__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../table/table-data-source */ "./src/app/shared/components/table/table-data-source.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DialogUpdateLogbookComponent = /** @class */ (function (_super) {
    ...
    function DialogUpdateLogbookComponent(sessionService) {
        var _this = _super.call(this, _enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__["ComponentOpenMode"].Write, 'DialogUpdateLogbookComponent') || this;
        _this.sessionService = sessionService;
        _this.init();
        return _this;
    }
        ...
        if (this.updateLogbookFromWorkOrderInput) {
            ...
            if (this.updateLogbookFromWorkOrderInput.woEvolutionInputList) {
                this.updateLogbookFromWorkOrderInput.woEvolutionInputList.forEach(function (input) {
                    var row = __assign({}, input, { asset: _utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_4__["BidoEquipmentUtils"].toString(input.workOrderEvolutionDTO.woRelatedAsset), availablePnList: input.potentialNewPnList.map(function (newPn) {
                            return { label: newPn, value: newPn };
                        }), evolution: input.workOrderEvolutionDTO.evolutionNumber + '-' + input.workOrderEvolutionDTO.evolutionRevisionNumber });
    ...
    DialogUpdateLogbookComponent.prototype.init = function () {
        ...
        this.evolutionColumns = [
            { field: 'evolution', alignment: _table_table_data_source__WEBPACK_IMPORTED_MODULE_5__["ColumnAlignment"].LEFT, width: '33%' },
            { field: 'asset', alignment: _table_table_data_source__WEBPACK_IMPORTED_MODULE_5__["ColumnAlignment"].LEFT, width: '33%' },
            { field: 'availablePnList', alignment: _table_table_data_source__WEBPACK_IMPORTED_MODULE_5__["ColumnAlignment"].LEFT, width: '33%' }
        ];
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogUpdateLogbookComponent.prototype, "updateLogbookFromWorkOrderInput", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogUpdateLogbookComponent.prototype, "onValidated", void 0);
    DialogUpdateLogbookComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-update-logbook',
            template: __webpack_require__(/*! ./dialog-update-logbook.html */ "./src/app/shared/components/dialog-update-logbook/dialog-update-logbook.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BidmWorkOrderUtils", function() { return BidmWorkOrderUtils; });
