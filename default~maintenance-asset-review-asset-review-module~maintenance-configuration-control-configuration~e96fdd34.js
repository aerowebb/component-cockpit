(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~maintenance-asset-review-asset-review-module~maintenance-configuration-control-configuration~e96fdd34"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AssetRevSearchComponent", function() { return AssetRevSearchComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
/* harmony import */ var _constants_app_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../constants/app-constants */ "./src/app/shared/constants/app-constants.ts");
...
/* harmony import */ var _constants_lang_constants__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../constants/lang-constants */ "./src/app/shared/constants/lang-constants.ts");
/* harmony import */ var _enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
...
/* harmony import */ var _services_serialization_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../services/serialization.service */ "./src/app/shared/services/serialization.service.ts");
/* harmony import */ var _services_tab_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../services/tab.service */ "./src/app/shared/services/tab.service.ts");
/* harmony import */ var _types_generic_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../types/generic-component */ "./src/app/shared/types/generic-component.ts");
/* harmony import */ var _utils_list_utils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../utils/list-utils */ "./src/app/shared/utils/list-utils.ts");
/* harmony import */ var _utils_select_item_utils__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../utils/select-item-utils */ "./src/app/shared/utils/select-item-utils.ts");
/* harmony import */ var _utils_string_utils__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../utils/string-utils */ "./src/app/shared/utils/string-utils.ts");
/* harmony import */ var _asset_rev_search_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./asset-rev-search.service */ "./src/app/shared/components/asset-rev-search/asset-rev-search.service.ts");
...
var AssetRevSearchComponent = /** @class */ (function (_super) {
    ...
    function AssetRevSearchComponent(assetReviewSearchService, propertiesService, translateService, tabService, serializationService) {
        var _this = _super.call(this, _enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_8__["ComponentOpenMode"].Write) || this;
        ...
        _this.ASSETREVIEW_SEARCH_CRITERIA_ID = _constants_app_constants__WEBPACK_IMPORTED_MODULE_2__["AppConstants"].ASSETREVIEW_SEARCH_CRITERIA_ID;
    ...
    AssetRevSearchComponent.prototype.search = function () {
        ...
        if (this.selectedSearchAsset === SearchAsset.Aircraft) {
            this.searchObject.itemFamilyCodeKey = _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].ITEM_FAMILY_CODE_AIRCRAFT_KEY;
        }
        else if (this.selectedSearchAsset === SearchAsset.Engine) {
            this.searchObject.itemFamilyCodeKey = _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].ITEM_FAMILY_CODE_ENGINE_KEY;
        }
        else {
        ...
        this.assetReviewSearchService.findAllAssetByCriteria(this.searchObject).subscribe(function (result) {
            ...
            _this.resultTable.list = _utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(result.list);
    ...
    AssetRevSearchComponent.prototype.loadBusinessPartnerList = function () {
        ...
        this.assetReviewSearchService.findAllBidoCustomer().subscribe(function (results) {
            _this.businessPartnerList = _utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(results)
                .filter(function (customer) { return !!customer.customerCode; })
                .map(function (customer) {
                return {
                    label: _utils_string_utils__WEBPACK_IMPORTED_MODULE_15__["StringUtils"].isNullOrEmpty(customer.customerName)
    ...
    AssetRevSearchComponent.prototype.loadFamilyVariantList = function () {
        ...
        var familyFunction;
        if (this.selectedSearchAsset === SearchAsset.Aircraft) {
            familyFunction = _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].FAMILY_FUNCTION_AIRCRAFT_KEY;
        }
        else if (this.selectedSearchAsset === SearchAsset.Engine) {
            familyFunction = _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].FAMILY_FUNCTION_ENGINE_KEY;
        }
        else {
            familyFunction = '';
        }
        this.assetReviewSearchService.findAllBireVariantVersionByFamilyFunction(familyFunction).subscribe(function (results) {
            _this.familyVariantList = _utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(results)
    ...
    AssetRevSearchComponent.prototype.loadFleetList = function () {
        ...
        this.assetReviewSearchService.findAllBidoFleetByCriteria(criteria).subscribe(function (results) {
            _this.fleetList = _utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(results)
                .filter(function (fleet) { return !!fleet.fleetCode; })
                .map(function (fleet) {
                return {
                    label: _utils_string_utils__WEBPACK_IMPORTED_MODULE_15__["StringUtils"].isNullOrEmpty(fleet.fleetName)
                        ? fleet.fleetCode
    ...
    AssetRevSearchComponent.prototype.loadFunctionList = function () {
        var _this = this;
        this.propertiesService.getValue(_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].ITEM_FAMILY_CODE_MAP).subscribe(function (results) {
            _this.functionList = _utils_select_item_utils__WEBPACK_IMPORTED_MODULE_14__["SelectItemUtils"].fromLabelValues(_utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(results).filter(function (elt) {
                return (elt.value !== _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].ITEM_FAMILY_CODE_AIRCRAFT_KEY &&
                    elt.value !== _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].ITEM_FAMILY_CODE_ENGINE_KEY);
            }));
        });
    };
    AssetRevSearchComponent.prototype.loadLocationList = function () {
        ...
        this.assetReviewSearchService
            .findAllBidoAttributeByAttributeId(_constants_bido_attribute_constants__WEBPACK_IMPORTED_MODULE_4__["BidoAttributeConstants"].ASSET_LOCATION)
            .subscribe(function (results) {
            _this.locationList = _utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(results).map(function (location) {
                return {
                    label: _this.translateService.currentLang === _constants_lang_constants__WEBPACK_IMPORTED_MODULE_7__["LangConstants"].FRENCH_CODE ? location.textFr : location.textEn,
    ...
    AssetRevSearchComponent.prototype.loadOperationalStatusList = function () {
        ...
        switch (this.selectedSearchAsset) {
            case SearchAsset.Aircraft:
                mapKey = _constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].AIRCRAFT_STATUS_MAP;
                break;
            default:
                mapKey = _constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].OPERATIONAL_STATUS_MAP;
                break;
        }
        this.propertiesService.getValue(mapKey).subscribe(function (results) {
            _this.operationalStatusList = _utils_select_item_utils__WEBPACK_IMPORTED_MODULE_14__["SelectItemUtils"].fromLabelValues(_utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(results));
        });
    };
    AssetRevSearchComponent.prototype.loadWareHouseList = function () {
        ...
        this.assetReviewSearchService.findAllWarehouse().subscribe(function (results) {
            _this.wareHouseList = _utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(results)
                .filter(function (warehouse) { return !!warehouse.whCode; })
                .map(function (warehouse) {
                return {
                    label: _utils_string_utils__WEBPACK_IMPORTED_MODULE_15__["StringUtils"].isNullOrEmpty(warehouse.whName)
                        ? warehouse.whCode
    ...
    AssetRevSearchComponent.prototype.createEvent = function () {
        ...
        this.openEvent(bidoNotificationDTO, _enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_8__["ComponentOpenMode"].Create);
    };
    AssetRevSearchComponent.prototype.openEvent = function (objectId, openMode) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _constants_component_constants__WEBPACK_IMPORTED_MODULE_5__["ComponentConstants"].FLE_EVENT_CREATE,
            openMode: openMode
        };
        if (!!objectId) {
    ...
    ], AssetRevSearchComponent.prototype, "onOpenClick", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('resultsContainerAnchor'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], AssetRevSearchComponent.prototype, "resultsContainerAnchor", void 0);
    AssetRevSearchComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-asset-rev-search',
            template: __webpack_require__(/*! ./asset-rev-search.component.html */ "./src/app/shared/components/asset-rev-search/asset-rev-search.component.html")
        }),
        __metadata("design:paramtypes", [_asset_rev_search_service__WEBPACK_IMPORTED_MODULE_16__["AssetRevSearchService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AssetRevSearchModule", function() { return AssetRevSearchModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var primeng_message__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! primeng/message */ "./node_modules/primeng/message.js");
/* harmony import */ var primeng_message__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(primeng_message__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var primeng_radiobutton__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! primeng/radiobutton */ "./node_modules/primeng/radiobutton.js");
/* harmony import */ var primeng_radiobutton__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(primeng_radiobutton__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _asset_rev_search_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./asset-rev-search.component */ "./src/app/shared/components/asset-rev-search/asset-rev-search.component.ts");
/* harmony import */ var _asset_rev_search_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./asset-rev-search.service */ "./src/app/shared/components/asset-rev-search/asset-rev-search.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AssetRevSearchService", function() { return AssetRevSearchService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _api_bidt_warehouse_api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../api/bidt-warehouse.api */ "./src/app/shared/api/bidt-warehouse.api.ts");
...
var AssetRevSearchService = /** @class */ (function (_super) {
    ...
    function AssetRevSearchService(http, appConfigService, bidtWarehouseApi, fleetManagementApi, productStructureManagementApi) {
