(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~administration-administration-module~administration-attributes-attributes-module~administrat~974549ff"],{
...
/* harmony import */ var _enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../enums/table-column-filter-mode.enum */ "./src/app/shared/enums/table-column-filter-mode.enum.ts");
/* harmony import */ var _enums_table_selection_mode_enum__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../enums/table-selection-mode.enum */ "./src/app/shared/enums/table-selection-mode.enum.ts");
/* harmony import */ var _services_date_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/date.service */ "./src/app/shared/services/date.service.ts");
/* harmony import */ var _services_loader_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../services/loader.service */ "./src/app/shared/services/loader.service.ts");
/* harmony import */ var _services_message_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../services/message.service */ "./src/app/shared/services/message.service.ts");
...
var DialogTableComponent = /** @class */ (function (_super) {
    ...
    function DialogTableComponent(translateService, dateService, loaderService, messageService) {
        var _this = _super.call(this, _enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__["ComponentOpenMode"].Write, 'DialogTableComponent') || this;
        ...
        _this.tableColumnFilterMode = _enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_5__["TableColumnFilterMode"];
        _this.tableSelectionMode = _enums_table_selection_mode_enum__WEBPACK_IMPORTED_MODULE_6__["TableSelectionMode"];
    ...
    DialogTableComponent.prototype.ngOnInit = function () {
        ...
        if (!!this.tableData) {
            ...
            this.selection = this.tableData.selectionMode === _enums_table_selection_mode_enum__WEBPACK_IMPORTED_MODULE_6__["TableSelectionMode"].Multiple ? [] : undefined;
            this.showColumnFilters = !this.tableData.tableCols.some(function (col) {
                return !!col.filterMode && col.filterMode === _enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_5__["TableColumnFilterMode"].None;
            });
        }
    };
    DialogTableComponent.prototype.validate = function () {
        var _this = this;
        if ((this.selection instanceof Array && _utils_list_utils__WEBPACK_IMPORTED_MODULE_10__["ListUtils"].isEmpty(this.selection)) ||
            (!(this.selection instanceof Array) && !this.selection)) {
            this.messageService.showWarningMessage('global.warningOnNoSelection');
        }
        else {
            if (this.selection instanceof Array) {
                this.onSelected.emit(this.selection.map(function (row) { return _this.objectMap.get(row); }).filter(function (obj) { return !!obj; }));
            }
            else {
    ...
    DialogTableComponent.prototype.computeTableWidth = function () {
        ...
        if (tableWidthData.every(function (regExpMatches) { return !!regExpMatches; })) {
            var widthIndex_1 = 1;
            var unitIndex_1 = 2;
            var colUnitList = tableWidthData
                .map(function (regExpMatches) { return regExpMatches[unitIndex_1]; })
                .map(function (unit) { return unit.trim(); })
                .map(function (unit) { return unit.toLowerCase(); });
            if (colUnitList.filter(function (v, i, a) { return a.indexOf(v) === i; }).length === 1) {
                this.colWidthUnit = colUnitList[0];
                var tableWidth = tableWidthData
                    .map(function (regExpMatches) { return regExpMatches[widthIndex_1]; })
                    .map(Number)
    ...
    DialogTableComponent.prototype.init = function () {
        ...
        if (!!this.keyObservableMap) {
            ...
            var keyValueMap_1 = {};
            Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["forkJoin"])(Array.from(this.keyObservableMap.values())).subscribe(function (keyValueResults) {
            ...
            if (!!result) {
                ...
                _this.formattedTableRows = result.list
                    ...
                    _this.tableData.tableCols.forEach(function (tableCol) {
                        if (Object.getOwnPropertyNames(obj).some(function (property) { return property === tableCol.field; })) {
                            if (tableCol.isDate !== undefined && tableCol.isDate !== null && tableCol.isDate) {
                                ...
                                formattedObj[tableCol.field] =
                                    columnsWithKey.includes(tableCol.field) &&
                                        Object.getOwnPropertyNames(keyValueMap).some(function (property) { return property === obj[tableCol.field]; })
                    ...
                    if (!!_this.tableData.dataKey &&
                        Object.getOwnPropertyNames(obj).some(function (property) { return property === _this.tableData.dataKey; })) {
                    ...
                    .filter(function (obj) { return !_utils_list_utils__WEBPACK_IMPORTED_MODULE_10__["ListUtils"].isEmpty(Object.getOwnPropertyNames(obj)); });
            }
        });
    };
    __decorate([
    ...
    ], DialogTableComponent.prototype, "tableData", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('keyMap'),
        __metadata("design:type", Map)
    ], DialogTableComponent.prototype, "keyObservableMap", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogTableComponent.prototype, "onSelected", void 0);
    DialogTableComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-table',
            template: __webpack_require__(/*! ./dialog-table.component.html */ "./src/app/shared/components/dialog-table/dialog-table.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogTableModule", function() { return DialogTableModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _dialog_table_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dialog-table.component */ "./src/app/shared/components/dialog-table/dialog-table.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
