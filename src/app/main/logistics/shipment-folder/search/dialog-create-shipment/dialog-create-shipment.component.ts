...
@Component({
  ...
  templateUrl: './dialog-create-shipment.component.html'
})
export class DialogCreateShipmentComponent extends DialogComponent {
  @Input()
  ...
  public constructor(
    ...
    super(ComponentOpenMode.Read, 'DialogCreateShipmentComponent');
  ...
  public validate(): void {
    ...
    this.logisticsService.addOrUpdateShipmentFolder(input).subscribe((res) => {
