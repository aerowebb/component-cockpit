...
export class DynamicComponentLoaderModule {
  public static forRoot(manifests: DynamicComponentManifest[]): ModuleWithProviders {
    return {
  ...
  public static forChild(components: Type<any>[]): ModuleWithProviders {
    return {
      ...
      providers: [
        ...
        // provider for DynamicComponentLoader to analyze
        { provide: DYNAMIC_COMPONENT, useValue: components }
      ]
    };
  }
}

export { DynamicComponentManifest } from './dynamic-component-manifest.interface';
