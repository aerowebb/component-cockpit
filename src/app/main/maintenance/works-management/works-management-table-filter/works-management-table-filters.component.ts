...
@Component({
  ...
  styleUrls: ['./works-management-table-filters.component.scss'],
  templateUrl: './works-management-table-filters.component.html'
})
export class WorksManagementTableFiltersComponent extends GenericComponent {
  @Input()
