...
export class DialogScheduleMaintenanceCalendarComponent extends DialogComponent implements OnInit {
  ...
  public constructor(
    ...
    private readonly scheduleMaintenanceFormService: ScheduleMaintenanceFormService
  ) {
  ...
  private updateWorkPackge(workPackage: BidmProjectDTO): void {
    this.scheduleMaintenanceFormService.updateWorkPackage(workPackage).subscribe((_) => {
