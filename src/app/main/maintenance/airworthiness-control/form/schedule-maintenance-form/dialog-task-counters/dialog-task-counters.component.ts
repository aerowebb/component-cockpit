...
export class DialogTaskCountersComponent extends DialogComponent implements OnDestroy, OnInit {
  ...
  public saveTaskCounter(): void {
    ...
    this.scheduleMaintenanceFormService.saveTaskCounter(input).subscribe((_) => {
  ...
  private load(): void {
    ...
    this.scheduleMaintenanceFormService.getAllCounterFromMaintenancePlan(input).subscribe((result) => {
      this.taskCountersTableLoading = false;
