...
export class AirworthinessControlForAssetFormComponent extends AirworthinessControlFormComponent {
  public constructor(
  ...
  public getComponentName(): string {
    return ComponentConstants.MAI_AIRWORTHINESS_CONTROL_FOR_ASSET_FORM;
  }
}
