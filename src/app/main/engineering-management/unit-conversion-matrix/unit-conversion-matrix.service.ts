...
export class UnitConversionMatrixService extends AbstractAwHttpService {
  ...
  public getDefaultMatrixByFamilyVariant(familyVariant: string): Observable<BireConversionMatrixDTO> {
    return super.post<string, BireConversionMatrixDTO>(
      this.unitMatrixConversionApi.getDefaultMatrixByFamilyVariant,
      familyVariant
    );
  }

  public deleteUnitConversionMatrix(ids: number[]): Observable<boolean> {
    return super.post<number[], boolean>(this.unitMatrixConversionApi.deleteUnitMatrixConversion, ids);
  }
  ...
  public getExcelTemplate(): Observable<FileContent> {
    return super.post<void, FileContent>(this.fleetBusinessApi.getXlsUnitConversionMatrixWithVariantReport);
  }

  public importUnitConversionMatrixFromExcel(input: SaveExcelDataInput): Observable<string> {
    return super.post<SaveExcelDataInput, string>(
      this.standardImportApi.importUnitConversionMatrixWithVariantFromExcel,
      input
    );
  }
