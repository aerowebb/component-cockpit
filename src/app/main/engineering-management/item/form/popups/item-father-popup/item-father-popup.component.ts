...
@Component({
  ...
  templateUrl: './item-father-popup.component.html',
  styleUrls: ['./item-father-popup.component.scss']
})
export class ItemFatherPopupComponent extends DialogComponent implements OnInit {
  ...
  public constructor(
    ...
    super(ComponentOpenMode.Write, 'ItemFatherPopupComponent');
