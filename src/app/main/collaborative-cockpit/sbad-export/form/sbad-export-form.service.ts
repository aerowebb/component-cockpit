...
@Injectable()
export class SbAdExportFormService extends AbstractAwMhiaelHttpService {
  public constructor(
    http: HttpClient,
  ...
  public sbadExport(): Observable<FileContentDTO> {
    return super.post<string, FileContentDTO>(this.mhiaelExportApi.sbadExport, undefined);
  }
}
