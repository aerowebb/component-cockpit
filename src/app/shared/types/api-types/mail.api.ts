...
export class MailApi extends AbstractApi {
  ...
  public readonly sendEventNotificationToContacts: string = super.appendToBaseUrl(
    '/send_event_notification_to_contacts'
  );

  public readonly sendEventNotificationToContactsAlternate: string = super.appendToBaseUrl(
