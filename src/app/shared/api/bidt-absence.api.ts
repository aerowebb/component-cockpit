...
export class BidtAbsenceApi extends AbstractApi {
  ...
  public readonly findAbsenceByEmployeeId: string = super.appendToBaseUrl('/find_absence_by_employee_id');

  public readonly findHolidaysByEmployeeId: string = super.appendToBaseUrl('/find_holidays_by_employee_id');
