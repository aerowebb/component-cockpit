...
export class ProductStructureManagementApi extends AbstractApi {
  ...
  public readonly findBirePnDocs: string = super.appendToBaseUrl('/find_bire_document_by_pn');
  ...
  public readonly findBireFamilyByFamilyId: string = super.appendToBaseUrl('/find_bire_family_by_family_id');
  ...
  public readonly findBireSbMaintenancePlanBySb: string = super.appendToBaseUrl('/find_bire_sb_maintenance_plan');
  ...
  public readonly findAllBireSite: string = super.appendToBaseUrl('/find_all_bire_site');

  public readonly findAuthorizedBireSite: string = super.appendToBaseUrl('/find_authorized_bire_site');
  ...
  public readonly findBireQualificationsByVariantPK: string = super.appendToBaseUrl(
    '/find_bire_qualifications_by_variant_pk'
  );

  public readonly findBireItemVersionsByItemAndPnCode: string = super.appendToBaseUrl(
    '/find_bire_item_versions_by_item_and_pn_code'
  );
  ...
  public readonly findBireEvolutionEvolutionsByEvolution: string = super.appendToBaseUrl(
    '/find_bire_evolution_evolutions_by_evolution'
  );

  public readonly checkAndReturnNewRevisionNumberBySB: string = super.appendToBaseUrl(
    '/check_and_return_new_revision_number_by_sb'
  );

  public readonly checkAndReturnNewRevisionNumberByEvolution: string = super.appendToBaseUrl(
    '/check_and_return_new_revision_number_by_evolution'
  );

  public readonly checkAndReturnNewRevisionNumberByModification: string = super.appendToBaseUrl(
    '/check_and_return_new_revision_number_by_modification'
  );
  ...
  public readonly findBireVariantVersionsByFamilyCode: string = super.appendToBaseUrl(
    '/find_bire_variant_versions_by_family_code'
  );
  ...
  public readonly findBireVariantVersionsByFamilyFunction: string = super.appendToBaseUrl(
    '/find_bire_variant_versions_by_family_function'
  );

  public readonly findBireItemPnEvolutionsByPnCodeOrPnPnCode: string = super.appendToBaseUrl(
    '/find_bire_item_pn_evolutions_by_pn_code_or_pn_pn_code'
  );

  // public readonly createOrUpdateBireVpAttributeList: string = super.appendToBaseUrl('/create_or_update_bire_vp_attribute_list');

  public readonly findBireEvolutionsByFamilyAndVariantCodes: string = super.appendToBaseUrl(
    '/find_bire_evolutions_by_family_and_variant_codes'
  );
  ...
  public readonly findBireVersionPnsByItemVersion: string = super.appendToBaseUrl(
    '/find_bire_version_pns_by_item_version'
  );
  ...
  public readonly findSbAdModForBireEvolutionEvolutionDto: string = super.appendToBaseUrl(
    '/find_sb_ad_mod_for_bire_evolution_evolution_dto '
  );
  ...
  public readonly findBireModelsBySearchCriteria: string = super.appendToBaseUrl(
    '/find_bire_models_by_search_criteria'
  );

  public readonly findBireModelsBySearchCriteriaForOVS: string = super.appendToBaseUrl(
    '/find_bire_models_by_search_criteria_for_ovs'
  );
  ...
  public readonly findBireItemsBySearchCriteriaToLVD: string = super.appendToBaseUrl(
    '/find_bire_items_by_search_criteria_to_lvd'
  );

  public readonly findBireRatingsBySearchCriteria: string = super.appendToBaseUrl(
    '/find_bire_ratings_by_search_criteria'
  );
  ...
  public readonly findBireItemPnEvolutionsByItem: string = super.appendToBaseUrl(
    '/find_bire_item_pn_evolutions_by_item'
  );
  ...
  public readonly findAllBireActionType: string = super.appendToBaseUrl('/find_all_bire_action_type');
  ...
  public readonly findBireEvolutionPnsByEvolution: string = super.appendToBaseUrl(
    '/find_bire_evolution_pns_by_evolution'
  );
  ...
  public readonly findBireEvolutionSbsByEvolution: string = super.appendToBaseUrl(
    '/find_bire_evolution_sbs_by_evolution'
  );
  ...
  // public readonly findBireVariantVersionsByPnCode: string = super.appendToBaseUrl(
  //  '/find_bire_variant_versions_by_pn_code'
  // );
  ...
  public readonly findBirePnsBySearchCriteriaToLVD: string = super.appendToBaseUrl(
    '/find_bire_pns_by_search_criteria_to_lvd'
  );

  public readonly findProductsBySearchCriteria: string = super.appendToBaseUrl('/find_products_by_search_criteria');

  public readonly findBireSbsBySbPKAndDesignation: string = super.appendToBaseUrl(
    '/find_bire_sbs_by_sb_pk_and_designation'
  );
  ...
  public readonly findBireModificationAttributesByItem: string = super.appendToBaseUrl(
    '/find_bire_modification_attributes_by_item'
  );

  public readonly findBireEvolutionAttributesByEvolution: string = super.appendToBaseUrl(
    '/find_bire_evolution_attributes_by_evolution'
  );
  ...
  public readonly findBireConfigurationsByItemVersion: string = super.appendToBaseUrl(
    '/find_bire_configurations_by_item_version'
  );

  public readonly findBireActionTypesByActionTypeCode: string = super.appendToBaseUrl(
    '/find_bire_action_types_by_action_type_code'
  );
  ...
  public readonly findBireEvolutionItemsByEvolution: string = super.appendToBaseUrl(
    '/find_bire_evolution_items_by_evolution'
  );

  // public readonly removeBireEvolutionSbsByEvolution: string = super.appendToBaseUrl('/remove_bire_evolution_sbs_by_evolution');

  public readonly findBireEvolutionVariantsByEvolutionNumbers: string = super.appendToBaseUrl(
    '/find_bire_evolution_variants_by_evolution_numbers'
  );
  ...
  public readonly findBireItemPnEvolutionsByEvolution: string = super.appendToBaseUrl(
    '/find_bire_item_pn_evolutions_by_evolution'
  );

  public readonly findBireModificationEvolutionsByEvolution: string = super.appendToBaseUrl(
    '/find_bire_modification_evolutions_by_evolution'
  );
  ...
  public readonly findBireModificationsByModificationPKAndDesignation: string = super.appendToBaseUrl(
    '/find_bire_modifications_by_modification_pk_and_designation'
  );

  public readonly findBireModificationsByModificationPKAndDesignationAlternative: string = super.appendToBaseUrl(
    '/find_bire_modifications_by_modification_pk_and_designation_alternative'
  );
  ...
  public readonly findBireEvolutionEvolutionsByFamilyAndVariantCodes: string = super.appendToBaseUrl(
    '/find_bire_evolution_evolutions_by_family_and_variant_codes'
  );
  ...
  public readonly findBireEvolutionsByEvolutionPKAndDesignation: string = super.appendToBaseUrl(
    '/find_bire_evolutions_by_evolution_pk_and_designation'
  );
  ...
  public readonly findBireVersionMeasuresByItemVersion: string = super.appendToBaseUrl(
    '/find_bire_version_measures_by_item_version'
  );
  ...
  public readonly findAllBireMaintenanceEnvironments: string = super.appendToBaseUrl(
    '/find_all_bire_maintenance_environments'
  );

  public readonly findBireUnmountAssemblysByFamilyAndVariantCodes: string = super.appendToBaseUrl(
    '/find_bire_unmount_assemblys_by_family_and_variant_codes'
  );

  public readonly findBireUnmountOrdersByFamilyAndVariantCodes: string = super.appendToBaseUrl(
    '/find_bire_unmount_orders_by_family_and_variant_codes'
  );
  ...
  public readonly removeBireMaintenanceEnvironment: string = super.appendToBaseUrl(
    '/remove_bire_maintenance_environment'
  );
  ...
  public readonly findBireAttributesByCategoryList: string = super.appendToBaseUrl(
    '/find_bire_attributes_by_category_list'
  );

  public readonly findBireAttributes: string = super.appendToBaseUrl('/find_bire_attributes');

  public readonly findBireItemAttributesByCategory: string = super.appendToBaseUrl(
    '/find_bire_item_attributes_by_category'
  );
  ...
  public readonly findBireEvolutionsByEvolutionCriteria: string = super.appendToBaseUrl(
    '/find_bire_evolutions_by_evolution_criteria'
  );
  ...
  public readonly findBireConcernedAssetsByEvolution: string = super.appendToBaseUrl(
    '/find_bire_concerned_assets_by_evolution'
  );

  public readonly findBireConcernedAssetsByModification: string = super.appendToBaseUrl(
    '/find_bire_concerned_assets_by_modification'
  );

  public readonly findBireMeasureReferencesBySearchCriteria: string = super.appendToBaseUrl(
    '/find_bire_measure_references_by_search_criteria'
  );

  public readonly getSBObjectStatusValue: string = super.appendToBaseUrl('/get_sb_object_status_value');

  public readonly saveSbAdData: string = super.appendToBaseUrl('/save_sb_ad_data');

  public readonly saveEvolutionData: string = super.appendToBaseUrl('/save_evolution_data');

  public readonly findBireDocumentBySb: string = super.appendToBaseUrl('/find_bire_document_by_sb');

  public readonly findBireDocumentByEvolution: string = super.appendToBaseUrl('/find_bire_document_by_evolution');

  public readonly findFamilyVariant: string = super.appendToBaseUrl('/find_family_variant');

  public readonly findEvolutionItemVersion: string = super.appendToBaseUrl('/find_evolution_item_version');

  public readonly findFamilyVariantVersion: string = super.appendToBaseUrl('/find_family_variant_version');

  public readonly findBireGroups: string = super.appendToBaseUrl('/find_bire_groups');

  public readonly saveModification: string = super.appendToBaseUrl('/save_modification');

  public readonly removeBireSbs: string = super.appendToBaseUrl('/remove_bire_sbs');

  public readonly findBireModelsByVariantPK: string = super.appendToBaseUrl('/find_bire_models_by_variant_pk');

  public readonly findBireVersionPnsByItem: string = super.appendToBaseUrl('/find_bire_version_pns_by_item');

  public readonly saveFamilyData: string = super.appendToBaseUrl('/save_family_data');

  public readonly savePartNumber: string = super.appendToBaseUrl('/save_part_number');

  public readonly findBireModificationsByFamilyId: string = super.appendToBaseUrl(
    '/find_bire_modifications_by_family_id'
  );

  public readonly findBireVariantVersionsByFamilyFunctionAlternative: string = super.appendToBaseUrl(
    '/find_bire_variant_versions_by_family_function_alternative'
  );

  public readonly findBireVariantVersionsByFamilyFunctionItemAlternative: string = super.appendToBaseUrl(
    '/find_bire_variant_versions_by_family_function_item_alternative'
  );

  public readonly findBireItemsBySearchCriteriaPartNumber: string = super.appendToBaseUrl(
    '/find_bire_items_by_search_criteria_part_number'
  );

  public readonly findProductsByPnSearchCriteria: string = super.appendToBaseUrl(
    '/find_products_by_pn_search_criteria'
  );

  public readonly findEvolutionModificationSbadList: string = super.appendToBaseUrl(
    '/find_evolution_modification_sb_ad_list'
  );

  public readonly findBireUnmountAssemblysByFamilyAndVariantCodesDropdownRemovalOrder: string = super.appendToBaseUrl(
    '/find_bire_unmount_assemblys_by_family_and_variant_codes_drop_down_removal_order'
  );

  public readonly findTopFathersBireItemsByFamilyAndVariantCodes: string = super.appendToBaseUrl('/find_ac_tree_node');

  public readonly findFlDelayCategory: string = super.appendToBaseUrl('/find_fl_delay_category');

  public readonly findBireModificationVariantsBySearchCriteria: string = super.appendToBaseUrl(
    '/find_configuration_documents'
  );

  public readonly findBireFamilyVariant: string = super.appendToBaseUrl('/find_bire_family_variant_dropdown');

  public readonly findBireItemsByFamilyAndVariantCodes: string = super.appendToBaseUrl(
    '/find_bire_items_by_family_and_variant_codes_alternative'
  );
  public readonly saveApplicationConfigurationData: string = super.appendToBaseUrl(
    '/save_application_configuration_data'
  );

  public readonly findAllBirePnByCriteria: string = super.appendToBaseUrl('/find_all_bire_pn_by_criteria');

  public readonly findAllDelayAuthorizedUnit: string = super.appendToBaseUrl('/find_all_delay_authorized_unit');

  public readonly findAllDelayCategory: string = super.appendToBaseUrl('/find_all_delay_category');

  public readonly exportLimitsData: string = super.appendToBaseUrl('/export_limits_data');

  public readonly findBireFamilyVariantDropdownForMaintenanceProgram: string = super.appendToBaseUrl(
    '/find_bire_family_variant_dropdown_for_maintenance_program'
  );

  public readonly getStandardCycleCounterLabel: string = super.appendToBaseUrl('/get_standard_cycle_counter_label');

  public readonly getStandardTimeCounterLabel: string = super.appendToBaseUrl('/get_standard_time_counter_label');

  public readonly checkAtaCodeExistence: string = super.appendToBaseUrl('/check_ata_code_existence');

  public readonly checkBirePnExistence: string = super.appendToBaseUrl('/check_bire_pn_existence');

  public readonly initializeFamilyVariantList: string = super.appendToBaseUrl('/initialize_Family_Variant_List');

  public readonly initializeOperationalStatusList: string = super.appendToBaseUrl(
    '/initialize_Operational_Status_List'
  );
  public readonly findBireVariantVersionsByFamilyFunctionConfigurationEvent: string = super.appendToBaseUrl(
    '/find_bire_variant_versions_by_family_function_configuration_and_event'
  );
  public readonly getServerDate: string = super.appendToBaseUrl('/get_server_date');
  public readonly findBirePnsBySearchCriteriaForParts: string = super.appendToBaseUrl(
    '/find_bire_pns_by_search_criteria_for_parts'
  );

  public readonly findAllBireMeasureReferencesMaintenanceProgram: string = super.appendToBaseUrl(
    '/find_all_bire_measure_references_maintenance_program'
  );

  public readonly findAllBireUnitMeasureTable: string = super.appendToBaseUrl('/find_all_bire_unit_measures_table');

  public readonly findBireSbsBySbCriteriaAd: string = super.appendToBaseUrl('/find_bire_sbs_by_sb_criteria_ad');

  public readonly findBireSbsBySbCriteriaAmg: string = super.appendToBaseUrl('/find_bire_sbs_by_sb_criteria_amg');

  public readonly findAllBireVariantVersionByFamilyFunction: string = super.appendToBaseUrl(
    '/find_all_bire_variant_version_by_family_function'
  );

  public readonly getAllOperationalStatusForTools: string = super.appendToBaseUrl(
    '/get_all_operational_status_for_tools'
  );
  ...
  public readonly saveBireAttribute: string = super.appendToBaseUrl('/save_bire_attribute');

  public readonly pnCodeEnteredSearch: string = super.appendToBaseUrl('/pn_code_entered_search');

  public readonly findBireVariantAttributesByVariantVersion: string = super.appendToBaseUrl(
    '/find_bire_variant_attributes_by_variant_version'
  );

  public readonly stockValuationSearch: string = super.appendToBaseUrl('/stockvaluationsearch');

  public readonly getPartNumberStructure: string = super.appendToBaseUrl('/get_part_number_structure');

  public readonly getIsMELIsIllustratedSelected: string = super.appendToBaseUrl('/get_is_mel_is_illustrated_selected');

  public readonly findBireKPourcentList: string = super.appendToBaseUrl('find_bire_k_pourcents_list');

  public readonly findBireMaintenanceEnvironmentsList: string = super.appendToBaseUrl(
    'find_bire_maintenance_environments'
  );

  public readonly findAllBireItemByFamilyCodeAndVariantCode: string = super.appendToBaseUrl(
    '/find_all_bire_item_by_family_code_and_variant_code'
  );

  public readonly findAllBireItemBySearchCriteria: string = super.appendToBaseUrl(
    '/find_all_bire_item_by_search_criteria'
  );

  public readonly findAllBireVariantVersionByFamilyCode: string = super.appendToBaseUrl(
    '/find_all_bire_variant_version_by_family_code'
  );

  public readonly findAllFamilyByModuleAndUseCase: string = super.appendToBaseUrl(
    '/find_all_family_by_module_and_use_case'
  );

  public readonly findAllBireItemPnEvolutionByItem: string = super.appendToBaseUrl(
    '/find_all_bire_item_pn_evolution_by_item'
  );

  public readonly findAllBireEvolutionPnByItem: string = super.appendToBaseUrl('/find_all_bire_evolution_pn_by_item');

  public readonly generatePnLinkSchema: string = super.appendToBaseUrl('/generate_pn_link_schema');

  public readonly getStructureDetails: string = super.appendToBaseUrl('get_structure_details');

  public readonly saveItem: string = super.appendToBaseUrl('save_item');

  public readonly findTopFatherBireItemListByFamilyCodeAndVariantCode: string = super.appendToBaseUrl(
    '/find_top_father_bire_item_list_by_family_code_and_variant_code'
  );

  public readonly findBireItemListByItemFather: string = super.appendToBaseUrl('/find_bire_item_list_by_item_father');

  public readonly getItemPartNumberDetails: string = super.appendToBaseUrl('/get_item_part_number_details');

  public readonly getItemPartNumberPropertyValue: string = super.appendToBaseUrl(
    '/get_item_part_number_property_value'
  );

  public readonly findBireAttributesByCategoryForPnTab: string = super.appendToBaseUrl(
    '/find_bire_attributes_by_category_for_pn_tab'
  );

  public readonly saveItemPartNumber: string = super.appendToBaseUrl('/save_item_part_number');

  public readonly findBireVersionPn: string = super.appendToBaseUrl('/find_bire_version_pn');

  public readonly findAllBireRatingByCriteria: string = super.appendToBaseUrl('/find_all_bire_rating_by_criteria');

  public readonly findAllBireMeasureReferenceByCriteria: string = super.appendToBaseUrl(
    '/find_all_bire_measure_reference_by_criteria'
  );

  public readonly validateDocumentUrl: string = super.appendToBaseUrl('/validate_document_url');

  public readonly findAllBireAlternativePnByItemVersionAndPnCode: string = super.appendToBaseUrl(
    '/find_all_bire_alternative_pn_by_item_version_and_pn_code'
  );

  public readonly findBireSbCountersBySb: string = super.appendToBaseUrl('/find_bire_sb_counters_by_sb');

  public readonly findAllCounterCode: string = super.appendToBaseUrl('/find_all_counter_code');

  public readonly findAllBireUnitMeasure: string = super.appendToBaseUrl('/find_all_bire_unit_measure');

  public readonly removeBireAlternativePnList: string = super.appendToBaseUrl('/remove_bire_alternative_pn_list');

  public readonly findAllBireItemByPnCodeAndFamilyVariantAndItemNumberAndFunctionCode: string = super.appendToBaseUrl(
    '/find_all_bire_item_by_pn_code_and_family_variant_and_item_number_and_function_code'
  );

  public readonly getPnFromFamilyVariantItem: string = super.appendToBaseUrl('/get_pn_from_family_variant_item');

  public readonly getItemFromFamilyAndVariant: string = super.appendToBaseUrl('/get_item_from_family_and_variant');

  public readonly getVariantFromFamilyCode: string = super.appendToBaseUrl('/get_variant_from_family_code');

  public readonly findBireDocItemByPnCode: string = super.appendToBaseUrl('/find_bire_doc_item_by_pn_code');

  public readonly findBirePackBaseOptionsByItemDropDown: string = super.appendToBaseUrl(
    '/find_bire_pack_base_options_by_item_drop_down'
  );

  public readonly saveBireConfigurationAndPacks: string = super.appendToBaseUrl('/save_bire_configuration_and_packs');

  public readonly findBireConfigurationPacksByItemVersionAndConfigurationCode: string = super.appendToBaseUrl(
    '/find_bire_configuration_packs_by_item_version_and_configuration_code'
  );

  public readonly findAllBireSiteForTask: string = super.appendToBaseUrl('/find_all_bire_site_for_task');

  public readonly findBirePackBaseOptionsByItemTab: string = super.appendToBaseUrl(
    '/find_bire_pack_base_options_by_item_tab'
  );

  public readonly findBirePackEvolutionsByItemAndPackBaseOptionCodeItem: string = super.appendToBaseUrl(
    '/find_bire_pack_evolutions_by_item_and_pack_base_option_code_item'
  );

  public readonly findBireEvolutionsByFamilyAndVariantCodesItemPack: string = super.appendToBaseUrl(
    '/find_bire_evolutions_by_family_and_variant_codes_item_pack'
  );

  public readonly getPackType: string = super.appendToBaseUrl('/get_pack_type');

  public readonly findMroBireSite: string = super.appendToBaseUrl('/find_mro_bire_site');

  public readonly findQuantityUnitMap: string = super.appendToBaseUrl('/fetch_quantity_unit_map');

  public readonly getGroundEquipmentStatusMap: string = super.appendToBaseUrl('/get_ground_equipment_status_map');

  public readonly findByBidoOrBire: string = super.appendToBaseUrl('/find_by_bido_or_bire');

  public readonly findCounterByAsset: string = super.appendToBaseUrl('/find_counter_by_asset');

  public readonly findBidoCounterReferencesByPnCode: string = super.appendToBaseUrl(
    '/find_bido_counter_references_by_pn_code'
  );

  public readonly saveBirePartUpdateGuideline: string = super.appendToBaseUrl('/save_bire_part_update_guideline');

  public readonly findBirePartUpdateGuideline: string = super.appendToBaseUrl('/find_bire_part_update_guideline');

  public readonly findBirePartUpdateGuidelineById: string = super.appendToBaseUrl(
    '/find_bire_part_update_guideline_by_id'
  );

  public readonly removeBirePartUpdateGuideline: string = super.appendToBaseUrl('/remove_bire_part_update_guideline');

  public readonly findBireDocPugs: string = super.appendToBaseUrl('/find_bire_doc_pugs');

  public readonly saveBireDocPugs: string = super.appendToBaseUrl('/save_bire_doc_pugs');

  public readonly findAlternativePnsByPnCode: string = super.appendToBaseUrl('/find_alternative_pns_by_pn_code');

  public readonly findBirePartUpdateGuidelinesBySearchCriteria: string = super.appendToBaseUrl(
    '/find_bire_part_update_guidelines_by_search_criteria'
  );

  public readonly isPartWithContainer: string = super.appendToBaseUrl('/is_part_with_container');

  public readonly findBireVersionPnsByFamilyAndVariantAndPnCode: string = super.appendToBaseUrl(
    '/find_bire_version_pns_by_family_and_variant_and_pn_code'
  );
