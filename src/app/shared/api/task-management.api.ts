...
export class TaskManagementApi extends AbstractApi {
  ...
  public readonly findBireTasksDecomposition: string = super.appendToBaseUrl('/find_task_decomposition');

  public readonly findBireMaintenanceProgramsByTask: string = super.appendToBaseUrl(
    '/get_maintainance_program_with_task'
  );

  public readonly findLastBireMaintenanceProgramsByTask: string = super.appendToBaseUrl(
    '/get_last_maintainance_program_with_task'
  );

  public readonly findBireMaintenanceProgramsByVisit: string = super.appendToBaseUrl(
    '/get_maintainance_program_with_visit'
  );

  public readonly saveVisit: string = super.appendToBaseUrl('/save_visit');

  public readonly saveTask: string = super.appendToBaseUrl('/save_task');
  ...
  public readonly findBireDocumentsByTask: string = super.appendToBaseUrl('find_bire_documents_by_task');

  public readonly findBireDocOperationByOperation: string = super.appendToBaseUrl(
    '/find_bire_doc_operation_by_operation'
  );

  public readonly findBireDocumentByOperation: string = super.appendToBaseUrl('/find_bire_document_by_operation');
  ...
  public readonly findBireQualificationsBySearchCriteria: string = super.appendToBaseUrl(
    '/find_bire_qualifications_by_search_criteria'
  );
  ...
  public readonly findBireOperationsBySearchCriteria: string = super.appendToBaseUrl(
    '/find_bire_operations_by_search_criteria'
  );

  // public readonly removeBireOperationPnsByOperation: string = super.appendToBaseUrl('/remove_bire_operation_pns_by_operation');

  public readonly findBirePlanTaskCountersByPlanCode: string = super.appendToBaseUrl(
    '/find_bire_plan_task_counters_by_plan_code'
  );
  ...
  public readonly findBireTaskItemsWithItemByTask: string = super.appendToBaseUrl(
    '/find_bire_task_items_with_item_by_task'
  );
  ...
  public readonly findAllBireTaskGroup: string = super.appendToBaseUrl('/find_all_bire_task_group');

  public readonly findAllAvailableRMP: string = super.appendToBaseUrl('/find_all_available_rmp');
  ...
  public readonly findBireOperationPnsByOperation: string = super.appendToBaseUrl(
    '/find_bire_operation_pns_by_operation'
  );
  ...
  public readonly findAllBireMaintenancePlanByItem: string = super.appendToBaseUrl(
    '/find_bire_maintenance_plans_by_item'
  );

  public readonly findBireMaintenancePlansByPn: string = super.appendToBaseUrl('/find_bire_maintenance_plans_by_pn');

  public readonly findBireMaintenanceProgramByPn: string = super.appendToBaseUrl(
    '/find_bire_maintenance_program_by_pn'
  );
  ...
  public readonly findApplicableMaintenancePlanCodeByRecommendedPlanCode: string = super.appendToBaseUrl(
    '/find_applicable_maintenance_plan_code_by_recommended_plan_code'
  );
  ...
  public readonly findBirePlanAttributesByPlanCode: string = super.appendToBaseUrl(
    '/find_bire_plan_attributes_by_plan_code'
  );
  ...
  public readonly findBireReturnReasonsByCriteria: string = super.appendToBaseUrl(
    '/find_bire_return_reasons_by_criteria'
  );
  ...
  public readonly findBireTaskEvolutionsByEvolution: string = super.appendToBaseUrl(
    '/find_bire_task_evolutions_by_evolution'
  );

  public readonly findBireOperationAttributesByOperation: string = super.appendToBaseUrl(
    '/find_bire_operation_attributes_by_operation'
  );

  public readonly findBireMaintenancePlansByCriteria: string = super.appendToBaseUrl(
    '/find_bire_maintenance_plans_by_criteria'
  );
  ...
  public readonly getPreviousAMPRevisionOfMaintenancePlan: string = super.appendToBaseUrl(
    '/get_previous_amp_revision_of_maintenance_plan'
  );

  public readonly getPreviousRMPRevisionOfMaintenancePlan: string = super.appendToBaseUrl(
    '/get_previous_rmp_revision_of_maintenance_plan'
  );

  public readonly findBireLocalisationCodesByCriteria: string = super.appendToBaseUrl(
    '/find_bire_localisation_codes_by_criteria'
  );
  ...
  public readonly findSuperiorTasksByTask: string = super.appendToBaseUrl('/superior_task');

  public readonly findTopDownTasksByTask: string = super.appendToBaseUrl('/get_tasks_structure');

  public readonly getTaskLinkInAdequate: string = super.appendToBaseUrl('/get_task_link_in_adequate');

  public readonly findBireTaskAttributeByTask: string = super.appendToBaseUrl('/find_bire_task_attribute_by_task');

  public readonly getLocalCurrency: string = super.appendToBaseUrl('/get_local_currency');

  public readonly refreshEngineeringDataExchange: string = super.appendToBaseUrl('/refresh_engineering_data_exchange');

  public readonly findAllBireTaskByCriteria: string = super.appendToBaseUrl('/find_all_bire_task_by_criteria');

  public readonly findBirePartNumbersBySearchCriteria: string = super.appendToBaseUrl(
    '/find_bire_part_numbers_by_search_criteria'
  );

  public readonly checkAndReturnNewRevisionNumberByMaintenancePlan: string = super.appendToBaseUrl(
    '/check_and_return_new_revision_number_by_maintenance_plan'
  );

  public readonly controlComplianceWithRMP: string = super.appendToBaseUrl('/control_compliance_with_rmp');

  public readonly saveMaintenanceProgram: string = super.appendToBaseUrl('/save_maintenance_program');

  public readonly findAllBireTaskGroupsCatalog: string = super.appendToBaseUrl('/find_all_bire_task_groups_catalog');

  public readonly findBireTaskTasksByVisit: string = super.appendToBaseUrl('/find_bire_task_tasks_by_visit');

  public readonly findBireVisitsByCriteriaForMP: string = super.appendToBaseUrl('/find_bire_visits_by_criteria_for_mp');

  public readonly findBireOperationsByTaskTotalCost: string = super.appendToBaseUrl(
    '/find_bire_operations_by_task_total_cost'
  );
  public readonly fetchProductDetails: string = super.appendToBaseUrl('/fetch_product_details');
  public readonly saveProductDetails: string = super.appendToBaseUrl('save_product_details');

  public readonly findBireReturnItem: string = super.appendToBaseUrl('find_cause_of_removal_item');

  public readonly findBireTaskItemsByItemTaskTab: string = super.appendToBaseUrl(
    'find_bire_task_items_by_item_task_tab'
  );

  public readonly findBireDamageItemsByItemVersionItemScreen: string = super.appendToBaseUrl(
    'find_bire_damage_items_by_item_version_item_screen'
  );

  public readonly findAllBireTaskByCriteriaInput: string = super.appendToBaseUrl('find_all_bire_task_by_criteria');

  public readonly findBireLocalisationItemsByItemVersion: string = super.appendToBaseUrl(
    'find_bire_localisation_items_by_item_version'
  );

  public readonly findBireDamLocTasksByItemVersion: string = super.appendToBaseUrl(
    'find_bire_dam_loc_tasks_by_item_version'
  );

  public readonly findAllBireOperationByCriteria: string = super.appendToBaseUrl('find_all_bire_operation_by_criteria');

  public readonly findBireTask: string = super.appendToBaseUrl('/find_bire_task');

  public readonly findRelatedItemsFromTask: string = super.appendToBaseUrl('/find_related_items_from_task');

  public readonly findRelatedItemsFromEvolution: string = super.appendToBaseUrl('/find_related_items_from_evolution');

  public readonly findRelatedAssets: string = super.appendToBaseUrl('/find_related_assets');

  public readonly findOperationsFromTaskAndRelatedTasks: string = super.appendToBaseUrl(
    '/find_operations_from_task_and_related_tasks'
  );

  public readonly findOperationsFromEvolution: string = super.appendToBaseUrl('/find_operations_from_evolution');

  public readonly checkAmpTaskCompliance: string = super.appendToBaseUrl('/check_amp_task_compliance');

  public readonly createOrUpdateBsdeAvailability: string = super.appendToBaseUrl(
    '/find_all_bire_qualification_datas_drop_down'
  );

  public readonly removeBireDocPlan: string = super.appendToBaseUrl('/remove_bire_doc_plan');

  public readonly updateBireDocPlan: string = super.appendToBaseUrl('/update_bire_doc_plan');

  public readonly createBireDocPlan: string = super.appendToBaseUrl('/create_bire_doc_plan');

  public readonly findBreDocPlansListByPlanCode: string = super.appendToBaseUrl(
    '/find_bire_doc_plans_list_by_plan_code'
  );

  public readonly findAllBireTaskMeasurementPoint: string = super.appendToBaseUrl('/find_all_bire_task_measure');

  public readonly findPartNumbersAssociatedWithTaskOperations: string = super.appendToBaseUrl(
    '/find_part_numbers_associated_with_task_operations'
  );

  public readonly getMainteanceProgramUpdatedList: string = super.appendToBaseUrl(
    'get_maintenance_program_updated_list'
  );
