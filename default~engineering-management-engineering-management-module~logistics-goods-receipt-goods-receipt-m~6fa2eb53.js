(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~engineering-management-engineering-management-module~logistics-goods-receipt-goods-receipt-m~6fa2eb53"],{
...
/* harmony import */ var _shared_pipes_extract_translation_pipe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../shared/pipes/extract-translation.pipe */ "./src/app/shared/pipes/extract-translation.pipe.ts");
...
var TransferOrderService = /** @class */ (function (_super) {
    ...
    function TransferOrderService(http, appConfigService, bidtDfTypeApi, translateService, propertiesService, extractTranslationPipe, fleetManagementApi) {
        var _this = _super.call(this, http, appConfigService) || this;
    ...
    TransferOrderService.prototype.fetchTypeList = function () {
        var _this = this;
        return _super.prototype.post.call(this, this.bidtDfTypeApi.findShipmentDfTypes).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (dfTypes) {
            return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__["ListUtils"].orEmpty(dfTypes).map(function (dfType) {
                return {
                    label: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_12__["StringUtils"].orEmpty(_this.extractTranslationPipe.transform(dfType.dftDesignation)),
                    value: dfType.id
                };
            });
        }));
    ...
    TransferOrderService.prototype.fetchCriticalityList = function () {
        return this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].LOGISTICAL_CRITICALITY_MAP);
    };
    TransferOrderService.prototype.fetchStatusList = function () {
        return this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].TRANSFER_FOLDER_STATUS_MAP);
    };
    TransferOrderService.prototype.fetchProcurementRequestTypeList = function () {
        return this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].PROCUREMENT_REQUEST_TYPE_MAP);
    };
    TransferOrderService.prototype.fetchProcurementRequestStatusList = function () {
        return this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].PROCUREMENT_REQUEST_STATUS_MAP);
    };
    TransferOrderService.prototype.fetchOperationalStatuses = function () {
        return this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].OPERATIONAL_STATUS_MAP);
    };
    TransferOrderService.prototype.fetchStockMvtStatuses = function () {
        return this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].MVT_STATUS_MAP);
    };
    TransferOrderService.prototype.fetchWorkPackageStatuses = function () {
        return this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].AIRM_PROJECT_STATUS_MAP);
    };
    TransferOrderService.prototype.fetchWorkPackageTypes = function () {
        return this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].WORK_PACKAGE_TYPE_MAP);
    };
