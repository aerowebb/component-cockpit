(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["maintenance-update-logbook-update-logbook-module"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogRecordReportComponent", function() { return DialogRecordReportComponent; });
...
/* harmony import */ var _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../shared/utils/list-utils */ "./src/app/shared/utils/list-utils.ts");
...
var DialogRecordReportComponent = /** @class */ (function (_super) {
    ...
    function DialogRecordReportComponent() {
        return _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__["ComponentOpenMode"].Write, 'DialogRecordReportComponent') || this;
    }
    ...
    DialogRecordReportComponent.prototype.setMessage = function () {
        ...
        if (!!this.reportObject && !!this.reportObject.messages) {
            this.message = this.reportObject.messages
                .map(function (x) { return x.listMessages; })
                .filter(function (list) { return !_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_3__["ListUtils"].isNullOrEmpty(list); })
                .reduce(function (acc, x) { return acc.concat(x); }, [])
                .map(function (y) { return y.message; })
                .filter(function (message) { return !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_4__["StringUtils"].isNullOrEmpty(message); })
                .join('\n');
        }
    };
    ...
    ], DialogRecordReportComponent.prototype, "report", null);
    DialogRecordReportComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-record-report',
            template: __webpack_require__(/*! ./dialog-record-report.component.html */ "./src/app/main/maintenance/update-logbook/form/dialog-record-report/dialog-record-report.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UpdateLogbookFormComponent", function() { return UpdateLogbookFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../../shared/utils/number-utils */ "./src/app/shared/utils/number-utils.ts");
/* harmony import */ var _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../../../shared/utils/object-utils */ "./src/app/shared/utils/object-utils.ts");
...
/* harmony import */ var _update_logbook_form_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./update-logbook-form.service */ "./src/app/main/maintenance/update-logbook/form/update-logbook-form.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var UpdateLogbookFormComponent = /** @class */ (function (_super) {
    ...
    function UpdateLogbookFormComponent(favoriteService, loaderService, messageService, serializationService, tabService, sessionService, updateLogbookFormService, translateService) {
    ...
    UpdateLogbookFormComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_7__["ComponentConstants"].MAI_UPDATE_LOGBOOK_FORM;
    };
    UpdateLogbookFormComponent.prototype.ngOnInit = function () {
        ...
        this.updateLogbookFormService.loadMROCenterList().subscribe(function (result) {
            ...
            _this.updateLogbookFormService.loadUserList().subscribe(function (res) {
                _this.userList = res;
                _this.updateLogbookFormService.loadGenProps(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_9__["GenericPropertyConstants"].WORK_PACKAGE_TYPE_MAP).subscribe(function (r) {
                    _this.typeList = r;
                    _this.init();
    ...
    UpdateLogbookFormComponent.prototype.getWpStatusList = function () {
        var _this = this;
        this.updateLogbookFormService.loadWorkPackageStatusList().subscribe(function (res) { return (_this.wpStatusList = res); });
    };
    // get data from server
    UpdateLogbookFormComponent.prototype.getWoStatusList = function () {
        var _this = this;
        this.updateLogbookFormService.loadWorkOrderStatusList().subscribe(function (res) { return (_this.woStatusList = res); });
    };
    // get data from server
    UpdateLogbookFormComponent.prototype.getWorkPackage = function () {
        ...
        this.updateLogbookFormService.findBidmProjectWithAttributesId(this.projectId).subscribe(function (result) {
            if (result === null) {
                ...
                _this.displayComponentContext(_shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_19__["NumberUtils"].toString(result.projectNumber), false);
                _this.workPackage = result;
                _this.workPackage.bireRepairCenterCode = _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_21__["SelectItemUtils"].formatSelectItem(result.bireRepairCenterCode, _this.mroCenterList);
                _this.workPackage.receivingAssignedTo = _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_21__["SelectItemUtils"].formatSelectItem(result.receivingAssignedTo, _this.userList);
                _this.loadAsset();
                _this.getWorkOrders();
            }
        });
    ...
    UpdateLogbookFormComponent.prototype.onClickConfirm = function () {
        ...
        var bidmProjectAttributeDTO = {
            ...
            attributeValue: 'true',
            attributeName: _shared_constants_bidm_attribute_constants__WEBPACK_IMPORTED_MODULE_6__["BidmAttributeConstants"].IS_MAINTENANCE_PLAN_UPDATED
        };
    ...
    UpdateLogbookFormComponent.prototype.loadWorkOrderStructure = function () {
        ...
        this.updateLogbookFormService.getWorkOrdersForLogbookUpdate(this.projectId).subscribe(function (result) {
            if (result) {
                ...
                _this.workOrderStructure = Object(lodash_es__WEBPACK_IMPORTED_MODULE_2__["cloneDeep"])(_this.workOrderStructureSrc);
    ...
    UpdateLogbookFormComponent.prototype.setWorkOrderStructureGlobalFilter = function () {
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.unsubscribe))
    ...
    UpdateLogbookFormComponent.prototype.onClickRecordEvent = function () {
        ...
        if (!!this.selectedWorkOrder) {
            if (!this.recordDate) {
                ...
                this.updateLogbookFormService.updateMaintenancePlanFromWorkOrder(proj).subscribe(function (data) {
                    _this.isEventCreatedLoading = false;
    ...
    UpdateLogbookFormComponent.prototype.onClickEventKey = function (woLine) {
        var data = {
            ...
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_7__["ComponentConstants"].FLE_EVENT_CREATE,
    ...
    UpdateLogbookFormComponent.prototype.openLogbookAsset = function () {
        if (!!this.bidoEquipmentDTO && !!this.bidoEquipmentDTO.equipmentFunction) {
            this.openAssetUC(this.workPackage.assetCode, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_10__["ComponentOpenMode"].Read, this.bidoEquipmentDTO.equipmentFunction);
        }
    };
    ...
    UpdateLogbookFormComponent.prototype.loadAsset = function () {
        ...
        this.updateLogbookFormService.findBidoEquipment(input).subscribe(function (result) {
            ...
            if (_this.bidoEquipmentDTO.equipmentFunction !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].FAMILY_FUNCTION_AIRCRAFT_KEY &&
                _this.bidoEquipmentDTO.equipmentFunction !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].FAMILY_FUNCTION_ENGINE_KEY) {
                _this.subtitleAsset = '';
            ...
            else if (_this.bidoEquipmentDTO.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].FAMILY_FUNCTION_AIRCRAFT_KEY) {
                if (!!_this.workPackage.aircraftMsn) {
                    _this.subtitleAsset = "" + _this.workPackage.aircraftMsn;
                }
            }
            else if (_this.bidoEquipmentDTO.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].FAMILY_FUNCTION_ENGINE_KEY) {
    ...
    UpdateLogbookFormComponent.prototype.matchAssetStructureNode = function (node, searchText) {
        ...
        // Asset
        var asset = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_22__["StringUtils"].orEmpty(nodeData.woCode).toLowerCase();
        var assetMatch = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_22__["StringUtils"].isNullOrEmpty(searchText) || asset.includes(searchText);
        // Control
        var controlMatch = true;
        if (!_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_18__["ListUtils"].isNullOrEmpty(this.selectedControlList)) {
            var nodeControl = nodeData.control === 'OK' ? '9' : nodeData.control === 'NOK' ? '10' : '11';
            controlMatch = _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_20__["ObjectUtils"].isDefined(nodeControl) && this.selectedControlList.includes(nodeControl);
        }
        // Description
        var name = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_22__["StringUtils"].orEmpty(nodeData.description).toLowerCase();
        var nameMatch = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_22__["StringUtils"].isNullOrEmpty(searchText) || name.includes(searchText);
        return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_18__["ListUtils"].orEmpty(node.children).length > 0 || ((assetMatch || nameMatch) && controlMatch);
    };
    UpdateLogbookFormComponent.prototype.setSearchControlList = function () {
        ...
        this.translateService.get([alertNokKey, alertOkKey]).subscribe(function (results) {
            ...
            _this.searchControlList = [
                {
                    label: alertOkLabel,
                    value: _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_8__["ControlConfigConstants"].ICON_GREEN
                },
                {
                    label: alertNokLabel,
                    value: _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_8__["ControlConfigConstants"].ICON_RED
                }
            ];
        });
    };
    UpdateLogbookFormComponent.prototype.setDefaultSearchControlList = function () {
        this.selectedControlList = [
            _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_8__["ControlConfigConstants"].ICON_GREEN,
            _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_8__["ControlConfigConstants"].ICON_YELLOW,
    ...
    UpdateLogbookFormComponent.prototype.filterWorkOrderStructure = function (searchTextValue) {
        ...
        this.workOrderStructure = Object(lodash_es__WEBPACK_IMPORTED_MODULE_2__["cloneDeep"])(this.workOrderStructureSrc);
    ...
    UpdateLogbookFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./update-logbook-form.component.html */ "./src/app/main/maintenance/update-logbook/form/update-logbook-form.component.html"),
            styles: [__webpack_require__(/*! ./update-logbook-form.component.scss */ "./src/app/main/maintenance/update-logbook/form/update-logbook-form.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UpdateLogbookFormService", function() { return UpdateLogbookFormService; });
...
/* harmony import */ var _shared_utils_array_utils__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../../shared/utils/array-utils */ "./src/app/shared/utils/array-utils.ts");
/* harmony import */ var _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../../shared/utils/select-item-utils */ "./src/app/shared/utils/select-item-utils.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var UpdateLogbookFormService = /** @class */ (function (_super) {
    ...
    function UpdateLogbookFormService(http, appConfigService, amProjectManagementApi, aircraftMaintenanceApi, propertiesService, fleetManagementApi, productStructureManagementApi, userProfileManagementApi) {
    ...
    UpdateLogbookFormService.prototype.findBidmProjectWithAttributesId = function (projectId) {
        return _super.prototype.post.call(this, this.amProjectManagementApi.findBidmProjectWithAttributesId, projectId);
    };
    UpdateLogbookFormService.prototype.loadWorkPackageStatusList = function () {
        return this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_10__["GenericPropertyConstants"].AIRM_PROJECT_STATUS_MAP).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (results) {
            var statusList = !!results ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_15__["SelectItemUtils"].fromLabelValues(results) : [];
            return statusList.filter(function (status) {
                return status.value !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_8__["AWPropertiesConstants"].AIRM_PROJECT_STATUS_SCHEDULED &&
                    status.value !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_8__["AWPropertiesConstants"].AIRM_PROJECT_STATUS_SIMULATED;
            });
        }));
    };
    UpdateLogbookFormService.prototype.loadWorkOrderStatusList = function () {
        return this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_10__["GenericPropertyConstants"].AIRM_OPERATION_STATUS_MAP).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (results) {
            var statusList = !!results ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_15__["SelectItemUtils"].fromLabelValues(results) : [];
            return statusList.filter(function (status) {
                return status.value !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_8__["AWPropertiesConstants"].AIRM_PROJECT_STATUS_SCHEDULED &&
                    status.value !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_8__["AWPropertiesConstants"].AIRM_PROJECT_STATUS_SIMULATED;
    ...
    UpdateLogbookFormService.prototype.getBidmWorkOrdersStructureByProject = function (projectId) {
        ...
        return _super.prototype.post.call(this, this.aircraftMaintenanceApi.getBidmWorkOrdersStructureByProject, projectIdDto);
    };
    UpdateLogbookFormService.prototype.getWorkOrdersForLogbookUpdate = function (projectId) {
        var projectIdDto = { projectId: projectId };
        return _super.prototype.post.call(this, this.aircraftMaintenanceApi.getWorkOrdersForLogbookUpdate, projectIdDto);
    };
    ...
    UpdateLogbookFormService.prototype.updateMaintenancePlanFromWorkOrder = function (bidmWorkOrderDTOId) {
        return _super.prototype.post.call(this, this.aircraftMaintenanceApi.updateMaintenancePlanFromWorkOrder, bidmWorkOrderDTOId);
    };
    UpdateLogbookFormService.prototype.loadMROCenterList = function () {
        return this.findAuthorizedBireSite().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (results) {
            var mroCenterList = !!results ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_15__["SelectItemUtils"].fromLabelValues(results) : [];
        ...
        return this.findUsersWithUseCase().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (results) {
            return !!results
                ? results
                    ...
                    .sort(_shared_utils_array_utils__WEBPACK_IMPORTED_MODULE_14__["ArrayUtils"].compareValues('label'))
                : [];
        }));
    };
    UpdateLogbookFormService.prototype.findUsersWithUseCase = function () {
        return _super.prototype.post.call(this, this.userProfileManagementApi.findBidoUsersWithUseCase, _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_9__["BidoFunctionTypeConstants"].UC_AIRM_RECEPTION);
    };
    UpdateLogbookFormService.prototype.loadGenProps = function (key) {
        return this.propertiesService.getValue(key).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (results) {
            return !!results ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_15__["SelectItemUtils"].fromLabelValues(results) : [];
        }));
    };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ValidWoLineComponent", function() { return ValidWoLineComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../shared/enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
/* harmony import */ var _shared_types_dialog_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../shared/types/dialog-component */ "./src/app/shared/types/dialog-component.ts");
var __extends = (undefined && undefined.__extends) || (function () {
...
var ValidWoLineComponent = /** @class */ (function (_super) {
    ...
    function ValidWoLineComponent() {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__["ComponentOpenMode"].Write, 'ValidWoLineComponent') || this;
        _this.initData();
        return _this;
    }
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], ValidWoLineComponent.prototype, "elementsToValidate", void 0);
    ValidWoLineComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-valid-wo-line',
            template: __webpack_require__(/*! ./valid-wo-line.component.html */ "./src/app/main/maintenance/update-logbook/form/valid-wo-line/valid-wo-line.component.html"),
            styles: [__webpack_require__(/*! ./valid-wo-line.component.scss */ "./src/app/main/maintenance/update-logbook/form/valid-wo-line/valid-wo-line.component.scss")]
        }),
        __metadata("design:paramtypes", [])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UpdateLogbookModule", function() { return UpdateLogbookModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _form_dialog_record_report_dialog_record_report_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./form/dialog-record-report/dialog-record-report.component */ "./src/app/main/maintenance/update-logbook/form/dialog-record-report/dialog-record-report.component.ts");
/* harmony import */ var _form_update_logbook_form_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./form/update-logbook-form.component */ "./src/app/main/maintenance/update-logbook/form/update-logbook-form.component.ts");
/* harmony import */ var _form_update_logbook_form_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./form/update-logbook-form.service */ "./src/app/main/maintenance/update-logbook/form/update-logbook-form.service.ts");
/* harmony import */ var _form_valid_wo_line_valid_wo_line_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./form/valid-wo-line/valid-wo-line.component */ "./src/app/main/maintenance/update-logbook/form/valid-wo-line/valid-wo-line.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Components
 *************************************************************************** */
var COMPONENTS = [_form_dialog_record_report_dialog_record_report_component__WEBPACK_IMPORTED_MODULE_14__["DialogRecordReportComponent"]];
var DYNAMIC_COMPONENTS = [_form_update_logbook_form_component__WEBPACK_IMPORTED_MODULE_15__["UpdateLogbookFormComponent"], _form_valid_wo_line_valid_wo_line_component__WEBPACK_IMPORTED_MODULE_17__["ValidWoLineComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
