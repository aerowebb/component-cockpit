(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["maintenance-configuration-control-configuration-control-module"],{
...
/* harmony import */ var _shared_types_generic_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../shared/types/generic-component */ "./src/app/shared/types/generic-component.ts");
...
/* harmony import */ var _configuration_control_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../configuration-control.service */ "./src/app/main/maintenance/configuration-control/configuration-control.service.ts");
...
var AssetViewScopeComponent = /** @class */ (function (_super) {
    ...
    function AssetViewScopeComponent(configurationControlService, propertiesService, serializationService, tabService) {
    ...
    AssetViewScopeComponent.prototype.loadCsnAndTsnValues = function (equipmentCode) {
        ...
        this.configurationControlService
            ...
            if (result) {
                _this.assetCsn = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_12__["StringUtils"].orEmpty(result.csn);
                _this.assetTsn = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_12__["StringUtils"].orEmpty(result.tsn);
            }
        });
    };
    ...
    AssetViewScopeComponent.prototype.openAircraft = function (equipmentCode) {
        ...
        var data = {
            ...
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_3__["ComponentConstants"].FLE_AIRCRAFT_FORM,
    ...
    AssetViewScopeComponent.prototype.openEngine = function (equipmentCode) {
        ...
        var data = {
            id: this.tabService.generateId(),
            openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_6__["ComponentOpenMode"].Read,
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_3__["ComponentConstants"].FLE_ENGINE_FORM,
            objectId: this.serializationService.serialize(objectId)
        };
        var labelKey = 'transaction.' + data.componentId;
        this.tabService.open(this.tabService.create(data, labelKey, true));
    ...
    AssetViewScopeComponent.prototype.openEquipment = function (equipmentCode) {
        ...
        var data = {
            id: this.tabService.generateId(),
            openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_6__["ComponentOpenMode"].Read,
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_3__["ComponentConstants"].FLE_EQUIPMENT_FORM,
            objectId: this.serializationService.serialize(objectId)
        };
        var labelKey = 'transaction.' + data.componentId;
        this.tabService.open(this.tabService.create(data, labelKey, true));
    ...
    AssetViewScopeComponent.prototype.setAssetStatus = function () {
        var _this = this;
        if (this.isAssetAircraft) {
            var familyVariantInput = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].FAMILY_FUNCTION_AIRCRAFT_KEY;
            this.configurationControlService.getStatusMap(familyVariantInput).subscribe(function (results) {
                var status = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__["ListUtils"].orEmpty(results).find(function (elt) { return elt.value === _this._asset.operationalStatus; });
                _this.assetStatus = status ? status.label : '';
            });
        }
        else {
            this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].OPERATIONAL_STATUS_MAP).subscribe(function (results) {
                var status = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__["ListUtils"].orEmpty(results).find(function (elt) { return elt.value === _this._asset.operationalStatus; });
                _this.assetStatus = status ? status.label : '';
            });
        }
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], AssetViewScopeComponent.prototype, "isGroundEquipment", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String),
        __metadata("design:paramtypes", [String])
    ], AssetViewScopeComponent.prototype, "alert", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object),
    ...
    AssetViewScopeComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./asset-view-scope.component.html */ "./src/app/main/maintenance/configuration-control/asset-view-scope/asset-view-scope.component.html"),
            styles: [__webpack_require__(/*! ../share.scss */ "./src/app/main/maintenance/configuration-control/share.scss")]
        }),
        __metadata("design:paramtypes", [_configuration_control_service__WEBPACK_IMPORTED_MODULE_13__["ConfigurationControlService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConfigurationControlComponent", function() { return ConfigurationControlComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_constants_bidm_attribute_constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../shared/constants/bidm-attribute-constants */ "./src/app/shared/constants/bidm-attribute-constants.ts");
...
/* harmony import */ var _shared_utils_bire_item_utils__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../../shared/utils/bire-item-utils */ "./src/app/shared/utils/bire-item-utils.ts");
/* harmony import */ var _shared_utils_boolean_utils__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../../shared/utils/boolean-utils */ "./src/app/shared/utils/boolean-utils.ts");
/* harmony import */ var _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../../shared/utils/file-utils */ "./src/app/shared/utils/file-utils.ts");
...
/* harmony import */ var _configuration_control_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./configuration-control.service */ "./src/app/main/maintenance/configuration-control/configuration-control.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ConfigurationControlComponent = /** @class */ (function (_super) {
    ...
    // *****************************************************************************
    function ConfigurationControlComponent(favoriteService, loaderService, messageService, serializationService, tabService, sessionService, configurationControlService, propertiesService, translateService) {
    ...
    ConfigurationControlComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_8__["ComponentConstants"].MAI_CONFIGURATION_CONTROL;
    };
    ...
    ConfigurationControlComponent.prototype.onBeforeLoad = function () {
        ...
        this.globalStatus = _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_RED;
    ...
    ConfigurationControlComponent.prototype.cancelAllWorkPackageMovement = function () {
        ...
        if (attributeToRemove && attributeToRemove.id) {
            this.configurationControlService.removeBidmProjectAttribute(attributeToRemove.id).subscribe(function () {
                _this.workPackageAttributeList = _this.workPackageAttributeList.filter(function (attribute) { return attribute.id !== attributeToRemove.id; });
    ...
    ConfigurationControlComponent.prototype.confirmAllWorkPackageMovement = function () {
        ...
        var input = {
            ...
            attributeName: _shared_constants_bidm_attribute_constants__WEBPACK_IMPORTED_MODULE_6__["BidmAttributeConstants"].IS_ASSET_STRUCTURE_UPDATED,
            attributeValue: 'true'
        };
    ...
    ConfigurationControlComponent.prototype.installEquipmentFromWP = function () {
        ...
        this.mvtWay = _shared_constants_bidt_stock_mvt_constants__WEBPACK_IMPORTED_MODULE_7__["BidtStockMvtConstants"].MVT_WAY_DEBIT;
    ...
    ConfigurationControlComponent.prototype.removeEquipmentFromWP = function () {
        ...
        this.woAssetDesignation = undefined;
        this.woAssetFunction = undefined;
        this.mvtWay = _shared_constants_bidt_stock_mvt_constants__WEBPACK_IMPORTED_MODULE_7__["BidtStockMvtConstants"].MVT_WAY_CREDIT;
        this.installRemoveFromWP();
    };
    ...
    ConfigurationControlComponent.prototype.installRemoveFromWP = function () {
        if (this.assetStructureSelection) {
            ...
            if (data.uniqueBidoEquipmentChild && this.mvtWay === _shared_constants_bidt_stock_mvt_constants__WEBPACK_IMPORTED_MODULE_7__["BidtStockMvtConstants"].MVT_WAY_CREDIT) {
    ...
    ConfigurationControlComponent.prototype.isAssetAircraft = function (asset) {
        return !!asset.equipmentFunction && asset.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].ITEM_FAMILY_CODE_AIRCRAFT_KEY;
    };
    ConfigurationControlComponent.prototype.isAssetEngine = function (asset) {
        return !!asset.equipmentFunction && asset.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].ITEM_FAMILY_CODE_ENGINE_KEY;
    };
    ...
    ConfigurationControlComponent.prototype.isAssetGroundEquipment = function (asset) {
        return (asset.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].ITEM_FAMILY_CODE_GROUND_SUPPORT_EQUIPMENT_KEY ||
            asset.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].ITEM_FAMILY_CODE_TOOL_KEY ||
            asset.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].ITEM_FAMILY_CODE_PILOT_EQUIPMENT_KEY);
    };
    ConfigurationControlComponent.prototype.isFlAircraft = function (fl) {
        return !!fl.flFunction && fl.flFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].ITEM_FAMILY_CODE_AIRCRAFT_KEY;
    };
    ConfigurationControlComponent.prototype.isFlEngine = function (fl) {
        return !!fl.flFunction && fl.flFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].ITEM_FAMILY_CODE_ENGINE_KEY;
    };
    ConfigurationControlComponent.prototype.isItemAircraft = function (item) {
        return !!item.itemFamilyCode && item.itemFamilyCode === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].ITEM_FAMILY_CODE_AIRCRAFT_KEY;
    };
    ConfigurationControlComponent.prototype.isItemEngine = function (item) {
        return !!item.itemFamilyCode && item.itemFamilyCode === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].ITEM_FAMILY_CODE_ENGINE_KEY;
    };
    ...
    ConfigurationControlComponent.prototype.openAssetAtDate = function () {
        var data = {
            ...
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_8__["ComponentConstants"].FLE_ASSET_AT_DATE_FORM,
            objectId: "structure-----" + this.serializationService.serialize({
                equipmentCode: this.equipmentCode,
                function: this.asset.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].FAMILY_FUNCTION_AIRCRAFT_KEY
                    ? 'Aircraft'
                    : this.asset.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].FAMILY_FUNCTION_ENGINE_KEY
                        ? 'Engine'
                        : 'Equipment',
    ...
    ConfigurationControlComponent.prototype.openMaintenancePlanning = function () {
        if (!!this.equipmentCode) {
            ...
            var data = {
                id: this.tabService.generateId(),
                openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_11__["ComponentOpenMode"].Write,
                componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_8__["ComponentConstants"].MAI_AIRWORTHINESS_CONTROL_SCHEDULE_MAINTENANCE_FORM,
                objectId: this.serializationService.serialize(objectId)
            };
            var labelKey = 'transaction.' + data.componentId;
            this.tabService.open(this.tabService.create(data, labelKey, true));
    ...
    ConfigurationControlComponent.prototype.openGroundMaintenancePlanning = function () {
        ...
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_8__["ComponentConstants"].LOG_TOOLS_MAINTENANCE_PLANNING_FORM,
            openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_11__["ComponentOpenMode"].Read,
            objectId: this.serializationService.serialize(objectId)
        };
        var labelKey = 'transaction.' + data.componentId;
    ...
    ConfigurationControlComponent.prototype.addControlTableRow = function (id, causeIdList, causeList, controlList, category) {
        var hasRedFlag = controlList
            .filter(_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_24__["ObjectUtils"].isDefined)
            .some(function (control) { return control === _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_RED; });
        var hasYellowFlag = controlList
            .filter(_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_24__["ObjectUtils"].isDefined)
            .some(function (control) { return control === _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_YELLOW; });
        var controlRow = {
            category: category,
            causeIdList: causeIdList.filter(_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_24__["ObjectUtils"].isDefined).join(', '),
            causeList: causeList.filter(function (elt) { return !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_25__["StringUtils"].isNullOrEmpty(elt); }),
            control: hasRedFlag
    ...
    ConfigurationControlComponent.prototype.calculateCheckGlobalResultForAssetStructureNode = function (asset) {
        var checkList = [
            ...
            asset.checkFlResult
        ].filter(function (check) { return _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_24__["ObjectUtils"].isDefined(check); });
        return checkList.some(function (check) { return check === _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_RED; })
            ? _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_RED
            : checkList.some(function (check) { return check === _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_YELLOW; })
                ? _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_YELLOW
                : _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_GREEN;
    };
    ...
    ConfigurationControlComponent.prototype.createAssetStructureTreeNode = function (asset) {
        ...
        var node = {
            data: asset,
            expanded: false,
            children: _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_23__["ListUtils"].orEmpty(asset.children).map(function (childAsset) { return _this.createAssetStructureTreeNode(childAsset); })
        };
        return node;
    };
    ...
    ConfigurationControlComponent.prototype.loadAsset = function () {
        ...
        this.configurationControlService.findBidoEquipment(input).subscribe(function (asset) {
            ...
            _this.componentContext = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_25__["StringUtils"].isEmpty(_this.componentContext) ? '' : _this.componentContext + " / ";
            ...
            if (asset.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].ITEM_FAMILY_CODE_GROUND_SUPPORT_EQUIPMENT_KEY ||
                asset.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].ITEM_FAMILY_CODE_TOOL_KEY ||
                asset.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].ITEM_FAMILY_CODE_PILOT_EQUIPMENT_KEY) {
    ...
    ConfigurationControlComponent.prototype.loadAssetStructure = function () {
        ...
        this.configurationControlService.controlConfiguration(input).subscribe(function (result) {
            if (result) {
                ...
                _this.assetStructure = Object(lodash_es__WEBPACK_IMPORTED_MODULE_2__["cloneDeep"])(_this.assetStructureSrc);
    ...
    ConfigurationControlComponent.prototype.matchAssetStructureNode = function (node, searchText) {
        var _this = this;
        if (!_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_23__["ListUtils"].isNullOrEmpty(node.children)) {
            node.children = node.children.filter(function (child) { return _this.matchAssetStructureNode(child, searchText); });
        }
        var nodeData = node.data;
        // Asset
        var asset = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_25__["StringUtils"].orEmpty(nodeData.asset).toLowerCase();
        var assetMatch = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_25__["StringUtils"].isNullOrEmpty(searchText) || asset.includes(searchText);
        // Control
        var controlMatch = true;
        if (!_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_23__["ListUtils"].isNullOrEmpty(this.selectedControlList)) {
            var nodeControl = nodeData.checkGlobalResult;
            controlMatch = _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_24__["ObjectUtils"].isDefined(nodeControl) && this.selectedControlList.includes(nodeControl);
        }
        // Stock status
        var stockStatusMatch = this.selectedStockMvtStatusList
            ...
            if (status === SearchStockMvtStatus.ALL) {
                ...
                return _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_24__["ObjectUtils"].isDefined(nodeData.installedStockMvtData);
            }
            else if (status === SearchStockMvtStatus.REMOVALS) {
                return _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_24__["ObjectUtils"].isDefined(nodeData.removedStockMvtData);
            }
            else {
                return true;
            }
        ...
        // Structure
        var name = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_25__["StringUtils"].orEmpty(nodeData.structure).toLowerCase();
        var nameMatch = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_25__["StringUtils"].isNullOrEmpty(searchText) || name.includes(searchText);
        return (_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_23__["ListUtils"].orEmpty(node.children).length > 0 || ((assetMatch || nameMatch) && controlMatch && stockStatusMatch));
    };
    ...
    ConfigurationControlComponent.prototype.setAssetStructureGlobalFilter = function () {
        ...
        this.searchAssetStructureGlobalFilterChanged
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(ConfigurationControlComponent_1.SEARCH_TEXT_DEBOUNCE_TIME), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.unsubscribe))
    ...
    ConfigurationControlComponent.prototype.setControlTable = function () {
        this.controlTable = [];
        var asset = this.assetStructureSelection.data;
        if (asset.checkConfigurationResult ||
            asset.checkCoreResult ||
            asset.checkFlResult ||
            asset.checkMelResult ||
            asset.checkCoreResult ||
            asset.checkStructureResult) {
            this.addControlTableRow(ConfigurationControlComponent_1.CONTROLS_TABLE_CHECK_OTHER_ID, [
        ...
        if (asset.checkLogbookResult) {
            this.addControlTableRow(ConfigurationControlComponent_1.CONTROLS_TABLE_CHECK_LOGBOOK_ID, [asset.checkLogbookCause], [asset.checkLogbookCauseAlt], [asset.checkLogbookResult], ConfigurationControlComponent_1.SUMMARY_TABLE_AIRWORTHINESS_DOCUMENT_COMPLIANCE_LABEL);
        }
        if (asset.checkPotentialResult) {
            this.addControlTableRow(ConfigurationControlComponent_1.CONTROLS_TABLE_CHECK_POTENTIAL_ID, [asset.checkPotentialCause], [asset.checkPotentialCauseAlt], [asset.checkPotentialResult], ConfigurationControlComponent_1.SUMMARY_TABLE_LLP_POTENTIAL_LABEL);
        }
    };
    ...
    ConfigurationControlComponent.prototype.updateSummaryTable = function () {
        ...
        this.assetStructure.forEach(function (asset) { return _this.updateSummaryTableWithAssetStructureTreeNode(asset); });
    ...
    ConfigurationControlComponent.prototype.updateSummaryTableRow = function (rowIndex, checkResult) {
        this.summaryTable[rowIndex].nok += checkResult === _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_RED ? 1 : 0;
        this.summaryTable[rowIndex].ok += checkResult === _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_GREEN ? 1 : 0;
        this.summaryTable[rowIndex].warning += checkResult === _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_YELLOW ? 1 : 0;
    };
    ...
    ConfigurationControlComponent.prototype.updateSummaryTableWithAssetStructureTreeNode = function (node) {
        ...
        var applicableConfigurationComplianceIndex = ConfigurationControlComponent_1.SUMMARY_TABLE_APPLICABLE_CONFIGURATION_COMPLIANCE_INDEX;
        ...
        this.updateSummaryTableRow(ConfigurationControlComponent_1.SUMMARY_TABLE_AIRWORTHINESS_DOCUMENT_COMPLIANCE_INDEX, asset.checkLogbookResult);
        // LLP potential
        this.updateSummaryTableRow(ConfigurationControlComponent_1.SUMMARY_TABLE_LLP_POTENTIAL_INDEX, asset.checkPotentialResult);
        // Children
        if (node.children) {
            node.children.forEach(function (childAsset) { return _this.updateSummaryTableWithAssetStructureTreeNode(childAsset); });
        }
    };
    ConfigurationControlComponent.prototype.initDisplayWithKardex = function () {
        ...
        if (!!this.workPackageCode) {
            ...
            this.propertiesService
                .getConfigurationValue(_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].FM_APPLIED_CONF_DISPLAYED_WITH_KARDEX)
                .subscribe(function (result) {
                _this.displayWithKardex = _shared_utils_boolean_utils__WEBPACK_IMPORTED_MODULE_21__["BooleanUtils"].isTrue(result);
    ...
    ConfigurationControlComponent.prototype.loadAircraftStatusList = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_10__["GenericPropertyConstants"].AIRCRAFT_STATUS_MAP).subscribe(function (results) {
            _this.aircraftStatusList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_23__["ListUtils"].orEmpty(results);
        });
    };
    ...
    ConfigurationControlComponent.prototype.loadWorkPackage = function () {
        ...
        if (this.workPackageCode) {
            this.configurationControlService.findBidmProject(this.workPackageCode).subscribe(function (result) {
                ...
                _this.componentContext = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_25__["StringUtils"].isEmpty(_this.componentContext)
                    ? componentContext
    ...
    ConfigurationControlComponent.prototype.loadWorkPackageAttributeList = function () {
        ...
        if (this.workPackage.projectId) {
            ...
            this.configurationControlService.findBidmProjectAttributesByWorkOrder(input).subscribe(function (result) {
                _this.workPackageAttributeList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_23__["ListUtils"].orEmpty(result);
    ...
    ConfigurationControlComponent.prototype.getAssetStructureUpdatedAttribute = function () {
        return this.workPackageAttributeList.find(function (attribute) {
            return (attribute.attributeName === _shared_constants_bidm_attribute_constants__WEBPACK_IMPORTED_MODULE_6__["BidmAttributeConstants"].IS_ASSET_STRUCTURE_UPDATED &&
                !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_25__["StringUtils"].isNullOrEmpty(attribute.attributeValue) &&
    ...
    ConfigurationControlComponent.prototype.checkIfWorkPackageHasAssetStructureUpdatedAttribute = function () {
        this.workPackageMovementsUpdated = _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_24__["ObjectUtils"].isDefined(this.getAssetStructureUpdatedAttribute());
    };
    ...
    ConfigurationControlComponent.prototype.openEvolution = function (row) {
        ...
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_8__["ComponentConstants"].ENG_EVOLUTION_FORM,
    ...
    ConfigurationControlComponent.prototype.getColorByIconCode = function (iconCode) {
        switch (iconCode) {
            case _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_GREEN_LIGHT_CODE:
                return 'ok';
            case _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_YELLOW_LIGHT_CODE:
                return 'warning';
            case _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_RED_LIGHT_CODE:
                return 'nok';
            case _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_NONE_LIGHT_CODE:
                return 'ok';
            case _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_GREEN_LED_CODE:
                return 'ok';
            case _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_YELLOW_LED_CODE:
                return 'warning';
            case _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_RED_LED_CODE:
                return 'nok';
            case _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_9__["ControlConfigConstants"].ICON_NONE_LED_CODE:
                return 'ok';
            default:
                return 'nok';
        }
    ...
    ConfigurationControlComponent.prototype.generateFormEASA1 = function (asset) {
        ...
        this.configurationControlService
            ...
            next: function (fileContent) {
                _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_22__["FileUtils"].downloadFile(fileContent.fileContent, fileContent.fileName);
            }
        });
    };
    ...
    ConfigurationControlComponent.prototype.showInstallations = function () {
        ...
        if (this.assetStructureFilterInstallationVisible) {
            if (this.assetStructureFilterRemovalVisible) {
                ...
                this.assetStructure = this.assetStructure.filter(function (node) { return _this.matchAssetStructureNodeByInstallation(node); });
            }
            this.expandAssetStructure(this.assetStructure);
        }
        else if (this.assetStructureFilterRemovalVisible) {
            this.assetStructure = this.assetStructure.filter(function (node) { return _this.matchAssetStructureNodeByRemoval(node); });
            this.expandAssetStructure(this.assetStructure);
        }
    ...
    ConfigurationControlComponent.prototype.matchAssetStructureNodeByInstallation = function (node) {
        ...
        var nodeData = node.data;
        return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_23__["ListUtils"].orEmpty(node.children).length > 0 || _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_24__["ObjectUtils"].isDefined(nodeData.installedStockMvtData);
    };
    ConfigurationControlComponent.prototype.matchAssetStructureNodeByInstallationAndRemoval = function (node) {
        ...
        var nodeData = node.data;
        return (_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_23__["ListUtils"].orEmpty(node.children).length > 0 ||
            _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_24__["ObjectUtils"].isDefined(nodeData.installedStockMvtData) ||
            _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_24__["ObjectUtils"].isDefined(nodeData.removedStockMvtData));
    };
    ConfigurationControlComponent.prototype.matchAssetStructureNodeByRemoval = function (node) {
        ...
        var nodeData = node.data;
        return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_23__["ListUtils"].orEmpty(node.children).length > 0 || _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_24__["ObjectUtils"].isDefined(nodeData.removedStockMvtData);
    };
    ...
    ConfigurationControlComponent.prototype.onCreateWorkPackage = function (data) {
        var _this = this;
        this.configurationControlService.createWorkPackage(data.woManagementInputDTO).subscribe(function () {
    ...
    ConfigurationControlComponent.SUMMARY_TABLE_AIRWORTHINESS_DOCUMENT_COMPLIANCE_LABEL = 'checkAirworthinessDocumentCompliance';
    ConfigurationControlComponent.SUMMARY_TABLE_APPLICABLE_CONFIGURATION_COMPLIANCE_LABEL = 'checkAppliableConfigurationCompliance';
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(ConfigurationControlComponent_1.CONFIGURATION_CONTROL_ANCHOR_ID),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], ConfigurationControlComponent.prototype, "configurationControlEltRef", void 0);
    ConfigurationControlComponent = ConfigurationControlComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-configuration-control',
            template: __webpack_require__(/*! ./configuration-control.component.html */ "./src/app/main/maintenance/configuration-control/configuration-control.component.html"),
            styles: [__webpack_require__(/*! ./configuration-control.component.scss */ "./src/app/main/maintenance/configuration-control/configuration-control.component.scss"), __webpack_require__(/*! ./share.scss */ "./src/app/main/maintenance/configuration-control/share.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConfigurationControlModule", function() { return ConfigurationControlModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var primeng_togglebutton__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! primeng/togglebutton */ "./node_modules/primeng/togglebutton.js");
/* harmony import */ var primeng_togglebutton__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(primeng_togglebutton__WEBPACK_IMPORTED_MODULE_13__);
...
/* harmony import */ var _shared_components_asset_rev_search_asset_rev_search_module__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../../shared/components/asset-rev-search/asset-rev-search.module */ "./src/app/shared/components/asset-rev-search/asset-rev-search.module.ts");
...
/* harmony import */ var _shared_components_dialog_search_task_dialog_search_task_module__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../../../shared/components/dialog-search-task/dialog-search-task.module */ "./src/app/shared/components/dialog-search-task/dialog-search-task.module.ts");
...
/* harmony import */ var _shared_components_work_package_list_work_package_list_module__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../../../shared/components/work-package-list/work-package-list.module */ "./src/app/shared/components/work-package-list/work-package-list.module.ts");
/* harmony import */ var _dynamic_component_loader_dynamic_component_loader_module__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../../dynamic-component-loader/dynamic-component-loader.module */ "./src/app/main/dynamic-component-loader/dynamic-component-loader.module.ts");
/* harmony import */ var _asset_view_scope_asset_view_scope_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./asset-view-scope/asset-view-scope.component */ "./src/app/main/maintenance/configuration-control/asset-view-scope/asset-view-scope.component.ts");
/* harmony import */ var _configuration_control_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./configuration-control.component */ "./src/app/main/maintenance/configuration-control/configuration-control.component.ts");
/* harmony import */ var _configuration_control_service__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./configuration-control.service */ "./src/app/main/maintenance/configuration-control/configuration-control.service.ts");
/* harmony import */ var _dialog_help_dialog_help_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./dialog-help/dialog-help.component */ "./src/app/main/maintenance/configuration-control/dialog-help/dialog-help.component.ts");
/* harmony import */ var _dialog_work_order_dialog_work_order_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./dialog-work-order/dialog-work-order.component */ "./src/app/main/maintenance/configuration-control/dialog-work-order/dialog-work-order.component.ts");
/* harmony import */ var _dialog_work_order_dialog_work_order_service__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./dialog-work-order/dialog-work-order.service */ "./src/app/main/maintenance/configuration-control/dialog-work-order/dialog-work-order.service.ts");
/* harmony import */ var _installation_equipment_installation_equipment_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./installation-equipment/installation-equipment.component */ "./src/app/main/maintenance/configuration-control/installation-equipment/installation-equipment.component.ts");
/* harmony import */ var _removal_equipment_removal_equipment_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./removal-equipment/removal-equipment.component */ "./src/app/main/maintenance/configuration-control/removal-equipment/removal-equipment.component.ts");
/* harmony import */ var _search_configuration_control_search_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./search/configuration-control-search.component */ "./src/app/main/maintenance/configuration-control/search/configuration-control-search.component.ts");
/* harmony import */ var _search_configuration_control_search_service__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./search/configuration-control-search.service */ "./src/app/main/maintenance/configuration-control/search/configuration-control-search.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var INTERNAL_MODULES = [
    _shared_components_asset_rev_search_asset_rev_search_module__WEBPACK_IMPORTED_MODULE_20__["AssetRevSearchModule"],
    ...
    _shared_components_dialog_search_task_dialog_search_task_module__WEBPACK_IMPORTED_MODULE_24__["DialogSearchTaskModule"],
    _shared_components_work_package_list_work_package_list_module__WEBPACK_IMPORTED_MODULE_28__["WorkPackageListModule"],
 ...
 * Components
 *************************************************************************** */
var COMPONENTS = [_asset_view_scope_asset_view_scope_component__WEBPACK_IMPORTED_MODULE_30__["AssetViewScopeComponent"], _dialog_help_dialog_help_component__WEBPACK_IMPORTED_MODULE_33__["DialogHelpComponent"], _dialog_work_order_dialog_work_order_component__WEBPACK_IMPORTED_MODULE_34__["DialogWorkOrderCreationComponent"]];
var DYNAMIC_COMPONENTS = [
    _search_configuration_control_search_component__WEBPACK_IMPORTED_MODULE_38__["ConfigurationControlSearchComponent"],
    _configuration_control_component__WEBPACK_IMPORTED_MODULE_31__["ConfigurationControlComponent"],
    _installation_equipment_installation_equipment_component__WEBPACK_IMPORTED_MODULE_36__["InstallationEquipmentComponent"],
    _removal_equipment_removal_equipment_component__WEBPACK_IMPORTED_MODULE_37__["RemovalEquipmentComponent"]
];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_search_configuration_control_search_service__WEBPACK_IMPORTED_MODULE_39__["ConfigurationControlSearchService"], _configuration_control_service__WEBPACK_IMPORTED_MODULE_32__["ConfigurationControlService"], _dialog_work_order_dialog_work_order_service__WEBPACK_IMPORTED_MODULE_35__["DialogWorkOrderCreationService"]];
    ...
    ConfigurationControlModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: __spread([
                ...
                _dynamic_component_loader_dynamic_component_loader_module__WEBPACK_IMPORTED_MODULE_29__["DynamicComponentLoaderModule"].forChild(DYNAMIC_COMPONENTS)
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConfigurationControlService", function() { return ConfigurationControlService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _shared_api_work_order_management_api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../..//shared/api/work-order-management.api */ "./src/app/shared/api/work-order-management.api.ts");
/* harmony import */ var _shared_api_aircraft_maintenance_api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../shared/api/aircraft-maintenance.api */ "./src/app/shared/api/aircraft-maintenance.api.ts");
/* harmony import */ var _shared_api_airworthiness_management_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../shared/api/airworthiness-management.api */ "./src/app/shared/api/airworthiness-management.api.ts");
/* harmony import */ var _shared_api_am_project_management_api__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../shared/api/am-project-management.api */ "./src/app/shared/api/am-project-management.api.ts");
/* harmony import */ var _shared_api_asset_management_api__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../shared/api/asset-management.api */ "./src/app/shared/api/asset-management.api.ts");
/* harmony import */ var _shared_api_bidt_warehouse_api__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../shared/api/bidt-warehouse.api */ "./src/app/shared/api/bidt-warehouse.api.ts");
/* harmony import */ var _shared_api_fleet_business_api__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../shared/api/fleet-business.api */ "./src/app/shared/api/fleet-business.api.ts");
/* harmony import */ var _shared_api_fleet_history_api__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../shared/api/fleet-history.api */ "./src/app/shared/api/fleet-history.api.ts");
...
/* harmony import */ var _shared_api_product_structure_business_api__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../shared/api/product-structure-business.api */ "./src/app/shared/api/product-structure-business.api.ts");
...
/* harmony import */ var _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../shared/constants/component-constants */ "./src/app/shared/constants/component-constants.ts");
...
/* harmony import */ var _shared_http_abstract_aw_http__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../shared/http/abstract-aw-http */ "./src/app/shared/http/abstract-aw-http.ts");
/* harmony import */ var _shared_services_app_config_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../shared/services/app-config.service */ "./src/app/shared/services/app-config.service.ts");
...
var ConfigurationControlService = /** @class */ (function (_super) {
    ...
    function ConfigurationControlService(http, appConfigService, aircraftMaintenanceApi, airworthinessManagementApi, amProjectManagementApi, assetManagementApi, bidtWarehouseApi, fleetBusinessApi, fleetHistoryApi, fleetManagementApi, productStructureBusinessApi, productStructureManagementApi, serializationService, workOrderManagementApi, tabService) {
    ...
    ConfigurationControlService.prototype.getAssetAtDate = function (equipmentCode, notificationCode) {
        var _this = this;
        return this.findBidoNotification({ notificationCode: notificationCode }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatMap"])(function (notification) {
            return _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_21__["ObjectUtils"].isDefined(notification.reportingPeriodStartDate)
    ...
    ConfigurationControlService.prototype.getFunctionLocationLabel = function (bidoNotificationDTO) {
        return _super.prototype.post.call(this, this.fleetManagementApi.getFunctionLocationLabel, bidoNotificationDTO);
    };
    ...
    ConfigurationControlService.prototype.openEvent = function (notificationCode) {
        ...
        var data = {
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_15__["ComponentConstants"].FLE_EVENT_CREATE,
            id: this.tabService.generateId(),
            objectId: this.serializationService.serialize(objectId),
    ...
    ConfigurationControlService.prototype.openWorkOrder = function (workOrder) {
        if (workOrder) {
            ...
            var data = {
                componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_15__["ComponentConstants"].MAI_WORK_ORDER_FORM,
                id: this.tabService.generateId(),
                objectId: this.serializationService.serialize(objectId),
                openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_16__["ComponentOpenMode"].Read
            };
    ...
    ConfigurationControlService.prototype.findBidmProjectAttributesByWorkOrder = function (input) {
        return _super.prototype.post.call(this, this.amProjectManagementApi.findBidmProjectAttributesByWorkOrder, input);
    };
    ConfigurationControlService.prototype.generateEASACertificate = function (bidmProjectReportDTOId) {
        return _super.prototype.post.call(this, this.amProjectManagementApi.generateEASACertificate, bidmProjectReportDTOId);
    };
    ConfigurationControlService.prototype.generateFAACertificate = function (bidmProjectReportDTOId) {
        return _super.prototype.post.call(this, this.amProjectManagementApi.generateFAACertificate, bidmProjectReportDTOId);
    };
    ...
    ConfigurationControlService.prototype.getFunctionLocationListToInstallEquipment = function (input) {
        return _super.prototype.post.call(this, this.fleetBusinessApi.getFunctionLocationListToInstallEquipment, input);
    };
    ...
    ConfigurationControlService.prototype.findBidoEquipmentByEquipmentCodeFromDate = function (input) {
        return _super.prototype.post.call(this, this.fleetHistoryApi.findBidoEquipmentByEquipmentCodeFromDate, input);
    };
    /**************************************************************************
    ...
    ConfigurationControlService.prototype.findBidoFlEquipmentByEquipmentCodeFromDate = function (bidoNotificationDTOId) {
        return _super.prototype.post.call(this, this.fleetManagementApi.findBidoFlEquipmentByEquipmentCodeFromDate, bidoNotificationDTOId);
    };
    ConfigurationControlService.prototype.findBidoNotification = function (bidoNotificationDTOId) {
        return _super.prototype.post.call(this, this.fleetManagementApi.findBidoNotification, bidoNotificationDTOId);
    };
    /**************************************************************************
...
module.exports = ".widthClass {\n  width: 15em;\n  padding-bottom: 3px; }\n\n.marginClass {\n  margin-left: 0 !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogHelpComponent", function() { return DialogHelpComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
...
var DialogHelpComponent = /** @class */ (function (_super) {
    ...
    function DialogHelpComponent(translateService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Read, 'DialogHelpComponent') || this;
        _this.translateService = translateService;
    ...
    DialogHelpComponent = DialogHelpComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./dialog-help.component.html */ "./src/app/main/maintenance/configuration-control/dialog-help/dialog-help.component.html"),
            styles: [__webpack_require__(/*! ./dialog-help.component.scss */ "./src/app/main/maintenance/configuration-control/dialog-help/dialog-help.component.scss")]
        }),
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogWorkOrderCreationComponent", function() { return DialogWorkOrderCreationComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
...
/* harmony import */ var _shared_utils_bire_item_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../shared/utils/bire-item-utils */ "./src/app/shared/utils/bire-item-utils.ts");
...
/* harmony import */ var _dialog_work_order_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./dialog-work-order.service */ "./src/app/main/maintenance/configuration-control/dialog-work-order/dialog-work-order.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DialogWorkOrderCreationComponent = /** @class */ (function (_super) {
    ...
    function DialogWorkOrderCreationComponent(sessionService, dialogWorkPackageService, messageService, propertiesService, translateService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_7__["ComponentOpenMode"].Write, 'DialogWorkOrderCreationComponent') || this;
        _this.sessionService = sessionService;
    ...
    DialogWorkOrderCreationComponent.prototype.ngOnInit = function () {
        ...
        this.getProjectList();
        if (this.woItemPk) {
            this.displayWoItem = _shared_utils_bire_item_utils__WEBPACK_IMPORTED_MODULE_12__["BireItemUtils"].createItemKey(this.woItemPk);
        }
        if (this.mvtWay === _shared_constants_bidt_stock_mvt_constants__WEBPACK_IMPORTED_MODULE_5__["BidtStockMvtConstants"].MVT_WAY_CREDIT) {
            this.getWarehouseList();
        }
        this.initAssetRepresentation();
    };
    DialogWorkOrderCreationComponent.prototype.isValid = function () {
        return (!_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_15__["StringUtils"].isNullOrEmpty(this.woManagementInputDTO.projectName) &&
            !!this.woManagementInputDTO.projectStartDate &&
            !!this.woManagementInputDTO.projectType &&
            !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_15__["StringUtils"].isNullOrEmpty(this.woManagementInputDTO.projectMroCenterCode));
    };
    DialogWorkOrderCreationComponent.prototype.validate = function () {
        if (this.woManagementInputDTO.projectStartDate &&
            this.woManagementInputDTO.projectDueDate &&
            moment__WEBPACK_IMPORTED_MODULE_2__(this.woManagementInputDTO.projectStartDate).isAfter(moment__WEBPACK_IMPORTED_MODULE_2__(this.woManagementInputDTO.projectDueDate))) {
    ...
    DialogWorkOrderCreationComponent.prototype.init = function () {
        ...
        this.woManagementInputDTO = {
            ...
            woType: this.mvtWay === _shared_constants_bidt_stock_mvt_constants__WEBPACK_IMPORTED_MODULE_5__["BidtStockMvtConstants"].MVT_WAY_DEBIT
                ? _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_MANUAL
                : _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_SN_CHANGE
        };
    ...
    DialogWorkOrderCreationComponent.prototype.loadMroCenterList = function () {
        ...
        this.dialogWorkPackageService.findAuthorizedBireSite().subscribe(function (results) {
            ...
            _this.mroCenterList = !!results ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_14__["SelectItemUtils"].fromLabelValues(results) : [];
        });
    };
    DialogWorkOrderCreationComponent.prototype.loadOperationList = function () {
        ...
        this.dialogWorkPackageService.findAllBidoOperation().subscribe(function (results) {
            _this.operationList = _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_14__["SelectItemUtils"].fromLabelValues(results);
        });
    };
    DialogWorkOrderCreationComponent.prototype.loadStatusList = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].AIRM_PROJECT_STATUS_MAP).subscribe(function (results) {
    ...
    DialogWorkOrderCreationComponent.prototype.loadWorkPackageStatusList = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].AIRM_PROJECT_STATUS_MAP).subscribe(function (results) {
            _this.workPackageStatusList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(results);
        });
    };
    DialogWorkOrderCreationComponent.prototype.loadTypeList = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].WORK_PACKAGE_TYPE_MAP).subscribe(function (results) {
    ...
    DialogWorkOrderCreationComponent.prototype.loadUserList = function () {
        ...
        this.dialogWorkPackageService
            .findBidoUsersWithUseCase(_shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_4__["BidoFunctionTypeConstants"].UC_AIRM_RECEPTION)
            .subscribe(function (results) {
            var resultUserList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(results).map(function (result) {
                var userName = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_15__["StringUtils"].orEmpty(result.lastname) + " " + _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_15__["StringUtils"].orEmpty(result.firstname);
                return {
                    label: userName.trim(),
                    value: result.userId
                };
    ...
    DialogWorkOrderCreationComponent.prototype.getWarehouseList = function () {
        ...
        if (this.woPn) {
            this.dialogWorkPackageService.findAllWarehouseByProduct(this.woPn).subscribe(function (results) {
                ...
                _this.warehouseList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(results)
    ...
    DialogWorkOrderCreationComponent.prototype.getProjectList = function () {
        ...
        if (this.topAssetDTOId && this.topAssetDTOId.equipmentCode) {
            this.dialogWorkPackageService
                ...
                .subscribe(function (results) {
                _this.bidmProjectDtos = results.filter(function (project) { return project.statusState !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].AIRM_PROJECT_STATUS_CLOSE; });
                _this.projectList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(_this.bidmProjectDtos).map(function (project) {
                    return {
                        label: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_15__["StringUtils"].isNullOrEmpty(project.projectName)
    ...
    DialogWorkOrderCreationComponent.prototype.onSelectedTask = function (task) {
        ...
        this.woManagementInputDTO.woType = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_TASK;
    };
    ...
    DialogWorkOrderCreationComponent.prototype.initAssetRepresentation = function () {
        ...
        if (this.woSn) {
            ...
            var snDataKey_1 = this.woAssetFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].ITEM_FAMILY_CODE_ENGINE_KEY ? 'global.esn' : 'global.sn';
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogWorkOrderCreationComponent.prototype, "displayAssignedTo", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogWorkOrderCreationComponent.prototype, "displayDescription", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogWorkOrderCreationComponent.prototype, "displayDueDate", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogWorkOrderCreationComponent.prototype, "displayMroCenter", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogWorkOrderCreationComponent.prototype, "displayName", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogWorkOrderCreationComponent.prototype, "displayOperation", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogWorkOrderCreationComponent.prototype, "displayStartDate", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogWorkOrderCreationComponent.prototype, "displayStatus", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogWorkOrderCreationComponent.prototype, "displayWorkCenter", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogWorkOrderCreationComponent.prototype, "startDate", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], DialogWorkOrderCreationComponent.prototype, "warningMessageList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Number)
    ], DialogWorkOrderCreationComponent.prototype, "wpType", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], DialogWorkOrderCreationComponent.prototype, "mvtWay", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogWorkOrderCreationComponent.prototype, "woPn", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogWorkOrderCreationComponent.prototype, "woSn", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogWorkOrderCreationComponent.prototype, "woAssetFunction", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogWorkOrderCreationComponent.prototype, "woAssetDesignation", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogWorkOrderCreationComponent.prototype, "woFunctionCode", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogWorkOrderCreationComponent.prototype, "woItemPk", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogWorkOrderCreationComponent.prototype, "topAssetDTOId", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogWorkOrderCreationComponent.prototype, "onValidated", void 0);
    DialogWorkOrderCreationComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-work-order-creation',
            template: __webpack_require__(/*! ./dialog-work-order.component.html */ "./src/app/main/maintenance/configuration-control/dialog-work-order/dialog-work-order.component.html"),
            styles: [__webpack_require__(/*! ./dialog-work-order.component.scss */ "./src/app/main/maintenance/configuration-control/dialog-work-order/dialog-work-order.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogWorkOrderCreationService", function() { return DialogWorkOrderCreationService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var DialogWorkOrderCreationService = /** @class */ (function (_super) {
    ...
    function DialogWorkOrderCreationService(http, appConfigService, fleetManagementApi, productStructureManagementApi, userProfileManagementApi, bidtSiteApi, bidtWarehouseApi, aMProjectManagementApi) {
        var _this = _super.call(this, http, appConfigService) || this;
        _this.fleetManagementApi = fleetManagementApi;
        _this.productStructureManagementApi = productStructureManagementApi;
    ...
    DialogWorkOrderCreationService.prototype.findUnfinishedProjectByEquipmentCode = function (equipmentCode) {
        return _super.prototype.post.call(this, this.aMProjectManagementApi.findUnfinishedProjectByEquipmentCode, equipmentCode);
    };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InstallationEquipmentComponent", function() { return InstallationEquipmentComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_types_generic_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../shared/types/generic-component */ "./src/app/shared/types/generic-component.ts");
/* harmony import */ var _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../shared/utils/bido-equipment-utils */ "./src/app/shared/utils/bido-equipment-utils.ts");
/* harmony import */ var _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../shared/utils/list-utils */ "./src/app/shared/utils/list-utils.ts");
...
/* harmony import */ var _configuration_control_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../configuration-control.service */ "./src/app/main/maintenance/configuration-control/configuration-control.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var InstallationEquipmentComponent = /** @class */ (function (_super) {
    ...
    function InstallationEquipmentComponent(messageService, sessionService, configurationControlService, propertiesService) {
    ...
    InstallationEquipmentComponent.prototype.onChangeFunctionLocation = function () {
        if (_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_12__["ObjectUtils"].isDefined(this.installationFunctionLocation)) {
            this.loadItemList();
        }
        else {
            this.installationItem = undefined;
    ...
    InstallationEquipmentComponent.prototype.onChangeItem = function () {
        if (_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_12__["ObjectUtils"].isDefined(this.installationItem)) {
    ...
    InstallationEquipmentComponent.prototype.onChangeSuperiorAsset = function () {
        if (_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_12__["ObjectUtils"].isDefined(this.installationSuperiorAsset)) {
            this.loadItemList();
        }
        else {
            this.functionLocationList = [];
    ...
    InstallationEquipmentComponent.prototype.validate = function () {
        var _this = this;
        if (this.installationDate && moment__WEBPACK_IMPORTED_MODULE_1__(this.installationDate).isBefore(moment__WEBPACK_IMPORTED_MODULE_1__(this.workPackage.projectStartDate))) {
    ...
    InstallationEquipmentComponent.prototype.loadFunctionLocationFromNotification = function () {
        ...
        if (this.stockMvt.bidoNotificationNotificationCode) {
            this.configurationControlService
                .getFunctionLocationAtDate(this.assetStructureSelection.bidoEquipment
                ...
                _this.installationFunctionLocationName = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__["StringUtils"].orEmpty(flAtDate);
            });
        }
    };
    InstallationEquipmentComponent.prototype.loadFunctionLocationList = function () {
        var _this = this;
        if (this.assetStructureSelection.bidoEquipment &&
            ...
            this.configurationControlService.getFunctionLocationListToInstallEquipment(input).subscribe(function (list) {
    ...
    InstallationEquipmentComponent.prototype.loadOperationalStatusFromNotification = function () {
        ...
        if (this.stockMvt.bidoNotificationNotificationCode) {
            this.configurationControlService
                ...
                if (assetAtDate) {
                    var matchingStatus = _this.operationalStatusList.find(function (elt) { return elt.value === assetAtDate.operationalStatus; });
    ...
    InstallationEquipmentComponent.prototype.loadOperationalStatusList = function () {
        ...
        var observable = this.isGroundEquipment
            ? this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_4__["GenericPropertyConstants"].GROUND_EQUIPMENT_STATUS_MAP)
            : this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_4__["GenericPropertyConstants"].OPERATIONAL_STATUS_MAP);
        observable.subscribe(function (list) {
            _this.operationalStatusList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__["ListUtils"].orEmpty(list)
                .filter(function (elt) {
                return elt.value !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].OPERATIONAL_STATUS_SPARE_KEY &&
                    elt.value !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].OPERATIONAL_STATUS_SCRAPPED_KEY;
            })
                .sort(function (elt1, elt2) { return elt1.label.localeCompare(elt2.label); });
    ...
    InstallationEquipmentComponent.prototype.loadSuperiorAsset = function () {
        ...
        if (this.assetStructureSelection.bidoEquipment && this.assetStructureSelection.bidoEquipment.equEquipmentCode) {
            this.configurationControlService
                ...
                _this.superiorAssetList = [{ label: _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_10__["BidoEquipmentUtils"].toString(asset), value: asset }];
    ...
    InstallationEquipmentComponent.prototype.loadWarehouse = function () {
        ...
        if (this.stockMvt.bidtWarehouseId) {
            this.configurationControlService.getById(this.stockMvt.bidtWarehouseId).subscribe(function (warehouse) {
                _this.installationWarehouseName = warehouse ? _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__["StringUtils"].orEmpty(warehouse.whName) : '';
            });
        }
    };
    InstallationEquipmentComponent.prototype.loadWorkOrder = function () {
        ...
        if (this.stockMvt.bidmWorkOrderWoId) {
            ...
            this.configurationControlService.findWorkOrder(input).subscribe(function (workOrder) {
                ...
                _this.workOrderCode = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__["StringUtils"].orEmpty(_this.workOrder.woCode);
                _this.workOrderDescription = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__["StringUtils"].orEmpty(_this.workOrder.woDescription);
            });
        }
    };
    InstallationEquipmentComponent.prototype.setComponentOpenMode = function () {
        this.updateOpenMode(this.stockMvt.bidoNotificationNotificationCode ? _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_5__["ComponentOpenMode"].Read : _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_5__["ComponentOpenMode"].Write);
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], InstallationEquipmentComponent.prototype, "equipmentCode", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], InstallationEquipmentComponent.prototype, "familyVariantCode", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], InstallationEquipmentComponent.prototype, "workPackage", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], InstallationEquipmentComponent.prototype, "isGroundEquipment", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], InstallationEquipmentComponent.prototype, "assetStructureSelection", null);
    InstallationEquipmentComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-installation-equipment',
            template: __webpack_require__(/*! ./installation-equipment.component.html */ "./src/app/main/maintenance/configuration-control/installation-equipment/installation-equipment.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RemovalEquipmentComponent", function() { return RemovalEquipmentComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../shared/constants/aw-properties-constants */ "./src/app/shared/constants/aw-properties-constants.ts");
...
/* harmony import */ var _shared_types_generic_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../shared/types/generic-component */ "./src/app/shared/types/generic-component.ts");
/* harmony import */ var _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../shared/utils/bido-equipment-utils */ "./src/app/shared/utils/bido-equipment-utils.ts");
...
var RemovalEquipmentComponent = /** @class */ (function (_super) {
    ...
    function RemovalEquipmentComponent(messageService, sessionService, configurationControlService, propertiesService) {
    ...
    RemovalEquipmentComponent.prototype.onLoad = function () {
        ...
        this.loadWarehouse();
        this.loadWorkOrder();
        this.loadSuperiorAsset(this.assetStructureSelection.bidoEquipment && this.assetStructureSelection.bidoEquipment.equEquipmentCode
    ...
    RemovalEquipmentComponent.prototype.onChangeFunctionLocation = function () {
        if (_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_11__["ObjectUtils"].isDefined(this.removalFunctionLocation)) {
            this.loadItemList();
        }
        else {
            this.removalItem = undefined;
    ...
    RemovalEquipmentComponent.prototype.onChangeSuperiorAsset = function () {
        if (_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_11__["ObjectUtils"].isDefined(this.removalSuperiorAsset)) {
            this.loadItemList();
        }
        else {
            this.functionLocationList = [];
    ...
    RemovalEquipmentComponent.prototype.loadFunctionLocationFromNotification = function () {
        ...
        if (this.stockMvt.bidoNotificationNotificationCode) {
            this.configurationControlService
                ...
                .subscribe(function (flAtDate) {
                _this.removalFunctionLocationName = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_12__["StringUtils"].orEmpty(flAtDate);
            });
        }
    };
    ...
    RemovalEquipmentComponent.prototype.loadNotification = function () {
        ...
        if (this.stockMvt.bidoNotificationNotificationCode) {
            this.configurationControlService
                ...
                if (notification) {
                    var matchingReason = _this.removalReasonList.find(function (elt) { return elt.value === notification.eventReason; });
    ...
    RemovalEquipmentComponent.prototype.loadOperationalStatusList = function () {
        var _this = this;
        var observable = this.isGroundEquipment
            ? this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_3__["GenericPropertyConstants"].GROUND_EQUIPMENT_STATUS_MAP)
            : this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_3__["GenericPropertyConstants"].OPERATIONAL_STATUS_MAP);
        observable.subscribe(function (list) {
            _this.operationalStatusList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_10__["ListUtils"].orEmpty(list)
                .filter(function (elt) { return elt.value !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].OPERATIONAL_STATUS_IN_OPERATION_KEY; })
                .sort(function (elt1, elt2) { return elt1.label.localeCompare(elt2.label); });
            _this.loadOperationalStatusFromNotification();
        });
    };
    RemovalEquipmentComponent.prototype.loadRemovalReasonList = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_3__["GenericPropertyConstants"].REMOVAL_REASON_MAP).subscribe(function (list) {
            _this.removalReasonList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_10__["ListUtils"].orEmpty(list).sort(function (e1, e2) { return e1.label.localeCompare(e2.label); });
        });
    };
    RemovalEquipmentComponent.prototype.loadSuperiorAsset = function (equipmentCode) {
        ...
        this.configurationControlService
            ...
            .subscribe(function (asset) {
            _this.superiorAssetList = [{ label: _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_9__["BidoEquipmentUtils"].toString(asset), value: asset }];
        ...
        if (this.stockMvt.bidtWarehouseId) {
            this.configurationControlService.getById(this.stockMvt.bidtWarehouseId).subscribe(function (warehouse) {
                ...
                if (_this.removalWarehouse) {
                    _this.removalWarehouseName = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_12__["StringUtils"].orEmpty(_this.removalWarehouse.whName);
                    if (!_this.stockMvt.bidoNotificationNotificationCode) {
                        if (!_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_11__["ObjectUtils"].isDefined(_this.removalWarehouse.whType)) {
                            _this.removalNewOperationalStatus = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].OPERATIONAL_STATUS_SPARE_KEY;
                        }
                        else if (_this.removalWarehouse.whType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].MM_WAREHOUSE_TYPE_REPAIR_KEY) {
                            _this.removalNewOperationalStatus = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].OPERATIONAL_STATUS_MAINTENANCE_KEY;
                        }
                        else if (_this.removalWarehouse.whType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].MM_WAREHOUSE_TYPE_UNSERVICEABLE_KEY) {
                            _this.removalNewOperationalStatus = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].OPERATIONAL_STATUS_IN_STOCK_KEY;
                        }
                        else if (_this.removalWarehouse.whType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].MM_WAREHOUSE_TYPE_SCRAP_KEY) {
                            _this.removalNewOperationalStatus = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].OPERATIONAL_STATUS_SCRAPPED_KEY;
                        }
                        else if (_this.removalWarehouse.whType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].MM_WAREHOUSE_TYPE_USED_KEY) {
                            _this.removalNewOperationalStatus = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].OPERATIONAL_STATUS_SPARE_KEY;
                        }
                        else if (_this.removalWarehouse.whType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].MM_WAREHOUSE_TYPE_NEW_KEY) {
                            _this.removalNewOperationalStatus = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].OPERATIONAL_STATUS_SPARE_KEY;
                        }
                    }
                }
    ...
    RemovalEquipmentComponent.prototype.loadWorkOrder = function () {
        ...
        if (this.workPackage.projectId && this.stockMvt.bidmWorkOrderWoId) {
            ...
            this.configurationControlService.findWorkOrder(input).subscribe(function (workOrder) {
                _this.workOrder = workOrder;
                _this.workOrderCode = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_12__["StringUtils"].orEmpty(_this.workOrder.woCode);
                _this.workOrderDescription = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_12__["StringUtils"].orEmpty(_this.workOrder.woDescription);
            });
        }
    };
    RemovalEquipmentComponent.prototype.setComponentOpenMode = function () {
        this.updateOpenMode(this.stockMvt.bidoNotificationNotificationCode ? _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__["ComponentOpenMode"].Read : _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__["ComponentOpenMode"].Write);
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], RemovalEquipmentComponent.prototype, "equipmentCode", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], RemovalEquipmentComponent.prototype, "familyVariantCode", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], RemovalEquipmentComponent.prototype, "workPackage", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], RemovalEquipmentComponent.prototype, "isGroundEquipment", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], RemovalEquipmentComponent.prototype, "assetStructureSelection", null);
    RemovalEquipmentComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-removal-equipment',
            template: __webpack_require__(/*! ./removal-equipment.component.html */ "./src/app/main/maintenance/configuration-control/removal-equipment/removal-equipment.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConfigurationControlSearchComponent", function() { return ConfigurationControlSearchComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _configuration_control_search_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./configuration-control-search.service */ "./src/app/main/maintenance/configuration-control/search/configuration-control-search.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ConfigurationControlSearchComponent = /** @class */ (function (_super) {
    ...
    function ConfigurationControlSearchComponent(favoriteService, loaderService, messageService, serializationService, tabService, searchService) {
    ...
    ConfigurationControlSearchComponent.prototype.openSelection = function (event) {
        if (!!event.output) {
            ...
            if (event.warehouseId) {
                var selectedWarehouse = this.wareHouseList.find(function (wareHouse) { return wareHouse.value === event.warehouseId; });
            ...
            var data = {
                id: this.tabService.generateId(),
                componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_1__["ComponentConstants"].MAI_CONFIGURATION_CONTROL,
    ...
    ConfigurationControlSearchComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_1__["ComponentConstants"].MAI_CONFIGURATION_CONTROL_SEARCH;
    };
    ConfigurationControlSearchComponent.prototype.loadWareHouseList = function () {
        ...
        this.searchService.findAllWarehouse().subscribe(function (results) {
            _this.wareHouseList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_9__["ListUtils"].orEmpty(results)
                .filter(function (warehouse) { return !!warehouse.whCode; })
                .map(function (warehouse) {
                return {
    ...
    ConfigurationControlSearchComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./configuration-control-search.component.html */ "./src/app/main/maintenance/configuration-control/search/configuration-control-search.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConfigurationControlSearchService", function() { return ConfigurationControlSearchService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
module.exports = ".configuration-control-alert {\n  text-align: center; }\n\n.configuration-control-alert.configuration-control-alert--nok {\n  background-color: #f6685e; }\n\n.configuration-control-alert.configuration-control-alert--ok {\n  background-color: #4caf50; }\n\n.configuration-control-alert.configuration-control-alert--warning {\n  background-color: #ffc107; }\n\n.aw-table2 .configuration-control-alert {\n  display: inline-block;\n  width: 100%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
