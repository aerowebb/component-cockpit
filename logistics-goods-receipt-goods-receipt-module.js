(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["logistics-goods-receipt-goods-receipt-module"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogAddItemComponent", function() { return DialogAddItemComponent; });
...
/* harmony import */ var _logistics_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../logistics.service */ "./src/app/main/logistics/logistics.service.ts");
/* harmony import */ var _delivery_folder_search_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../delivery-folder-search.service */ "./src/app/main/logistics/goods-receipt/delivery-folder-search.service.ts");
...
var DialogAddItemComponent = /** @class */ (function (_super) {
    ...
    function DialogAddItemComponent(sessionService, logisticsService, propertiesService, deliveryFolderSearchService, messageService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__["ComponentOpenMode"].Read, 'DialogAddItemComponent') || this;
    ...
    DialogAddItemComponent.prototype.loadDropDowns = function () {
        var _this = this;
        var packageTypes = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_2__["GenericPropertyConstants"].PACKAGE_TYPE_MAP);
    ...
    DialogAddItemComponent.prototype.loadPackageList = function () {
        return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_8__["ListUtils"].orEmpty(this.packageDtoList)
            .filter(function (pack) { return !!pack.packageCode; })
    ...
    ], DialogAddItemComponent.prototype, "deliveryFolder", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], DialogAddItemComponent.prototype, "packageDtoList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogAddItemComponent.prototype, "onCreate", void 0);
    DialogAddItemComponent = DialogAddItemComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-add-item',
            template: __webpack_require__(/*! ./dialog-add-item.component.html */ "./src/app/main/logistics/goods-receipt/form/dialog-add-item/dialog-add-item.component.html"),
            styles: [__webpack_require__(/*! ./dialog-add-item.component.scss */ "./src/app/main/logistics/goods-receipt/form/dialog-add-item/dialog-add-item.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogAddMaterialComponent", function() { return DialogAddMaterialComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
...
/* harmony import */ var _shared_constants_bire_rating_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../shared/constants/bire-rating-constants */ "./src/app/shared/constants/bire-rating-constants.ts");
...
/* harmony import */ var _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../../shared/utils/bido-equipment-utils */ "./src/app/shared/utils/bido-equipment-utils.ts");
...
/* harmony import */ var _logistics_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../logistics.service */ "./src/app/main/logistics/logistics.service.ts");
/* harmony import */ var _delivery_folder_search_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../delivery-folder-search.service */ "./src/app/main/logistics/goods-receipt/delivery-folder-search.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DialogAddMaterialComponent = /** @class */ (function (_super) {
    ...
    function DialogAddMaterialComponent(sessionService, messageService, propertiesService, deliveryFolderSearchService, logisticsService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_6__["ComponentOpenMode"].Read, 'DialogAddMaterialComponent') || this;
        _this.sessionService = sessionService;
        _this.messageService = messageService;
        _this.propertiesService = propertiesService;
        _this.deliveryFolderSearchService = deliveryFolderSearchService;
    ...
    DialogAddMaterialComponent.prototype.ngOnInit = function () {
        this.loadDropDowns();
        this.isDraftStatus = this.bidtDeliveryFolder.dfStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].RECEIPT_FOLDER_STATUS_DRAFT;
    };
    ...
    DialogAddMaterialComponent.prototype.loadDropDowns = function () {
        var _this = this;
        var packageTypes = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].PACKAGE_TYPE_MAP);
        Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["forkJoin"])({ packageTypes: packageTypes }).subscribe({
            next: function (results) {
                _this.packagesTypesList = results.packageTypes;
                _this.itemsList = [];
    ...
    DialogAddMaterialComponent.prototype.loadPackageList = function () {
        return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(this.packageDtoList)
            .filter(function (pack) { return !!pack.packageCode; })
            .map(function (bidtPackage) {
            var unit = {
                label: bidtPackage.packageCode,
    ...
    DialogAddMaterialComponent.prototype.loadItemsList = function () {
        return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(this.itemsDtoList)
            .filter(function (item) { return !!item.dfiCode; })
            .map(function (bidtItem) {
            var unit = {
                label: bidtItem.dfiCode + " : " + bidtItem.birePnPnCode + " (" + bidtItem.birePn.articleDesignation + ")",
                value: bidtItem
            };
            return unit;
        });
    ...
    DialogAddMaterialComponent.prototype.checkIsNotReceiptdone = function (item) {
        return item.bidtPackage && item.bidtPackage.packageStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].PACKAGE_STATUS_DELIVERED
            ? false
            : true;
    };
    ...
    DialogAddMaterialComponent.prototype.checkPn = function (pn) {
        ...
        if (pn) {
            ...
            switch (pn.traceability) {
                case _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].PN_TRACEABILITY_BY_BATCH:
                    this.isTracabilityByBatch = true;
                    break;
                case _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].PN_TRACEABILITY_BY_SN:
                    this.isTracabilityBySN = true;
                    break;
                case _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].PN_TRACEABILITY_BY_PACKAGING_BATCH:
                    this.isTracabilityByPackagingBatch = true;
                    break;
                case _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].PN_TRACEABILITY_BY_PACKAGING_BATCH_AND_SN:
    ...
    DialogAddMaterialComponent.prototype.onSelectAsset = function (equipment) {
        ...
        this.selectedAssetName = _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_11__["BidoEquipmentUtils"].createAssetRepresentation(equipment);
    };
    ...
    DialogAddMaterialComponent.prototype.isAddBtnVisible = function () {
        return this.remainingQuantity > 0 && this.stockMvtTable.every(function (row) { return !row.isEditable; });
    };
    ...
    DialogAddMaterialComponent.prototype.isStockMvtTableComplete = function (rowData) {
        ...
        if (this.isTracabilityByBatch) {
            ...
            complete = _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_15__["ObjectUtils"].isDefined(rowData.stockMvtSn);
        }
    ...
    DialogAddMaterialComponent.prototype.deleteStockItem = function (row) {
        this.stockMvtTable = this.stockMvtTable.filter(function (data) { return row.id !== data.id; });
        this.updateListId();
        this.updateRemainingQuantity();
    };
    ...
    DialogAddMaterialComponent.prototype.fillByBatch = function (row, batchNumber, isManufacturingBatchType) {
        var _this = this;
        if (this.pnChoose && !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_16__["StringUtils"].isNullOrEmpty(batchNumber)) {
            var logUnknownEquipment_1 = function () {
                _this.messageService.showWarningMessage(_this.getTranslateKey(isManufacturingBatchType ? 'warningOnUnknownBatchNumber' : 'warningOnUnknownPackagingNumber'));
            };
            var existingRow = isManufacturingBatchType &&
                this.stockMvtTable
                    .slice(0, -1)
                    .find(function (r) { return !!r.manufacturingBatch && r.manufacturingBatch === row.manufacturingBatch; });
            if (!!existingRow) {
                    ...
                    if (!!equipment) {
                        if (_this.isTracabilityByBatchAndSn ||
                            (isManufacturingBatchType &&
                                equipment.batchType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].BATCH_TYPE_MANUFACTURING_KEY) ||
                            (!isManufacturingBatchType && equipment.batchType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].BATCH_TYPE_PACKAGING_KEY)) {
                            row.manufacturingDate = equipment.manufacturingDate;
                            if (!isManufacturingBatchType) {
                                row.stockMvtQuantity = _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_15__["ObjectUtils"].isDefined(equipment.quantity)
                                    ? _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_14__["NumberUtils"].toString(_shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_14__["NumberUtils"].roundNumber(equipment.quantity))
                                    : undefined;
                            }
                            if (_this.isTracabilityByBatchAndSn) {
                            ...
                            if (!isManufacturingBatchType &&
                                equipment.batchType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__["AWPropertiesConstants"].BATCH_TYPE_PACKAGING_KEY &&
                                _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_15__["ObjectUtils"].isDefined(equipment.equEquipmentCode)) {
                                _this.logisticsService.findEquipment({ equipmentCode: equipment.equEquipmentCode }).subscribe({
                            ...
                            if (!_this.isTracabilityByBatchAndSn && !_this.isTracabilityByPackagingBatch) {
                                ...
                                _this.logisticsService
                                    ...
                                    counterCode: _shared_constants_bire_measure_reference_constants__WEBPACK_IMPORTED_MODULE_3__["BireMeasureReferenceConstants"].BIRE_MEASURE_REFERENCE_COUNTER_CODE_CALENDAR_LIMIT,
                                    familyCode: _shared_utils_bido_family_variant_utils__WEBPACK_IMPORTED_MODULE_12__["BidoFamilyVariantUtils"].getFamilyCodeFromFamilyVariantCode(equipment.familyVariantCode),
                                    ratingCode: _shared_constants_bire_rating_constants__WEBPACK_IMPORTED_MODULE_4__["BireRatingConstants"].DEFAULT
                                })
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogAddMaterialComponent.prototype, "bidtDeliveryFolder", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], DialogAddMaterialComponent.prototype, "itemsDtoList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], DialogAddMaterialComponent.prototype, "packageDtoList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogAddMaterialComponent.prototype, "onCreate", void 0);
    DialogAddMaterialComponent = DialogAddMaterialComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-add-material',
            template: __webpack_require__(/*! ./dialog-add-material.component.html */ "./src/app/main/logistics/goods-receipt/form/dialog-add-material/dialog-add-material.component.html"),
            styles: [__webpack_require__(/*! ./dialog-add-material.component.scss */ "./src/app/main/logistics/goods-receipt/form/dialog-add-material/dialog-add-material.component.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_session_service__WEBPACK_IMPORTED_MODULE_9__["SessionService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogAddPackageComponent", function() { return DialogAddPackageComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var _shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../shared/constants/generic-property-constants */ "./src/app/shared/constants/generic-property-constants.ts");
/* harmony import */ var _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../shared/enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
...
/* harmony import */ var _logistics_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../logistics.service */ "./src/app/main/logistics/logistics.service.ts");
/* harmony import */ var _delivery_folder_search_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../delivery-folder-search.service */ "./src/app/main/logistics/goods-receipt/delivery-folder-search.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DialogAddPackageComponent = /** @class */ (function (_super) {
    ...
    function DialogAddPackageComponent(logisticsService, propertiesService, deliveryFolderSearchService, messageService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__["ComponentOpenMode"].Read, 'DialogAddPackageComponent') || this;
        _this.logisticsService = logisticsService;
        _this.propertiesService = propertiesService;
        _this.deliveryFolderSearchService = deliveryFolderSearchService;
        _this.messageService = messageService;
    ...
    DialogAddPackageComponent.prototype.isFormValid = function () {
        return _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_7__["ObjectUtils"].isDefined(this.quantity) && _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_7__["ObjectUtils"].isDefined(this.pnUse);
    };
    ...
    DialogAddPackageComponent.prototype.validateInputs = function () {
        if (this.isGenerated) {
            ...
            return !!this.pnUse && _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_7__["ObjectUtils"].isDefined(this.packageNumber) && !!this.quantity;
        }
    };
    ...
    DialogAddPackageComponent.prototype.loadUnitOfIssueOptions = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_2__["GenericPropertyConstants"].UNIT_OF_ISSUE_MAP).subscribe(function (results) {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogAddPackageComponent.prototype, "bidtDeliveryFolder", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogAddPackageComponent.prototype, "onCreate", void 0);
    DialogAddPackageComponent = DialogAddPackageComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-add-package',
            template: __webpack_require__(/*! ./dialog-add-package.component.html */ "./src/app/main/logistics/goods-receipt/form/dialog-add-package/dialog-add-package.component.html"),
            styles: [__webpack_require__(/*! ./dialog-add-package.component.scss */ "./src/app/main/logistics/goods-receipt/form/dialog-add-package/dialog-add-package.component.scss")]
        }),
        __metadata("design:paramtypes", [_logistics_service__WEBPACK_IMPORTED_MODULE_8__["LogisticsService"],
            _shared_services_properties_service__WEBPACK_IMPORTED_MODULE_5__["PropertiesService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogCreateLitigationComponent", function() { return DialogCreateLitigationComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var DialogCreateLitigationComponent = /** @class */ (function (_super) {
    ...
    function DialogCreateLitigationComponent(sessionService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__["ComponentOpenMode"].Read, 'DialogCreateLitigationComponent') || this;
        _this.sessionService = sessionService;
        return _this;
    }
    ...
    DialogCreateLitigationComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./dialog-create-litigation.component.html */ "./src/app/main/logistics/goods-receipt/form/dialog-create-litigation/dialog-create-litigation.component.html"),
            styles: [__webpack_require__(/*! ./dialog-create-litigation.component.scss */ "./src/app/main/logistics/goods-receipt/form/dialog-create-litigation/dialog-create-litigation.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogDocumentCategoriesReceiptFolderComponent", function() { return DialogDocumentCategoriesReceiptFolderComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var DialogDocumentCategoriesReceiptFolderComponent = /** @class */ (function (_super) {
    ...
    function DialogDocumentCategoriesReceiptFolderComponent(propertiesService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Read, 'DialogDocumentCategoriesReceiptFolderComponent') || this;
        _this.propertiesService = propertiesService;
        return _this;
    }
    DialogDocumentCategoriesReceiptFolderComponent.prototype.ngOnInit = function () {
        ...
        this.numberOfDocs = 1;
        this.dialogContent = '';
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_1__["GenericPropertyConstants"].DOC_ASSET_CATEGORY_MAP).subscribe(function (docCategorieMap) {
            if (_this.bidtDfTypeOperationDTO.docCategories && _this.bidtDfTypeOperationDTO.docCategories.length > 0) {
                _this.bidtDfTypeOperationDTO.docCategories.forEach(function (categorieOpe) {
                    if (_this.numberOfDocs === 1) {
                        _this.dialogContent = _this.numberOfDocs + ". " + docCategorieMap.filter(function (categorie) { return categorie.value === categorieOpe; })[0].label;
                        _this.numberOfDocs++;
                    }
                    else {
                        _this.dialogContent = _this.dialogContent + "\r\r" + _this.numberOfDocs + ". " + docCategorieMap.filter(function (categorie) { return categorie.value === categorieOpe; })[0].label;
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogDocumentCategoriesReceiptFolderComponent.prototype, "bidtDfTypeOperationDTO", void 0);
    DialogDocumentCategoriesReceiptFolderComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-document-categories',
            template: __webpack_require__(/*! ./dialog-document-categories.component.html */ "./src/app/main/logistics/goods-receipt/form/dialog-document-categories/dialog-document-categories.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GoodsReceiptFormComponent", function() { return GoodsReceiptFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_constants_bire_measure_reference_constants__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../shared/constants/bire-measure-reference-constants */ "./src/app/shared/constants/bire-measure-reference-constants.ts");
/* harmony import */ var _shared_constants_bire_rating_constants__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../shared/constants/bire-rating-constants */ "./src/app/shared/constants/bire-rating-constants.ts");
...
/* harmony import */ var _shared_pipes_extract_translation_pipe__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../../shared/pipes/extract-translation.pipe */ "./src/app/shared/pipes/extract-translation.pipe.ts");
...
/* harmony import */ var _shared_services_loader_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../../shared/services/loader.service */ "./src/app/shared/services/loader.service.ts");
/* harmony import */ var _shared_services_message_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../../shared/services/message.service */ "./src/app/shared/services/message.service.ts");
/* harmony import */ var _shared_services_properties_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../../shared/services/properties.service */ "./src/app/shared/services/properties.service.ts");
/* harmony import */ var _shared_services_serialization_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../../../shared/services/serialization.service */ "./src/app/shared/services/serialization.service.ts");
...
/* harmony import */ var _shared_utils_bido_family_variant_utils__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../../../../shared/utils/bido-family-variant-utils */ "./src/app/shared/utils/bido-family-variant-utils.ts");
/* harmony import */ var _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../../../../shared/utils/file-utils */ "./src/app/shared/utils/file-utils.ts");
...
/* harmony import */ var _administration_catalog_catalog_service__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../../../administration/catalog/catalog.service */ "./src/app/main/administration/catalog/catalog.service.ts");
/* harmony import */ var _overlay_overlay_service__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ../../../overlay/overlay.service */ "./src/app/main/overlay/overlay.service.ts");
/* harmony import */ var _logistics_service__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ../../logistics.service */ "./src/app/main/logistics/logistics.service.ts");
/* harmony import */ var _stock_movements_search_search_service__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ../../stock-movements/search/search.service */ "./src/app/main/logistics/stock-movements/search/search.service.ts");
/* harmony import */ var _goods_receipt_form_service__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./goods-receipt-form.service */ "./src/app/main/logistics/goods-receipt/form/goods-receipt-form.service.ts");
/* harmony import */ var _status_good_receipt_status_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./status/good-receipt-status.component */ "./src/app/main/logistics/goods-receipt/form/status/good-receipt-status.component.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var GoodsReceiptFormComponent = /** @class */ (function (_super) {
    ...
    function GoodsReceiptFormComponent(favoriteService, loaderService, messageService, pageTocService, serializationService, tabService, translateService, sessionService, confirmationService, logisticService, propertiesService, catalogService, overlayService, extractTranslationPipe, searchService, goodsReceiptFormService) {
    ...
    GoodsReceiptFormComponent.prototype.getAllMaps = function () {
        var _this = this;
        var deliveryFolderStatuses$ = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_12__["GenericPropertyConstants"].RECEIPT_FOLDER_STATUS_MAP);
        var shipmentFolderStatuses$ = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_12__["GenericPropertyConstants"].SHIPMENT_FOLDER_STATUS_MAP);
        var packageStatusMap$ = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_12__["GenericPropertyConstants"].PACKAGE_STATUS_MAP);
        var documentTypes$ = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_12__["GenericPropertyConstants"].DOC_PARTNER_CATEGORY_MAP);
        // status equipment maps
        var opeartionalStatusMap$ = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_12__["GenericPropertyConstants"].OPERATIONAL_STATUS_MAP);
        var batchStatusMap$ = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_12__["GenericPropertyConstants"].BATCH_EQUIPMENT_STATUS_MAP);
        var transferOrderStatusMap$ = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_12__["GenericPropertyConstants"].TRANSFER_FOLDER_STATUS_MAP);
        this.torTypeList = [];
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["forkJoin"])([
            ...
            next: function (_a) {
                var _b = __read(_a, 7), deliveryFolderStatuses = _b[0], shipmentFolderStatuses = _b[1], packageStatusMap = _b[2], documentTypes = _b[3], opeartionalStatusMap = _b[4], batchStatusMap = _b[5], transferOrderStatusMap = _b[6];
                ...
                _this.documentTypes = !!documentTypes ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_27__["SelectItemUtils"].fromLabelValues(documentTypes) : [];
                _this.opeartionalStatusMap = !!opeartionalStatusMap ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_27__["SelectItemUtils"].fromLabelValues(opeartionalStatusMap) : [];
                _this.opeartionalStatusMap = _this.opeartionalStatusMap.concat(!!batchStatusMap ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_27__["SelectItemUtils"].fromLabelValues(batchStatusMap) : []);
                _this.transfertOrderStatusMap = transferOrderStatusMap;
            }
        });
    };
    GoodsReceiptFormComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_11__["ComponentConstants"].LOG_GOODS_RECEIPT_FORM;
    };
    GoodsReceiptFormComponent.prototype.ngOnInit = function () {
        ...
        if (this.componentData.objectId) {
            ...
            this.logisticService.findReceiptFolderWithAllObjectsById(this.deliveryFolderId).subscribe(function (deliveryFolder) {
                ...
                if (_this.deliveryFolder.externalDeliveryNumber) {
                    ...
                    _this.logisticService.findDeliveryFoldersByCriteria(searchCriteria).subscribe(function (deliveryFolderList) {
                        _this.shipmentFolderLinked = deliveryFolderList[0];
                        _this.shipmentFolderLinkedType = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_28__["StringUtils"].orEmpty(_this.extractTranslationPipe.transform(_this.shipmentFolderLinked.bidtDfType.dftDesignation));
                    });
                }
                _this.goodsReceiptFormService
                    ...
                    _this.documentTableDataSource.setData(_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(_this.deliveryFolder.bidtDocuments));
                });
                var logTypes = _this.catalogService.fetchPropertyValuesTableData(_this.LOG_TYPE_MAP);
                var pnTypes = _this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_12__["GenericPropertyConstants"].PN_TYPE_MAP);
                var packageTypes = _this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_12__["GenericPropertyConstants"].PACKAGE_TYPE_MAP);
                Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["forkJoin"])({ logTypes: logTypes, pnTypes: pnTypes, packageTypes: packageTypes }).subscribe({
                    next: function (results) {
                        _this.pnTypeList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(results.pnTypes);
    ...
    GoodsReceiptFormComponent.prototype.renderPackageTableData = function () {
        var _this = this;
        var operationsList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(this.deliveryFolder.bidtDfItems)
            .filter(function (item) { return !!item.bidtPackage && !!item.bidtPackage.bidtPackageOperations; })
            .map(function (item) { return item.bidtPackage.bidtPackageOperations; })
        ...
        this.goodsReceiptFormService.getBidtDfTypeOperationsByDfType(input).subscribe(function (operationsResult) {
            ...
            if (_this.deliveryFolder.bidtDfItems && _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(_this.deliveryFolder.bidtDfItems)) {
                var packageAllreadyAdded_1 = [];
                _this.deliveryFolder.bidtDfItems.forEach(function (items) {
                    if (!!items.bidtPackage && !!items.bidtPackage.id && !packageAllreadyAdded_1.includes(items.bidtPackage.id)) {
    ...
    GoodsReceiptFormComponent.prototype.isGoodPackageStatus = function (key) {
        return key !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].PACKAGE_STATUS_AWAITING;
    };
    /********************************
     * Fetch Items Table data
     ********************************/
    GoodsReceiptFormComponent.prototype.renderItemsTableData = function () {
        var _this = this;
        var operations = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(this.deliveryFolder.bidtDfItems)
        ...
        if (!!this.deliveryFolder && !!this.deliveryFolder.bidtDfItems && this.deliveryFolder.bidtDfItems.length > 0) {
            ...
            this.materialTableData.forEach(function (material) {
                    ...
                    _this.goodsReceiptFormService.findBidoEquipmentByPnAndBatchNumber(equipmentInput).subscribe(function (equipment) {
                        ...
                        if (equipment && equipment.equipmentCode) {
                            _this.logisticService
                                .findBidoEquipmentCounter({
                                equipmentCode: equipment.equipmentCode,
                                counterCode: _shared_constants_bire_measure_reference_constants__WEBPACK_IMPORTED_MODULE_9__["BireMeasureReferenceConstants"].BIRE_MEASURE_REFERENCE_COUNTER_CODE_CALENDAR_LIMIT,
                                familyCode: _shared_utils_bido_family_variant_utils__WEBPACK_IMPORTED_MODULE_24__["BidoFamilyVariantUtils"].getFamilyCodeFromFamilyVariantCode(equipment.familyVariantCode),
                                ratingCode: _shared_constants_bire_rating_constants__WEBPACK_IMPORTED_MODULE_10__["BireRatingConstants"].DEFAULT
                            })
                                .subscribe(function (bidoEquipmentCounter) {
                                if (bidoEquipmentCounter) {
                ...
                if (material._operations.length > 0) {
                    ...
                    _this.goodsReceiptFormService.getOperationCategories(operationsList).subscribe(function (dfOperationsList) {
                        if (dfOperationsList.dfTypeOperationList && dfOperationsList.dfTypeOperationList.length > 0) {
                            dfOperationsList.dfTypeOperationList.forEach(function (dfOperation) {
                                material._operations.filter(function (ope) {
                                    return !!ope.bidtStockMvtOperationDTO &&
    ...
    GoodsReceiptFormComponent.prototype.renderMaterialsTableData = function (rowData) {
        var _this = this;
        var operations = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(rowData.bidtStockMvts)
        ...
        if (!!rowData.bidtStockMvts && rowData.bidtStockMvts.length > 0) {
            rowData.bidtStockMvts.forEach(function (material) {
                ...
                var operationPhysical = _this.getMaterialOperation(material.bidtStockMvtOperations, _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].LOGISTICAL_OPERATION_PHYSICAL_RECEIPT);
                ...
                var materialCustom = {
                    ...
                    documentary: !!operationDocumentary && operationDocumentary.bidtStockMvtOperationDTO
                        ? _this.isStatusPerformed(operationDocumentary.bidtStockMvtOperationDTO.smoStatus)
                            ? true
                            : false
                        : undefined,
                    visual: !!operationVisual && operationVisual.bidtStockMvtOperationDTO
                        ? _this.isStatusPerformed(operationVisual.bidtStockMvtOperationDTO.smoStatus)
                            ? true
                            : false
                        : undefined,
                    physical: !!operationPhysical && operationPhysical.bidtStockMvtOperationDTO
    ...
    GoodsReceiptFormComponent.prototype.onChangeMaterialControl = function (rowData, colField) {
        ...
        if (operationCheck && operationCheck.bidtStockMvtOperationDTO) {
            if (this.isStatusPerformed(operationCheck.bidtStockMvtOperationDTO.smoStatus)) {
                operationCheck.bidtStockMvtOperationDTO.smoStatus = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].LOGISTICAL_OPERATION_STATUS_PLANNED;
            }
            else {
                operationCheck.bidtStockMvtOperationDTO.smoStatus = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].LOGISTICAL_OPERATION_STATUS_PERFORMED;
            }
            var input = {
    ...
    GoodsReceiptFormComponent.prototype.showStatus = function () {
        var _this = this;
        if (this.deliveryFolder.dfStatus !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].RECEIPT_FOLDER_STATUS_CANCELED) {
            var overlayRef = this.overlayService.openWithPositionCenter({
                content: _status_good_receipt_status_component__WEBPACK_IMPORTED_MODULE_34__["GoodReceiptStatusComponent"],
                data: this.deliveryFolder
            });
            overlayRef.afterClosed$.subscribe({
                next: function (event) {
                    if (event.data) {
                        if (event.data === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].RECEIPT_FOLDER_STATUS_ON_GOING) {
                            var input = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(_this.deliveryFolder.bidtDfItems).map(function (dfItem) {
                                return {
                                    bidtDfItemDTO: dfItem,
                                    newStatus: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].RECEIPT_FOLDER_STATUS_ON_GOING
                                };
                            });
    ...
    GoodsReceiptFormComponent.prototype.openLinkEquipment = function (code) {
        if (code) {
            this.openEquipment(code, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_13__["ComponentOpenMode"].Read);
        }
    };
    ...
    GoodsReceiptFormComponent.prototype.openLink = function (equipment) {
        if (equipment.sn) {
            this.openEquipment(equipment.equipmentCode, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_13__["ComponentOpenMode"].Read);
        }
        else {
    ...
    GoodsReceiptFormComponent.prototype.openSelectedBatch = function (code) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_11__["ComponentConstants"].LOG_PACKAGING_BATCH_FORM,
    ...
    GoodsReceiptFormComponent.prototype.uploadDocument = function (event, fileUploader) {
        ...
        if (!!event.files) {
            ...
            if (fileExists) {
                ...
                _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_25__["FileUtils"].getFileContentAsBase64(file_1, function (fileContent) {
                    if (!!fileContent) {
                        ...
                        _this.deliveryFolder.bidtDocuments = __spread(_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(_this.deliveryFolder.bidtDocuments), [document_1]);
    ...
    GoodsReceiptFormComponent.prototype.downloadFiles = function () {
        this.documentTableDataSource.dataSelection.forEach(function (documentRow) {
            if (!!documentRow) {
                _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_25__["FileUtils"].downloadFile(documentRow.documentContent, documentRow.documentName);
            }
        });
    };
    ...
    GoodsReceiptFormComponent.prototype.isDeliveryFolderDraftStatus = function () {
        if (this.deliveryFolder.dfStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].RECEIPT_FOLDER_STATUS_DRAFT) {
            return true;
        }
        else {
            return false;
    ...
    GoodsReceiptFormComponent.prototype.isDeliveryFolderPerformedStatus = function () {
        if (this.deliveryFolder.dfStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].RECEIPT_FOLDER_STATUS_PERFORMED) {
            return true;
        }
        else {
            return false;
    ...
    GoodsReceiptFormComponent.prototype.openMfgBatch = function (objectId) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_11__["ComponentConstants"].LOG_MANUFACTURING_BATCH_FORM,
    ...
    GoodsReceiptFormComponent.prototype.openPartNumberLink = function (item) {
        this.openPN(item.birePnPnCode, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_13__["ComponentOpenMode"].Read);
    };
    GoodsReceiptFormComponent.prototype.openPN = function (objectId, openMode) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_11__["ComponentConstants"].ENG_PART_NUMBER_FORM,
            objectId: objectId,
            openMode: openMode
        };
        var labelKey = 'transaction.' + data.componentId;
    ...
    GoodsReceiptFormComponent.prototype.openShipmentFolder = function () {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_11__["ComponentConstants"].LOG_GOODS_SHIPMENT_FORM,
            openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_13__["ComponentOpenMode"].Read,
    ...
    GoodsReceiptFormComponent.prototype.toStockpilling = function () {
        ...
        this.searchService.findByCriteria(this.getSearchCriteriaStockpilling()).subscribe(function (mvtList) {
            ...
            var data = {
                ...
                componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_11__["ComponentConstants"].LOG_STOCK_MOVEMENTS_FORM_STOCKPILLING,
                openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_13__["ComponentOpenMode"].Read,
        ...
        var searchCriteria = {
            ...
            stockMvt: {
                ...
                bidtWarehouseByBidtWarehouseReceiptId: this.deliveryFolder.bidtWarehouseReceiver
                    ...
                    : undefined,
                bidtStockMvtTypeId: _shared_constants_bidt_stock_mvt_type_constants__WEBPACK_IMPORTED_MODULE_8__["BidtStockMvtTypeConstant"].STORAGE
            },
    ...
    GoodsReceiptFormComponent.prototype.toCrossDocking = function () {
        ...
        this.searchService.findByCriteria(this.getSearchCriteriaCrossDocking()).subscribe(function (mvtList) {
            ...
            var data = {
                id: _this.tabService.generateId(),
                componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_11__["ComponentConstants"].LOG_STOCK_MOVEMENTS_FORM,
                openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_13__["ComponentOpenMode"].Read,
                objectId: _this.serializationService.serialize(params)
            };
            var labelKey = 'transaction.' + data.componentId;
        ...
        var searchCriteria = {
            ...
            stockMvt: {
                ...
                bidtWarehouseByBidtWarehouseReceiptId: this.deliveryFolder.bidtWarehouseReceiver
                    ? this.deliveryFolder.bidtWarehouseReceiver.wareHouseId
                    : undefined,
                bidtStockMvtTypeId: _shared_constants_bidt_stock_mvt_type_constants__WEBPACK_IMPORTED_MODULE_8__["BidtStockMvtTypeConstant"].CROSS_DOCKING
            },
            withAlternatives: false,
            dfShipmentSearch: false
        };
    ...
    GoodsReceiptFormComponent.prototype.openOrder = function (id) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_11__["ComponentConstants"].LOG_TRANSFER_ORDER_FORM,
    ...
    GoodsReceiptFormComponent.prototype.onScanAssetBatchNumber = function (batchNumber) {
        var matchingAsset = this.materialTableData.find(function (elt) { return elt._obj.stockMvtBatchNumber === batchNumber; });
        if (!matchingAsset) {
            ...
            var bidtPackageOperation = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(bidtPackage.bidtPackageOperations).find(function (operation) { return operation.packopeDesignation === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].LOGISTICAL_OPERATION_PHYSICAL_RECEIPT; });
            if (!!bidtPackageOperation &&
                bidtPackageOperation.packopeStatus !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].LOGISTICAL_OPERATION_STATUS_PERFORMED) {
                this.messageService.showErrorMessage(this.getTranslateKey('physicalReceiptOnPackageNotPerformed'));
            }
            else {
                var operationCheck = this.getMaterialOperation(matchingAsset._obj.bidtStockMvtOperations, _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].LOGISTICAL_OPERATION_VISUAL_CONTROL);
                if (operationCheck && operationCheck.bidtStockMvtOperationDTO) {
                    if (this.isStatusPerformed(operationCheck.bidtStockMvtOperationDTO.smoStatus)) {
    ...
    GoodsReceiptFormComponent = GoodsReceiptFormComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./goods-receipt-form.component.html */ "./src/app/main/logistics/goods-receipt/form/goods-receipt-form.component.html"),
            styles: [__webpack_require__(/*! ./goods-receipt-form.component.scss */ "./src/app/main/logistics/goods-receipt/form/goods-receipt-form.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GoodsReceiptModule", function() { return GoodsReceiptModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_components_dialog_search_customer_dialog_search_customer_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../shared/components/dialog-search-customer/dialog-search-customer.module */ "./src/app/shared/components/dialog-search-customer/dialog-search-customer.module.ts");
/* harmony import */ var _shared_components_dialog_search_equipment_dialog_search_equipment_module__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../shared/components/dialog-search-equipment/dialog-search-equipment.module */ "./src/app/shared/components/dialog-search-equipment/dialog-search-equipment.module.ts");
/* harmony import */ var _shared_components_dialog_search_pn_dialog_search_pn_module__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../shared/components/dialog-search-pn/dialog-search-pn.module */ "./src/app/shared/components/dialog-search-pn/dialog-search-pn.module.ts");
...
/* harmony import */ var _administration_catalog_catalog_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../administration/catalog/catalog.service */ "./src/app/main/administration/catalog/catalog.service.ts");
...
/* harmony import */ var _stock_movements_search_search_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../stock-movements/search/search.service */ "./src/app/main/logistics/stock-movements/search/search.service.ts");
/* harmony import */ var _transfer_order_shared_transfer_order_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../transfer-order/shared/transfer-order-service */ "./src/app/main/logistics/transfer-order/shared/transfer-order-service.ts");
/* harmony import */ var _delivery_folder_search_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./delivery-folder-search.service */ "./src/app/main/logistics/goods-receipt/delivery-folder-search.service.ts");
/* harmony import */ var _form_dialog_add_item_dialog_add_item_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./form/dialog-add-item/dialog-add-item.component */ "./src/app/main/logistics/goods-receipt/form/dialog-add-item/dialog-add-item.component.ts");
/* harmony import */ var _form_dialog_add_material_dialog_add_material_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./form/dialog-add-material/dialog-add-material.component */ "./src/app/main/logistics/goods-receipt/form/dialog-add-material/dialog-add-material.component.ts");
/* harmony import */ var _form_dialog_add_package_dialog_add_package_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./form/dialog-add-package/dialog-add-package.component */ "./src/app/main/logistics/goods-receipt/form/dialog-add-package/dialog-add-package.component.ts");
/* harmony import */ var _form_dialog_create_litigation_dialog_create_litigation_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./form/dialog-create-litigation/dialog-create-litigation.component */ "./src/app/main/logistics/goods-receipt/form/dialog-create-litigation/dialog-create-litigation.component.ts");
/* harmony import */ var _form_dialog_document_categories_dialog_document_categories_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./form/dialog-document-categories/dialog-document-categories.component */ "./src/app/main/logistics/goods-receipt/form/dialog-document-categories/dialog-document-categories.component.ts");
/* harmony import */ var _form_goods_receipt_form_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./form/goods-receipt-form.component */ "./src/app/main/logistics/goods-receipt/form/goods-receipt-form.component.ts");
/* harmony import */ var _form_goods_receipt_form_service__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./form/goods-receipt-form.service */ "./src/app/main/logistics/goods-receipt/form/goods-receipt-form.service.ts");
/* harmony import */ var _search_dialog_asset_scan_dialog_asset_scan_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./search/dialog-asset-scan/dialog-asset-scan.component */ "./src/app/main/logistics/goods-receipt/search/dialog-asset-scan/dialog-asset-scan.component.ts");
/* harmony import */ var _search_dialog_create_receipt_dialog_create_receipt_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./search/dialog-create-receipt/dialog-create-receipt.component */ "./src/app/main/logistics/goods-receipt/search/dialog-create-receipt/dialog-create-receipt.component.ts");
/* harmony import */ var _search_dialog_package_scan_dialog_package_scan_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./search/dialog-package-scan/dialog-package-scan.component */ "./src/app/main/logistics/goods-receipt/search/dialog-package-scan/dialog-package-scan.component.ts");
/* harmony import */ var _search_external_good_receipt_search_components__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./search/external-good-receipt-search.components */ "./src/app/main/logistics/goods-receipt/search/external-good-receipt-search.components.ts");
/* harmony import */ var _search_local_good_receipt_search_components__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./search/local-good-receipt-search.components */ "./src/app/main/logistics/goods-receipt/search/local-good-receipt-search.components.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EXTERNAL_MODULES = [
    ...
    _shared_components_dialog_search_customer_dialog_search_customer_module__WEBPACK_IMPORTED_MODULE_15__["DialogSearchCustomerModule"]
];
var INTERNAL_MODULES = [_shared_components_dialog_search_pn_dialog_search_pn_module__WEBPACK_IMPORTED_MODULE_17__["DialogSearchPnModule"], _shared_components_dialog_search_equipment_dialog_search_equipment_module__WEBPACK_IMPORTED_MODULE_16__["DialogSearchEquipmentModule"]];
/******************************************************************************
 * Components
 *************************************************************************** */
var COMPONENTS = [];
var DYNAMIC_COMPONENTS = [
    ...
    _search_external_good_receipt_search_components__WEBPACK_IMPORTED_MODULE_35__["ExternalGoodReceiptSearchComponent"],
    _form_dialog_create_litigation_dialog_create_litigation_component__WEBPACK_IMPORTED_MODULE_28__["DialogCreateLitigationComponent"],
    _search_dialog_asset_scan_dialog_asset_scan_component__WEBPACK_IMPORTED_MODULE_32__["DialogGoodsReceiptAssetScanComponent"],
    _search_dialog_package_scan_dialog_package_scan_component__WEBPACK_IMPORTED_MODULE_34__["DialogGoodsReceiptPackageScanComponent"],
    _search_dialog_create_receipt_dialog_create_receipt_component__WEBPACK_IMPORTED_MODULE_33__["DialogCreateReceiptComponent"],
    _form_dialog_add_package_dialog_add_package_component__WEBPACK_IMPORTED_MODULE_27__["DialogAddPackageComponent"],
    _form_dialog_add_item_dialog_add_item_component__WEBPACK_IMPORTED_MODULE_25__["DialogAddItemComponent"],
    _form_dialog_add_material_dialog_add_material_component__WEBPACK_IMPORTED_MODULE_26__["DialogAddMaterialComponent"],
    _form_dialog_document_categories_dialog_document_categories_component__WEBPACK_IMPORTED_MODULE_29__["DialogDocumentCategoriesReceiptFolderComponent"]
];
/******************************************************************************
 * Services
 *************************************************************************** */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogGoodsReceiptAssetScanComponent", function() { return DialogGoodsReceiptAssetScanComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
...
var DialogGoodsReceiptAssetScanComponent = /** @class */ (function (_super) {
    ...
    function DialogGoodsReceiptAssetScanComponent(messageService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__["ComponentOpenMode"].Read, 'DialogGoodsReceiptAssetScanComponent') || this;
        _this.messageService = messageService;
    ...
    DialogGoodsReceiptAssetScanComponent.prototype.registerCodeObservable = function () {
        ...
        this.codeChanged
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(DialogGoodsReceiptAssetScanComponent_1.CODE_DEBOUNCE_TIME), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.unsubscribe))
            .subscribe({
            next: function (value) {
                if (value) {
                    try {
    ...
    ], DialogGoodsReceiptAssetScanComponent.prototype, "keepDialogOpened", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogGoodsReceiptAssetScanComponent.prototype, "onValidate", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('codeInput'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], DialogGoodsReceiptAssetScanComponent.prototype, "codeInputElt", void 0);
    DialogGoodsReceiptAssetScanComponent = DialogGoodsReceiptAssetScanComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./dialog-asset-scan.component.html */ "./src/app/main/logistics/goods-receipt/search/dialog-asset-scan/dialog-asset-scan.component.html"),
            styles: [__webpack_require__(/*! ./dialog-asset-scan.component.scss */ "./src/app/main/logistics/goods-receipt/search/dialog-asset-scan/dialog-asset-scan.component.scss")]
        }),
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogCreateReceiptComponent", function() { return DialogCreateReceiptComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _delivery_folder_search_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../delivery-folder-search.service */ "./src/app/main/logistics/goods-receipt/delivery-folder-search.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DialogCreateReceiptComponent = /** @class */ (function (_super) {
    ...
    function DialogCreateReceiptComponent(sessionService, extractTranslationPipe, dfSearchService, logisticsService, messageService, propertiesService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__["ComponentOpenMode"].Read, 'DialogCreateReceiptComponent') || this;
        _this.sessionService = sessionService;
        _this.extractTranslationPipe = extractTranslationPipe;
    ...
    ], DialogCreateReceiptComponent.prototype, "contextComponent", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogCreateReceiptComponent.prototype, "onValidate", void 0);
    DialogCreateReceiptComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-create-receipt',
            template: __webpack_require__(/*! ./dialog-create-receipt.component.html */ "./src/app/main/logistics/goods-receipt/search/dialog-create-receipt/dialog-create-receipt.component.html"),
            styles: [__webpack_require__(/*! ./dialog-create-receipt.component.scss */ "./src/app/main/logistics/goods-receipt/search/dialog-create-receipt/dialog-create-receipt.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogGoodsReceiptPackageScanComponent", function() { return DialogGoodsReceiptPackageScanComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../shared/enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
...
var DialogGoodsReceiptPackageScanComponent = /** @class */ (function (_super) {
    ...
    function DialogGoodsReceiptPackageScanComponent(messageService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__["ComponentOpenMode"].Read, 'DialogGoodsReceiptPackageScanComponent') || this;
        _this.messageService = messageService;
        _this.onValidate = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        _this.code = '';
        _this.registerCodeObservable();
    ...
    DialogGoodsReceiptPackageScanComponent.prototype.registerCodeObservable = function () {
        ...
        this.codeChanged = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        this.codeChanged
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(DialogGoodsReceiptPackageScanComponent_1.CODE_DEBOUNCE_TIME), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.unsubscribe))
            .subscribe({
            next: function (value) {
                if (value) {
                    try {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogGoodsReceiptPackageScanComponent.prototype, "onValidate", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('codeInput'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], DialogGoodsReceiptPackageScanComponent.prototype, "codeInputElt", void 0);
    DialogGoodsReceiptPackageScanComponent = DialogGoodsReceiptPackageScanComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-goods-receipt-scan',
            template: __webpack_require__(/*! ./dialog-package-scan.component.html */ "./src/app/main/logistics/goods-receipt/search/dialog-package-scan/dialog-package-scan.component.html"),
            styles: [__webpack_require__(/*! ./dialog-package-scan.component.scss */ "./src/app/main/logistics/goods-receipt/search/dialog-package-scan/dialog-package-scan.component.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_message_service__WEBPACK_IMPORTED_MODULE_4__["MessageService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExternalGoodReceiptSearchComponent", function() { return ExternalGoodReceiptSearchComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
...
/* harmony import */ var _transfer_order_shared_transfer_order_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../transfer-order/shared/transfer-order-service */ "./src/app/main/logistics/transfer-order/shared/transfer-order-service.ts");
/* harmony import */ var _delivery_folder_search_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../delivery-folder-search.service */ "./src/app/main/logistics/goods-receipt/delivery-folder-search.service.ts");
/* harmony import */ var _goods_receipt_search_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./goods-receipt-search.component */ "./src/app/main/logistics/goods-receipt/search/goods-receipt-search.component.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ExternalGoodReceiptSearchComponent = /** @class */ (function (_super) {
    ...
    function ExternalGoodReceiptSearchComponent(favoriteService, loaderService, messageService, serializationService, tabService, sessionService, translateService, dfSearchService, logisticsService, propertiesService, transferOrderService, extractTranslationPipe) {
        var _this = _super.call(this, favoriteService, loaderService, messageService, serializationService, tabService, sessionService, translateService, dfSearchService, logisticsService, propertiesService, transferOrderService, extractTranslationPipe) || this;
        _this.sessionService = sessionService;
        _this.translateService = translateService;
        _this.dfSearchService = dfSearchService;
        _this.logisticsService = logisticsService;
    ...
    ExternalGoodReceiptSearchComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_2__["ComponentConstants"].LOG_EXTERNAL_GOODS_RECEIPT_SEARCH;
    };
    ...
    ExternalGoodReceiptSearchComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./goods-receipt-search.component.html */ "./src/app/main/logistics/goods-receipt/search/goods-receipt-search.component.html"),
            styles: [__webpack_require__(/*! ./goods-receipt-search.component.scss */ "./src/app/main/logistics/goods-receipt/search/goods-receipt-search.component.scss")]
        }),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ComponentContext", function() { return ComponentContext; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GoodsReceiptSearchComponent", function() { return GoodsReceiptSearchComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var GoodsReceiptSearchComponent = /** @class */ (function (_super) {
    ...
    function GoodsReceiptSearchComponent(favoriteService, loaderService, messageService, serializationService, tabService, sessionService, translateService, dfSearchService, logisticsService, propertiesService, transferOrderService, extractTranslationPipe) {
    ...
    GoodsReceiptSearchComponent.prototype.canSearch = function () {
        return _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_13__["ObjectUtils"].isDefined(this.selectedRecipientSite);
    };
    ...
    GoodsReceiptSearchComponent.prototype.loadByAssetBatchNumber = function (batchNumber) {
        ...
        this.logisticsService
            ...
            batchNumber: batchNumber,
            folderStatusExcluded: [_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].RECEIPT_FOLDER_STATUS_PERFORMED],
            deliveryFolder: {}
        })
            .subscribe({
            next: function (bidtDeliveryFolders) {
                if (!bidtDeliveryFolders || bidtDeliveryFolders.length === 0) {
                    ...
                    if (!_this.userSiteId ||
                        ...
                        var bidtDfItems = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__["ListUtils"].orEmpty(bidtDeliveryFolder_1.bidtDfItems).filter(function (item) {
                            return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__["ListUtils"].orEmpty(item.bidtStockMvts).some(function (stockMvt) { return stockMvt.stockMvtBatchNumber === batchNumber; });
                        });
                        var assetsToUpdate$ = bidtDfItems
                            .map(function (bidtDfItem) {
                            var bidtPackage = bidtDfItem.bidtPackage;
                            var bidtPackageOperation = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__["ListUtils"].orEmpty(bidtPackage.bidtPackageOperations).find(function (operation) {
                                return operation.packopeDesignation === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].LOGISTICAL_OPERATION_PHYSICAL_RECEIPT;
                            });
                            var bidtStockMvt = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__["ListUtils"].orEmpty(bidtDfItem.bidtStockMvts).find(function (stockMvt) { return stockMvt.stockMvtBatchNumber === batchNumber; });
                            var bidtStockMvtOperation = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__["ListUtils"].orEmpty(bidtStockMvt.bidtStockMvtOperations).find(function (operation) {
                                return operation.smoDesignation === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].LOGISTICAL_OPERATION_VISUAL_CONTROL;
                            });
                            if (bidtDeliveryFolder_1.dfStatus !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].RECEIPT_FOLDER_STATUS_DRAFT &&
                                !!bidtPackageOperation &&
                                bidtPackageOperation.packopeStatus ===
                                    _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].LOGISTICAL_OPERATION_STATUS_PERFORMED &&
                                !!bidtStockMvtOperation &&
                                bidtStockMvtOperation.smoStatus !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].LOGISTICAL_OPERATION_STATUS_PERFORMED) {
                                return _this.logisticsService.performStockMovementOperations([
                                    {
                                        bidtDfItem: bidtDfItem,
                                        bidtStockMvt: bidtStockMvt,
                                        newStatus: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].LOGISTICAL_OPERATION_STATUS_PERFORMED,
            ...
            next: function (bidtDeliveryFolders) {
                if (!bidtDeliveryFolders || bidtDeliveryFolders.length === 0) {
                    ...
                    if (!_this.userSiteId ||
                        ...
                        var bidtPackage = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__["ListUtils"].orEmpty(bidtDeliveryFolders[0].bidtDfItems).find(function (dfItem) {
                            return !!dfItem.bidtPackage &&
                        ...
                        if (bidtDeliveryFolders[0].dfStatus !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].RECEIPT_FOLDER_STATUS_DRAFT &&
                            !!bidtPackageOperation &&
                            bidtPackageOperation.packopeStatus !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].LOGISTICAL_OPERATION_STATUS_PERFORMED) {
                            _this.logisticsService
    ...
    GoodsReceiptSearchComponent.prototype.openDf = function (df) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_7__["ComponentConstants"].LOG_GOODS_RECEIPT_FORM,
            openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_9__["ComponentOpenMode"].Read,
    ...
    GoodsReceiptSearchComponent.prototype.openDocument = function (dfRow) {
        ...
        if (dfRow._obj.bidtTransferOrder) {
            ...
            this.logisticsService.findDeliveryFoldersByCriteria(searchCriteria).subscribe(function (deliveryFolderList) {
                // Delivery Folder
                var data = {
                    id: _this.tabService.generateId(),
    ...
    GoodsReceiptSearchComponent.prototype.search = function () {
        ...
        var searchCriteria = {
            ...
            folderStatusExcluded: this.selectedStatus ? [] : [_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].RECEIPT_FOLDER_STATUS_PERFORMED],
            ...
            folderCategorie: this.selectedDfType ? undefined : _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].DELIVERY_CATEGORY_RECEIPT,
    ...
    GoodsReceiptSearchComponent.prototype.loadDfStatuses = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_8__["GenericPropertyConstants"].RECEIPT_FOLDER_STATUS_MAP).subscribe({
    ...
    GoodsReceiptSearchComponent.prototype.retrieveDocData = function (df, dfRow) {
        if (df.bidtTransferOrder) {
            ...
            dfRow.docType = this.typeList
                .filter(function (ty) { return ty.value.toString() === df.bidtTransferOrder.torType; })
    ...
    __decorate([
        ...
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], GoodsReceiptSearchComponent.prototype, "resultsContainerAnchor", void 0);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LocalGoodReceiptSearchComponent", function() { return LocalGoodReceiptSearchComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
/* harmony import */ var _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../shared/constants/component-constants */ "./src/app/shared/constants/component-constants.ts");
/* harmony import */ var _shared_pipes_extract_translation_pipe__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../shared/pipes/extract-translation.pipe */ "./src/app/shared/pipes/extract-translation.pipe.ts");
...
/* harmony import */ var _logistics_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../logistics.service */ "./src/app/main/logistics/logistics.service.ts");
/* harmony import */ var _transfer_order_shared_transfer_order_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../transfer-order/shared/transfer-order-service */ "./src/app/main/logistics/transfer-order/shared/transfer-order-service.ts");
/* harmony import */ var _goods_receipt_search_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./goods-receipt-search.component */ "./src/app/main/logistics/goods-receipt/search/goods-receipt-search.component.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
var LocalGoodReceiptSearchComponent = /** @class */ (function (_super) {
    ...
    function LocalGoodReceiptSearchComponent(favoriteService, loaderService, messageService, serializationService, tabService, sessionService, translateService, dfSearchService, logisticsService, propertiesService, transferOrderService, extractTranslationPipe) {
        var _this = _super.call(this, favoriteService, loaderService, messageService, serializationService, tabService, sessionService, translateService, dfSearchService, logisticsService, propertiesService, transferOrderService, extractTranslationPipe) || this;
        _this.sessionService = sessionService;
        _this.translateService = translateService;
        _this.dfSearchService = dfSearchService;
    ...
    LocalGoodReceiptSearchComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_2__["ComponentConstants"].LOG_LOCAL_GOODS_RECEIPT_SEARCH;
    };
