(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~flight-operations-flight-flight-module~maintenance-airworthiness-control-airworthiness-contr~4dbc4abb"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkPackageFormService", function() { return WorkPackageFormService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _shared_api_bidt_stock_mvt_api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../shared/api/bidt-stock-mvt.api */ "./src/app/shared/api/bidt-stock-mvt.api.ts");
...
/* harmony import */ var _shared_api_aircraft_maintenance_api__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./../../../../shared/api/aircraft-maintenance.api */ "./src/app/shared/api/aircraft-maintenance.api.ts");
/* harmony import */ var _shared_api_airworthiness_management_api__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./../../../../shared/api/airworthiness-management.api */ "./src/app/shared/api/airworthiness-management.api.ts");
/* harmony import */ var _shared_api_am_project_management_api__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./../../../../shared/api/am-project-management.api */ "./src/app/shared/api/am-project-management.api.ts");
/* harmony import */ var _shared_api_fleet_business_api__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./../../../../shared/api/fleet-business.api */ "./src/app/shared/api/fleet-business.api.ts");
/* harmony import */ var _shared_api_project_management_api__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./../../../../shared/api/project-management.api */ "./src/app/shared/api/project-management.api.ts");
/* harmony import */ var _shared_api_task_management_api__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./../../../../shared/api/task-management.api */ "./src/app/shared/api/task-management.api.ts");
/* harmony import */ var _shared_api_user_profile_business_api__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./../../../../shared/api/user-profile-business.api */ "./src/app/shared/api/user-profile-business.api.ts");
...
/* harmony import */ var _work_package_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./../work-package.service */ "./src/app/main/maintenance/work-package/work-package.service.ts");
...
var WorkPackageFormService = /** @class */ (function (_super) {
    ...
    function WorkPackageFormService(http, appConfigService, aircraftMaintenanceApi, amProjectManagementApi, bidtStockMvtApi, dateService, taskManagementApi, wpService, fleetBusinessApi, fleetManagementApi, airworthinessManagementApi, userProfileBusinessApi, projectManagementApi) {
    ...
    WorkPackageFormService.prototype.createBidmProject = function (bidmProjectDTO) {
        return _super.prototype.post.call(this, this.amProjectManagementApi.createBidmProject, bidmProjectDTO)
    ...
    WorkPackageFormService.prototype.updateBidmProject = function (bidmProjectDTO) {
        return _super.prototype.post.call(this, this.amProjectManagementApi.updateBidmProject, bidmProjectDTO)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res; }));
    };
    WorkPackageFormService.prototype.checkAcrsEventForBidmProject = function (bidmProjectDTO) {
        return _super.prototype.post.call(this, this.amProjectManagementApi.checkAcrsEventForBidmProject, bidmProjectDTO)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res; }));
    };
    ...
    WorkPackageFormService.prototype.getLocalCurrency = function () {
        return _super.prototype.post.call(this, this.taskManagementApi.getLocalCurrency)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.substr(res.indexOf('(')); }));
    };
    ...
    WorkPackageFormService.prototype.getBidmWorkOrdersStructureByProject = function (projectId) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["forkJoin"])({
            woTypeList: this.wpService.loadGenProps(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_15__["GenericPropertyConstants"].AIRM_WORK_ORDER_TYPES_MAP),
            woStatusList: this.wpService.loadGenProps(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_15__["GenericPropertyConstants"].AIRM_OPERATION_STATUS_MAP),
            ...
            return _super.prototype.post.call(_this, _this.aircraftMaintenanceApi.getBidmWorkOrdersStructureByProject, projectIdDto)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (woList) {
    ...
    WorkPackageFormService.prototype.getBidmWorkOrdersStructure = function (woListInput) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["forkJoin"])({
            ...
            var woTypeList = _a.woTypeList, woStatusList = _a.woStatusList, userList = _a.userList;
            return _super.prototype.post.call(_this, _this.aircraftMaintenanceApi.getBidmWorkOrdersStructure, woListInput)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (woList) {
                _this._woStatusList.next(woStatusList);
                _this._woTypeList.next(woTypeList);
                _this._userList.next(userList);
        ...
        return !!woList
            ? woList.map(function (wo) {
                var data = {
                    ...
                    code: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_20__["StringUtils"].orEmpty(wo.bidmWorkOrder.woCode),
                    description: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_20__["StringUtils"].isNullOrEmpty(wo.workOrderStatusDetail.taskDesignation)
                        ? _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_20__["StringUtils"].orEmpty(wo.bidmWorkOrder.woDescription)
                        : _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_20__["StringUtils"].orEmpty(wo.workOrderStatusDetail.taskDesignation),
                    type: _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__["SelectItemUtils"].formatSelectItem(wo.bidmWorkOrder.woType, woTypeList),
                    woType: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_20__["StringUtils"].orEmpty(wo.bidmWorkOrder.woType),
                    ...
                    status: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_20__["StringUtils"].orEmpty(wo.workOrderStatusDetail.status),
                    ...
                    assignedTo: _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__["SelectItemUtils"].formatSelectItem(wo.bidmWorkOrder.woAssignedTo, userList),
                    ...
                    checkedBy: _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__["SelectItemUtils"].formatSelectItem(wo.bidmWorkOrder.woCheckedBy, userList),
                    ...
                    standardDuration: _this.roundNumberToString(wo.workOrderStatusDetail.costAndDuration.theoreticalDuration),
                    standardCost: _this.roundNumberToString(wo.workOrderStatusDetail.costAndDuration.theoreticalOpeCosts),
                    qualification: wo.qualificationNeeded,
                    planWorkload: _this.roundNumberToString(wo.workOrderStatusDetail.costAndDuration.theoreticalWorkload),
                    planDuration: _this.roundNumberToString(wo.workOrderStatusDetail.costAndDuration.theoreticalDuration),
                    planTotalCost: _this.roundNumberToString(wo.workOrderStatusDetail.costAndDuration.theoreticalTotalCost),
                    planLaborCost: _this.roundNumberToString(wo.workOrderStatusDetail.costAndDuration.theoreticalLaborCost),
                    planMaterialCost: _this.roundNumberToString(wo.workOrderStatusDetail.costAndDuration.theoreticalMaterialCost),
                    planSubcontractCost: _this.roundNumberToString(wo.workOrderStatusDetail.costAndDuration.theoreticalSubcontractingCost),
                    Workload: '',
                    Duration: '',
                    ...
                    SubcontractingCost: _this.roundNumberToString(wo.workOrderStatusDetail.costAndDuration.subcontractingCost),
    ...
    WorkPackageFormService.prototype.loadReturnReasons = function () {
        return this.findReturnReasons().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (results) {
            return !!results
                ? results
                    .map(function (reason) {
                    return {
                    ...
                    .sort(_shared_utils_array_utils__WEBPACK_IMPORTED_MODULE_17__["ArrayUtils"].compareValues('label'))
                : [];
        }));
    };
    WorkPackageFormService.prototype.roundNumberToString = function (value) {
        return value ? _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_18__["NumberUtils"].toString(_shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_18__["NumberUtils"].roundNumber(value)) : '0';
    };
    ...
    WorkPackageFormService.prototype.findBidmProjectWithLinkedObjects = function (input) {
        return _super.prototype.post.call(this, this.amProjectManagementApi.findBidmProjectWithLinkedObjects, input);
    };
    ...
    WorkPackageFormService.prototype.isBuildingBlockInstalled = function (buildingBlock) {
        return _super.prototype.post.call(this, this.userProfileBusinessApi.isBuildingBlockInstalled, buildingBlock);
    };
