(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~engineering-management-engineering-management-module~fleet-management-asset-asset-module~fle~924f9586"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchPnAlternativesComponent", function() { return DialogSearchPnAlternativesComponent; });
...
/* harmony import */ var _dialog_search_pn_alternatives_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dialog-search-pn-alternatives.service */ "./src/app/shared/components/dialog-search-pn-alternatives/dialog-search-pn-alternatives.service.ts");
...
var DialogSearchPnAlternativesComponent = /** @class */ (function (_super) {
    ...
    function DialogSearchPnAlternativesComponent(dialogSearchPnAlternativesService) {
        var _this = _super.call(this, _enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__["ComponentOpenMode"].Write, 'DialogSearchPnAlternativesComponent') || this;
    ...
    DialogSearchPnAlternativesComponent.prototype.initAlternativesTableDataSource = function () {
        this.alternativesTableDataSource = new _table_table_data_source__WEBPACK_IMPORTED_MODULE_5__["TableDataSource"]({
    ...
    DialogSearchPnAlternativesComponent.prototype.load = function () {
        ...
        this.dialogSearchPnAlternativesService
            ...
            var alternatives = results
                ...
                var isPresent = acc.find(function (item) { return item.birePn.pnCode === current.birePn.pnCode; });
                if (!isPresent) {
                ...
                .map(function (result) {
                return {
                    designation: _utils_string_utils__WEBPACK_IMPORTED_MODULE_4__["StringUtils"].orEmpty(result.birePn.articleDesignation),
                    interchangeability: _utils_string_utils__WEBPACK_IMPORTED_MODULE_4__["StringUtils"].orEmpty(result.interchangeability),
                    manufacturerOtanCode: _utils_string_utils__WEBPACK_IMPORTED_MODULE_4__["StringUtils"].orEmpty(result.birePn.manufacturerOtanCode),
                    otanPnReference: _utils_string_utils__WEBPACK_IMPORTED_MODULE_4__["StringUtils"].orEmpty(result.birePn.otanPnReference),
                    pnCode: _utils_string_utils__WEBPACK_IMPORTED_MODULE_4__["StringUtils"].orEmpty(result.birePn.pnCode),
                    _obj: result
                };
            });
    ...
    ], DialogSearchPnAlternativesComponent.prototype, "pn", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], DialogSearchPnAlternativesComponent.prototype, "onSelected", void 0);
    DialogSearchPnAlternativesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-search-pn-alternatives[pn]',
            template: __webpack_require__(/*! ./dialog-search-pn-alternatives.component.html */ "./src/app/shared/components/dialog-search-pn-alternatives/dialog-search-pn-alternatives.component.html")
        }),
        __metadata("design:paramtypes", [_dialog_search_pn_alternatives_service__WEBPACK_IMPORTED_MODULE_6__["DialogSearchPnAlternativesService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchPnAlternativesModule", function() { return DialogSearchPnAlternativesModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _modal_modal_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../modal/modal.module */ "./src/app/shared/components/modal/modal.module.ts");
/* harmony import */ var _table_table_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../table/table.module */ "./src/app/shared/components/table/table.module.ts");
/* harmony import */ var _dialog_search_pn_alternatives_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dialog-search-pn-alternatives.component */ "./src/app/shared/components/dialog-search-pn-alternatives/dialog-search-pn-alternatives.component.ts");
/* harmony import */ var _dialog_search_pn_alternatives_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./dialog-search-pn-alternatives.service */ "./src/app/shared/components/dialog-search-pn-alternatives/dialog-search-pn-alternatives.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Components
 *************************************************************************** */
var COMPONENTS = [_dialog_search_pn_alternatives_component__WEBPACK_IMPORTED_MODULE_6__["DialogSearchPnAlternativesComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_dialog_search_pn_alternatives_service__WEBPACK_IMPORTED_MODULE_7__["DialogSearchPnAlternativesService"]];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchPnAlternativesService", function() { return DialogSearchPnAlternativesService; });
...
var DialogSearchPnAlternativesService = /** @class */ (function (_super) {
    ...
    DialogSearchPnAlternativesService.prototype.findAlternatives = function (pnCode) {
        return _super.prototype.post.call(this, this.productStructureManagementApi.findAlternativePnsByPnCode, pnCode);
    };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchPnComponent", function() { return DialogSearchPnComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _shared_types_dialog_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../shared/types/dialog-component */ "./src/app/shared/types/dialog-component.ts");
/* harmony import */ var _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../constants/aw-properties-constants */ "./src/app/shared/constants/aw-properties-constants.ts");
/* harmony import */ var _constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../constants/bido-function-type-constants */ "./src/app/shared/constants/bido-function-type-constants.ts");
/* harmony import */ var _constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../constants/generic-property-constants */ "./src/app/shared/constants/generic-property-constants.ts");
...
/* harmony import */ var _services_properties_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../services/properties.service */ "./src/app/shared/services/properties.service.ts");
...
/* harmony import */ var _utils_object_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../utils/object-utils */ "./src/app/shared/utils/object-utils.ts");
/* harmony import */ var _dialog_search_pn_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./dialog-search-pn.service */ "./src/app/shared/components/dialog-search-pn/dialog-search-pn.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DialogSearchPnComponent = /** @class */ (function (_super) {
    ...
    function DialogSearchPnComponent(dialogSearchPnService, confirmationService, messageService, propertiesService) {
        var _this = _super.call(this, _enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_6__["ComponentOpenMode"].Write, 'DialogSearchPnComponent') || this;
    ...
    DialogSearchPnComponent.prototype.ngOnInit = function () {
        if (!this.pnType && (!_utils_object_utils__WEBPACK_IMPORTED_MODULE_11__["ObjectUtils"].isDefined(this.withAllTypes) || !this.withAllTypes)) {
            this.pnType = _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_PART_KEY;
        }
    ...
    DialogSearchPnComponent.prototype.loadDropDownLists = function () {
        ...
        var familyVariantInput = {
            useCase: _constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_4__["BidoFunctionTypeConstants"].UC_MCH_BOM,
            module: _constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_4__["BidoFunctionTypeConstants"].MODULE_FAMILY
        };
        this.statusDictionary = {};
        this.dialogSearchPnService.getFamilyVariant(familyVariantInput).subscribe(function (results) {
            var list = new Array();
        ...
        if (this.withAllTypes) {
            this.propertiesService.getValue(_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].PN_TYPE_MAP).subscribe(function (results) {
                _this.pnTypes = results.sort(function (x, y) { return x.label.localeCompare(y.label); });
            });
        }
        else {
            this.propertiesService.getValue(_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].ENGINEERING_PN_TYPES_MAP).subscribe(function (results) {
                _this.pnTypes = results.sort(function (x, y) { return x.label.localeCompare(y.label); });
            });
        }
        this.propertiesService.getValue(_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].FUNC_OBJECT_STATUS_MAP).subscribe(function (results) {
            _this.propertyStatus = results;
            _this.fillStatusDictionary(results);
        }, function () {
            _this.messageService.showErrorMessage(_this.getTranslateKey('errorOnGetFamilyVariant'));
        });
        this.propertiesService.getValue(_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].OBJECT_STATUS_MAP).subscribe(function (results) {
            _this.fillStatusDictionary(results);
        }, function () {
            _this.messageService.showErrorMessage(_this.getTranslateKey('errorOnGetFamilyVariant'));
        });
    ...
    DialogSearchPnComponent.prototype.loadSparePartClasses = function () {
        var _this = this;
        this.propertiesService.getValue(_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].SPARE_PART_CLASS_CODE).subscribe({
            next: function (sparePartClasses) {
                _this.sparePartClasses = _utils_list_utils__WEBPACK_IMPORTED_MODULE_10__["ListUtils"].orEmpty(sparePartClasses).sort(function (x, y) { return x.label.localeCompare(y.label); });
                if (_this.isSparePartClassPredefined) {
                    _this.searchObject.sparePartClassCode = _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].SPC_REPAIRABLE_KEY;
                }
            }
        });
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogSearchPnComponent.prototype, "familyVariant", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], DialogSearchPnComponent.prototype, "pnType", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogSearchPnComponent.prototype, "toolSearch", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogSearchPnComponent.prototype, "showPartTypeSelection", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogSearchPnComponent.prototype, "showFamilyVariantSelection", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogSearchPnComponent.prototype, "checkContainer", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], DialogSearchPnComponent.prototype, "onSelected", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogSearchPnComponent.prototype, "withAllTypes", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogSearchPnComponent.prototype, "withSparePartClass", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogSearchPnComponent.prototype, "isSparePartClassPredefined", void 0);
    DialogSearchPnComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-search-pn',
            template: __webpack_require__(/*! ./dialog-search-pn.component.html */ "./src/app/shared/components/dialog-search-pn/dialog-search-pn.component.html")
        }),
        __metadata("design:paramtypes", [_dialog_search_pn_service__WEBPACK_IMPORTED_MODULE_12__["DialogSearchPnService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchPnModule", function() { return DialogSearchPnModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _dialog_search_pn_alternatives_dialog_search_pn_alternatives_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../dialog-search-pn-alternatives/dialog-search-pn-alternatives.module */ "./src/app/shared/components/dialog-search-pn-alternatives/dialog-search-pn-alternatives.module.ts");
...
/* harmony import */ var _dialog_search_pn_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./dialog-search-pn.component */ "./src/app/shared/components/dialog-search-pn/dialog-search-pn.component.ts");
/* harmony import */ var _dialog_search_pn_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./dialog-search-pn.service */ "./src/app/shared/components/dialog-search-pn/dialog-search-pn.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Modules
 *************************************************************************** */
var EXTERNAL_MODULES = [primeng_table__WEBPACK_IMPORTED_MODULE_2__["TableModule"], primeng_dropdown__WEBPACK_IMPORTED_MODULE_1__["DropdownModule"]];
var INTERNAL_MODULES = [_dialog_search_pn_alternatives_dialog_search_pn_alternatives_module__WEBPACK_IMPORTED_MODULE_6__["DialogSearchPnAlternativesModule"], _modal_modal_module__WEBPACK_IMPORTED_MODULE_7__["ModalModule"]];
/******************************************************************************
 * Components
 *************************************************************************** */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchPnService", function() { return DialogSearchPnService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _api_product_structure_management_api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../api/product-structure-management.api */ "./src/app/shared/api/product-structure-management.api.ts");
/* harmony import */ var _http_abstract_aw_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../http/abstract-aw-http */ "./src/app/shared/http/abstract-aw-http.ts");
...
var DialogSearchPnService = /** @class */ (function (_super) {
    ...
    DialogSearchPnService.prototype.findBirePnsBySearchCriteria = function (criteria, familyCode, structureType, variantCode, toolSearch) {
        var params = {
