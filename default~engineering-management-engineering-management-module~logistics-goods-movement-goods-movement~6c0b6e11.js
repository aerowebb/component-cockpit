(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~engineering-management-engineering-management-module~logistics-goods-movement-goods-movement~6c0b6e11"],{
...
/* harmony import */ var _shared_api_bido_equipment_api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../shared/api/bido-equipment.api */ "./src/app/shared/api/bido-equipment.api.ts");
/* harmony import */ var _shared_api_bidt_delivery_folder_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../shared/api/bidt-delivery-folder.api */ "./src/app/shared/api/bidt-delivery-folder.api.ts");
/* harmony import */ var _shared_api_bidt_df_type_api__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../shared/api/bidt-df-type.api */ "./src/app/shared/api/bidt-df-type.api.ts");
/* harmony import */ var _shared_api_bidt_document_api__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../shared/api/bidt-document.api */ "./src/app/shared/api/bidt-document.api.ts");
/* harmony import */ var _shared_api_bidt_proc_req_item_api__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../shared/api/bidt-proc-req-item.api */ "./src/app/shared/api/bidt-proc-req-item.api.ts");
/* harmony import */ var _shared_api_bidt_procurement_request_api__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../shared/api/bidt-procurement-request.api */ "./src/app/shared/api/bidt-procurement-request.api.ts");
/* harmony import */ var _shared_api_bidt_site_api__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../shared/api/bidt-site.api */ "./src/app/shared/api/bidt-site.api.ts");
/* harmony import */ var _shared_api_bidt_stock_mvt_type_api__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../shared/api/bidt-stock-mvt-type.api */ "./src/app/shared/api/bidt-stock-mvt-type.api.ts");
/* harmony import */ var _shared_api_bidt_stock_mvt_api__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../shared/api/bidt-stock-mvt.api */ "./src/app/shared/api/bidt-stock-mvt.api.ts");
/* harmony import */ var _shared_api_bidt_tor_item_api__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../shared/api/bidt-tor-item.api */ "./src/app/shared/api/bidt-tor-item.api.ts");
/* harmony import */ var _shared_api_bidt_transfer_order_api__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../shared/api/bidt-transfer-order.api */ "./src/app/shared/api/bidt-transfer-order.api.ts");
/* harmony import */ var _shared_api_bidt_warehouse_api__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../shared/api/bidt-warehouse.api */ "./src/app/shared/api/bidt-warehouse.api.ts");
/* harmony import */ var _shared_api_bidt_work_center_api__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../shared/api/bidt-work-center.api */ "./src/app/shared/api/bidt-work-center.api.ts");
...
/* harmony import */ var _shared_api_product_structure_management_api__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../shared/api/product-structure-management.api */ "./src/app/shared/api/product-structure-management.api.ts");
/* harmony import */ var _shared_http_abstract_aw_http__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../shared/http/abstract-aw-http */ "./src/app/shared/http/abstract-aw-http.ts");
/* harmony import */ var _shared_services_app_config_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../shared/services/app-config.service */ "./src/app/shared/services/app-config.service.ts");
...
var LogisticsService = /** @class */ (function (_super) {
    ...
    function LogisticsService(http, appConfigService, bidtWorkCenterApi, aircraftMaintenanceApi, amProjectManagementApi, bidtDeliveryFolderApi, bidtTransferOrderApi, bidtDfTypeApi, bidtProcReqItemApi, bidtProcurementRequestApi, bidtStockMvtApi, bidtStockMvtTypeApi, productStructureManagementApi, bidtWarehouseApi, bidtSiteApi, fleetManagementApi, bidtDocumentApi, assetManagementApi, bidoEquipmentApi, bidtTorItemApi) {
    ...
    LogisticsService.prototype.findShipmentFolderWithAllObjectsById = function (input) {
        return _super.prototype.post.call(this, this.bidtDeliveryFolderApi.findShipmentFolderWithAllObjectsById, input);
    };
    ...
    LogisticsService.prototype.findReceiptFolderWithAllObjectsById = function (input) {
        return _super.prototype.post.call(this, this.bidtDeliveryFolderApi.findReceiptFolderWithAllObjectsById, input);
    };
    ...
    LogisticsService.prototype.putInLitigationStockMovementOperations = function (input) {
        return _super.prototype.post.call(this, this.bidtDeliveryFolderApi.putInLitigationStockMovementOperations, input);
    };
    ...
    LogisticsService.prototype.updateProcurementRequestReceiver = function (input) {
        return _super.prototype.post.call(this, this.bidtProcurementRequestApi.updateProcurementRequestReceiver, input);
    };
    ...
    LogisticsService.prototype.updateProcurementRequestItemQuantity = function (input) {
        return _super.prototype.post.call(this, this.bidtProcurementRequestApi.updateProcurementRequestItemQuantity, input);
    };
    ...
    LogisticsService.prototype.findProcurementRequestsByCriteria = function (input) {
        return _super.prototype.post.call(this, this.bidtProcurementRequestApi.findProcurementRequestsByCriteria, input);
    };
    LogisticsService.prototype.findProcurementRequestsByWoId = function (input) {
        return _super.prototype.post.call(this, this.bidtProcurementRequestApi.findProcurementRequestsByWoId, input);
    };
    ...
    LogisticsService.prototype.searchCandidateAssetsForCannibalism = function (input) {
        return _super.prototype.post.call(this, this.bidtProcurementRequestApi.searchCandidateAssetsForCannibalism, input);
    };
    ...
    LogisticsService.prototype.searchWarehouseCandidateAssets = function (input) {
        return _super.prototype.post.call(this, this.bidtProcurementRequestApi.searchWarehouseCandidateAssets, input);
    };
    ...
    LogisticsService.prototype.findBirePnMeasuresByPnCode = function (input) {
        return _super.prototype.post.call(this, this.productStructureManagementApi.findBirePnMeasuresByPnCode, input);
    };
    ...
    LogisticsService.prototype.findBireVersionPnsByFamilyAndVariantAndPnCode = function (input) {
        return _super.prototype.post.call(this, this.productStructureManagementApi.findBireVersionPnsByFamilyAndVariantAndPnCode, input);
    };
    /**************************************************************************
     * AM project management api
     *************************************************************************/
    ...
    LogisticsService.prototype.createBidoNotification = function (bidoNotificationDTO) {
        return _super.prototype.post.call(this, this.assetManagementApi.createBidoNotification, bidoNotificationDTO);
    };
    ...
    LogisticsService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"],
            ...
            _shared_api_product_structure_management_api__WEBPACK_IMPORTED_MODULE_19__["ProductStructureManagementApi"],
