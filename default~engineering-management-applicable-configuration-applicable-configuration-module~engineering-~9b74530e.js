(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~engineering-management-applicable-configuration-applicable-configuration-module~engineering-~9b74530e"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatusUpdateHistoryComponent", function() { return StatusUpdateHistoryComponent; });
...
/* harmony import */ var _enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../enums/table-column-filter-mode.enum */ "./src/app/shared/enums/table-column-filter-mode.enum.ts");
/* harmony import */ var _enums_table_selection_mode_enum__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../enums/table-selection-mode.enum */ "./src/app/shared/enums/table-selection-mode.enum.ts");
/* harmony import */ var _services_confirmation_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../services/confirmation.service */ "./src/app/shared/services/confirmation.service.ts");
/* harmony import */ var _services_date_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../services/date.service */ "./src/app/shared/services/date.service.ts");
...
/* harmony import */ var _services_properties_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../services/properties.service */ "./src/app/shared/services/properties.service.ts");
/* harmony import */ var _services_session_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../services/session.service */ "./src/app/shared/services/session.service.ts");
/* harmony import */ var _services_update_historic_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../services/update-historic.service */ "./src/app/shared/services/update-historic.service.ts");
/* harmony import */ var _utils_label_value_utils__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../utils/label-value-utils */ "./src/app/shared/utils/label-value-utils.ts");
...
var StatusUpdateHistoryComponent = /** @class */ (function (_super) {
    ...
    function StatusUpdateHistoryComponent(messageService, propertiesService, sessionService, updateHistoricService, confirmationService, translateService, dateService) {
        var _this = _super.call(this, _enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_5__["ComponentOpenMode"].Write, 'DialogStatusUpdateComponent') || this;
        ...
        _this.DATE_WITH_HOUR = _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_3__["AppConstants"].MOMENTJS_DATE_TIME;
        _this.tableColumnFilterMode = _enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_6__["TableColumnFilterMode"];
        _this.tableSelectionMode = _enums_table_selection_mode_enum__WEBPACK_IMPORTED_MODULE_7__["TableSelectionMode"];
    ...
    StatusUpdateHistoryComponent.prototype.loadTableRows = function () {
        ...
        if (!!this.tableData) {
            ...
            this.tableData.tableRows.subscribe(function (results) {
                _this.isLoading = false;
                _this.tableRows = results.list;
                _this.tableRows.forEach(function (element) {
                    _this.addMissingStatusLabel(element[statusState_1]);
                    if (!_utils_label_value_utils__WEBPACK_IMPORTED_MODULE_14__["LabelValueUtils"].stringValueToLabel(element, 'statusState', _this.statusList)) {
    ...
    StatusUpdateHistoryComponent.prototype.loadStatusList = function (statusState) {
        ...
        this.propertiesService
            .getObjectStatusList(this.isObjectTypeOfBireSbDTO, this.isObjectTypeOfBireEvolutionDTO, this.isObjectBireMaintenancePlanDTO, statusState, this.isSapSession)
            .subscribe(function (result) {
            result.forEach(function (element) {
                if (_this.statusList.filter(function (status) { return status.value === element.value; }).length === 0) {
            ...
            _this.tableRows.forEach(function (element) {
                _utils_label_value_utils__WEBPACK_IMPORTED_MODULE_14__["LabelValueUtils"].stringValueToLabel(element, 'statusState', _this.statusList);
            });
            _this.tableRows = __spread(_this.tableRows);
        }, function () {
    ...
    StatusUpdateHistoryComponent.prototype.addMissingStatusLabel = function (statusState) {
        if (statusState &&
            this.statusList &&
            !this.statusList.find(function (lv) { return lv.value === statusState; }) &&
    ...
    StatusUpdateHistoryComponent.prototype.deleteSelectedObjects = function () {
        ...
        this.confirmationService.confirmDelete({
            ...
            accept: function () {
                _this.updateHistoricService.removeUpdateHistory(_this.deleteApi, _this.selectedRows).subscribe(function (result) {
                    if (result) {
                        _this.loadTableRows();
                        _this.selectedRows = [];
                    }
    ...
    ], StatusUpdateHistoryComponent.prototype, "onUpdated", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('object'),
        __metadata("design:type", Object)
    ], StatusUpdateHistoryComponent.prototype, "object", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('data'),
        __metadata("design:type", Object)
    ], StatusUpdateHistoryComponent.prototype, "tableData", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('deleteApi'),
        __metadata("design:type", String)
    ], StatusUpdateHistoryComponent.prototype, "deleteApi", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('keyMap'),
        __metadata("design:type", Map)
    ], StatusUpdateHistoryComponent.prototype, "keyObservableMap", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('isStatusEditable'),
        __metadata("design:type", Boolean)
    ], StatusUpdateHistoryComponent.prototype, "isStatusEditable", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('isObjectTypeOfBireSbDTO'),
        __metadata("design:type", Boolean)
    ], StatusUpdateHistoryComponent.prototype, "isObjectTypeOfBireSbDTO", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('isObjectTypeOfBireEvolutionDTO'),
        __metadata("design:type", Boolean)
    ], StatusUpdateHistoryComponent.prototype, "isObjectTypeOfBireEvolutionDTO", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('isObjectBireMaintenancePlanDTO'),
        __metadata("design:type", Boolean)
    ], StatusUpdateHistoryComponent.prototype, "isObjectBireMaintenancePlanDTO", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('isSapSession'),
        __metadata("design:type", Boolean)
    ], StatusUpdateHistoryComponent.prototype, "isSapSession", void 0);
    StatusUpdateHistoryComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-status-update-history',
            template: __webpack_require__(/*! ./status-update-history.component.html */ "./src/app/shared/components/status-update-history/status-update-history.component.html"),
            styles: [__webpack_require__(/*! ./status-update-history.component.scss */ "./src/app/shared/components/status-update-history/status-update-history.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatusUpdateHistoryModule", function() { return StatusUpdateHistoryModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _status_update_history_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./status-update-history.component */ "./src/app/shared/components/status-update-history/status-update-history.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Components
 *************************************************************************** */
var COMPONENTS = [_status_update_history_component__WEBPACK_IMPORTED_MODULE_9__["StatusUpdateHistoryComponent"]];
