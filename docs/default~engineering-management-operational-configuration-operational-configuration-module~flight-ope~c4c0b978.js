      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var Slider = /** @class */ (function() {
          ...
          Slider.prototype.onTouchMove = function(event, index) {
            ...
            if (this.orientation === 'horizontal') {
              handleValue =
                Math.floor(((parseInt(touchobj.clientX, 10) - this.startx) * 100) / this.barWidth) +
                this.startHandleValue;
            } else {
              handleValue =
                Math.floor(((this.starty - parseInt(touchobj.clientY, 10)) * 100) / this.barHeight) +
                this.startHandleValue;
            }
          ...
          Slider.prototype.updateHandleValue = function() {
            if (this.range) {
              this.handleValues[0] =
                ((this.values[0] < this.min ? 0 : this.values[0] - this.min) * 100) / (this.max - this.min);
              this.handleValues[1] =
                ((this.values[1] > this.max ? 100 : this.values[1] - this.min) * 100) / (this.max - this.min);
            } else {
...
//# sourceMappingURL=default~engineering-management-operational-configuration-operational-configuration-module~flight-ope~c4c0b978.js.map
