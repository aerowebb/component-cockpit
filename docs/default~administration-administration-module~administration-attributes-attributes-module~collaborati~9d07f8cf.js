  ...
  \**********************************************************************/
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var OverlayPanel = /** @class */ (function() {
          ...
          OverlayPanel.prototype.onAnimationStart = function(event) {
            switch (event.toState) {
              case 'visible':
                ...
                if (
                  domhandler_1.DomHandler.getOffset(this.container).top <
                  domhandler_1.DomHandler.getOffset(this.target).top
                ) {
                  domhandler_1.DomHandler.addClass(this.container, 'ui-overlaypanel-flipped');
                }
                if (
                  domhandler_1.DomHandler.getOffset(this.container).left <
                    domhandler_1.DomHandler.getOffset(this.target).left &&
          ...
          __decorate([core_1.Input(), __metadata('design:type', Number)], OverlayPanel.prototype, 'baseZIndex', void 0);
          __decorate(
...
//# sourceMappingURL=default~administration-administration-module~administration-attributes-attributes-module~collaborati~9d07f8cf.js.map
