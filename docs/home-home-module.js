(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \*********************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_constants_menu_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_services_app_version_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ../../shared/services/app-version.service */ './src/app/shared/services/app-version.service.ts'
        );
        ...
        /* harmony import */ var _shared_types_generic_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
        ...
        /* harmony import */ var _menu_menu_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
        ...
        var HomeComponent = /** @class */ (function(_super) {
          ...
          HomeComponent.prototype.isFavoriteToOpen = function(favorite) {
            if (this.favoriteToOpen) {
              if (this.favoriteToOpen.objectId) {
                return (
                  favorite.componentId === this.favoriteToOpen.componentId &&
                  favorite.objectId === this.favoriteToOpen.objectId
                );
              } else {
          ...
          HomeComponent.prototype.toggleDefaultFavorite = function(selectedFavorite) {
            this.favorites.forEach(function(favorite) {
              return (favorite.shouldOpenAtStartup = false);
            });
            if (
              !!this.favoriteToOpen &&
          ...
          HomeComponent.prototype.formatFavoriteContext = function(favoriteEntry) {
            if (!!favoriteEntry.context) {
              this.translateService.get(favoriteEntry.context).subscribe(function(translatedValue) {
                favoriteEntry.formattedContext = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__[
                  'StringUtils'
                ].isNullOrEmpty(translatedValue)
          ...
          HomeComponent.prototype.getLogoUri = function(favoriteEntry) {
            var mainMenu =
              _shared_constants_menu_constants__WEBPACK_IMPORTED_MODULE_4__['MenuConstants'].COMPONENTS_ROOT[
                favoriteEntry.componentId
              ];
            switch (mainMenu) {
              ...
              case _shared_constants_menu_constants__WEBPACK_IMPORTED_MODULE_4__['MenuConstants']
                .MENU_COLLABORATIVE_COCKPIT:
          ...
          HomeComponent.prototype.setupObservables = function() {
            var _this = this;
            this.favoriteService.favoriteAdded$
            ...
            this.favoriteService.favoriteRemoved$
              .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['takeUntil'])(this.unsubscribe))
              .subscribe(
                function(result) {
          ...
          HomeComponent = HomeComponent_1 = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__['Component'])({
                animations: [
                  Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__['trigger'])('imgState', [
                    ...
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__['transition'])('hidden => visible', [
                  ...
                  Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__['trigger'])('mainContainerState', [
                    ...
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__['transition'])('hidden => visible', [
                      Object(_angular_animations__WEBPACK_IMPORTED_MODULE_0__['animate'])('1000ms')
                    ])
                  ])
                ],
                selector: 'aw-home',
              ...
              __metadata('design:paramtypes', [
                _shared_services_app_version_service__WEBPACK_IMPORTED_MODULE_6__['AppVersionService'],
  ...
  \******************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_angular_common_shared_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ../../shared/angular-common-shared.module */ './src/app/shared/angular-common-shared.module.ts'
        );
        /* harmony import */ var _shared_app_common_shared_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../../shared/app-common-shared.module */ './src/app/shared/app-common-shared.module.ts'
        );
        /* harmony import */ var _dynamic_component_loader_dynamic_component_loader_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        ...
        /* harmony import */ var _home_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./home.component */ './src/app/main/home/home.component.ts'
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
          function(decorators, target, key, desc) {
          ...
          HomeModule = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['NgModule'])({
                ...
                imports: [
                  _shared_angular_common_shared_module__WEBPACK_IMPORTED_MODULE_1__['AngularCommonSharedModule'],
                  _shared_app_common_shared_module__WEBPACK_IMPORTED_MODULE_2__['AppCommonSharedModule'],
                  _dynamic_component_loader_dynamic_component_loader_module__WEBPACK_IMPORTED_MODULE_3__[
                    'DynamicComponentLoaderModule'
