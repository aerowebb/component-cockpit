(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \****************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _main_maintenance_work_package_form_popups_dialog_work_order_edition_dialog_work_order_edition_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        ...
        /* harmony import */ var _services_session_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ../../services/session.service */ './src/app/shared/services/session.service.ts'
        );
        /* harmony import */ var _types_dialog_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
        ...
        /* harmony import */ var _utils_select_item_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
        ...
        /* harmony import */ var _dialog_work_package_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
        ...
        var DialogWorkPackageComponent = /** @class */ (function(_super) {
          ...
          function DialogWorkPackageComponent(
            sessionService,
          ...
          DialogWorkPackageComponent.prototype.isValid = function() {
            return (
              !_utils_string_utils__WEBPACK_IMPORTED_MODULE_12__['StringUtils'].isNullOrEmpty(
                this.workPackage.projectName
              ) &&
              !!this.workPackage.projectStartDate &&
              !!this.workPackage.projectType &&
              !_utils_string_utils__WEBPACK_IMPORTED_MODULE_12__['StringUtils'].isNullOrEmpty(
                this.workPackage.bireRepairCenterCode
              )
            );
          };
          DialogWorkPackageComponent.prototype.validate = function() {
            if (
              ...
              moment__WEBPACK_IMPORTED_MODULE_1__(this.workPackage.projectStartDate).isAfter(
                moment__WEBPACK_IMPORTED_MODULE_1__(this.workPackage.projectDueDate)
              )
            ) {
          ...
          this.mroCenterList = !!results ? SelectItemUtils.fromLabelValues(results) : [];
            ...
            this.dialogWorkPackageService.findAuthorizedBireSite().subscribe(function(results) {
              ...
              _this.mroCenterList = !!results
                ? _utils_select_item_utils__WEBPACK_IMPORTED_MODULE_11__['SelectItemUtils'].fromLabelValues(results)
                : [];
            });
          };
          DialogWorkPackageComponent.prototype.loadOperationList = function() {
            ...
            this.dialogWorkPackageService.findAllBidoOperation().subscribe(function(results) {
              _this.operationList = _utils_select_item_utils__WEBPACK_IMPORTED_MODULE_11__[
                'SelectItemUtils'
          ...
          DialogWorkPackageComponent.prototype.loadUserList = function() {
            ...
            this.dialogWorkPackageService
              ...
              .subscribe(function(results) {
                var resultUserList = _utils_list_utils__WEBPACK_IMPORTED_MODULE_10__['ListUtils']
                  .orEmpty(results)
                  .map(function(result) {
                    var userName =
          ...
          __decorate(
            ...
            DialogWorkPackageComponent.prototype,
            'displayAssignedTo',
            void 0
          );
          __decorate(
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./dialog-work-package.component.html */ './src/app/shared/components/dialog-work-package/dialog-work-package.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./dialog-work-package.component.scss */ './src/app/shared/components/dialog-work-package/dialog-work-package.component.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
                _services_session_service__WEBPACK_IMPORTED_MODULE_8__['SessionService'],
                ...
                _main_maintenance_work_package_form_popups_dialog_work_order_edition_dialog_work_order_edition_service__WEBPACK_IMPORTED_MODULE_2__[
                  'DialogWorkOrderEditService'
                ]
              ])
            ],
  ...
  \**************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var DialogWorkPackageService = /** @class */ (function(_super) {
          ...
          function DialogWorkPackageService(
            http,
            appConfigService,
            fleetManagementApi,
