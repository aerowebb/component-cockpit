(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \***************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _main_fleet_management_asset_search_asset_search_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../../../../main/fleet-management/asset/search/asset-search.service */ './src/app/main/fleet-management/asset/search/asset-search.service.ts'
        );
        ...
        /* harmony import */ var _form_popups_dialog_work_order_edition_dialog_work_order_edition_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
          /*! ../form/popups/dialog-work-order-edition/dialog-work-order-edition.service */ './src/app/main/maintenance/work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.service.ts'
        );
        /* harmony import */ var _work_package_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
          /*! ../work-package.service */ './src/app/main/maintenance/work-package/work-package.service.ts'
        );
        /* harmony import */ var _work_package_search_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
          /*! ./work-package-search.service */ './src/app/main/maintenance/work-package/search/work-package-search.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
          (function() {
        ...
        var WorkPackageSearchComponent = /** @class */ (function(_super) {
          ...
          /* ***************************************************************************/
          function WorkPackageSearchComponent(
            favoriteService,
            loaderService,
            messageService,
            ...
            _this.wpService.loadMROCenterList().subscribe(function(result) {
            ...
            _this.wpService
              ...
              .subscribe(function(r) {
                return (_this.typeList = r);
              });
            _this.wpService.loadOperationList().subscribe(function(result) {
              return (_this.operationList = result);
            });
            _this.wpService.loadUserList().subscribe(function(result) {
              return (_this.userList = result);
            });
            _this.wpSearchService.loadDateCriteriaList().subscribe(function(result) {
            ...
            var bireId = {
              attributeId: _shared_constants_bido_attribute_constants__WEBPACK_IMPORTED_MODULE_5__[
                'BidoAttributeConstants'
              ].ASSET_SYSTEM_SOURCE_ID.toString()
            };
            _this.assetSearchService.getAssetSourceSystemIdList(bireId).subscribe(
              function(results) {
          ...
          WorkPackageSearchComponent.prototype.checkPMRights = function() {
            ...
            this.wpSearchService
              .hasManagePMRights({
                useCaseCode:
                  _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_6__[
                    'BidoFunctionTypeConstants'
                  ].UC_AIRM_WP_MANAGEMENT
              })
              ...
              this.resultTable.list = result.list.map(function(workPackage) {
                var resultRow = {
                  ...
                  type: _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__[
                    'SelectItemUtils'
                  ].formatSelectItem(workPackage.projectType, _this.typeList),
                  asset: workPackage.assetName,
                  status: _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__[
                    'SelectItemUtils'
                  ].formatSelectItem(workPackage.statusState, _this.statusList),
                  mroCenter: _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__[
                    'SelectItemUtils'
                  ].formatSelectItem(workPackage.bireRepairCenterCode, _this.mroCenterList),
                  workshop: _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__[
                    'SelectItemUtils'
                  ].formatNumberSelectItem(workPackage.bidtWarehouseId, _this.workShopList),
                  assignedTo: _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__[
                    'SelectItemUtils'
                  ].formatSelectItem(workPackage.receivingAssignedTo, _this.userList),
                  operation: _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__[
                    'SelectItemUtils'
                  ].formatSelectItem(workPackage.bidoOperationCode, _this.operationList),
          ...
          WorkPackageSearchComponent.prototype.deleteWorkPackages = function() {
            ...
            var partialMessageKey =
              this.selectedWorkPackages.length > 1
                ? 'confirmDeleteSelectedWorkPackages'
                : 'confirmDeleteSelectedWorkPackage';
              ...
              accept: function() {
                var observables = _this.selectedWorkPackages
                  ...
                  .map(function(workPackage) {
                    return _this.wpSearchService.removeBidmProject({ projectId: workPackage.projectId });
                  });
                Object(rxjs__WEBPACK_IMPORTED_MODULE_2__['forkJoin'])(observables).subscribe(function() {
                  _this.messageService.showSuccessMessage(
                    _this.getTranslateKey(
                      _this.selectedWorkPackages.length > 1
                        ? 'successOnRemoveWorkPackages'
                        : 'successOnRemoveWorkPackage'
                    )
                  );
                  _this.selectedWorkPackages = [];
                  _this.search();
          ...
          WorkPackageSearchComponent.prototype.getWorkShops = function() {
            var _this = this;
            if (
              !!this.searchObject.bireRepairCenterCode &&
              !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_20__['StringUtils'].isEmpty(
                this.searchObject.bireRepairCenterCode
              )
            ) {
              this.dialogWorkOrderEditService
                .loadWarehouseList(this.searchObject.bireRepairCenterCode)
          ...
          __decorate(
            ...
            WorkPackageSearchComponent.prototype,
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./work-package-search.component.html */ './src/app/main/maintenance/work-package/search/work-package-search.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./work-package-search.component.scss */ './src/app/main/maintenance/work-package/search/work-package-search.component.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
                ...
                _main_fleet_management_asset_search_asset_search_service__WEBPACK_IMPORTED_MODULE_3__[
                  'AssetSearchService'
                ],
                _form_popups_dialog_work_order_edition_dialog_work_order_edition_service__WEBPACK_IMPORTED_MODULE_21__[
                  'DialogWorkOrderEditService'
                ]
              ])
            ],
