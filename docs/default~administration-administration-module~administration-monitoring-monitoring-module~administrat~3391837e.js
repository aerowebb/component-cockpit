      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var Dialog = /** @class */ (function() {
          ...
          Dialog.prototype.positionOverlay = function() {
            ...
            if (
              domhandler_1.DomHandler.getOuterHeight(this.container) +
                this.contentViewChild.nativeElement.scrollHeight -
                this.contentViewChild.nativeElement.clientHeight >
              viewport.height
            ) {
              this.contentViewChild.nativeElement.style.height = viewport.height * 0.75 + 'px';
          ...
          Dialog.prototype.toggleMaximize = function(event) {
            if (this.maximized) this.revertMaximize();
            else this.maximize();
            event.preventDefault();
          };
          ...
          Dialog.prototype.getFocusableElements = function() {
            var focusableElements = domhandler_1.DomHandler.find(
              this.container,
          ...
          __decorate(
            [core_1.ViewChild('titlebar'), __metadata('design:type', core_1.ElementRef)],
            Dialog.prototype,
            'headerViewChild',
            void 0
          );
          ...
          __decorate(
            [core_1.ViewChild('footer'), __metadata('design:type', core_1.ElementRef)],
            Dialog.prototype,
            'footerViewChild',
            void 0
          );
...
//# sourceMappingURL=default~administration-administration-module~administration-monitoring-monitoring-module~administrat~3391837e.js.map
