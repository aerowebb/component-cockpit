(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ['default~flight-operations-flight-flight-module~logistics-tools-maintenance-planning-tools-maintenanc~ae8e1aae'],
  {
  ...
  \*************************************************************************************/
    ...
    /***/ './src/app/shared/components/work-package-list/work-package-list.component.html':
      /*!**************************************************************************************!*\
  !*** ./src/app/shared/components/work-package-list/work-package-list.component.html ***!
  \**************************************************************************************/
      /*! no static exports found */
      /***/ function(module, exports) {
        module.exports =
          '<div class="content">\r\n  <div\r\n    class="card"\r\n    *ngFor="let workPackage of formattedWorkPackageList; let i = index"\r\n    [pTooltip]="workPackage.tooltip"\r\n    tooltipPosition="top"\r\n    [escape]="false"\r\n  >\r\n    <div>\r\n      <a (click)="openWorkPackage(workPackage)">{{ workPackage.projectNumber }}</a>\r\n    </div>\r\n    <div>{{ workPackage.status }}</div>\r\n    <div>{{ workPackage.date }}</div>\r\n\r\n    <div class="action-list">\r\n      <i\r\n        *ngIf="addToVisible"\r\n        class="fa fa-fw fa-link aw-icon"\r\n        aria-hidden="true"\r\n        (click)="addToWorkPackage(workPackage)"\r\n      ></i>\r\n\r\n      <i\r\n        *ngIf="removeVisible"\r\n        class="fa fa-fw fa-trash aw-icon"\r\n        aria-hidden="true"\r\n        (click)="removeWorkPackage(workPackage)"\r\n      ></i>\r\n    </div>\r\n  </div>\r\n</div>\r\n';

        /***/
      },

    /***/ './src/app/shared/components/work-package-list/work-package-list.component.scss':
      /*!**************************************************************************************!*\
  !*** ./src/app/shared/components/work-package-list/work-package-list.component.scss ***!
  \**************************************************************************************/
      /*! no static exports found */
  ...
  \************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ../../constants/bido-function-type-constants */ './src/app/shared/constants/bido-function-type-constants.ts'
        );
        /* harmony import */ var _constants_component_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
        ...
        /* harmony import */ var _services_bidm_project_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
        ...
        /* harmony import */ var _services_serialization_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ../../services/serialization.service */ './src/app/shared/services/serialization.service.ts'
        );
        /* harmony import */ var _services_tab_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! ../../services/tab.service */ './src/app/shared/services/tab.service.ts'
        );
        /* harmony import */ var _types_generic_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ../../types/generic-component */ './src/app/shared/types/generic-component.ts'
        );
        /* harmony import */ var _utils_list_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! ../../utils/list-utils */ './src/app/shared/utils/list-utils.ts'
        );
        /* harmony import */ var _utils_string_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! ../../utils/string-utils */ './src/app/shared/utils/string-utils.ts'
        );
        /* harmony import */ var _work_package_list_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
          /*! ./work-package-list.service */ './src/app/shared/components/work-package-list/work-package-list.service.ts'
        );
        var __extends =
        ...
        var WorkPackageListComponent = /** @class */ (function(_super) {
          __extends(WorkPackageListComponent, _super);
          function WorkPackageListComponent(
            bidmProjectService,
            dateService,
            workPackageListService,
            propertiesService,
            ...
            _this.workPackageListService = workPackageListService;
          ...
          Object.defineProperty(WorkPackageListComponent.prototype, 'workPackageList', {
            get: function() {
          ...
          WorkPackageListComponent.prototype.getComponentName = function() {
            return 'WorkPackageListComponent';
          };
          WorkPackageListComponent.prototype.addToWorkPackage = function(workPackage) {
            this.onAddTo.emit(workPackage._obj);
          };
          WorkPackageListComponent.prototype.openWorkPackage = function(workPackage) {
            var data = {
              id: this.tabService.generateId(),
              componentId:
                _constants_component_constants__WEBPACK_IMPORTED_MODULE_2__['ComponentConstants'].MAI_WORK_PACKAGE_FORM,
              openMode: _enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__['ComponentOpenMode'].Read,
              objectId: this.serializationService.serialize({ wpId: workPackage._obj.projectId })
            };
            var labelKey = 'transaction.' + data.componentId;
            this.tabService.open(this.tabService.create(data, labelKey, true));
          };
          WorkPackageListComponent.prototype.removeWorkPackage = function(workPackage) {
            this.onRemove.emit(workPackage._obj);
          };
          WorkPackageListComponent.prototype.formatWorkPackgeList = function(workPackageList) {
            var _this = this;
            return workPackageList.map(function(workPackage) {
              var selectedStatus = _this.workPackageStatusList.find(function(status) {
                return status.value === workPackage.statusState;
              });
              return {
                date: _this.dateService.dateToString(workPackage.projectStartDate),
                projectNumber: 'WP n\u00B0 ' + workPackage.projectNumber,
                status: !!selectedStatus ? selectedStatus.label : '',
                tooltip: _this.bidmProjectService.getRepresentationAsHtml(
                  workPackage,
                  _this.mroCenterList,
          ...
          WorkPackageListComponent.prototype.init = function() {
            this.addToVisible = false;
            this.removeVisible = false;
            this.formattedWorkPackageList = [];
            this.workPackageStatusList = [];
            this.onAddTo = new _angular_core__WEBPACK_IMPORTED_MODULE_0__['EventEmitter']();
            this.onRemove = new _angular_core__WEBPACK_IMPORTED_MODULE_0__['EventEmitter']();
          };
          WorkPackageListComponent.prototype.loadMroCenterList = function() {
            var _this = this;
            this.workPackageListService.findAllMroCenter().subscribe(function(results) {
              _this.mroCenterList = _utils_list_utils__WEBPACK_IMPORTED_MODULE_11__['ListUtils'].orEmpty(results);
            });
          };
          WorkPackageListComponent.prototype.loadTypeList = function() {
            var _this = this;
            this.propertiesService
              ...
              .subscribe(function(results) {
                _this.typeList = _utils_list_utils__WEBPACK_IMPORTED_MODULE_11__['ListUtils'].orEmpty(results);
              });
          };
          WorkPackageListComponent.prototype.loadUserList = function() {
            var _this = this;
            this.workPackageListService
              .findBidoUsersWithUseCase(
                _constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_1__['BidoFunctionTypeConstants']
                  .UC_AIRM_RECEPTION
              )
              .subscribe(function(results) {
                _this.userList = _utils_list_utils__WEBPACK_IMPORTED_MODULE_11__['ListUtils']
                  .orEmpty(results)
                  .filter(function(elt) {
                    return !_utils_string_utils__WEBPACK_IMPORTED_MODULE_12__['StringUtils'].isNullOrEmpty(elt.userId);
                  })
                  .map(function(result) {
                    var userName =
                      _utils_string_utils__WEBPACK_IMPORTED_MODULE_12__['StringUtils'].orEmpty(result.firstname) +
                      ' ' +
                      _utils_string_utils__WEBPACK_IMPORTED_MODULE_12__['StringUtils'].orEmpty(result.lastname);
                    return {
                      label: userName.trim(),
                      value: result.userId
                    };
          ...
          __decorate(
            ...
            WorkPackageListComponent.prototype,
            'addToVisible',
            void 0
          );
          __decorate(
          ...
          WorkPackageListComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                selector: 'aw-work-package-list',
                template: __webpack_require__(
                  /*! ./work-package-list.component.html */ './src/app/shared/components/work-package-list/work-package-list.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./work-package-list.component.scss */ './src/app/shared/components/work-package-list/work-package-list.component.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
                _services_bidm_project_service__WEBPACK_IMPORTED_MODULE_5__['BidmProjectService'],
                _services_date_service__WEBPACK_IMPORTED_MODULE_6__['DateService'],
                _work_package_list_service__WEBPACK_IMPORTED_MODULE_13__['WorkPackageListService'],
                _services_properties_service__WEBPACK_IMPORTED_MODULE_7__['PropertiesService'],
                _services_serialization_service__WEBPACK_IMPORTED_MODULE_8__['SerializationService'],
                _services_tab_service__WEBPACK_IMPORTED_MODULE_9__['TabService']
              ])
            ],
            WorkPackageListComponent
          );
          return WorkPackageListComponent;
        })(_types_generic_component__WEBPACK_IMPORTED_MODULE_10__['GenericComponent']);

        /***/
      },

    /***/ './src/app/shared/components/work-package-list/work-package-list.module.ts':
      /*!*********************************************************************************!*\
  !*** ./src/app/shared/components/work-package-list/work-package-list.module.ts ***!
  \*********************************************************************************/
      /*! exports provided: WorkPackageListModule */
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'WorkPackageListModule', function() {
          return WorkPackageListModule;
        });
        /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! @angular/core */ './node_modules/@angular/core/fesm5/core.js'
        );
        ...
        /* harmony import */ var _work_package_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ./work-package-list.component */ './src/app/shared/components/work-package-list/work-package-list.component.ts'
        );
        /* harmony import */ var _work_package_list_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ./work-package-list.service */ './src/app/shared/components/work-package-list/work-package-list.service.ts'
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
         ...
         * Components
         *************************************************************************** */
        var COMPONENTS = [_work_package_list_component__WEBPACK_IMPORTED_MODULE_5__['WorkPackageListComponent']];
        /******************************************************************************
         * Services
         *************************************************************************** */
        var SERVICES = [_work_package_list_service__WEBPACK_IMPORTED_MODULE_6__['WorkPackageListService']];
        var WorkPackageListModule = /** @class */ (function() {
          function WorkPackageListModule() {}
          WorkPackageListModule = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['NgModule'])({
                declarations: __spread(COMPONENTS),
                exports: __spread(COMPONENTS),
    ...
    /***/ './src/app/shared/components/work-package-list/work-package-list.service.ts':
      /*!**********************************************************************************!*\
  !*** ./src/app/shared/components/work-package-list/work-package-list.service.ts ***!
  \**********************************************************************************/
      /*! exports provided: WorkPackageListService */
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'WorkPackageListService', function() {
          return WorkPackageListService;
        });
        ...
        /* harmony import */ var _api_bidt_site_api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../../api/bidt-site.api */ './src/app/shared/api/bidt-site.api.ts'
        );
        ...
        var WorkPackageListService = /** @class */ (function(_super) {
          __extends(WorkPackageListService, _super);
          function WorkPackageListService(http, appConfigService, bidtSiteApi, userProfileManagementApi) {
...
//# sourceMappingURL=default~flight-operations-flight-flight-module~logistics-tools-maintenance-planning-tools-maintenanc~ae8e1aae.js.map
