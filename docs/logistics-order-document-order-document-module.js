(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ['logistics-order-document-order-document-module'],
  {
          ...
          function DialogBusinessPartnerBidoDocumentComponent(sessionService) {
            var _this =
              _super.call(
                ...
                'DialogOrderDocBidtDocumentComponent'
              ) || this;
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./dialog-business-partner-bido-document.component.html */ './src/app/main/logistics/order-document/dialog-business-partner-bido-document/dialog-business-partner-bido-document.component.html'
                )
              }),
  ...
  \**********************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _form_order_document_form_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ../form/order-document-form.service */ './src/app/main/logistics/order-document/form/order-document-form.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
          (function() {
        ...
        var DialogMaterialAndServicesComponent = /** @class */ (function(_super) {
            ...
            if (!!this.pnCode) {
              this.orderDocumentFormService.displayWarehouse(this.pnCode).subscribe(function(results) {
                ...
                if (!_this.newObj && !!_this.obj.warehouse) {
                  _this.obj.warehouse = _this.warehouses.filter(function(ware) {
                    return ware.label === _this.obj.warehouse;
                  })[0].value;
                }
              });
            }
            ...
            this.orderDocumentFormService.findBirePn(input).subscribe(function(result) {
              if (
                ...
                (_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_1__['AWPropertiesConstants']
                  .PN_TRACEABILITY_BY_SN === result.traceability ||
                  _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_1__['AWPropertiesConstants']
                    .PN_TRACEABILITY_BY_PACKAGING_BATCH_AND_SN === result.traceability)
              ) {
              ...
              if (
                !!result &&
                (_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_1__['AWPropertiesConstants']
                  .PN_TRACEABILITY_BY_BATCH === result.traceability ||
                  _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_1__['AWPropertiesConstants']
                    .PN_TRACEABILITY_BY_PACKAGING_BATCH_AND_SN === result.traceability)
              ) {
          ...
          DialogMaterialAndServicesComponent.prototype.updateBidtStockMvtDTO = function() {
            ...
            if (!!this.obj.bidtStockMvtDTO) {
              ...
              if (!!this.obj.warehouse) {
                ...
                this.obj.warehouse = this.warehouses.filter(function(ware) {
                  return ware.value === _this.obj.warehouse;
                })[0].label;
              }
          ...
          __decorate(
            ...
            DialogMaterialAndServicesComponent.prototype,
            'category',
            void 0
          );
          __decorate(
          ...
          DialogMaterialAndServicesComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./dialog-material-and-services.component.html */ './src/app/main/logistics/order-document/dialog-material-and-services/dialog-material-and-services.component.html'
                )
              }),
              __metadata('design:paramtypes', [
  ...
  \*************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_utils_label_value_utils__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
        ...
        /* harmony import */ var _search_order_document_search_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
          /*! ../search/order-document-search.service */ './src/app/main/logistics/order-document/search/order-document-search.service.ts'
        );
        /* harmony import */ var _order_document_form_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
          /*! ./order-document-form.service */ './src/app/main/logistics/order-document/form/order-document-form.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
          (function() {
        ...
        var OrderDocumentFormComponent = /** @class */ (function(_super) {
          ...
          function OrderDocumentFormComponent(
            favoriteService,
            loaderService,
            messageService,
          ...
          OrderDocumentFormComponent.prototype.ngOnInit = function() {
            ...
            if (!!this.componentData) {
              ...
              if (!!this.pageId) {
                ...
                this.mainData.prStatus =
                  this.mainData.prStatus ||
                  _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__['AWPropertiesConstants']
                    .PURCHASE_STATUS_OPEN;
          ...
          OrderDocumentFormComponent.prototype.setPageContext = function(objectId) {
            ...
            supplierInfo =
              ...
              !!this.serializationService.deserialize(this.componentData.objectId).supplier
          ...
          OrderDocumentFormComponent.prototype.fetchTypeDropdownData = function() {
            ...
            if (!!this.mainData.prCategory) {
              this.orderDocumentSearchService
                .findTypeBasedOnCategory(this.mainData.prCategory)
                .subscribe(function(results) {
          ...
          OrderDocumentFormComponent.prototype.loadConsecutiveTypeOptions = function() {
            ...
            if (!!this.consecutiveCategory) {
              this.orderDocumentSearchService
                .findTypeBasedOnCategory(this.consecutiveCategory)
                .subscribe(function(results) {
          ...
          OrderDocumentFormComponent.prototype.loadOrderDoc = function() {
            ...
            if (!!this.pageId) {
              this.orderDocumentFormService.getById(this.pageId).subscribe(function(result) {
                ...
                var componentData = _this.serializationService.serialize(
                  _this.getOrderDocRow(result.bidtPurchaseRequestDTO)
                );
                ...
                _this.materialsAndServicesTable.forEach(function(ms) {
                  if (!!ms.bidtStockMvtDTO && !!ms.bidtStockMvtDTO.byQuotation) {
                    ms.byQuotation =
                      ms.bidtStockMvtDTO.byQuotation === 1
                        ? true
                        : ms.bidtStockMvtDTO.byQuotation === 0
                        ? false
                        : undefined;
                  }
                  if (!!ms.pnText) {
                ...
                _this.databaseMSTable = Object(lodash_es__WEBPACK_IMPORTED_MODULE_2__['cloneDeep'])(
                  _this.materialsAndServicesTable
                );
                _this.materialsAndServicesTable.forEach(function(ms) {
                ...
                _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_20__['ListUtils']
                  .orEmpty(result.documentTablist)
          ...
          OrderDocumentFormComponent.prototype.goToDocument = function(id) {
            ...
            if (!!id) {
              this.orderDocumentFormService.getById(id).subscribe(function(res) {
                ...
                _shared_utils_label_value_utils__WEBPACK_IMPORTED_MODULE_19__['LabelValueUtils'].stringValueToLabel(
                  input,
                  'category',
          ...
          OrderDocumentFormComponent.prototype.formatDocExtension = function(document) {
            return _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_18__['FileUtils']
          ...
          OrderDocumentFormComponent.prototype.formatDocSize = function(document) {
            return !!document.documentContent
              ? _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_18__['FileUtils'].getFormattedSize(
          ...
          OrderDocumentFormComponent.prototype.createMaterial = function() {
            ...
            this.currentMSObject = Object(lodash_es__WEBPACK_IMPORTED_MODULE_2__['cloneDeep'])(
          ...
          OrderDocumentFormComponent.prototype.navigateToSelectedSectionFromSummary = function(
            anchorId,
            elementRef,
            event
          ) {
            ...
            if (!this.mainData.prCategory || !this.mainData.prType) {
              ...
              this.materialsAndServicesTable.forEach(function(ms) {
                if (!!ms.bidtStockMvtDTO) {
                  var updating = _this.databaseMSTable.some(function(dms) {
                    return (
                      !!dms.bidtStockMvtDTO && !!ms.bidtStockMvtDTO && dms.bidtStockMvtDTO.id === ms.bidtStockMvtDTO.id
                    );
                  });
          ...
          OrderDocumentFormComponent.prototype.enableDocumentCreation = function() {
            ...
            response =
              _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__['AWPropertiesConstants']
                .PURCHASE_STATUS_ACCEPTED === this.backupMainData.prStatus &&
              (_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__['AWPropertiesConstants']
                .PURCHASE_CATEGORY_REQUEST === this.backupMainData.prCategory ||
                _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__['AWPropertiesConstants']
                  .PURCHASE_CATEGORY_QUOTATION === this.backupMainData.prCategory ||
                _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__['AWPropertiesConstants']
                  .PURCHASE_CATEGORY_ORDER === this.backupMainData.prCategory)
                ? true
                : false;
            return response;
          };
          OrderDocumentFormComponent.prototype.priceVisibility = function() {
            ...
            response =
              _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__['AWPropertiesConstants']
                .PURCHASE_CATEGORY_REQUEST === this.mainData.prCategory
                ? false
                : true;
            return response;
          };
          OrderDocumentFormComponent.prototype.logisticVisibility = function() {
            ...
            response =
              _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__['AWPropertiesConstants']
                .PURCHASE_CATEGORY_CONTRACT === this.mainData.prCategory
                ? false
                : true;
            return response;
          };
            ...
            this.selectedMaterials.forEach(function(material) {
              _this.materialsAndServicesTable = _this.materialsAndServicesTable.filter(function(ms) {
                return (
                  ...
                  ms.bidtStockMvtDTO.id !== material.bidtStockMvtDTO.id
                );
              });
                  ...
                  if (!!_this.pageId) {
                    ...
                    _this.orderDocumentFormService.getById(_this.pageId).subscribe(function(r) {
                      ...
                      _this.orderDocumentFormService.getById(result).subscribe(function(res) {
                        ...
                        _shared_utils_label_value_utils__WEBPACK_IMPORTED_MODULE_19__[
                          'LabelValueUtils'
                        ].stringValueToLabel(newPageInput, 'category', _this.categoryOptions);
                        _shared_utils_label_value_utils__WEBPACK_IMPORTED_MODULE_19__[
                          'LabelValueUtils'
                        ].stringValueToLabel(newPageInput, 'type', _this.typeOptions);
                      });
                    });
                  }
                });
            ...
            if (!!row.bidtStockMvtDTO) {
              ...
              this.orderDocumentFormService.getEuipmentBYpnAndSN(input).subscribe(function(result) {
                if (!!result) {
                  if (
                    _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__['AWPropertiesConstants']
                      .ITEM_FAMILY_CODE_AIRCRAFT_KEY === result[0].equipmentFunction
                  ) {
                    _this.goToAircraft(
                      result[0].equipmentCode,
                      _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_7__['ComponentOpenMode'].Read
                    );
                  } else if (
                    _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__['AWPropertiesConstants']
                      .ITEM_FAMILY_CODE_ENGINE_KEY === result[0].equipmentFunction
                  ) {
                    _this.goToEngine(
                      result[0].equipmentCode,
                      _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_7__['ComponentOpenMode'].Read
                    ...
                    _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__['AWPropertiesConstants']
                      .ITEM_FAMILY_CODE_TOOL_KEY === result[0].equipmentFunction
                  ) {
                    _this.goToTools(
                      result[0].equipmentCode,
                      _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_7__['ComponentOpenMode'].Read
                            ...
                            next: function(listPc) {
                              for (var index = 0; index < listPc.length; index++) {
                                ...
                                if (
                                  _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__[
                                    'AWPropertiesConstants'
                                  ].PN_TRACEABILITY_BY_SN !== pn.traceability &&
                                  ...
                                  row.quantity = _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_21__[
                                    'NumberUtils'
                                  ].fromString(pcData.productQuantity);
                                }
                                // price
                                if (
                                  pcData.priceValue &&
                                  ...
                                  row.totalPrice = _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_21__[
                                    'NumberUtils'
                                  ].fromString(pcData.priceValue);
                                }
                                // lead time
                                if (
                                  _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_22__['ObjectUtils'].isDefined(
                                    pcData.numberOfDays
                                  ) &&
                                  pcData.numberOfDays > 0
                                ) {
          ...
          __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['ViewChild'])(
                OrderDocumentFormComponent_1.MAIN_ANCHOR_ID
              ),
              __metadata('design:type', _angular_core__WEBPACK_IMPORTED_MODULE_0__['ElementRef'])
            ],
            OrderDocumentFormComponent.prototype,
          ...
          __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['ViewChild'])(
                OrderDocumentFormComponent_1.ADDITIONAL_ANCHOR_ID
              ),
              __metadata('design:type', _angular_core__WEBPACK_IMPORTED_MODULE_0__['ElementRef'])
            ],
            OrderDocumentFormComponent.prototype,
          ...
          __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['ViewChild'])(
                OrderDocumentFormComponent_1.MS_ANCHOR_ID
              ),
              __metadata('design:type', _angular_core__WEBPACK_IMPORTED_MODULE_0__['ElementRef'])
            ],
            OrderDocumentFormComponent.prototype,
          ...
          __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['ViewChild'])(
                OrderDocumentFormComponent_1.CONSECUTIVE_ANCHOR_ID
              ),
              __metadata('design:type', _angular_core__WEBPACK_IMPORTED_MODULE_0__['ElementRef'])
            ],
            OrderDocumentFormComponent.prototype,
          ...
          __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['ViewChild'])(
                OrderDocumentFormComponent_1.DOCUMENTS_ANCHOR_ID
              ),
              __metadata('design:type', _angular_core__WEBPACK_IMPORTED_MODULE_0__['ElementRef'])
            ],
            OrderDocumentFormComponent.prototype,
          ...
          OrderDocumentFormComponent = OrderDocumentFormComponent_1 = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./order-document-form.component.html */ './src/app/main/logistics/order-document/form/order-document-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./order-document-form.component.scss */ './src/app/main/logistics/order-document/form/order-document-form.component.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
  ...
  \************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'OrderDocumentModule', function() {
        ...
        /* harmony import */ var _shared_components_dialog_search_purchase_request_dialog_search_purchase_request_module__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
        ...
        /* harmony import */ var _dialog_business_partner_bido_document_dialog_business_partner_bido_document_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
          /*! ./dialog-business-partner-bido-document/dialog-business-partner-bido-document.component */ './src/app/main/logistics/order-document/dialog-business-partner-bido-document/dialog-business-partner-bido-document.component.ts'
        );
        /* harmony import */ var _dialog_material_and_services_dialog_material_and_services_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
          /*! ./dialog-material-and-services/dialog-material-and-services.component */ './src/app/main/logistics/order-document/dialog-material-and-services/dialog-material-and-services.component.ts'
        );
        /* harmony import */ var _form_order_document_form_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
          /*! ./form/order-document-form.component */ './src/app/main/logistics/order-document/form/order-document-form.component.ts'
        );
        /* harmony import */ var _form_order_document_form_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
          /*! ./form/order-document-form.service */ './src/app/main/logistics/order-document/form/order-document-form.service.ts'
        );
        /* harmony import */ var _search_order_document_search_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
          /*! ./search/order-document-search.component */ './src/app/main/logistics/order-document/search/order-document-search.component.ts'
        );
        /* harmony import */ var _search_order_document_search_service__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
          /*! ./search/order-document-search.service */ './src/app/main/logistics/order-document/search/order-document-search.service.ts'
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
        ...
        var INTERNAL_MODULES = [
          ...
          _shared_components_dialog_search_purchase_request_dialog_search_purchase_request_module__WEBPACK_IMPORTED_MODULE_18__[
         ...
         *************************************************************************** */
        var COMPONENTS = [
          _dialog_business_partner_bido_document_dialog_business_partner_bido_document_component__WEBPACK_IMPORTED_MODULE_22__[
            'DialogBusinessPartnerBidoDocumentComponent'
          ],
        ...
        var DYNAMIC_COMPONENTS = [
          _form_order_document_form_component__WEBPACK_IMPORTED_MODULE_24__['OrderDocumentFormComponent'],
          _search_order_document_search_component__WEBPACK_IMPORTED_MODULE_26__['OrderDocumentSearchComponent']
        ];
        /******************************************************************************
         * Services
         *************************************************************************** */
        var SERVICES = [
          _form_order_document_form_service__WEBPACK_IMPORTED_MODULE_25__['OrderDocumentFormService'],
          _search_order_document_search_service__WEBPACK_IMPORTED_MODULE_27__['OrderDocumentSearchService']
        ];
  ...
  \*****************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _order_document_search_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
          /*! ./order-document-search.service */ './src/app/main/logistics/order-document/search/order-document-search.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
          (function() {
        ...
        var OrderDocumentSearchComponent = /** @class */ (function(_super) {
          ...
          /* ***************************************************************************/
          function OrderDocumentSearchComponent(
            favoriteService,
            loaderService,
            messageService,
            serializationService,
          ...
          OrderDocumentSearchComponent.prototype.exportTable = function() {
            this.exportService.toExcel(
              ...
              OrderDocumentSearchComponent_1.ORDER_DOCUMENT_TABLE_EXPORT_NAME,
              this.componentData.componentId
            );
          };
          OrderDocumentSearchComponent.prototype.openNewOrderDocument = function() {
            this.openOrderDocument(
              undefined,
          ...
          OrderDocumentSearchComponent.prototype.loadOrderDocumentCategories = function() {
            ...
            this.propertiesService
              ...
              .subscribe(function(results) {
                _this.orderDocumentCategories = !!results
          ...
          OrderDocumentSearchComponent.prototype.loadOrderDocumentStatus = function() {
            ...
            this.propertiesService
              ...
              .subscribe(function(results) {
                _this.orderDocumentStatus = !!results
                  ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_16__['SelectItemUtils'].fromLabelValues(
                      results
                    )
                  : [];
          ...
          OrderDocumentSearchComponent.prototype.loadOrderDocumentTypes = function() {
            ...
            if (category !== null && category !== undefined) {
              this.orderDocumentSearchService.findTypeBasedOnCategory(category).subscribe(function(results) {
                _this.orderDocumentTypes = !!results
                  ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_16__['SelectItemUtils'].fromLabelValues(
                      results
                    )
                  : [];
          ...
          OrderDocumentSearchComponent.prototype.loadOrderDocumentSupplierCodes = function() {
            var _this = this;
            this.orderDocumentSearchService.findBidoCustomerBySearchCriteriaOrder().subscribe(function(results) {
              _this.orderDocumentSuppliers = !!results
                ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_16__['SelectItemUtils'].fromLabelValues(
                    results
                  )
                : [];
          ...
          OrderDocumentSearchComponent.prototype.openSuperiorOrderDocument = function(object) {
            if (!!object) {
              var superiorRow = this.orderDocumentTable.list.filter(function(doc) {
                return doc.code === object.superiorDocument;
              })[0];
              this.openOrderDocument(
                superiorRow,
                _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__['ComponentOpenMode'].Read
          ...
          __decorate(
            ...
            OrderDocumentSearchComponent.prototype,
          ...
          OrderDocumentSearchComponent = OrderDocumentSearchComponent_1 = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./order-document-search.component.html */ './src/app/main/logistics/order-document/search/order-document-search.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./order-document-search.component.scss */ './src/app/main/logistics/order-document/search/order-document-search.component.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
