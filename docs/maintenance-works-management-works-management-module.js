(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ['maintenance-works-management-works-management-module'],
  {
  ...
  \*******************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_services_page_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
          /*! ../../../../shared/utils/select-item-utils */ './src/app/shared/utils/select-item-utils.ts'
        );
        /* harmony import */ var _works_management_form_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
          /*! ./works-management-form.service */ './src/app/main/maintenance/works-management/form/works-management-form.service.ts'
        );
        var __extends =
        ...
        var WorksManagementFormComponent = /** @class */ (function(_super) {
          ...
          function WorksManagementFormComponent(
            favoriteService,
            loaderService,
            messageService,
            ...
            workOrderList.forEach(function(worksManagement) {
              worksManagement.worksManagementInformationDTOs.forEach(function(worksManagementInformation) {
                ...
                if (workOrder.woCode) {
                  ...
                  jobCardRow.wpProgressPercent =
                    (worksManagement.nbCloseWorkOrders / worksManagement.nbTotalWorkOrders) * cent;
                  ...
                  jobCardRow.assetRepresentation = worksManagementInformation.woEquipmentDTO
                    ? _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_15__['BidoEquipmentUtils'].toString(
                  ...
                  jobCardRow.asset = worksManagementInformation.woEquipmentDTO
                    ? worksManagementInformation.woEquipmentDTO
                    : worksManagementInformation.wpEquipmentDTO;
                  jobCardRow.progressStatus = workOrder.calculatedStatus
                    ? workOrder.calculatedStatus.slice(2)
                    : undefined;
                  jobCardRow.assignedTo = _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_17__[
                    'SelectItemUtils'
                  ].formatSelectItem(jobCardRow.workOrderDTO.woAssignedTo, _this.userList);
                  ...
                  if (_this.worksManagementTable.length > 1) {
                    _this.worksManagementTable.sort(function(a, b) {
          ...
          WorksManagementFormComponent.prototype.initializeSearchCriteria = function(jobCardRow) {
            ...
            if (jobCardRow.wpEquipementDTO) {
              if (
                ...
                this.searchWPAssetList.push({
                  label: _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_15__[
                    'BidoEquipmentUtils'
              ...
              this.searchWPAssetList.sort(
                _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_17__['SelectItemUtils'].labelSorter
              );
            }
            ...
            if (
              ...
              this.searchUserList.push({
                label: _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_17__[
                  'SelectItemUtils'
          ...
          WorksManagementFormComponent.prototype.manageButtonDisplay = function() {
            ...
            if (this.selectedWorkOrders.length > 0) {
              ...
              this.selectedWorkOrders.forEach(function(row) {
                if (
                  row.workOrderDTO.calculatedStatus ===
                  _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__['AWPropertiesConstants']
                  ...
                  if (row.workOrderStatusDetailDTO.isCritical && row.workOrderStatusDetailDTO.bidmOperationDataList) {
                    if (
                      row.workOrderStatusDetailDTO.bidmOperationDataList.filter(function(ope) {
                        return (
                          ope.opeStatus !==
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./works-management-form.component.html */ './src/app/main/maintenance/works-management/form/works-management-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./works-management-form.component.scss */ './src/app/main/maintenance/works-management/form/works-management-form.component.scss'
                  )
                ]
              }),
  ...
  \*****************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_utils_array_utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
        ...
        var WorksManagementFormService = /** @class */ (function(_super) {
          ...
          function WorksManagementFormService(
            http,
            appConfigService,
            propertiesService,
              ...
              Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__['map'])(function(results) {
                return !!results
                  ? results
                      ...
                      .sort(
                        _shared_utils_array_utils__WEBPACK_IMPORTED_MODULE_10__['ArrayUtils'].compareValues('label')
                      )
                  : [];
              })
            );
  ...
  \*******************************************************************************************************************************/
      ...
      /***/ function(module, exports) {
        module.exports =
          ':host .action-list {\n  justify-content: flex-end; }\n  :host .action-list .aw-btn {\n    margin-left: 8px; }\n  :host .action-list .aw-btn:first-of-type {\n      margin-left: 0; }\n\n/*# sourceMappingURL=data:application/json;base64, */';
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var WorksManagementTableFiltersComponent = /** @class */ (function(_super) {
          ...
          __decorate(
            ...
            WorksManagementTableFiltersComponent.prototype,
            'searchStatusList',
            void 0
          );
          __decorate(
          ...
          WorksManagementTableFiltersComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./works-management-table-filters.component.html */ './src/app/main/maintenance/works-management/works-management-table-filter/works-management-table-filters.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./works-management-table-filters.component.scss */ './src/app/main/maintenance/works-management/works-management-table-filter/works-management-table-filters.component.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
  ...
  \******************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'WorksManagementModule', function() {
        ...
        /* harmony import */ var _form_works_management_form_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
          /*! ./form/works-management-form.component */ './src/app/main/maintenance/works-management/form/works-management-form.component.ts'
        );
        /* harmony import */ var _form_works_management_form_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
          /*! ./form/works-management-form.service */ './src/app/main/maintenance/works-management/form/works-management-form.service.ts'
        );
        /* harmony import */ var _works_management_table_filter_works_management_table_filters_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
          /*! ./works-management-table-filter/works-management-table-filters.component */ './src/app/main/maintenance/works-management/works-management-table-filter/works-management-table-filters.component.ts'
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
          function(decorators, target, key, desc) {
         ...
         *************************************************************************** */
        var COMPONENTS = [
          _works_management_table_filter_works_management_table_filters_component__WEBPACK_IMPORTED_MODULE_17__[
            'WorksManagementTableFiltersComponent'
          ]
        ];
        var DYNAMIC_COMPONENTS = [
          _form_works_management_form_component__WEBPACK_IMPORTED_MODULE_15__['WorksManagementFormComponent']
        ];
        /******************************************************************************
         * Services
         *************************************************************************** */
        var SERVICES = [
          _form_works_management_form_service__WEBPACK_IMPORTED_MODULE_16__['WorksManagementFormService'],
