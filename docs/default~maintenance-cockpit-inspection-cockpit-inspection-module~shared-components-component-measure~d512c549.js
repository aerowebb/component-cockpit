(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _constants_app_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
        ...
        /* harmony import */ var _constants_control_config_constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
        ...
        /* harmony import */ var _services_favorite_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! ../../services/favorite.service */ './src/app/shared/services/favorite.service.ts'
        );
        /* harmony import */ var _services_loader_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ../../services/loader.service */ './src/app/shared/services/loader.service.ts'
        );
        /* harmony import */ var _services_message_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! ../../services/message.service */ './src/app/shared/services/message.service.ts'
        );
        /* harmony import */ var _services_serialization_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! ../../services/serialization.service */ './src/app/shared/services/serialization.service.ts'
        );
        /* harmony import */ var _services_tab_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
          /*! ../../services/tab.service */ './src/app/shared/services/tab.service.ts'
        );
        /* harmony import */ var _types_page_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
          /*! ../../types/page-component */ './src/app/shared/types/page-component.ts'
        );
        /* harmony import */ var _component_measure_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
          /*! ./component-measure.service */ './src/app/shared/components/component-measure/component-measure.service.ts'
        );
        var __extends =
        ...
        var ComponentMeasureComponent = /** @class */ (function(_super) {
          ...
          function ComponentMeasureComponent(
            favoriteService,
            loaderService,
            messageService,
            ...
            _this.TABLE_PAGINATION_DEFAULT_ROWS =
              _constants_app_constants__WEBPACK_IMPORTED_MODULE_4__['AppConstants'].TABLE_PAGINATION_DEFAULT_ROWS;
            return _this;
          }
          ...
          ComponentMeasureComponent.prototype.init = function() {
            ...
            this.componentMeasureService
              .findFirstBidoEquipmentsByPnAndSnCodes(this.bidoEquipmentDTO)
          ...
          ComponentMeasureComponent.prototype.getComponentName = function() {
            return _constants_component_constants__WEBPACK_IMPORTED_MODULE_5__['ComponentConstants']
            ...
            this.componentMeasureService
              ...
              .pipe(
                Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['finalize'])(function() {
                  return (_this.isLoadingMeasureTable = false);
                })
              )
                    ...
                    .forEach(function(res) {
                      if (res && res._obj && res._obj.bidoEquipmentCounterDto) {
                        ...
                        if (setUpCounters_1.indexOf(counterCode) < 0) {
                          ...
                          observables_1.push(
                            _this.componentMeasureService.getMeasureDetailTableData(bidoEquipmentCounterDTOId)
                          );
                ...
                .forEach(function(element) {
                  ...
                  if (getFirstElement) {
                    ...
                    var datasetObj_1 = {
                      data: data,
                      label:
                        getFirstElement.counterCode === _this.tsnLabel
          ...
          ComponentMeasureComponent.prototype.setTableDynamicHeaders = function() {
            ...
            if (
              ...
              this.componentMeasureService
                .isFollowedInRating(this.equipment.bidoEquipmentDTO.familyVariantCode)
                .subscribe(
                  function(results) {
                    _this.followedInRatingVisibility = results;
                    var checkRatingExists = _this.bidoMeasuresDisplayed.filter(function(obj) {
                      return !!obj.counterCode
                        ? _this.getRatingDataVisibility(_this.counterMap.get(obj.counterCode))
                        : false;
                    })[0];
          ...
          ComponentMeasureComponent.prototype.setMeasureChartOptions = function() {
            this.measureChartOptions = {
              ...
              tooltips: {
                bodyFontColor:
                  _constants_app_constants__WEBPACK_IMPORTED_MODULE_4__['AppConstants'].COLOR_BACKGROUND_PRIMARY
              }
            };
          };
          ...
          ComponentMeasureComponent.prototype.getColorByIconCode = function(iconCode) {
            switch (iconCode) {
              case _constants_control_config_constants__WEBPACK_IMPORTED_MODULE_6__['ControlConfigConstants']
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./component-measure.component.html */ './src/app/shared/components/component-measure/component-measure.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./component-measure.component.scss */ './src/app/shared/components/component-measure/component-measure.component.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
                _services_favorite_service__WEBPACK_IMPORTED_MODULE_9__['FavoriteService'],
  ...
  \*********************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'ComponentMeasureModule', function() {
        ...
        /* harmony import */ var _main_dynamic_component_loader_dynamic_component_loader_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
        ...
        /* harmony import */ var _dialog_table_dialog_table_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ../dialog-table/dialog-table.module */ './src/app/shared/components/dialog-table/dialog-table.module.ts'
        );
        /* harmony import */ var _component_measure_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! ./component-measure.component */ './src/app/shared/components/component-measure/component-measure.component.ts'
        );
        /* harmony import */ var _component_measure_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! ./component-measure.service */ './src/app/shared/components/component-measure/component-measure.service.ts'
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['NgModule'])({
                ...
                imports: __spread(
                  ...
                  INTERNAL_MODULES,
                  [
                    _main_dynamic_component_loader_dynamic_component_loader_module__WEBPACK_IMPORTED_MODULE_7__[
  ...
  \**********************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _api_asset_management_api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../../api/asset-management.api */ './src/app/shared/api/asset-management.api.ts'
        );
        /* harmony import */ var _api_fleet_business_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../../api/fleet-business.api */ './src/app/shared/api/fleet-business.api.ts'
        );
        /* harmony import */ var _api_fleet_management_api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ../../api/fleet-management.api */ './src/app/shared/api/fleet-management.api.ts'
        );
        /* harmony import */ var _api_product_structure_business_api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ../../api/product-structure-business.api */ './src/app/shared/api/product-structure-business.api.ts'
        );
        /* harmony import */ var _api_product_structure_management_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ../../api/product-structure-management.api */ './src/app/shared/api/product-structure-management.api.ts'
        );
        /* harmony import */ var _http_abstract_aw_http__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ../../http/abstract-aw-http */ './src/app/shared/http/abstract-aw-http.ts'
        );
        /* harmony import */ var _services_app_config_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
        ...
        var ComponentMeasureService = /** @class */ (function(_super) {
          ...
          function ComponentMeasureService(
            http,
            appConfigService,
            assetManagementApi,
