(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \**************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'FlightSchedulingModule', function() {
        ...
        /* harmony import */ var primeng_components_table_table__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! primeng/components/table/table */ './node_modules/primeng/components/table/table.js'
        );
        /* harmony import */ var primeng_components_table_table__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/ __webpack_require__.n(
          primeng_components_table_table__WEBPACK_IMPORTED_MODULE_3__
        );
        ...
        /* harmony import */ var primeng_primeng__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! primeng/primeng */ './node_modules/primeng/primeng.js'
        );
        /* harmony import */ var primeng_primeng__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/ __webpack_require__.n(
        ...
        /* harmony import */ var _shared_components_dialog_search_customer_dialog_search_customer_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_components_scheduler_scheduler_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
        ...
        /* harmony import */ var _form_flight_scheduling_form_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
          /*! ./form/flight-scheduling-form.component */ './src/app/main/flight-operations/flight-scheduling/form/flight-scheduling-form.component.ts'
        );
        /* harmony import */ var _form_flight_scheduling_form_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
          /*! ./form/flight-scheduling-form.service */ './src/app/main/flight-operations/flight-scheduling/form/flight-scheduling-form.service.ts'
        );
        /* harmony import */ var _search_flight_scheduling_search_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
          /*! ./search/flight-scheduling-search.component */ './src/app/main/flight-operations/flight-scheduling/search/flight-scheduling-search.component.ts'
        );
        /* harmony import */ var _search_flight_scheduling_search_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
          /*! ./search/flight-scheduling-search.service */ './src/app/main/flight-operations/flight-scheduling/search/flight-scheduling-search.service.ts'
        );
        var __decorate =
         ...
         *************************************************************************** */
        var PRIMENG_MODULES = [
          primeng_components_table_table__WEBPACK_IMPORTED_MODULE_3__['TableModule'],
         ...
         *************************************************************************** */
        var SERVICES = [
          _form_flight_scheduling_form_service__WEBPACK_IMPORTED_MODULE_14__['FlightSchedulingFormService'],
          _search_flight_scheduling_search_service__WEBPACK_IMPORTED_MODULE_16__['FlightSchedulingSearchService']
        ];
              ...
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__['NgModule'])({
                ...
                imports: __spread(
                  [
                    ...
                    _shared_components_dialog_search_customer_dialog_search_customer_module__WEBPACK_IMPORTED_MODULE_10__[
  ...
  \***************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var bryntum_scheduler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        ...
        /* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! moment */ './node_modules/moment/moment.js'
        );
        /* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/ __webpack_require__.n(
          moment__WEBPACK_IMPORTED_MODULE_5__
        );
        /* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_components_scheduler_scheduler_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
        ...
        /* harmony import */ var _flight_scheduling_form_service__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
          /*! ./flight-scheduling-form.service */ './src/app/main/flight-operations/flight-scheduling/form/flight-scheduling-form.service.ts'
        );
        var __extends =
        ...
        var FlightSchedulingFormComponent = /** @class */ (function(_super) {
          ...
          function FlightSchedulingFormComponent(
            favoriteService,
            loaderService,
            messageService,
          ...
          FlightSchedulingFormComponent.prototype.registerSchedulerTimeResolutionObservable = function() {
            ...
            this.schedulerTimeResolutionChanged
              .pipe(
                Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__['distinctUntilChanged'])(),
          ...
          FlightSchedulingFormComponent.prototype.recursiveFind = function(resourcesMissionNameSearched, id) {
            var resourceModelFound = resourcesMissionNameSearched.find(function(resource) {
          ...
          FlightSchedulingFormComponent.prototype.registerSchedulerListeners = function() {
            var _this = this;
            bryntum_scheduler__WEBPACK_IMPORTED_MODULE_3__['EventHelper'].addListener(
          ...
          FlightSchedulingFormComponent.prototype.configureEventSelectedColorAndButtons = function(event, eventRecord) {
            ...
            if (!!flightOutputData) {
              ...
              var previousEventSelectedFoundInEventsList = this.events.find(function(anEvent) {
                return !!_this.previousEventSelected && anEvent.id === _this.previousEventSelected.id;
              });
              if (!!previousEventSelectedFoundInEventsList) {
                var previousResource = this.recursiveFind(
              ...
              var eventSelected = this.events.find(function(anEvent) {
                return anEvent.id === event[eventRecord].data.id;
              });
          ...
          FlightSchedulingFormComponent.prototype.setSchedulerDate = function() {
            this.schedulerConfig = __assign({}, this.schedulerConfig, {
              startDate: moment__WEBPACK_IMPORTED_MODULE_5__()
                .startOf('year')
                .toDate(),
              endDate: moment__WEBPACK_IMPORTED_MODULE_5__()
                .endOf('year')
                .toDate()
            });
          };
              ...
              columns: [
                {
                  ...
                  renderer: function(_a) {
                    ...
                    return (
                      ...
                      record.data.id +
                      ' class=' +
                      FlightSchedulingFormComponent_1.MISSION_NAME_CLASS +
                      '>\n                    ' +
          ...
          FlightSchedulingFormComponent.prototype.buildSchedulerEventFromResource = function(parentResource, resource) {
            ...
            for (var i = 0; i < resource.children.length; i++) {
              returnArray.push.apply(
                returnArray,
                __spread(this.buildSchedulerEventFromResource(resource, resource.children[i]))
              );
            }
            return returnArray;
          };
          ...
          FlightSchedulingFormComponent.prototype.buildSchedulerResourceList = function(wsTreeNodes) {
            var _this = this;
            this.resourcesMissionName = wsTreeNodes.map(function(wsTreeNode) {
              return _this.buildSchedulerResourceFromFleet(wsTreeNode);
            });
          };
          FlightSchedulingFormComponent.prototype.buildSchedulerResourceFromFleet = function(wsTreeNode) {
            ...
            return {
              ...
              children: !!wsTreeNode.children
                ? wsTreeNode.children.map(function(childElement) {
                    return _this.buildSchedulerResourceFromFleet(childElement);
                  })
                : []
            };
          };
          ...
          FlightSchedulingFormComponent.prototype.ngAfterViewInit = function() {
            ...
            if (
              ...
              _shared_constants_lang_constants__WEBPACK_IMPORTED_MODULE_13__['LangConstants'].FRENCH_CODE
            ) {
          ...
          FlightSchedulingFormComponent.prototype.updateFlightScheduleDates = function() {
            ...
            if (currentTimeZoneValue !== previousTimezoneValue) {
                    ...
                    if (!!rowData && !!rowData.date) {
                      ...
                      for (var i = 0; i < startDates.length; i++) {
                        startDates[i] = new Date(
                          _this.updateFlightScheduleDate(gap_1, isGapPositive_1, '' + startDates[i])
                        ).toISOString();
                        endDates[i] = new Date(
                          _this.updateFlightScheduleDate(gap_1, isGapPositive_1, '' + endDates[i])
                        ).toISOString();
              ...
              this.previousTimezone = Object(lodash_es__WEBPACK_IMPORTED_MODULE_4__['cloneDeep'])(
          ...
          FlightSchedulingFormComponent.prototype.loadTimeZoneList = function() {
            ...
            this.propertiesService.getTimeZones().subscribe(function(results) {
              ...
              _this.propertiesService.getDefaultTimeZoneCode().subscribe(function(result) {
                ...
                _this.previousTimezone = Object(lodash_es__WEBPACK_IMPORTED_MODULE_4__['cloneDeep'])(
                  _this.timeZoneSelected
                );
              });
            });
          };
            ...
            if (!!rowData) {
              if (!!rowData.missionCode) {
                ...
                switch (equipmentFunction) {
                  case _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_10__['AWPropertiesConstants']
          ...
          FlightSchedulingFormComponent.prototype.getCellColor = function(rowData, colName) {
            var cellSelectedCheck =
              JSON.stringify(rowData) === JSON.stringify(this.cellSelected) &&
              this.colsSelected.some(function(col) {
                return col === colName;
              });
              ...
              for (var i = 0; i < startDates.length; i++) {
                ...
                if (condition) {
                  formattedStartDate = this.dateService.dateWitCustomFormatToString(
                    ...
                    _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_9__['AppConstants'].MOMENTJS_DATE_TIME
                  );
          ...
          FlightSchedulingFormComponent.prototype.setTreeTableCols = function() {
            ...
            for (var i = 1; i <= this.noOfDateToDisplay; i++) {
              this.treeTableCols.push({
                field: '' + this.dateService.dateToString(date),
                width: '6%',
                alignment: 'left'
              });
          ...
          FlightSchedulingFormComponent.prototype.isCellColourable = function(rowData, colName) {
            ...
            if (!!rowData && !!rowData.equiFunction) {
              // aircraft
              var indexInTreeTable = this.treeTable.findIndex(function(row) {
                return '' + row.data.equipmentCode === rowData.equipmentCode;
              });
              var children = this.treeTable[indexInTreeTable].children;
              if (!!children) {
                return children.some(function(child) {
                  return _this.isCellColourable(child.data, colName);
                });
              }
            } else {
              // flight
          ...
          FlightSchedulingFormComponent.prototype.addFlight = function() {
            if (
              !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_26__['StringUtils'].isNullOrEmpty(this.colClicked)
            ) {
              ...
              var data = {
                ...
                openMode:
                  _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_14__['ComponentOpenMode'].Create
              };
            ...
            this.confirmationService.confirmDelete({
              ...
              accept: function() {
                if (
                  ...
                  _this.flightSchedulingFormService
                    .removeBidoMissionEquipment(missionEquipmentId)
                    .subscribe(function() {
          ...
          __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__['ViewChild'])(
                _shared_components_scheduler_scheduler_component__WEBPACK_IMPORTED_MODULE_8__['SchedulerComponent']
              ),
              __metadata(
                'design:type',
                _shared_components_scheduler_scheduler_component__WEBPACK_IMPORTED_MODULE_8__['SchedulerComponent']
            ...
            FlightSchedulingFormComponent.prototype,
            'scheduler',
            void 0
          );
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./flight-scheduling-form.component.html */ './src/app/main/flight-operations/flight-scheduling/form/flight-scheduling-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./flight-scheduling-form.component.scss */ './src/app/main/flight-operations/flight-scheduling/form/flight-scheduling-form.component.scss'
                  )
                ]
              }),
  ...
  \*******************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _flight_scheduling_search_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ./flight-scheduling-search.service */ './src/app/main/flight-operations/flight-scheduling/search/flight-scheduling-search.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
          (function() {
        ...
        var FlightSchedulingSearchComponent = /** @class */ (function(_super) {
          ...
          function FlightSchedulingSearchComponent(
            favoriteService,
            loaderService,
            messageService,
            serializationService,
          ...
          FlightSchedulingSearchComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./flight-scheduling-search.component.html */ './src/app/main/flight-operations/flight-scheduling/search/flight-scheduling-search.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./flight-scheduling-search.component.scss */ './src/app/main/flight-operations/flight-scheduling/search/flight-scheduling-search.component.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
