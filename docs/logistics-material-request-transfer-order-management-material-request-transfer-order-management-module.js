(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \*********************************************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_constants_bidt_stock_mvt_type_constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
        ...
        /* harmony import */ var _material_request_transfer_order_management_form_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
          /*! ./material-request-transfer-order-management-form.service */ './src/app/main/logistics/material-request-transfer-order-management/form/material-request-transfer-order-management-form.service.ts'
        );
        var __extends =
        ...
        var MaterialRequestTransferOrderManagementFormComponent = /** @class */ (function(_super) {
          ...
          function MaterialRequestTransferOrderManagementFormComponent(
            favoriteService,
            loaderService,
            messageService,
            ...
            logisticsService,
            propertiesService,
            materialRequestTransferOrderFormService
          ) {
            var _this =
              _super.call(
                this,
            ...
            _this.componentOpenMode =
              _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_9__['ComponentOpenMode'];
            ...
            _this.propertiesService
              ...
              .subscribe(function(statusList) {
                _this.statusList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_20__['ListUtils']
                  .orEmpty(statusList)
                  .sort(function(s1, s2) {
            ...
            _this.propertiesService
              ...
              .subscribe(function(statusList) {
                _this.equipmentStatusList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_20__['ListUtils']
                  .orEmpty(statusList)
                  .sort(function(s1, s2) {
                    return s1.label.localeCompare(s2.label);
                  });
            ...
            _this.materialRequestTransferOrderFormService.getOperationalStatusMap(' ').subscribe(function(statusList) {
              _this.equipmentStatusListFilter = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_20__['ListUtils']
                .orEmpty(statusList)
                .sort(function(s1, s2) {
                  return s1.label.localeCompare(s2.label);
                });
            ...
            _this.materialRequestTransferOrderFormService.findAllSite().subscribe({
              next: function(sites) {
                _this.siteList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_20__['ListUtils']
                  .orEmpty(sites)
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.load = function() {
            ...
            if (!this.isCreateOpenMode && this.componentData.objectId) {
              var _a = this.serializationService.deserialize(this.componentData.objectId),
                torId = _a.torId,
                torItemId_1 = _a.torItemId;
              this.materialRequestTransferOrderFormService.findTransferOrderById(torId).subscribe(function(ftor) {
                _this.transferOrder = ftor.bidtTransferOrder;
                if (!!_this.transferOrder.bidtTorItems) {
                  var tempSelectedTorItem = _this.transferOrder.bidtTorItems.find(function(item) {
                    return item.id === torItemId_1;
                  });
                ...
                if (_this.transferOrder.statusUser) {
                  _this.materialRequestTransferOrderFormService
                    .findUser(_this.transferOrder.statusUser)
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.openManufacturingBatch = function(
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.calculateSituation = function() {
            var stockMvts = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_20__['ListUtils']
              .orEmpty(this.selectedTorItem.pickingMovements)
            ...
            this.transferedStockMvts = stockMvts.filter(function(stockMvt) {
              return (
                stockMvt.mvtStatus ===
                _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__['AWPropertiesConstants']
            ...
            this.receivedNb = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_20__['ListUtils']
              .orEmpty(this.selectedTorItem.pickingMovements)
              .filter(function(stockMvt) {
                return (
                  stockMvt.stockMvtWay ===
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.loadPreemptionRight = function(candidateAsset) {
            ...
            if (candidateAsset.stockInformation && candidateAsset.stockInformation.siteId) {
              this.materialRequestTransferOrderFormService
                ...
                .pipe(
                  Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__['concatMap'])(function(site) {
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.sortCandidateAssets = function(
            candidateAssets
          ) {
            var _this = this;
              ...
              if (_this.isCandidateAssetServed(c1) && !_this.isCandidateAssetServed(c2)) {
                ...
                if (
                  ...
                  if (r1 > r2) {
                    ...
                    var e1 = c1.equipment
                      ? _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(c1.equipment.sn)
                      : '';
                    var e2 = c2.equipment
                      ? _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(c2.equipment.sn)
                      : '';
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.satifactoryRateSameSiteFilterCriteria = function(
            elt
          ) {
            return (
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.satisfactoryRateAvailableAtDateCriteria = function(
            elt
          ) {
            return (
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.statifactoryRateBookingStatusCriteria = function(
            elt
          ) {
            return (
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.satisfactoryRateNoUnconfirmedFailureCriteria = function(
            elt
          ) {
            return (
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.formatEquipmentStatus = function(statusValue) {
            ...
            return matchingStatus
              ? _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(matchingStatus.label)
              : '';
          };
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.formatQuantity = function(quantity) {
            return quantity
              ? _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_21__['NumberUtils']
                  .roundNumber(
                    _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_21__['NumberUtils'].fromString(quantity),
                    2
                  )
                  .toString()
              : '';
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.formatPotential = function(potential) {
            return potential
              ? _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_21__['NumberUtils']
                  .roundNumber(
                    _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_21__['NumberUtils'].fromString(potential),
                    2
                  )
                  .toString()
              : '';
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.isAvailableAtDate = function(candidateAsset) {
            return !_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_22__['ObjectUtils'].isDefined(
              candidateAsset.plannedAvailabilityDate
            );
          };
          MaterialRequestTransferOrderManagementFormComponent.prototype.calculateSatisfactionRate = function(
            candidateAsset
          ) {
            var rates = [];
            ...
            return _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_21__['NumberUtils'].roundNumber(
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.formatSite = function(siteCode) {
            ...
            return matchingSite
              ? _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(matchingSite.siteName)
              : '';
          };
          MaterialRequestTransferOrderManagementFormComponent.prototype.openSatisfactionRateDetails = function(
            candidateAsset
          ) {
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.openProcurementRequest = function(
            procurementRequest
          ) {
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.bookCandidateAsset = function(candidateAsset) {
            ...
            if (candidateAsset.equipment) {
              ...
              this.logisticsService
                .bookCandidateAssetByTorItem({
                  quantity: quantity,
                  candidateAsset: candidateAsset,
                  bidtTorItem: this.selectedTorItem
                })
                .pipe(
                  Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__['finalize'])(function() {
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.confirmPreemptCandidateAsset = function(
            candidateAsset
          ) {
            var _this = this;
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.preemptCandidateAsset = function(
            candidateAsset
          ) {
            var _this = this;
            if (candidateAsset.equipment) {
              ...
              var quantity = candidateAsset.equipment.sn
                ...
                : Math.min(this.notSelectedNb, candidateAsset.equipment.quantity || 0).toString();
              this.logisticsService
                .preemptCandidateAssetByTorItem({
                  quantity: quantity,
                  candidateAsset: candidateAsset,
                  bidtTorItem: this.selectedTorItem
                })
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.isCancelBookingBtnVisible = function(
            candidateAsset
          ) {
            return (
                ...
                .some(function(stockMvt) {
                  return (
                    ...
                    (stockMvt.bidtStockMvtTypeId ===
                      _shared_constants_bidt_stock_mvt_type_constants__WEBPACK_IMPORTED_MODULE_6__[
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.isCandidateAssetServed = function(
            candidateAsset
          ) {
            return (
              !!candidateAsset.equipment &&
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.loadWareHouses = function(
            siteId,
            warehouseCategory
          ) {
          ...
          MaterialRequestTransferOrderManagementFormComponent.prototype.getBookedQty = function(candidateAsset) {
            if (candidateAsset.transferOrder && candidateAsset.transferOrder.bidtTorItems) {
              ...
              if (matchingStockMvt) {
                return _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./material-request-transfer-order-management-form.component.html */ './src/app/main/logistics/material-request-transfer-order-management/form/material-request-transfer-order-management-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ../shared/style.scss */ './src/app/main/logistics/material-request-transfer-order-management/shared/style.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
                ...
                _material_request_transfer_order_management_form_service__WEBPACK_IMPORTED_MODULE_25__[
  ...
  \*******************************************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_api_bidt_transfer_order_api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_api_user_profile_business_api__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! ../../../../shared/api/user-profile-business.api */ './src/app/shared/api/user-profile-business.api.ts'
        );
        /* harmony import */ var _shared_api_user_profile_management_api__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
        ...
        var MaterialRequestTransferOrderManagementFormService = /** @class */ (function(_super) {
          ...
          function MaterialRequestTransferOrderManagementFormService(
            http,
            appConfigService,
            bidtSiteApi,
          ...
          MaterialRequestTransferOrderManagementFormService.prototype.fetchTypeList = function() {
            return _super.prototype.post.call(this, this.bidtDfTypeApi.findShipmentDfTypes).pipe(
              Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__['map'])(function(dfTypes) {
  ...
  \***********************************************************************************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../../../../../../shared/utils/number-utils */ './src/app/shared/utils/number-utils.ts'
        );
        ...
        var DialogSatisfactionRateTransferOrderComponent = /** @class */ (function(_super) {
          ...
          DialogSatisfactionRateTransferOrderComponent.prototype.isAvailableAtDate = function() {
            return !_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_4__['ObjectUtils'].isDefined(
          ...
          DialogSatisfactionRateTransferOrderComponent.prototype.calculateSatisfactionRate = function() {
            ...
            this.bookingStatus =
              !_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_4__['ObjectUtils'].isDefined(
                this.candidateAsset.transferOrder
            ...
            rate(this.sameSite);
            this.noUnconfirmedFailure = !_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_4__[
              'ObjectUtils'
            ].isDefined(this.candidateAsset.unconfirmedFailure);
            rate(this.noUnconfirmedFailure);
            // tslint:disable-next-line:no-magic-numbers
            return _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_3__['NumberUtils'].roundNumber(
              (rates.filter(function(value) {
                return value === 1;
              }).length /
                rates.length) *
          ...
          __decorate(
            ...
            DialogSatisfactionRateTransferOrderComponent.prototype,
            'candidateAsset',
            void 0
          );
          __decorate(
          ...
          DialogSatisfactionRateTransferOrderComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./dialog-satisfaction-rate-transfer-order.component.html */ './src/app/main/logistics/material-request-transfer-order-management/form/popups/dialog-satisfaction-rate-transfe-order/dialog-satisfaction-rate-transfer-order.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./dialog-satisfaction-rate-transfer-order.component.scss */ './src/app/main/logistics/material-request-transfer-order-management/form/popups/dialog-satisfaction-rate-transfe-order/dialog-satisfaction-rate-transfer-order.component.scss'
                  ),
                  __webpack_require__(
                    /*! ../../../shared/style.scss */ './src/app/main/logistics/material-request-transfer-order-management/shared/style.scss'
                  )
  ...
  \********************************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _form_material_request_transfer_order_management_form_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
          /*! ./form/material-request-transfer-order-management-form.component */ './src/app/main/logistics/material-request-transfer-order-management/form/material-request-transfer-order-management-form.component.ts'
        );
        /* harmony import */ var _form_material_request_transfer_order_management_form_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
          /*! ./form/material-request-transfer-order-management-form.service */ './src/app/main/logistics/material-request-transfer-order-management/form/material-request-transfer-order-management-form.service.ts'
        );
        /* harmony import */ var _form_popups_dialog_satisfaction_rate_transfe_order_dialog_satisfaction_rate_transfer_order_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
         ...
         *************************************************************************** */
        var COMPONENTS = [
          _form_popups_dialog_satisfaction_rate_transfe_order_dialog_satisfaction_rate_transfer_order_component__WEBPACK_IMPORTED_MODULE_26__[
            'DialogSatisfactionRateTransferOrderComponent'
          ]
        ];
        var DYNAMIC_COMPONENTS = [
          _form_material_request_transfer_order_management_form_component__WEBPACK_IMPORTED_MODULE_24__[
            'MaterialRequestTransferOrderManagementFormComponent'
          ]
        ];
        /******************************************************************************
        ...
        var SERVICES = [
          ...
          _form_material_request_transfer_order_management_form_service__WEBPACK_IMPORTED_MODULE_25__[
            'MaterialRequestTransferOrderManagementFormService'
          ]
        ];
