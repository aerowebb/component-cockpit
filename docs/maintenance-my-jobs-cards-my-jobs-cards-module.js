(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ['maintenance-my-jobs-cards-my-jobs-cards-module'],
  {
  ...
  \*************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_services_file_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
        ...
        /* harmony import */ var _my_jobs_cards_form_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
          /*! ./my-jobs-cards-form.service */ './src/app/main/maintenance/my-jobs-cards/form/my-jobs-cards-form.service.ts'
        );
        var __extends =
        ...
        var MyJobsCardsFormComponent = /** @class */ (function(_super) {
          ...
          function MyJobsCardsFormComponent(
            favoriteService,
            loaderService,
            messageService,
          ...
          MyJobsCardsFormComponent.prototype.init = function() {
            ...
            this.myJobsCardsFormService
              ...
              .subscribe(function(result) {
                return (_this.searchTypeList = result);
              });
            this.myJobsCardsFormService
              .loadGenProps(
                _shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__['GenericPropertyConstants']
              ...
              .subscribe(function(result) {
                return (_this.searchStatusList = result);
              });
          ...
          MyJobsCardsFormComponent.prototype.getWorkOrders = function() {
            ...
            if (this.sessionService.loggedUser) {
              ...
              if (this.hasQualityCheckAuthorization) {
                this.criteriaStatusList.push(
                  _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__['AWPropertiesConstants']
                    .AIRM_OPERATION_STATUS_TO_BE_CONFIRMED
                );
              }
              this.myJobsCardsFormService
                .findBidoUserByLogin(this.sessionService.loggedUser.login)
          ...
          MyJobsCardsFormComponent.prototype.setWorkOrdersRows = function(workOrderList) {
            ...
            workOrderList.forEach(function(workOrder) {
              if (workOrder.woCode) {
                ...
                _this.myJobsCardsFormService
                  .calculateWorkOrderStatus(workOrderDetailInput)
                  .subscribe(function(statusOutput) {
                    if (
                      statusOutput.workOrderDetail.status !==
                        _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_2__['AWPropertiesConstants']
                          .AIRM_OPERATION_STATUS_CLOSE &&
                      jobCardRow_1.workOrderDTO.projectId
                    ) {
                      _this.myJobsCardsFormService
                        .findBidmProjectById(jobCardRow_1.workOrderDTO.projectId)
                        .subscribe(function(project) {
                          if (project.assetCode) {
                            ...
                            _this.myJobsCardsFormService
                              .findBidoEquipmentById(bidoEquipementId)
                              .subscribe(function(wpEquipement) {
                                var bidoEquipement = {
                                      ...
                                      _this.myJobsCardsFormService
                                        ...
                                        .subscribe(function(workOrderData) {
                                          workOrderData.forEach(function(woData) {
                                            if (
                                              woData.woAssignedTo === jobCardRow_1.workOrderDTO.woAssignedTo &&
                                              ...
                                              if (statusOutput.workOrderDetail.status) {
                                                ...
                                                jobCardRow_1.progressStatus = statusOutput.workOrderDetail.status.slice(
                                                  2
                                                );
                                                jobCardRow_1.assignedTo = _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__[
                                                  'SelectItemUtils'
                                                ].formatSelectItem(woData.woAssignedTo, _this.userList);
                                                ...
                                                if (_this.jobCardTable.length > 1) {
                                                  _this.jobCardTable.sort(function(a, b) {
                                                    return a.woCodeNumber - b.woCodeNumber;
                                                  });
                                                }
                                              }
                                            }
                  ...
                  this.fileService
                    ...
                    .subscribe(function(illustrationDocument) {
                      if (illustrationDocument) {
                        jobCardRow.materialIllustration = _this.fileService.sanitizeAndGetBase64Prefix(
          ...
          MyJobsCardsFormComponent.prototype.printAllJobsCards = function() {
            ...
            this.myJobsCardsFormService.generateJobcards(jobcardIdList).subscribe({
              next: function(jobcard) {
                _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_17__['FileUtils'].downloadFile(
                  jobcard.fileContent,
                  jobcard.fileName
                );
                _this.showSaveSpinner = false;
          ...
          MyJobsCardsFormComponent.prototype.openItem = function(objectId, openMode) {
            var data = {
              id: this.tabService.generateId(),
              componentId:
                _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_5__['ComponentConstants'].ENG_ITEM_FORM,
              openMode: openMode
            };
            if (!!objectId) {
              var itemFormId = {
              ...
              this.myJobsCardsFormService
                ...
                .subscribe(function(result) {
                  if (
                    ...
                    if (
                      _shared_constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_3__['BidoEvolutionConstants']
          ...
          MyJobsCardsFormComponent.prototype.initializeSearchCriteria = function(jobCardRow) {
            ...
            if (jobCardRow.wpEquipementDTO) {
              if (
                this.searchWPAssetList.filter(function(item) {
                  return jobCardRow.wpEquipementDTO && item.value === jobCardRow.wpEquipementDTO.equipmentCode;
                }).length === 0
              ) {
                this.searchWPAssetList.push({
                  label: _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_16__[
                    'BidoEquipmentUtils'
                  ].toString(jobCardRow.wpEquipementDTO),
                  value: jobCardRow.wpEquipementDTO.equipmentCode
                });
              }
              this.searchWPAssetList.sort(
                _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__['SelectItemUtils'].labelSorter
              );
            }
            if (jobCardRow.woEquipementDTO) {
              if (
                this.searchWOAssetList.filter(function(item) {
                  return jobCardRow.woEquipementDTO && item.value === jobCardRow.woEquipementDTO.equipmentCode;
                }).length === 0
              ) {
                this.searchWOAssetList.push({
                  label: _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_16__[
                    'BidoEquipmentUtils'
                  ].toString(jobCardRow.woEquipementDTO),
                  value: jobCardRow.woEquipementDTO.equipmentCode
                });
                this.searchWOAssetList.sort(
                  _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__['SelectItemUtils'].labelSorter
                );
              }
            }
            if (
              this.searchWOCodeList.filter(function(item) {
                return jobCardRow.woEquipementDTO && item.value === jobCardRow.workOrderDTO.woCode;
              }).length === 0
            ) {
              ...
              this.searchWOCodeList.sort(
                _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__['SelectItemUtils'].labelSorter
              );
            }
            if (
              this.searchUserList.filter(function(item) {
                return !!jobCardRow.workOrderDTO.woAssignedTo && item.value === jobCardRow.workOrderDTO.woAssignedTo;
              }).length === 0
            ) {
              this.searchUserList.push({
                label: _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__[
                  'SelectItemUtils'
                ].formatSelectItem(jobCardRow.workOrderDTO.woAssignedTo, this.userList),
                value: jobCardRow.workOrderDTO.woAssignedTo
              });
              this.searchUserList.sort(
                _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_19__['SelectItemUtils'].labelSorter
              );
            }
          };
          MyJobsCardsFormComponent.prototype.jobCardRowMatchFilters = function(jobCardRow) {
            ...
            if (
              !_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_18__['ListUtils'].isNullOrEmpty(
                this.searchCriteria.statusList
              ) &&
              jobCardRow.workOrderStatusDetailDTO &&
              jobCardRow.workOrderStatusDetailDTO.status
            ) {
            ...
            if (this.searchCriteria.woAsset) {
              if (
                jobCardRow.woEquipementDTO &&
                jobCardRow.woEquipementDTO.equipmentCode === this.searchCriteria.woAsset
              ) {
                woAssetMatch = true;
              } else {
                woAssetMatch = false;
            ...
            if (this.searchCriteria.wpAsset) {
              if (
                jobCardRow.wpEquipementDTO &&
                jobCardRow.wpEquipementDTO.equipmentCode === this.searchCriteria.wpAsset
              ) {
                wpAssetMatch = true;
              } else {
                wpAssetMatch = false;
            ...
            if (this.searchCriteria.nextDays) {
              if (
                ...
                moment__WEBPACK_IMPORTED_MODULE_1__(jobCardRow.workOrderDTO.woScheduledStartDate).isBefore(
                  moment__WEBPACK_IMPORTED_MODULE_1__(new Date()).add(this.searchCriteria.nextDays, 'days')
                )
              ) {
                nextDayMatch = true;
              } else {
            ...
            if (
              ...
              this.searchCriteria.assignedTo !== jobCardRow.workOrderDTO.woAssignedTo
            ) {
            ...
            if (
              ...
              !moment__WEBPACK_IMPORTED_MODULE_1__(this.searchCriteria.scheduledStartDate).isSame(
                jobCardRow.workOrderDTO.woScheduledStartDate,
                'day'
              )
            ) {
            ...
            if (
              ...
              !moment__WEBPACK_IMPORTED_MODULE_1__(this.searchCriteria.scheduledEndDate).isSame(
                jobCardRow.workOrderDTO.woScheduledEndDate,
                'day'
              )
            ) {
            ...
            if (
              ...
              jobCardRow.workOrderStatusDetailDTO &&
              !moment__WEBPACK_IMPORTED_MODULE_1__(this.searchCriteria.executionStartDate).isSame(
                jobCardRow.workOrderStatusDetailDTO.startDate,
                'day'
              )
            ) {
            ...
            if (
              ...
              jobCardRow.workOrderStatusDetailDTO &&
              !moment__WEBPACK_IMPORTED_MODULE_1__(this.searchCriteria.executionEndDate).isSame(
                jobCardRow.workOrderStatusDetailDTO.endDate,
                'day'
              )
            ) {
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./my-jobs-cards-form.component.html */ './src/app/main/maintenance/my-jobs-cards/form/my-jobs-cards-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./my-jobs-cards-form.component.scss */ './src/app/main/maintenance/my-jobs-cards/form/my-jobs-cards-form.component.scss'
                  )
                ]
              }),
  ...
  \***********************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'MyJobsCardsFormService', function() {
        ...
        /* harmony import */ var _shared_api_am_project_management_api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
        ...
        var MyJobsCardsFormService = /** @class */ (function(_super) {
          ...
          function MyJobsCardsFormService(
            http,
            appConfigService,
            propertiesService,
  ...
  \***********************************************************************************************************************/
      ...
      /***/ function(module, exports) {
        module.exports =
          ':host .action-list {\n  justify-content: flex-end; }\n  :host .action-list .aw-btn {\n    margin-left: 8px; }\n  :host .action-list .aw-btn:first-of-type {\n      margin-left: 0; }\n\n/*# sourceMappingURL=data:application/json;base64, */';
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var MyJobsCardsTableFiltersComponent = /** @class */ (function(_super) {
          ...
          __decorate(
            ...
            MyJobsCardsTableFiltersComponent.prototype,
            'searchStatusList',
            void 0
          );
          __decorate(
          ...
          MyJobsCardsTableFiltersComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./my-jobs-cards-table-filters.component.html */ './src/app/main/maintenance/my-jobs-cards/my-jobs-cards-table-filters/my-jobs-cards-table-filters.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./my-jobs-cards-table-filters.component.scss */ './src/app/main/maintenance/my-jobs-cards/my-jobs-cards-table-filters/my-jobs-cards-table-filters.component.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
  ...
  \************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'MyJobsCardsModule', function() {
        ...
        /* harmony import */ var _shared_services_file_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
          /*! ../../../shared/services/file.service */ './src/app/shared/services/file.service.ts'
        );
        ...
        /* harmony import */ var _form_my_jobs_cards_form_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
          /*! ./form/my-jobs-cards-form.component */ './src/app/main/maintenance/my-jobs-cards/form/my-jobs-cards-form.component.ts'
        );
        /* harmony import */ var _form_my_jobs_cards_form_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
          /*! ./form/my-jobs-cards-form.service */ './src/app/main/maintenance/my-jobs-cards/form/my-jobs-cards-form.service.ts'
        );
        /* harmony import */ var _my_jobs_cards_table_filters_my_jobs_cards_table_filters_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
          /*! ./my-jobs-cards-table-filters/my-jobs-cards-table-filters.component */ './src/app/main/maintenance/my-jobs-cards/my-jobs-cards-table-filters/my-jobs-cards-table-filters.component.ts'
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
          function(decorators, target, key, desc) {
         ...
         *************************************************************************** */
        var COMPONENTS = [
          _my_jobs_cards_table_filters_my_jobs_cards_table_filters_component__WEBPACK_IMPORTED_MODULE_17__[
            'MyJobsCardsTableFiltersComponent'
          ]
        ];
        var DYNAMIC_COMPONENTS = [
          _form_my_jobs_cards_form_component__WEBPACK_IMPORTED_MODULE_15__['MyJobsCardsFormComponent']
        ];
        /******************************************************************************
         * Services
         *************************************************************************** */
        var SERVICES = [
          _form_my_jobs_cards_form_service__WEBPACK_IMPORTED_MODULE_16__['MyJobsCardsFormService'],
          _shared_services_file_service__WEBPACK_IMPORTED_MODULE_13__['FileService']
        ];
