(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ['engineering-management-item-item-module'],
  {
  ...
  \******************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'ItemFormComponent', function() {
        ...
        /* harmony import */ var _shared_api_product_structure_history_api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../../../../shared/api/product-structure-history.api */ './src/app/shared/api/product-structure-history.api.ts'
        );
        ...
        /* harmony import */ var _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! ../../../../shared/enums/table-column-filter-mode.enum */ './src/app/shared/enums/table-column-filter-mode.enum.ts'
        );
        /* harmony import */ var _shared_enums_table_selection_mode_enum__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_utils_url_utils__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
          /*! ../../../../shared/utils/url-utils */ './src/app/shared/utils/url-utils.ts'
        );
        /* harmony import */ var _search_item_search_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(
          /*! ../search/item-search.service */ './src/app/main/engineering-management/item/search/item-search.service.ts'
        );
        /* harmony import */ var _item_form_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
          /*! ./item-form.service */ './src/app/main/engineering-management/item/form/item-form.service.ts'
        );
        var __extends =
        ...
        var ItemFormComponent = /** @class */ (function(_super) {
          ...
          function ItemFormComponent(
            ...
            _this.componentName =
              _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_6__['ComponentConstants'].ENG_ITEM_FORM;
            _this.init();
          ...
          ItemFormComponent.prototype.ngOnInit = function() {
            ...
            if (!!this.componentData) {
              ...
              if (!this.isCreateOpenMode && this.componentData.objectId) {
                ...
                var context =
                  this.bireItemDTO.chapter + '-' + this.bireItemDTO.section + '-' + this.bireItemDTO.subject;
          ...
          ItemFormComponent.prototype.bindToc = function() {
            ...
            this.translateService
              ...
              .subscribe(function(results) {
                ...
                var damagesLocalisationLabel = !!results
                  ? results[damagesLocalisationKey]
                  : 'Task, Damages and Localisation';
          ...
          ItemFormComponent.prototype.loadItemFamilyList = function() {
            ...
            this.itemFormService.getEquipmentFunctionList().subscribe(function(results) {
              _this.itemFamilyList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_22__['ListUtils'].orEmpty(
                results
              );
            });
          };
          ...
          ItemFormComponent.prototype.initDropdown = function() {
            ...
            this.itemSearchService
              .findBireVariantVersionsByFamilyFunctionItemAlternative()
              .subscribe(function(results) {
          ...
          ItemFormComponent.prototype.changeDissassembly = function() {
            var _this = this;
            var unmountCodeDTO = this.bireUnmountAssemblyList.filter(function(res) {
              return res.unmountCode === _this.bireItemDTO.unmountCode;
            })[0];
            if (!!unmountCodeDTO) {
          ...
          ItemFormComponent.prototype.initEvolutionData = function() {
            ...
            if (!this.isCreateOpenMode) {
              var bireItemDTOId = this.returnBireItemDTOId();
              this.itemFormService.findBireItemPnEvolutionsByItem(bireItemDTOId).subscribe(function(results) {
                results.forEach(function(res) {
          ...
          ItemFormComponent.prototype.initMaintenanceProgramData = function() {
            ...
            if (!this.isCreateOpenMode) {
              ...
              this.itemFormService.findBireMaintenancePlansByItem(bireItemDTOId).subscribe(function(results) {
                _this.maintenanceProgramList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_22__['ListUtils']
                  .orEmpty(results)
                  .map(function(result) {
                    var maintenanceProgram = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__[
                      'StringUtils'
                    ].orEmpty(result.planCode);
                    maintenanceProgram += _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__[
                      'StringUtils'
                    ].isNullOrEmpty(result.planDescription)
                      ? ''
          ...
          ItemFormComponent.prototype.initTechnicalLevelData = function() {
            ...
            if (!this.isCreateOpenMode) {
              ...
              this.itemFormService.findBireTilItemsByItem(bireItemDTOId).subscribe(function(results) {
                _this.technicalLevelList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_22__['ListUtils']
                  .orEmpty(results)
                  .map(function(result) {
                    var technicalLevel = '' + result.technicalLevel;
                    technicalLevel += _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__[
                      'StringUtils'
                    ].isNullOrEmpty(result.tilDescription)
                      ? ''
                      : ' - ' + result.tilDescription;
                    return {
            ...
            if (!this.isCreateOpenMode) {
              ...
              this.itemFormService.findBireItemSitesByItem(bireItemDTOId).subscribe(function(results) {
                results.forEach(function(dto) {
                  ...
                  if (!!dto.exchangeType) {
                    dto.exchangeType = _this.exchangeTypeList.filter(function(res) {
                      return res.value === dto.exchangeType;
                    })[0].label;
                  }
          ...
          ItemFormComponent.prototype.statisticsData = function() {
            ...
            if (!this.isCreateOpenMode) {
              var bireItemDTOId = this.returnBireItemDTOId();
              this.itemFormService.findBireItemMaintenanceByItem(bireItemDTOId).subscribe(function(results) {
                var cloneBireItemMaintenance = [];
                results.forEach(function(dto) {
                  if (!!dto) {
                    if (!!dto.environmentCode) {
                      dto.environmentCode = _this.maintenanceTypeList.filter(function(res) {
                        return res.value === dto.environmentCode;
                      })[0].label;
                    }
                    if (!!dto.kPourcentCode) {
                      dto.kPourcentCode = _this.kPourcentList.filter(function(res) {
                        return res.value === dto.kPourcentCode;
                      })[0].label;
                    }
                    if (!!dto.repairCenterCode) {
                      dto.repairCenterCode = _this.repairCenterList.filter(function(res) {
          ...
          ItemFormComponent.prototype.partNumberData = function() {
            ...
            if (!this.isCreateOpenMode) {
              ...
              this.itemFormService.getPartNumberStructure(bireItemDTOId).subscribe(function(results) {
                var filteredResults = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_22__['ListUtils']
                  .orEmpty(results)
                ...
                filteredResults.forEach(function(result) {
                  ...
                  var alternatePn = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_22__['ListUtils']
                    .orEmpty(result.alternatePn)
                    .map(function(pn) {
                      var formattedPn = '' + pn.pnPnCode;
                      formattedPn += _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__[
                        'StringUtils'
                      ].isNullOrEmpty(pn.interchangeability)
                        ? ''
                  ...
                  var partNumberRow = {
                    ...
                    ipcQuantity: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                      result.ipcQuantity
                    ),
                    mplQuantity: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                      result.mplQuantity
                    ),
                    _obj: result
                  };
          ...
          ItemFormComponent.prototype.addNewItem = function(newItem) {
            var searchInDisplayedList = this.technicalLevelList.find(
              ...
              function(value) {
                return value._obj.technicalLevel == newItem.technicalLevel;
              }
            );
            if (!searchInDisplayedList) {
              if (!!newItem && !!newItem.technicalLevel) {
                ...
                if (!!bireTilDTO) {
                  ...
                  technicalLevel += _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__[
                    'StringUtils'
                  ].isNullOrEmpty(dto.tilDescription)
                    ? ''
                    : ' - ' + dto.tilDescription;
            ...
            this.confirmationService.confirmDelete({
              ...
              accept: function() {
                _this.selectedTechnicalLevel.forEach(function(element) {
                  var searchInAddedList = _this.bireTilItemDTOAddedList.find(function(value) {
                    return value.technicalLevel === element._obj.technicalLevel;
                  });
          ...
          ItemFormComponent.prototype.editRepairCenterDialog = function() {
            if (this.selectedRepairCenters.length === 1) {
              ...
              cloneDTO_1.repairCenterCode = this.repairCenterList.filter(function(res) {
                return res.label === cloneDTO_1.repairCenterCode;
              })[0].value;
              if (!!cloneDTO_1.exchangeType) {
                cloneDTO_1.exchangeType = this.exchangeTypeList.filter(function(res) {
                  return res.label === cloneDTO_1.exchangeType;
                })[0].value;
              }
              this.dataRepairCenter = {
                componentId: 'RepairCenterPopupComponent',
          ...
          ItemFormComponent.prototype.updateRepairCenter = function(updatedCenter) {
            ...
            cloneDTO.repairCenterCode = this.repairCenterList.filter(function(res) {
              return res.value === updatedCenter.repairCenterCode;
            })[0].label;
            cloneDTO.exchangeType = this.exchangeTypeList.filter(function(res) {
              return res.value === updatedCenter.exchangeType;
            })[0].label;
            var searchInAddedList = this.bireItemSiteDTOAddedList.find(function(value) {
              return (
                value.repairCenterCode === cloneDTO.repairCenterCode && value.exchangeType === cloneDTO.exchangeType
              );
            });
            var searchInUpdatedList = this.bireItemSiteDTOUpdatedList.find(function(value) {
              return (
                value.repairCenterCode === cloneDTO.repairCenterCode && value.exchangeType === cloneDTO.exchangeType
              );
            });
            ...
            clone.repairCenterCode = this.repairCenterList.filter(function(res) {
              return res.value === updatedCenter.repairCenterCode;
            })[0].label;
            clone.exchangeType = this.exchangeTypeList.filter(function(res) {
              return res.value === updatedCenter.exchangeType;
            })[0].label;
          ...
          ItemFormComponent.prototype.addNewRepairCenter = function(newCenter) {
            ...
            if (!!cloneCenter.exchangeType) {
              cloneCenter.exchangeType = this.exchangeTypeList.filter(function(res) {
                return res.value === cloneCenter.exchangeType;
              })[0].label;
            }
            var searchInDisplayedList = this.repairCentersList.find(function(value) {
              return value.repairCenterCode === cloneCenter.repairCenterCode;
            });
            if (!searchInDisplayedList) {
              if (!!newCenter) {
                ...
                dto_1.repairCenterCode = this.repairCenterList.filter(function(res) {
                  return res.value === dto_1.repairCenterCode;
                })[0].label;
                if (!!dto_1.exchangeType) {
                  dto_1.exchangeType = this.exchangeTypeList.filter(function(res) {
                    return res.value === dto_1.exchangeType;
                  })[0].label;
                }
            ...
            this.confirmationService.confirmDelete({
              ...
              accept: function() {
                _this.selectedRepairCenters.forEach(function(element) {
                  var searchInAddedList = _this.bireItemSiteDTOAddedList.find(function(value) {
                    return value.repairCenterCode === element.repairCenterCode;
                  });
                  if (searchInAddedList) {
                    ...
                    dto_2.repairCenterCode = _this.repairCenterList.filter(function(res) {
                      return res.label === dto_2.repairCenterCode;
                    })[0].value;
          ...
          ItemFormComponent.prototype.addNewCause = function(newCenter) {
            ...
            newCenter.forEach(function(element) {
              var searchInDisplayedList = _this.causeOfRemovalList.find(function(value) {
                return value.returnReasonCode === element.returnReasonCode;
              });
              if (!searchInDisplayedList) {
                if (!!element) {
                  var elementDTO = {
                  ...
                  if (!!bireReturnReasonDTO_1) {
                    var causeType = _this.causeTypeList.find(function(elt) {
                      return elt.value === bireReturnReasonDTO_1.causeType;
                    });
                    var dto = {
            ...
            this.confirmationService.confirmDelete({
              ...
              accept: function() {
                _this.selectedCauseOfRemoval.forEach(function(element) {
                  var searchInAddedList = _this.bireReturnItemDTOAddedList.find(function(value) {
                    return value.returnReasonCode === element.returnReasonCode;
                  });
                  if (searchInAddedList) {
          ...
          ItemFormComponent.prototype.openMaintenanceStatDialog = function() {
            if (this.selectedStatistics.length === 1) {
              ...
              cloneDTO_2.environmentCode = this.maintenanceTypeList.filter(function(res) {
                return res.label === cloneDTO_2.environmentCode;
              })[0].value;
              cloneDTO_2.kPourcentCode = this.kPourcentList.filter(function(res) {
                return res.label === cloneDTO_2.kPourcentCode;
              })[0].value;
              cloneDTO_2.repairCenterCode = this.repairCenterList.filter(function(res) {
                return res.label === cloneDTO_2.repairCenterCode;
              })[0].value;
              this.dataMaintenanceStats = {
                componentId: 'StatisticsPopupComponent',
                selectedRow: undefined,
          ...
          ItemFormComponent.prototype.addNewStat = function(newCenter) {
            var envCode = this.maintenanceTypeList.filter(function(res) {
              return res.value === newCenter.environmentCode;
            })[0].label;
            var kPourCode = this.kPourcentList.filter(function(res) {
              return res.value === newCenter.kPourcentCode;
            })[0].label;
            var repairCenterCode = this.repairCenterList.filter(function(res) {
              return res.value === newCenter.repairCenterCode;
            })[0].label;
            ...
            if (!searchInDisplayedList) {
              if (!!newCenter) {
                ...
                tableDTO.environmentCode = this.maintenanceTypeList.filter(function(res) {
                  return res.value === newCenter.environmentCode;
                })[0].label;
                tableDTO.kPourcentCode = this.kPourcentList.filter(function(res) {
                  return res.value === newCenter.kPourcentCode;
                })[0].label;
                tableDTO.repairCenterCode = this.repairCenterList.filter(function(res) {
                  return res.value === newCenter.repairCenterCode;
                })[0].label;
          ...
          ItemFormComponent.prototype.editStat = function() {
            ...
            if (this.selectedStatistics.length === 1) {
              ...
              cloneObj.environmentCode = this.maintenanceTypeList.filter(function(res) {
                return res.label === _this.selectedStatistics[0].environmentCode;
              })[0].value;
              cloneObj.kPourcentCode = this.kPourcentList.filter(function(res) {
                return res.label === _this.selectedStatistics[0].kPourcentCode;
              })[0].value;
              cloneObj.repairCenterCode = this.repairCenterList.filter(function(res) {
                return res.label === _this.selectedStatistics[0].repairCenterCode;
              })[0].value;
              this.dataMaintenanceStats = {
                componentId: 'StatisticsPopupComponent',
                selectedRow: undefined,
          ...
          ItemFormComponent.prototype.updateStat = function(udpatedStat) {
            ...
            clone.environmentCode = this.maintenanceTypeList.filter(function(res) {
              return res.value === udpatedStat.environmentCode;
            })[0].label;
            clone.kPourcentCode = this.kPourcentList.filter(function(res) {
              return res.value === udpatedStat.kPourcentCode;
            })[0].label;
            clone.repairCenterCode = this.repairCenterList.filter(function(res) {
              return res.value === udpatedStat.repairCenterCode;
            })[0].label;
              ...
              accept: function() {
                _this.selectedStatistics.forEach(function(element) {
                  ...
                  if (searchInAddedList) {
                    ...
                    clone.environmentCode = _this.maintenanceTypeList.filter(function(res) {
                      return res.label === _this.selectedStatistics[0].environmentCode;
                    })[0].value;
                    clone.kPourcentCode = _this.kPourcentList.filter(function(res) {
                      return res.label === _this.selectedStatistics[0].kPourcentCode;
                    })[0].value;
                    clone.repairCenterCode = _this.repairCenterList.filter(function(res) {
                      return res.label === _this.selectedStatistics[0].repairCenterCode;
                    })[0].value;
            ...
            this.itemFormService.getStructureDetails(bireEvolutionItemDTO).subscribe(function(results) {
              results.forEach(function(res) {
                if (!!res.itemFatherOutput) {
                  _this.itemFatherList = __spread(_this.itemFatherList, [
                    _this.createStructureRow(res.itemFatherOutput)
                  ]);
                }
          ...
          ItemFormComponent.prototype.createStructureRow = function(obj) {
            var itemFamily = this.itemFamilyCodeList.find(function(elt) {
              return elt.value === obj.itemFamily;
            });
            var structureRow = {
              item: obj.item,
          ...
          ItemFormComponent.prototype.initTasksData = function() {
            var _this = this;
            var bireItemDTOId = this.returnBireItemDTOId();
            this.itemFormService.findBireTaskItemsByItemTaskTab(bireItemDTOId).subscribe(function(results) {
          ...
          ItemFormComponent.prototype.bireDamLocTaskData = function() {
            ...
            this.itemVersions.forEach(function(res) {
              ...
              _this.itemFormService.findBireDamLocTasksByItemVersion(bireItemVersionDTOId).subscribe(function(results) {
                results.forEach(function(dto) {
                  if (!!dto && !!dto.bireDamLocTaskDTO) {
                    ...
                    var damage = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                      dto.bireDamLocTaskDTO.damageCode
                    );
                    damage += _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].isNullOrEmpty(
                      dto.damageDescription
                    )
                      ? ''
                      : ' - ' + dto.damageDescription;
                    var localisation = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                      dto.bireDamLocTaskDTO.localisationCode
                    );
                    localisation += _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__[
                      'StringUtils'
                    ].isNullOrEmpty(dto.localisationDescription)
                      ? ''
                      : ' - ' + dto.localisationDescription;
                    var damageLocalisationTaskRow = {
                      damage: damage,
                      localisation: localisation,
                      versionNumber: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                        dto.bireDamLocTaskDTO.versionNumber
                      ),
                      taskCode: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                        dto.bireDamLocTaskDTO.taskCode
                      ),
                      taskVersion: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                        dto.bireDamLocTaskDTO.taskVersion
                      ),
                      taskDesignation: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                        dto.taskDesignation
                      ),
          ...
          ItemFormComponent.prototype.addNewItemSon = function(ev) {
            ...
            if (!this.isItemAddedSame(item, father)) {
              var searchInDisplayedList = this.itemSonList.find(function(value) {
          ...
          ItemFormComponent.prototype.addNewItemFather = function(ev) {
            ...
            if (!this.isSonSameAsFather(son, item)) {
              if (!this.isFatherItemAddedSame(item)) {
                var searchInDisplayedList = this.itemFatherList.find(function(value) {
                  return value.item === item;
                });
                if (!searchInDisplayedList) {
                  if (!!ev) {
          ...
          ItemFormComponent.prototype.addNewItemVersion = function(ev) {
            var searchInDisplayedList = this.partNumberVersionList.find(function(value) {
              return value.data === ev.versionNumber;
            });
            if (!searchInDisplayedList) {
              if (!!ev) {
          ...
          ItemFormComponent.prototype.deleteVersion = function() {
            ...
            this.confirmationService.confirmDelete({
              ...
              accept: function() {
                ...
                _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_22__['ListUtils']
                  .orEmpty(_this.partNumberMap.get(version))
                ...
                _this.partNumberVersionList = _this.partNumberVersionList.filter(function(elt) {
                  return elt.data !== version;
                });
          ...
          ItemFormComponent.prototype.addNewDamage = function(ev) {
            var searchInDisplayedList = this.damagesList.find(function(value) {
              return value.damageCode === ev.damageCode && ev.versionNumber === value.versionNumber;
            });
            if (!searchInDisplayedList) {
              if (!!ev) {
            ...
            this.confirmationService.confirmDelete({
              ...
              accept: function() {
                _this.selectedDamages.forEach(function(element) {
                  var searchInAddedList = _this.bireDamageItemDTOAddedList.find(function(value) {
                    return value.damageCode === element.damageCode;
                  });
                  if (searchInAddedList) {
          ...
          ItemFormComponent.prototype.addNewLocalisation = function(ev) {
            var searchInDisplayedList = this.localisationList.find(function(value) {
              return value.localisationCode === ev.localisationCode && value.versionNumber === ev.versionNumber;
            });
            if (!searchInDisplayedList) {
              if (!!ev) {
            ...
            this.confirmationService.confirmDelete({
              ...
              accept: function() {
                _this.selectedLocalisation.forEach(function(element) {
                  var searchInAddedList = _this.bireLocalisationItemDTOAddedList.find(function(value) {
                    return value.localisationCode === element.localisationCode;
                  });
                  if (searchInAddedList) {
          ...
          ItemFormComponent.prototype.addNewDamLocTask = function(ev) {
            ...
            if (!searchInDisplayedList) {
              if (!!ev) {
                ...
                localisation += _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].isNullOrEmpty(
                  ev.localisationDescription
                )
                  ? ''
                  : ' - ' + ev.localisationDescription;
                var damageLocalisationTaskRow = {
          ...
          ItemFormComponent.prototype.openStatusUpdatesPopup = function() {
            ...
            var columns = [
              { field: 'time', alignment: 'left', width: '150px' },
              {
                ...
                width: '200px',
                filterMode:
                  _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_9__['TableColumnFilterMode']
                    .Input,
                alignment: 'left'
              },
              {
            ...
            if (!!objId) {
              this.tableStatusUpdatesData = {
                ...
                dataKey: undefined,
                selectionMode:
                  _shared_enums_table_selection_mode_enum__WEBPACK_IMPORTED_MODULE_10__['TableSelectionMode'].Multiple,
                globalFilter: false
              };
            } else {
                ...
                this.itemFormService.saveItem(saveItemDTO).subscribe(
                  function(result) {
                    if (result === 'SUCCESS') {
                      ...
                      var context =
                        _this.bireItemDTO.chapter + '-' + _this.bireItemDTO.section + '-' + _this.bireItemDTO.subject;
          ...
          ItemFormComponent.prototype.createItemPN = function() {
            ...
            this.openItemPartNumber(
              bireVersionPnDTO,
              _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_8__['ComponentOpenMode'].Create
            );
          };
          ItemFormComponent.prototype.editItemPN = function(row) {
            this.openItemPartNumber(
              row._obj.bireVersionPnDTO,
              _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_8__['ComponentOpenMode'].Read
            );
          };
          /**
          ...
          ItemFormComponent.prototype.loadCauseTypeList = function() {
            ...
            this.propertiesService
              ...
              .subscribe(function(results) {
                _this.causeTypeList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_22__['ListUtils'].orEmpty(
                  results
                );
              });
          };
          ...
          ItemFormComponent.prototype.editDocument = function() {
            ...
            if (this.selectedDocuments.length === 1) {
              this.currentDocumentIndex = this.documentsTable.findIndex(function(document) {
                return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_20__['DTOUtils'].equalsBireDocumentDTO(
                  document,
                  _this.selectedDocuments[0]._obj
                );
              });
          ...
          ItemFormComponent.prototype.loadDocumentsTable = function() {
            var _this = this;
            var bireItemDTOId = {
              familyCode: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                this.bireItemDTO.familyCode
              ),
              chapter: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                this.bireItemDTO.chapter
              ),
              subject: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                this.bireItemDTO.subject
              ),
              variantCode: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                this.bireItemDTO.variantCode
              ),
              section: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                this.bireItemDTO.section
              ),
              sheet: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                this.bireItemDTO.sheet
              ),
              marks: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                this.bireItemDTO.marks
              ),
              structureType: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                this.bireItemDTO.structureType
              )
            };
          ...
          ItemFormComponent.prototype.showDocExtension = function(document) {
            return _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_21__['FileUtils']
              .getExtension(document.docName)
              .toUpperCase();
          };
          ItemFormComponent.prototype.showDocSize = function(document) {
            return document.docFile
              ? _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_21__['FileUtils'].getFormattedSize(
                ...
                _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_21__['FileUtils'].getFileContentAsBase64(
                  ...
                  function(fileContent) {
                    if (fileContent) {
                      ...
                      var bireDocItemDTO = {
                        familyCode: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                          _this.bireItemDTO.familyCode
                        ),
                        chapter: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                          _this.bireItemDTO.chapter
                        ),
                        subject: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                          _this.bireItemDTO.subject
                        ),
                        variantCode: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                          _this.bireItemDTO.variantCode
                        ),
                        section: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                          _this.bireItemDTO.section
                        ),
                        sheet: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                          _this.bireItemDTO.sheet
                        ),
                        marks: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                          _this.bireItemDTO.marks
                        ),
                        structureType: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_23__['StringUtils'].orEmpty(
                          _this.bireItemDTO.structureType
                        ),
          ...
          ItemFormComponent.prototype.loadPacksEvolutions = function() {
            ...
            if (this.currentPackNumber && this.currentPackNumber.packBaseOptionCode) {
              ...
              this.itemFormService
                .findBirePackEvolutionsByItemAndPackBaseOptionCodeItem(input)
                .subscribe(function(results) {
          ...
          ItemFormComponent.prototype.updateConfigEvolution = function(input) {
            ...
            birePackEvolutionDTO.packBaseOptionCode =
              this.currentPackNumber && this.currentPackNumber.packBaseOptionCode;
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./item-form.component.html */ './src/app/main/engineering-management/item/form/item-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./item-form.component.scss */ './src/app/main/engineering-management/item/form/item-form.component.scss'
                  )
                ]
              }),
  ...
  \****************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'ItemFormService', function() {
        ...
        /* harmony import */ var _shared_api_product_structure_history_api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ../../../../shared/api/product-structure-history.api */ './src/app/shared/api/product-structure-history.api.ts'
        );
        ...
        var ItemFormService = /** @class */ (function(_super) {
          ...
          ItemFormService.prototype.isFollowedInRating = function(followedRatingInput) {
            return _super.prototype.post.call(
              this,
              this.productStructureBusinessApi.isFollowedInRating,
              followedRatingInput
            );
          };
          ...
          ItemFormService.prototype.findBireUnmountAssemblysByFamilyAndVariantCodes = function(
          ...
          ItemFormService.prototype.findBireRatingsBySearchCriteria = function(
            bireRatingCriteria,
            variantCodeCriteria
          ) {
            var searchCriteria = {
  ...
  \*******************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _item_form_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ../../item-form.service */ './src/app/main/engineering-management/item/form/item-form.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
        ...
        var AddEvolutionPopupComponent = /** @class */ (function(_super) {
          ...
          AddEvolutionPopupComponent.prototype.initItemTableData = function() {
            this.evolutionsTableDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_1__[
              'TableDataSource'
            ]({
              columns: [
          ...
          __decorate(
            ...
            AddEvolutionPopupComponent.prototype,
            'componentData',
            void 0
          );
          __decorate(
          ...
          AddEvolutionPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./add-evolution-popup.component.html */ './src/app/main/engineering-management/item/form/popups/add-evolution-popup/add-evolution-popup.component.html'
                )
              }),
  ...
  \*************************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _form_item_form_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! ../../../form/item-form.service */ './src/app/main/engineering-management/item/form/item-form.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
          (function() {
        ...
        var CauseOfRemovalPopupComponent = /** @class */ (function(_super) {
          ...
          CauseOfRemovalPopupComponent.prototype.init = function() {
            ...
            this.causeOfRemovalDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_1__[
              'TableDataSource'
            ]({
              columns: [
                {
          ...
          CauseOfRemovalPopupComponent.prototype.initilizeScreen = function() {
            ...
            // Repair Center List
            this.itemFormService.findAllBireReturnReasons().subscribe(function(results) {
              _this.causeOfRemovalDataSource.setData(
                _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_7__['ListUtils']
                  .orEmpty(results)
                  .map(function(result) {
                    return _this.createCauseOfRemovalRow(result);
                  })
              );
            });
          };
          CauseOfRemovalPopupComponent.prototype.createCauseOfRemovalRow = function(obj) {
            var causeType = this.causeTypeList.find(function(elt) {
              return elt.value === obj.causeType;
            });
            var causeOfRemovalRow = {
              returnReasonCode: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_8__['StringUtils'].orEmpty(
                obj.returnReasonCode
              ),
              returnReasonName: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_8__['StringUtils'].orEmpty(
                obj.returnReasonName
              ),
              returnReasonDescription: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_8__['StringUtils'].orEmpty(
                obj.returnReasonDescription
              ),
              causeType: causeType
                ? causeType.label
                : _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_8__['StringUtils'].orEmpty(obj.causeType),
              _obj: obj
            };
          ...
          CauseOfRemovalPopupComponent.prototype.onValidate = function() {
            if (this.validateScreen()) {
              var selectedCauseList = this.causeOfRemovalDataSource.dataSelection.map(function(elt) {
                return elt._obj;
              });
          ...
          CauseOfRemovalPopupComponent.prototype.loadCauseTypeList = function() {
            ...
            this.propertiesService
              ...
              .subscribe(function(results) {
                _this.causeTypeList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_7__['ListUtils'].orEmpty(
                  results
                );
          ...
          __decorate(
            ...
            CauseOfRemovalPopupComponent.prototype,
            'onCreate',
            void 0
          );
          CauseOfRemovalPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./cause-of-removal-popup.component.html */ './src/app/main/engineering-management/item/form/popups/cause-of-removal-popup/cause-of-removal-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
                _form_item_form_service__WEBPACK_IMPORTED_MODULE_9__['ItemFormService'],
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var ConfigurationPackPopupComponent = /** @class */ (function(_super) {
          ...
          __decorate(
            ...
            ConfigurationPackPopupComponent.prototype,
            'componentData',
            void 0
          );
          __decorate(
          ...
          ConfigurationPackPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./configuration-pack-popup.component.html */ './src/app/main/engineering-management/item/form/popups/configuration-pack-popup/configuration-pack-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [])
            ],
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var DamLocTaskPopupComponent = /** @class */ (function(_super) {
          ...
          __decorate(
            ...
            DamLocTaskPopupComponent.prototype,
            'componentData',
            void 0
          );
          __decorate(
          ...
          DamLocTaskPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./dam-loc-task-popup.component.html */ './src/app/main/engineering-management/item/form/popups/dam-loc-task-popup/dam-loc-task-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
  ...
  \****************************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _item_form_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ../../../item-form.service */ './src/app/main/engineering-management/item/form/item-form.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
        ...
        var DamageListPopupComponent = /** @class */ (function(_super) {
          ...
          DamageListPopupComponent.prototype.ngOnInit = function() {
            this.damageListDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_1__[
              'TableDataSource'
            ]({
          ...
          __decorate(
            ...
            DamageListPopupComponent.prototype,
            'onCreate',
            void 0
          );
          __decorate(
          ...
          DamageListPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./damage-list-popup.component.html */ './src/app/main/engineering-management/item/form/popups/damage-popup/damage-list-popup/damage-list-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
  ...
  \*****************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'DamagePopupComponent', function() {
        ...
        var DamagePopupComponent = /** @class */ (function(_super) {
          ...
          __decorate(
            ...
            DamagePopupComponent.prototype,
            'componentData',
            void 0
          );
          __decorate(
          ...
          DamagePopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./damage-popup.component.html */ './src/app/main/engineering-management/item/form/popups/damage-popup/damage-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
                _shared_services_message_service__WEBPACK_IMPORTED_MODULE_2__['MessageService'],
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var EditEvolutionPopupComponent = /** @class */ (function(_super) {
          ...
          __decorate(
            ...
            EditEvolutionPopupComponent.prototype,
            'componentData',
            void 0
          );
          __decorate(
          ...
          EditEvolutionPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./edit-evolution-popup.component.html */ './src/app/main/engineering-management/item/form/popups/edit-evolution-popup/edit-evolution-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
  ...
  \*****************************************************************************************************************/
      ...
      /***/ function(module, exports) {
        module.exports =
          ':host .separator {\n  display: flex;\n  flex-direction: row;\n  align-items: center; }\n\n/*# sourceMappingURL=data:application/json;base64, */';
  ...
  \***************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _item_form_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ../../item-form.service */ './src/app/main/engineering-management/item/form/item-form.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
        ...
        var ItemFatherPopupComponent = /** @class */ (function(_super) {
          ...
          __decorate(
            ...
            ItemFatherPopupComponent.prototype,
            'componentData',
            void 0
          );
          __decorate(
          ...
          ItemFatherPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./item-father-popup.component.html */ './src/app/main/engineering-management/item/form/popups/item-father-popup/item-father-popup.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./item-father-popup.component.scss */ './src/app/main/engineering-management/item/form/popups/item-father-popup/item-father-popup.component.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var ItemImportPopupComponent = /** @class */ (function(_super) {
              ...
              _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_4__['FileUtils'].getFileContentAsBase64(
                ...
                function(fileContent) {
                  if (fileContent) {
                    ...
                    _this.document.docType = _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_4__['FileUtils']
          ...
          __decorate(
            ...
            ItemImportPopupComponent.prototype,
            'display',
            null
          );
          __decorate(
          ...
          ItemImportPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./item-import-popup.component.html */ './src/app/main/engineering-management/item/form/popups/item-import-popup/item-import-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
                _shared_services_session_service__WEBPACK_IMPORTED_MODULE_2__['SessionService']
  ...
  \***********************************************************************************************************/
      ...
      /***/ function(module, exports) {
        module.exports =
          ':host .separator {\n  display: flex;\n  flex-direction: row;\n  align-items: center; }\n\n/*# sourceMappingURL=data:application/json;base64, */';
  ...
  \*********************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'ItemSonPopupComponent', function() {
        ...
        var ItemSonPopupComponent = /** @class */ (function(_super) {
          ...
          __decorate(
            ...
            ItemSonPopupComponent.prototype,
            'componentData',
            void 0
          );
          __decorate(
          ...
          ItemSonPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./item-son-popup.component.html */ './src/app/main/engineering-management/item/form/popups/item-son-popup/item-son-popup.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./item-son-popup.component.scss */ './src/app/main/engineering-management/item/form/popups/item-son-popup/item-son-popup.component.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var ItemVersionPopupComponent = /** @class */ (function(_super) {
          ...
          __decorate(
            ...
            ItemVersionPopupComponent.prototype,
            'componentData',
            void 0
          );
          __decorate(
          ...
          ItemVersionPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./item-version-popup.component.html */ './src/app/main/engineering-management/item/form/popups/item-version-popup/item-version-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
                _shared_services_message_service__WEBPACK_IMPORTED_MODULE_2__['MessageService']
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var LocalisationListPopupComponent = /** @class */ (function(_super) {
          ...
          LocalisationListPopupComponent.prototype.ngOnInit = function() {
            this.localisationDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_1__[
              'TableDataSource'
            ]({
              allowMultiSelect: false,
              columns: [
          ...
          LocalisationListPopupComponent.prototype.getLocalisationList = function() {
            var _this = this;
            this.itemFormService.findBireLocalisationCodesByCriteria().subscribe(function(result) {
          ...
          __decorate(
            ...
            LocalisationListPopupComponent.prototype,
            'onCreate',
            void 0
          );
          __decorate(
          ...
          LocalisationListPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./localisation-list-popup.component.html */ './src/app/main/engineering-management/item/form/popups/localisation-popup/localisation-list-popup/localisation-list-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
                _shared_services_message_service__WEBPACK_IMPORTED_MODULE_3__['MessageService'],
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var LocalisationPopupComponent = /** @class */ (function(_super) {
          ...
          __decorate(
            ...
            LocalisationPopupComponent.prototype,
            'componentData',
            void 0
          );
          __decorate(
          ...
          LocalisationPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./localisation-popup.component.html */ './src/app/main/engineering-management/item/form/popups/localisation-popup/localisation-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
                _shared_services_message_service__WEBPACK_IMPORTED_MODULE_2__['MessageService'],
  ...
  \***********************************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_constants_bire_rating_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
        ...
        /* harmony import */ var _form_item_form_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
          /*! ../../../form/item-form.service */ './src/app/main/engineering-management/item/form/item-form.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
        ...
        var ReferenceMeasurementPopupComponent = /** @class */ (function(_super) {
          ...
          function ReferenceMeasurementPopupComponent(
            sessionService,
            itemFormService,
            messageService,
            propertiesService,
          ...
          ReferenceMeasurementPopupComponent.prototype.defineIfFollowedInRating = function() {
            ...
            var familyVariantCode = _shared_utils_bido_family_variant_utils__WEBPACK_IMPORTED_MODULE_12__[
              'BidoFamilyVariantUtils'
            ].buildFamilyVariantCode(this.bireItemDTOId.familyCode, this.bireItemDTOId.variantCode);
            ...
            this.itemFormService.findBireItemVersions(this.bireItemDTOId).subscribe(function(results) {
              ...
              if (_this.componentData) {
                if (
                  ...
                  !!_this.componentData.object.versionNumber
                ) {
          ...
          ReferenceMeasurementPopupComponent.prototype.onValidate = function() {
            if (this.validateScreen()) {
              ...
              if (!this.isFollowedInRating) {
                this.bireVersionMeasureDTO.ratingCode =
                  _shared_constants_bire_rating_constants__WEBPACK_IMPORTED_MODULE_3__['BireRatingConstants'].DEFAULT;
              }
              // tslint:disable-next-line:radix
              if (
                !!this.bireVersionMeasureDTO.referenceValue &&
                parseInt(this.bireVersionMeasureDTO.referenceValue) > max
              ) {
          ...
          ReferenceMeasurementPopupComponent.prototype.setLimitList = function() {
            ...
            this.translateService.get([limitValueKey, limitDateKey]).subscribe(function(results) {
              ...
              _this.limitList = [
                { label: limitValueLabel, value: 'limitValue' },
                { label: limitDateLabel, value: 'limitDate' }
              ];
            });
          };
          __decorate(
            ...
            ReferenceMeasurementPopupComponent.prototype,
            'componentData',
            void 0
          );
          __decorate(
          ...
          ReferenceMeasurementPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./reference-measurement-popup.component.html */ './src/app/main/engineering-management/item/form/popups/reference-measurement-popup/reference-measurement-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
  ...
  \*******************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _form_item_form_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ../../../form/item-form.service */ './src/app/main/engineering-management/item/form/item-form.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
        ...
        var RepairCenterPopupComponent = /** @class */ (function(_super) {
          ...
          __decorate(
            ...
            RepairCenterPopupComponent.prototype,
            'componentData',
            void 0
          );
          __decorate(
          ...
          RepairCenterPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./repair-center-popup.component.html */ './src/app/main/engineering-management/item/form/popups/repair-center-popup/repair-center-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var StatisticsPopupComponent = /** @class */ (function(_super) {
          ...
          __decorate(
            ...
            StatisticsPopupComponent.prototype,
            'componentData',
            void 0
          );
          __decorate(
          ...
          StatisticsPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./statistics-popup.component.html */ './src/app/main/engineering-management/item/form/popups/statistics-popup/statistics-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
  ...
  \*************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'TaskPopupComponent', function() {
          ...
          TaskPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./task-popup.component.html */ './src/app/main/engineering-management/item/form/popups/task-popup/task-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
                _shared_services_message_service__WEBPACK_IMPORTED_MODULE_3__['MessageService'],
  ...
  \***********************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'TilPopupComponent', function() {
        ...
        /* harmony import */ var _form_item_form_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ../../../form/item-form.service */ './src/app/main/engineering-management/item/form/item-form.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
          ...
          TilPopupComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./til-popup.component.html */ './src/app/main/engineering-management/item/form/popups/til-popup/til-popup.component.html'
                )
              }),
              __metadata('design:paramtypes', [
                _form_item_form_service__WEBPACK_IMPORTED_MODULE_4__['ItemFormService'],
                _shared_services_message_service__WEBPACK_IMPORTED_MODULE_2__['MessageService']
              ])
            ],
            TilPopupComponent
  ...
  \*****************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'ItemModule', function() {
          return ItemModule;
        });
        /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! @angular/core */ './node_modules/@angular/core/fesm5/core.js'
        ...
        /* harmony import */ var primeng_tree__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
          /*! primeng/tree */ './node_modules/primeng/tree.js'
        );
        /* harmony import */ var primeng_tree__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/ __webpack_require__.n(
          primeng_tree__WEBPACK_IMPORTED_MODULE_11__
        );
        ...
        /* harmony import */ var _shared_components_component_sidebar_component_sidebar_mdule__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_components_dialog_bire_document_dialog_bire_document_module__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_components_dialog_search_rating_dialog_search_rating_module__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_components_dialog_search_rating_dialog_search_rating_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
          /*! ../../../shared/components/dialog-search-rating/dialog-search-rating.service */ './src/app/shared/components/dialog-search-rating/dialog-search-rating.service.ts'
        );
        /* harmony import */ var _shared_components_dialog_search_task_dialog_search_task_module__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_components_dynamic_attributes_dynamic_attributes_module__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
        ...
        /* harmony import */ var _form_item_form_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
          /*! ./form/item-form.component */ './src/app/main/engineering-management/item/form/item-form.component.ts'
        );
        /* harmony import */ var _form_item_form_service__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
          /*! ./form/item-form.service */ './src/app/main/engineering-management/item/form/item-form.service.ts'
        );
        /* harmony import */ var _form_popups_add_evolution_popup_add_evolution_popup_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
          /*! ./form/popups/add-evolution-popup/add-evolution-popup.component */ './src/app/main/engineering-management/item/form/popups/add-evolution-popup/add-evolution-popup.component.ts'
        );
        /* harmony import */ var _form_popups_cause_of_removal_popup_cause_of_removal_popup_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
          /*! ./form/popups/cause-of-removal-popup/cause-of-removal-popup.component */ './src/app/main/engineering-management/item/form/popups/cause-of-removal-popup/cause-of-removal-popup.component.ts'
        );
        /* harmony import */ var _form_popups_configuration_pack_popup_configuration_pack_popup_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
          /*! ./form/popups/configuration-pack-popup/configuration-pack-popup.component */ './src/app/main/engineering-management/item/form/popups/configuration-pack-popup/configuration-pack-popup.component.ts'
        );
        /* harmony import */ var _form_popups_dam_loc_task_popup_dam_loc_task_popup_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
          /*! ./form/popups/dam-loc-task-popup/dam-loc-task-popup.component */ './src/app/main/engineering-management/item/form/popups/dam-loc-task-popup/dam-loc-task-popup.component.ts'
        );
        /* harmony import */ var _form_popups_damage_popup_damage_list_popup_damage_list_popup_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(
          /*! ./form/popups/damage-popup/damage-list-popup/damage-list-popup.component */ './src/app/main/engineering-management/item/form/popups/damage-popup/damage-list-popup/damage-list-popup.component.ts'
        );
        /* harmony import */ var _form_popups_damage_popup_damage_popup_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(
          /*! ./form/popups/damage-popup/damage-popup.component */ './src/app/main/engineering-management/item/form/popups/damage-popup/damage-popup.component.ts'
        );
        /* harmony import */ var _form_popups_edit_evolution_popup_edit_evolution_popup_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(
          /*! ./form/popups/edit-evolution-popup/edit-evolution-popup.component */ './src/app/main/engineering-management/item/form/popups/edit-evolution-popup/edit-evolution-popup.component.ts'
        );
        /* harmony import */ var _form_popups_item_father_popup_item_father_popup_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(
          /*! ./form/popups/item-father-popup/item-father-popup.component */ './src/app/main/engineering-management/item/form/popups/item-father-popup/item-father-popup.component.ts'
        );
        /* harmony import */ var _form_popups_item_import_popup_item_import_popup_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(
          /*! ./form/popups/item-import-popup/item-import-popup.component */ './src/app/main/engineering-management/item/form/popups/item-import-popup/item-import-popup.component.ts'
        );
        /* harmony import */ var _form_popups_item_son_popup_item_son_popup_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(
          /*! ./form/popups/item-son-popup/item-son-popup.component */ './src/app/main/engineering-management/item/form/popups/item-son-popup/item-son-popup.component.ts'
        );
        /* harmony import */ var _form_popups_item_version_popup_item_version_popup_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(
          /*! ./form/popups/item-version-popup/item-version-popup.component */ './src/app/main/engineering-management/item/form/popups/item-version-popup/item-version-popup.component.ts'
        );
        /* harmony import */ var _form_popups_localisation_popup_localisation_list_popup_localisation_list_popup_component__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(
          /*! ./form/popups/localisation-popup/localisation-list-popup/localisation-list-popup.component */ './src/app/main/engineering-management/item/form/popups/localisation-popup/localisation-list-popup/localisation-list-popup.component.ts'
        );
        /* harmony import */ var _form_popups_localisation_popup_localisation_popup_component__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(
          /*! ./form/popups/localisation-popup/localisation-popup.component */ './src/app/main/engineering-management/item/form/popups/localisation-popup/localisation-popup.component.ts'
        );
        /* harmony import */ var _form_popups_reference_measurement_popup_reference_measurement_popup_component__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(
          /*! ./form/popups/reference-measurement-popup/reference-measurement-popup.component */ './src/app/main/engineering-management/item/form/popups/reference-measurement-popup/reference-measurement-popup.component.ts'
        );
        /* harmony import */ var _form_popups_repair_center_popup_repair_center_popup_component__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(
          /*! ./form/popups/repair-center-popup/repair-center-popup.component */ './src/app/main/engineering-management/item/form/popups/repair-center-popup/repair-center-popup.component.ts'
        );
        /* harmony import */ var _form_popups_statistics_popup_statistics_popup_component__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(
          /*! ./form/popups/statistics-popup/statistics-popup.component */ './src/app/main/engineering-management/item/form/popups/statistics-popup/statistics-popup.component.ts'
        );
        /* harmony import */ var _form_popups_task_popup_task_popup_component__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(
          /*! ./form/popups/task-popup/task-popup.component */ './src/app/main/engineering-management/item/form/popups/task-popup/task-popup.component.ts'
        );
        /* harmony import */ var _form_popups_til_popup_til_popup_component__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(
          /*! ./form/popups/til-popup/til-popup.component */ './src/app/main/engineering-management/item/form/popups/til-popup/til-popup.component.ts'
        );
        /* harmony import */ var _search_item_search_component__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(
          /*! ./search/item-search.component */ './src/app/main/engineering-management/item/search/item-search.component.ts'
        );
        /* harmony import */ var _search_item_search_service__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(
          /*! ./search/item-search.service */ './src/app/main/engineering-management/item/search/item-search.service.ts'
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
        ...
        var INTERNAL_MODULES = [
          ...
          _shared_components_dialog_search_rating_dialog_search_rating_module__WEBPACK_IMPORTED_MODULE_18__[
            'DialogSearchRatingModule'
          ],
          _shared_components_dialog_search_task_dialog_search_task_module__WEBPACK_IMPORTED_MODULE_20__[
          ...
          _shared_components_dynamic_attributes_dynamic_attributes_module__WEBPACK_IMPORTED_MODULE_22__[
         ...
         *************************************************************************** */
        var COMPONENTS = [
          _form_popups_add_evolution_popup_add_evolution_popup_component__WEBPACK_IMPORTED_MODULE_29__[
            'AddEvolutionPopupComponent'
          ],
          _form_popups_cause_of_removal_popup_cause_of_removal_popup_component__WEBPACK_IMPORTED_MODULE_30__[
            'CauseOfRemovalPopupComponent'
          ],
          _form_popups_configuration_pack_popup_configuration_pack_popup_component__WEBPACK_IMPORTED_MODULE_31__[
            'ConfigurationPackPopupComponent'
          ],
          _form_popups_damage_popup_damage_list_popup_damage_list_popup_component__WEBPACK_IMPORTED_MODULE_33__[
            'DamageListPopupComponent'
          ],
          _form_popups_damage_popup_damage_popup_component__WEBPACK_IMPORTED_MODULE_34__['DamagePopupComponent'],
          _form_popups_dam_loc_task_popup_dam_loc_task_popup_component__WEBPACK_IMPORTED_MODULE_32__[
            'DamLocTaskPopupComponent'
          ],
          _form_popups_edit_evolution_popup_edit_evolution_popup_component__WEBPACK_IMPORTED_MODULE_35__[
            'EditEvolutionPopupComponent'
          ],
          _form_popups_item_father_popup_item_father_popup_component__WEBPACK_IMPORTED_MODULE_36__[
            'ItemFatherPopupComponent'
          ],
          _form_popups_item_son_popup_item_son_popup_component__WEBPACK_IMPORTED_MODULE_38__['ItemSonPopupComponent'],
          _form_popups_item_version_popup_item_version_popup_component__WEBPACK_IMPORTED_MODULE_39__[
            'ItemVersionPopupComponent'
          ],
          _form_popups_localisation_popup_localisation_list_popup_localisation_list_popup_component__WEBPACK_IMPORTED_MODULE_40__[
            'LocalisationListPopupComponent'
          ],
          _form_popups_localisation_popup_localisation_popup_component__WEBPACK_IMPORTED_MODULE_41__[
            'LocalisationPopupComponent'
          ],
          _form_popups_reference_measurement_popup_reference_measurement_popup_component__WEBPACK_IMPORTED_MODULE_42__[
            'ReferenceMeasurementPopupComponent'
          ],
          _form_popups_repair_center_popup_repair_center_popup_component__WEBPACK_IMPORTED_MODULE_43__[
            'RepairCenterPopupComponent'
          ],
          _form_popups_statistics_popup_statistics_popup_component__WEBPACK_IMPORTED_MODULE_44__[
            'StatisticsPopupComponent'
          ],
          _form_popups_task_popup_task_popup_component__WEBPACK_IMPORTED_MODULE_45__['TaskPopupComponent'],
          _form_popups_item_import_popup_item_import_popup_component__WEBPACK_IMPORTED_MODULE_37__[
            'ItemImportPopupComponent'
          ],
          _form_popups_til_popup_til_popup_component__WEBPACK_IMPORTED_MODULE_46__['TilPopupComponent']
        ];
        var DYNAMIC_COMPONENTS = [
          _form_item_form_component__WEBPACK_IMPORTED_MODULE_27__['ItemFormComponent'],
          _search_item_search_component__WEBPACK_IMPORTED_MODULE_47__['ItemSearchComponent']
        ];
        /******************************************************************************
         * Services
         *************************************************************************** */
        var SERVICES = [
          _shared_components_dialog_search_rating_dialog_search_rating_service__WEBPACK_IMPORTED_MODULE_19__[
            'DialogSearchRatingService'
          ],
          _form_item_form_service__WEBPACK_IMPORTED_MODULE_28__['ItemFormService'],
          _search_item_search_service__WEBPACK_IMPORTED_MODULE_48__['ItemSearchService']
        ];
              ...
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['NgModule'])({
                ...
                imports: __spread(
                  [
                    ...
                    _shared_components_component_sidebar_component_sidebar_mdule__WEBPACK_IMPORTED_MODULE_15__[
                      'ComponentSidebarModule'
                    ],
                    _shared_components_dialog_bire_document_dialog_bire_document_module__WEBPACK_IMPORTED_MODULE_16__[
  ...
  \**********************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'ItemSearchComponent', function() {
        ...
        /* harmony import */ var _shared_utils_label_value_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
        ...
        /* harmony import */ var _item_search_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
          /*! ./item-search.service */ './src/app/main/engineering-management/item/search/item-search.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
          (function() {
        ...
        var ItemSearchComponent = /** @class */ (function(_super) {
          ...
          function ItemSearchComponent(
            ...
            _this.confirmationService = confirmationService;
            _this.componentName =
              _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_2__['ComponentConstants'].ENG_ITEM_SEARCH;
          ...
          ItemSearchComponent.prototype.exportTable = function() {
            ...
            this.exportService.toExcel(
              itemExportData,
              ItemSearchComponent_1.TABLE_EXPORT_NAME,
          ...
          ItemSearchComponent.prototype.openSelectedItem = function() {
            ...
            this.itemTableDataSource.dataSelection.forEach(function(item) {
              if (!!item) {
                if (
                  _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(item.familyCode)
                ) {
          ...
          ItemSearchComponent.prototype.openItem = function(objectId, openMode) {
            var data = {
              id: this.tabService.generateId(),
              componentId:
                _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_2__['ComponentConstants'].ENG_ITEM_FORM,
              openMode: openMode
            };
            if (!!objectId) {
              var itemFormId = {
          ...
          ItemSearchComponent.prototype.search = function() {
            ...
            var bire = {
              ...
              structureType: selectedFamilyVariant
                ? selectedFamilyVariant.bireVariantVersionDTO.structureType
                : undefined,
            ...
            this.itemSearchService.findBireItemsBySearchCriteria(criteria).subscribe(function(result) {
              ...
              if (result) {
                result.list.forEach(function(element) {
                  _shared_utils_label_value_utils__WEBPACK_IMPORTED_MODULE_12__['LabelValueUtils'].stringValueToLabel(
                    element,
                    'familyVariantCode',
                    _this.familyVariant
                  );
          ...
          ItemSearchComponent.prototype.initTableCols = function() {
            this.itemTableDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_1__[
              'TableDataSource'
            ]({
              columns: [
                ...
                { field: 'functionCode', translateKey: this.getTranslateKey('functionCode'), width: '10%' },
                {
                  ...
                  width: '10%',
                  alignment:
                    _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_1__['ColumnAlignment'].RIGHT
                }
              ],
              data: []
            });
          ...
          ItemSearchComponent = ItemSearchComponent_1 = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./item-search.component.html */ './src/app/main/engineering-management/item/search/item-search.component.html'
                )
              }),
              __metadata('design:paramtypes', [
