...
(function(global, factory) {
  ...
  function lab2xyz(lab) {
    ...
    x =
      x / 95.047 <= 0.008856 ? (x = (95.047 * (a / 500 + y2 - 16 / 116)) / 7.787) : 95.047 * Math.pow(a / 500 + y2, 3);
  ...
  var scale_category = core_scale.extend({
    ...
    buildTicks: function() {
      ...
      me.ticks =
        me.minIndex === 0 && me.maxIndex === labels.length - 1 ? labels : labels.slice(me.minIndex, me.maxIndex + 1);
    },
