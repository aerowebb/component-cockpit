(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ['logistics-material-material-module'],
  {
  ...
  \*************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'MaterialFormComponent', function() {
        ...
        /* harmony import */ var _shared_api_update_historic_api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! ../../../../shared/enums/table-column-filter-mode.enum */ './src/app/shared/enums/table-column-filter-mode.enum.ts'
        );
        /* harmony import */ var _shared_enums_table_selection_mode_enum__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
          /*! ../../../../shared/enums/table-selection-mode.enum */ './src/app/shared/enums/table-selection-mode.enum.ts'
        );
        /* harmony import */ var _shared_pipes_format_select_option_pipe__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_utils_workflow_utils__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
        ...
        /* harmony import */ var _material_form_service__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
          /*! ./material-form.service */ './src/app/main/logistics/material/form/material-form.service.ts'
        );
        var __extends =
        ...
        var MaterialFormComponent = /** @class */ (function(_super) {
          ...
          function MaterialFormComponent(
            favoriteService,
            loaderService,
            messageService,
          ...
          MaterialFormComponent.prototype.ngOnInit = function() {
            ...
            if (this.isCreateOpenMode) {
              this.materialFieldData.statusState =
                ...
                ].FUNC_OBJECT_STATUS_IS_INTEGRATED_KEY;
            }
          };
          ...
          MaterialFormComponent.prototype.init = function() {
            ...
            this.warehouseDialogOpenMode =
              _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_11__['ComponentOpenMode'].Read;
            this.supplierDialogOpenMode =
              _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_11__['ComponentOpenMode'].Read;
            this.valuationDialogOpenMode =
              _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_11__['ComponentOpenMode'].Read;
            this.alternativeDialogOpenMode =
              _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_11__['ComponentOpenMode'].Read;
            this.containerDialogOpenMode =
              _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_11__['ComponentOpenMode'].Read;
            this.supplyConversionDialogOpenMode =
              _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_11__['ComponentOpenMode'].Read;
          ...
          MaterialFormComponent.prototype.saveMaterial = function() {
            ...
            var missingFields = this.checkMandatoryFields(
              __assign({}, this.materialFieldData, {
          ...
          MaterialFormComponent.prototype.updateWorkflowStatusList = function() {
            if (!!this.materialFieldData) {
              this.workflowStatus = _shared_utils_workflow_utils__WEBPACK_IMPORTED_MODULE_27__[
                'WorkflowUtils'
              ].filterWorkflowStatusList(this.userWorkflow, this.partNumberStatus, this.materialFieldData.statusState);
            }
          };
          MaterialFormComponent.prototype.loadDropDown = function() {
            ...
            this.materialFormService.findAllBireUnitMeasures().subscribe(function(result) {
              ...
              result.forEach(function(res) {
                if (
                  _shared_constants_bire_unit_measure_constants__WEBPACK_IMPORTED_MODULE_8__['BireUnitMeasureConstants']
                    .DAY === res.label
                ) {
                  newLableValue.push({
          ...
          MaterialFormComponent.prototype.handleObjectStatus = function() {
            ...
            if (
              ...
              var currentState = this.getLabelValueByValue(
                this.propertyObjectStatus,
                this.materialFieldData.statusState
              );
              if (currentState) {
          ...
          MaterialFormComponent.prototype.loadMaterialDetailData = function() {
            ...
            var observables = [
              ...
              this.getDynamicAttributesObservable(
                _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__['AWPropertiesConstants']
                  .MCH_ATTRIBUTE_CATEGORY_MATERIAL_KEY
              )
            ];
            Object(rxjs__WEBPACK_IMPORTED_MODULE_2__['forkJoin'])(observables).subscribe(function(results) {
              if (results) {
                ...
                if (_this.componentData.objectId) {
                  ...
                  if (!!userId) {
                    _this.materialFormService.getMaterialDetails(userId).subscribe(
                      function(result) {
                        if (result !== null && result !== undefined) {
                          _this.materialFieldData = result.birePnDTO;
                          if (result.birePnDTO.averagePrice) {
                            _this.materialFieldData.averagePrice = _this.convertAveragePrice(
                              result.birePnDTO.averagePrice
                            );
                          }
                              ...
                              .subscribe(function(attributesResults) {
                                _this.dynamicAttributes.forEach(function(element) {
                                  element.attributes.forEach(function(attribute) {
                                    var attributeInResults = attributesResults.filter(function(res) {
                                      return res.attributeId === attribute.id;
                                    });
          ...
          MaterialFormComponent.prototype.loadMaterialUserWorkflow = function() {
            if (this.materialFieldData && this.propertyStatus) {
              ...
              if (
                !this.propertyStatus.find(function(item) {
                  return item.value === status_1;
                })
              ) {
              ...
              accept: function() {
                _this.selectedWarehouse.forEach(function(selected) {
                  if (!!_this.warehouseTable) {
                    _this.warehouseTable = _this.warehouseTable.filter(function(warehouse) {
                      return warehouse.dataId !== selected.dataId;
                    });
                  } else {
          ...
          MaterialFormComponent.prototype.openStatusUpdatesPopup = function() {
            ...
            var columns = [
              {
                ...
                width: '150px',
                filterMode:
                  _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_12__['TableColumnFilterMode']
                    .Input
              },
              {
                field: 'author',
            ...
            if (!!this.materialFieldData.sparePartClassCode) {
              this.updatesKeyMap.set(
                'sparePartClass',
                Object(rxjs__WEBPACK_IMPORTED_MODULE_2__['of'])(this.sparePartClassOptions)
              );
            }
            if (this.materialFieldData.pnCode) {
              this.tableStatusUpdatesData = {
                ...
                dataKey: undefined,
                selectionMode:
                  _shared_enums_table_selection_mode_enum__WEBPACK_IMPORTED_MODULE_13__['TableSelectionMode'].Multiple,
                globalFilter: false
              };
            }
          };
              ...
              accept: function() {
                _this.selectedValuation.forEach(function(selected) {
                  if (!!_this.valuationTable) {
                    _this.valuationTable = _this.valuationTable.filter(function(valuation) {
                      return valuation.bidtValuationGroupId !== selected.bidtValuationGroupId;
                    });
                  } else {
          ...
          MaterialFormComponent.prototype.onAddValuation = function(event) {
            ...
            if (!!event) {
              ...
              var isAdded = this.valuationTable.some(function(valuationData) {
                return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__['DTOUtils'].equalsValuationTableDTO(
                  valuationAttribute_1,
                  valuationData
                );
              });
              if (
                ...
                var checkElement = this.valuationTable.filter(function(valuationData, index) {
                  return (
                    index !== _this.currentValuationIndex &&
              ...
              accept: function() {
                _this.selectedSuppliers.forEach(function(selected) {
                  if (!!_this.supplierTable) {
                    _this.supplierTable = _this.supplierTable.filter(function(supplier) {
                      return supplier.dataId !== selected.dataId;
                    });
                  } else {
          ...
          MaterialFormComponent.prototype.onAddAlternative = function(event) {
            ...
            if (!!event) {
              ...
              var isAdded = this.alternativeTable.some(function(alternativeData) {
                return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__['DTOUtils'].equalsAlternativeTableDTO(
                  alternativeAttribute_1,
                  alternativeData
                );
              });
              if (
                ...
                var checkElement = this.alternativeTable.filter(function(alternativeData, index) {
                  return (
                    index !== _this.currentAlternativeIndex &&
              ...
              accept: function() {
                _this.selectedContainer.forEach(function(selected) {
                  if (!!_this.containerTable) {
                    _this.containerTable = _this.containerTable.filter(function(container) {
                      return container.pnCode !== selected.pnCode;
                    });
                  } else {
          ...
          MaterialFormComponent.prototype.onAddContainer = function(event) {
            if (!!event) {
              ...
              var isAdded = this.containerTable.some(function(containerData) {
                return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__['DTOUtils'].equalsContainerTableDTO(
                  containerAttribute_1,
                  containerData
                );
              });
              if (
          ...
          MaterialFormComponent.prototype.deleteSupplyConversion = function() {
            var _this = this;
            var partialMessageKey =
              this.selectedSupplyConversion.length > 1
                ? 'confirmOnDeleteSupplyConversions'
                : 'confirmOnDeleteSupplyConversion';
            this.confirmationService.confirmDelete({
              messageKey: this.getTranslateKey(partialMessageKey),
              accept: function() {
                _this.selectedSupplyConversion.forEach(function(selected) {
                  if (!!_this.supplyConversionTable) {
                    _this.supplyConversionTable = _this.supplyConversionTable.filter(function(supplyConversion) {
                      return supplyConversion.alternativeUnit !== selected.alternativeUnit;
                    });
                  } else {
                    _super.prototype.throwUnboundLocalError.call(
                      _this,
                      'deleteSupplyConversion',
                      'this.supplyConversionTable'
                    );
                  }
                });
          ...
          MaterialFormComponent.prototype.onAddSupplyConversion = function(event) {
            if (!!event) {
              ...
              var isAdded = this.supplyConversionTable.some(function(supplyConversionData) {
                return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__['DTOUtils'].equalsSupplyConversionTableDTO(
                  supplyConversionAttribute_1,
                  supplyConversionData
                );
              });
              if (
                this.supplyConversionDialogOpenMode ===
          ...
          __decorate(
            ...
            MaterialFormComponent.prototype,
            'mainAnchor',
            void 0
          );
          __decorate(
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./material-form.component.html */ './src/app/main/logistics/material/form/material-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./material-form.component.scss */ './src/app/main/logistics/material/form/material-form.component.scss'
                  )
                ]
              }),
  ...
  \******************************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _material_form_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ../../material-form.service */ './src/app/main/logistics/material/form/material-form.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
        ...
        var AssignAlternativesPopupFormComponent = /** @class */ (function(_super) {
          ...
          function AssignAlternativesPopupFormComponent(
            messageService,
            sessionService,
            propertiesService,
            materialFormService
          ...
          AssignAlternativesPopupFormComponent.prototype.loadDropDown = function() {
            ...
            this.propertiesService.getValue('getPnInterchangeabilityMap').subscribe(function(results) {
              _this.interchangeability = !!results
                ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_6__['SelectItemUtils'].fromLabelValues(
                    results
                  )
                : [];
            });
          ...
          __decorate(
            ...
            AssignAlternativesPopupFormComponent.prototype,
            'onValidated',
            void 0
          );
          __decorate(
          ...
          AssignAlternativesPopupFormComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./assign-alternative-popup-form.component.html */ './src/app/main/logistics/material/form/popups/assign-alternative-popup-form/assign-alternative-popup-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ../popup-form.component.scss */ './src/app/main/logistics/material/form/popups/popup-form.component.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
  ...
  \**************************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _material_form_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! ../../material-form.service */ './src/app/main/logistics/material/form/material-form.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
        ...
        var AssignContainerPopupFormComponent = /** @class */ (function(_super) {
          ...
          function AssignContainerPopupFormComponent(
            inputValidationService,
            messageService,
            sessionService,
            propertiesService,
          ...
          __decorate(
            [Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Input'])(), __metadata('design:type', Object)],
            AssignContainerPopupFormComponent.prototype,
            'containerDetail',
            void 0
          );
          __decorate(
          ...
          AssignContainerPopupFormComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./assign-container-popup-form.component.html */ './src/app/main/logistics/material/form/popups/assign-container-popup-form/assign-container-popup-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ../popup-form.component.scss */ './src/app/main/logistics/material/form/popups/popup-form.component.scss'
  ...
  \************************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _material_form_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ../../material-form.service */ './src/app/main/logistics/material/form/material-form.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
        ...
        var AssignSuppliersPopupFormComponent = /** @class */ (function(_super) {
          ...
          function AssignSuppliersPopupFormComponent(
            inputValidationService,
            messageService,
            sessionService,
            propertiesService,
          ...
          __decorate(
            [Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Input'])(), __metadata('design:type', Object)],
            AssignSuppliersPopupFormComponent.prototype,
            'supplierDetail',
            void 0
          );
          __decorate(
          ...
          AssignSuppliersPopupFormComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./assign-supplier-popup-form.component.html */ './src/app/main/logistics/material/form/popups/assign-supplier-popup-form/assign-supplier-popup-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ../popup-form.component.scss */ './src/app/main/logistics/material/form/popups/popup-form.component.scss'
  ...
  \******************************************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_services_date_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../../../../../../shared/services/date.service */ './src/app/shared/services/date.service.ts'
        );
        /* harmony import */ var _shared_services_input_validation_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../../../../../../shared/services/input-validation.service */ './src/app/shared/services/input-validation.service.ts'
        ...
        var AssignSupplyConversionPopupFormComponent = /** @class */ (function(_super) {
          ...
          function AssignSupplyConversionPopupFormComponent(
            inputValidationService,
            messageService,
            sessionService,
            propertiesService,
          ...
          __decorate(
            [Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Input'])(), __metadata('design:type', String)],
            AssignSupplyConversionPopupFormComponent.prototype,
            'pnCode',
            void 0
          );
          __decorate(
          ...
          AssignSupplyConversionPopupFormComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./assign-supply-conversion-popup-form.component.html */ './src/app/main/logistics/material/form/popups/assign-supply-conversion-popup-form/assign-supply-conversion-popup-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ../popup-form.component.scss */ './src/app/main/logistics/material/form/popups/popup-form.component.scss'
  ...
  \**************************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var AssignValuationPopupFormComponent = /** @class */ (function(_super) {
          ...
          function AssignValuationPopupFormComponent(
            inputValidationService,
            messageService,
            sessionService,
            propertiesService,
          ...
          AssignValuationPopupFormComponent.prototype.validate = function() {
            ...
            if (!!this.valuationDetail) {
              ...
              this.valuationDetail.bidtValuationGroupId = this.valuationGroupId
                ? parseInt(this.valuationGroupId, 10)
                : undefined;
          ...
          __decorate(
            [Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Input'])(), __metadata('design:type', Object)],
            AssignValuationPopupFormComponent.prototype,
            'valuationDetail',
            void 0
          );
          __decorate(
          ...
          AssignValuationPopupFormComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./assign-valuation-popup-form.component.html */ './src/app/main/logistics/material/form/popups/assign-valuation-popup-form/assign-valuation-popup-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ../popup-form.component.scss */ './src/app/main/logistics/material/form/popups/popup-form.component.scss'
  ...
  \**************************************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var AssignWarehousePopupFormComponent = /** @class */ (function(_super) {
          ...
          function AssignWarehousePopupFormComponent(
            inputValidationService,
            messageService,
            sessionService,
            propertiesService,
          ...
          AssignWarehousePopupFormComponent.prototype.ngOnInit = function() {
            ...
            if (!this.warehouseDetail) {
              ...
              this.wareHouseId = this.warehouseDetail.wareHouseId
                ? this.warehouseDetail.wareHouseId.toString()
                : undefined;
            }
          };
            ...
            if (!!this.wareHouseId) {
              ...
              this.materialFormService.findByWarehouseId(parseInt(this.wareHouseId, 10)).subscribe(function(result) {
                ...
                if (
                  ...
                  if (
                    !!_this.warehouseDetail.bidtStorageBinDTOList &&
                    _this.warehouseDetail.bidtStorageBinDTOList.length > 0
                  ) {
          ...
          __decorate(
            [Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Input'])(), __metadata('design:type', Object)],
            AssignWarehousePopupFormComponent.prototype,
            'warehouseDetail',
            void 0
          );
          __decorate(
          ...
          AssignWarehousePopupFormComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./assign-warehouse-popup-form.component.html */ './src/app/main/logistics/material/form/popups/assign-warehouse-popup-form/assign-warehouse-popup-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ../popup-form.component.scss */ './src/app/main/logistics/material/form/popups/popup-form.component.scss'
  ...
  \************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var primeng_tristatecheckbox__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! primeng/tristatecheckbox */ './node_modules/primeng/tristatecheckbox.js'
        );
        /* harmony import */ var primeng_tristatecheckbox__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/ __webpack_require__.n(
          primeng_tristatecheckbox__WEBPACK_IMPORTED_MODULE_12__
        );
        ...
        /* harmony import */ var _shared_components_dialog_search_material_dialog_search_material_module__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_components_dialog_table_dialog_table_module__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
          /*! ../../../shared/components/dialog-table/dialog-table.module */ './src/app/shared/components/dialog-table/dialog-table.module.ts'
        );
        /* harmony import */ var _shared_components_dynamic_attributes_dynamic_attributes_module__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_components_status_update_history_status_update_history_module__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
        ...
        /* harmony import */ var _procurement_request_search_procurement_request_popup_procurement_request_popup_module__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
          /*! ../procurement-request/search/procurement-request-popup/procurement-request-popup.module */ './src/app/main/logistics/procurement-request/search/procurement-request-popup/procurement-request-popup.module.ts'
        );
        ...
        /* harmony import */ var _form_material_form_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(
          /*! ./form/material-form.component */ './src/app/main/logistics/material/form/material-form.component.ts'
        );
        /* harmony import */ var _form_material_form_service__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(
          /*! ./form/material-form.service */ './src/app/main/logistics/material/form/material-form.service.ts'
        );
        /* harmony import */ var _form_popups_assign_alternative_popup_form_assign_alternative_popup_form_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(
          /*! ./form/popups/assign-alternative-popup-form/assign-alternative-popup-form.component */ './src/app/main/logistics/material/form/popups/assign-alternative-popup-form/assign-alternative-popup-form.component.ts'
        );
        /* harmony import */ var _form_popups_assign_container_popup_form_assign_container_popup_form_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(
          /*! ./form/popups/assign-container-popup-form/assign-container-popup-form.component */ './src/app/main/logistics/material/form/popups/assign-container-popup-form/assign-container-popup-form.component.ts'
        );
        /* harmony import */ var _form_popups_assign_supplier_popup_form_assign_supplier_popup_form_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(
          /*! ./form/popups/assign-supplier-popup-form/assign-supplier-popup-form.component */ './src/app/main/logistics/material/form/popups/assign-supplier-popup-form/assign-supplier-popup-form.component.ts'
        );
        /* harmony import */ var _form_popups_assign_supply_conversion_popup_form_assign_supply_conversion_popup_form_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(
          /*! ./form/popups/assign-supply-conversion-popup-form/assign-supply-conversion-popup-form.component */ './src/app/main/logistics/material/form/popups/assign-supply-conversion-popup-form/assign-supply-conversion-popup-form.component.ts'
        );
        /* harmony import */ var _form_popups_assign_valuation_popup_form_assign_valuation_popup_form_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(
        ...
        /* harmony import */ var _form_popups_assign_warehouse_popup_form_assign_warehouse_popup_form_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(
          /*! ./form/popups/assign-warehouse-popup-form/assign-warehouse-popup-form.component */ './src/app/main/logistics/material/form/popups/assign-warehouse-popup-form/assign-warehouse-popup-form.component.ts'
        );
        /* harmony import */ var _search_material_search_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(
          /*! ./search/material-search.component */ './src/app/main/logistics/material/search/material-search.component.ts'
        );
        /* harmony import */ var _search_material_search_service__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(
          /*! ./search/material-search.service */ './src/app/main/logistics/material/search/material-search.service.ts'
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
          function(decorators, target, key, desc) {
        ...
        var INTERNAL_MODULES = [
          ...
          _shared_components_dynamic_attributes_dynamic_attributes_module__WEBPACK_IMPORTED_MODULE_19__[
            'DynamicAttributesModule'
          ],
          _shared_components_modal_modal_module__WEBPACK_IMPORTED_MODULE_20__['ModalModule'],
          _shared_components_dialog_search_material_dialog_search_material_module__WEBPACK_IMPORTED_MODULE_17__[
            'DialogSearchMaterialModule'
          ],
          _shared_components_component_sidebar_component_sidebar_mdule__WEBPACK_IMPORTED_MODULE_16__[
            'ComponentSidebarModule'
          ],
          _shared_components_status_update_history_status_update_history_module__WEBPACK_IMPORTED_MODULE_21__[
            'StatusUpdateHistoryModule'
          ],
          _procurement_request_search_procurement_request_popup_procurement_request_popup_module__WEBPACK_IMPORTED_MODULE_24__[
         ...
         *************************************************************************** */
        var COMPONENTS = [
          _form_popups_assign_warehouse_popup_form_assign_warehouse_popup_form_component__WEBPACK_IMPORTED_MODULE_33__[
            'AssignWarehousePopupFormComponent'
          ],
          _form_popups_assign_supplier_popup_form_assign_supplier_popup_form_component__WEBPACK_IMPORTED_MODULE_30__[
            'AssignSuppliersPopupFormComponent'
          ],
          _form_popups_assign_valuation_popup_form_assign_valuation_popup_form_component__WEBPACK_IMPORTED_MODULE_32__[
            'AssignValuationPopupFormComponent'
          ],
          _form_popups_assign_alternative_popup_form_assign_alternative_popup_form_component__WEBPACK_IMPORTED_MODULE_28__[
            'AssignAlternativesPopupFormComponent'
          ],
          _form_popups_assign_container_popup_form_assign_container_popup_form_component__WEBPACK_IMPORTED_MODULE_29__[
            'AssignContainerPopupFormComponent'
          ],
          _form_popups_assign_supply_conversion_popup_form_assign_supply_conversion_popup_form_component__WEBPACK_IMPORTED_MODULE_31__[
            'AssignSupplyConversionPopupFormComponent'
          ]
        ];
        var DYNAMIC_COMPONENTS = [
          _search_material_search_component__WEBPACK_IMPORTED_MODULE_34__['MaterialSearchComponent'],
          _form_material_form_component__WEBPACK_IMPORTED_MODULE_26__['MaterialFormComponent']
        ];
        /******************************************************************************
         * Services
         *************************************************************************** */
        var SERVICES = [
          _search_material_search_service__WEBPACK_IMPORTED_MODULE_35__['MaterialSearchService'],
          _form_material_form_service__WEBPACK_IMPORTED_MODULE_27__['MaterialFormService']
        ];
  ...
  \*****************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _material_search_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
          /*! ./material-search.service */ './src/app/main/logistics/material/search/material-search.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
          (function() {
        ...
        var MaterialSearchComponent = /** @class */ (function(_super) {
          ...
          /* ***************************************************************************/
          function MaterialSearchComponent(
            favoriteService,
            loaderService,
            messageService,
            serializationService,
          ...
          MaterialSearchComponent.prototype.deleteMaterials = function() {
            ...
            this.confirmationService.confirmDelete({
              ...
              accept: function() {
                ...
                _this.materialSearchService.removeBireData(materialsId).subscribe(
                  function() {
          ...
          MaterialSearchComponent.prototype.exportTable = function() {
            ...
            this.exportService.toExcel(
              materialExportData,
              MaterialSearchComponent_1.CUSTOMER_TABLE_EXPORT_NAME,
          ...
          MaterialSearchComponent.prototype.search = function() {
            ...
            var searchData = {
              ...
              articleDesignation: this.searchObject.articleDesignation
                ? this.searchObject.articleDesignation.trim()
                : '',
          ...
          __decorate(
            ...
            MaterialSearchComponent.prototype,
          ...
          MaterialSearchComponent = MaterialSearchComponent_1 = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./material-search.component.html */ './src/app/main/logistics/material/search/material-search.component.html'
                )
              }),
              __metadata('design:paramtypes', [
  ...
  \***************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'MaterialSearchService', function() {
