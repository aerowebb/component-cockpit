(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \***********************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        ...
        /* harmony import */ var _shared_utils_service_locator__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ../../../shared/utils/service-locator */ './src/app/shared/utils/service-locator.ts'
        );
        var __extends =
        ...
        var TableDataSourceWithHistory = /** @class */ (function(_super) {
          ...
          function TableDataSourceWithHistory(_a) {
            var columns = _a.columns,
              ...
              allowUniqueValue = _a.allowUniqueValue,
              propertiesWitchIdentifyData = _a.propertiesWitchIdentifyData,
              errorOnAddedDuplicate = _a.errorOnAddedDuplicate,
            ...
            _this.errorOnAddedDuplicate = !!errorOnAddedDuplicate
              ? errorOnAddedDuplicate
              : _this.errorOnAddedDuplicateDefaultKey;
            _this.errorOnUpdatedDuplicate = !!errorOnUpdatedDuplicate
              ? errorOnUpdatedDuplicate
              : _this.errorOnUpdatedDuplicateDefaultKey;
            _this._messageService = _shared_utils_service_locator__WEBPACK_IMPORTED_MODULE_4__[
              'ServiceLocator'
            ].injector.get(_shared_services_message_service__WEBPACK_IMPORTED_MODULE_3__['MessageService']);
            _this._translateService = _shared_utils_service_locator__WEBPACK_IMPORTED_MODULE_4__[
              'ServiceLocator'
            ].injector.get(_ngx_translate_core__WEBPACK_IMPORTED_MODULE_0__['TranslateService']);
            _this.clearHistory();
            return _this;
          }
          TableDataSourceWithHistory.prototype.getComponentName = function() {
            return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_2__['ComponentConstants']
              .PCT_TABLE_DATA_SOURCE_WITH_HISTORY;
          };
            ...
            if (this.allowUniqueValue) {
              dataToAdd.forEach(function(entity) {
                if (!_this.existEqualsDatas(entity)) {
                  ...
                  addedData.forEach(function(elt) {
                    return _this.addedList.push(elt);
                  });
                } else {
                  _this._translateService
                    .get(_this.errorOnAddedDuplicate, { data: entity })
                    .subscribe(function(result) {
                      return _this._messageService.showErrorMessage(result);
                    });
                }
              });
            } else {
          ...
          TableDataSourceWithHistory.prototype.deleteDataSelection = function() {
            var _this = this;
            this.dataSelection.forEach(function(elt) {
              return _this.deleteData([elt]);
            });
            this.dataSelection = [];
          };
          TableDataSourceWithHistory.prototype.indexOf = function(list, entity) {
            ...
            if (!!list && list.length > 0) {
              return list.findIndex(function(elt) {
                return _this.equals(entity, elt);
              });
            } else {
              return -1;
            }
          ...
          TableDataSourceWithHistory.prototype.getEqualsDatas = function(toFind, idToIgnore) {
            var _this = this;
            var returnedData;
            var equalsData = this.dataSrc.filter(function(elt) {
              return elt._id !== idToIgnore && _this.equals(toFind, elt);
            });
          ...
          TableDataSourceWithHistory.prototype.equals = function(toFind, entity) {
            ...
            if (!!this.propertiesWitchIdentifyData && this.propertiesWitchIdentifyData.length > 0) {
              ...
              propertiesWitchIdentifyData = Object.keys(toFind).filter(function(keyOfT) {
                return Object.keys(entity).includes(keyOfT);
              });
            }
