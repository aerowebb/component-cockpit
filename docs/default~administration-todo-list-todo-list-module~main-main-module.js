(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_constants_function_object_constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
        ...
        /* harmony import */ var _workflow_management_form_workflow_management_form_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
          /*! ../../workflow-management/form/workflow-management-form.service */ './src/app/main/administration/workflow-management/form/workflow-management-form.service.ts'
        );
        /* harmony import */ var _todo_list_search_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
          /*! ./todo-list-search.service */ './src/app/main/administration/todo-list/search/todo-list-search.service.ts'
        );
        var __extends =
        ...
        var TodoListSearchComponent = /** @class */ (function(_super) {
          ...
          function TodoListSearchComponent(
            favoriteService,
            loaderService,
            messageService,
          ...
          TodoListSearchComponent.prototype.initTodoListTableDataSource = function() {
            this.todoListTableDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_3__[
              'TableDataSource'
            ]({
          ...
          TodoListSearchComponent.prototype.ngOnInit = function() {
            ...
            this.functionObjectMap = _shared_constants_function_object_constants__WEBPACK_IMPORTED_MODULE_5__[
              'FunctionObjectConstants'
            ].getFunctionObjectConfigurationMapByKey();
            this.loadReferences();
          };
          TodoListSearchComponent.prototype.loadReferences = function() {
            ...
            this.workflowManagementFormService.getInternationalizedFuncObject().subscribe(function(response) {
              ...
              _todo_list_search_service__WEBPACK_IMPORTED_MODULE_15__['TodoListSearchService'].todoList$
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__['takeUntil'])(_this.unsubscribe))
                .subscribe(function(result) {
                  if (result) {
                    var todoRowList = result.map(function(item) {
                      return {
                        obj: item,
                        id: item.functionalIdentifier || '_',
                        isUrgent: item.isUrgent,
                        funcObjectLabel: _this.getLabelByKey(
                          _this.functionObjectList,
                          item.funcObject && item.funcObject.objectKey
                        ),
          ...
          TodoListSearchComponent.prototype.getTodoItemConfiguration = function(item) {
            return item.funcObject && item.funcObject.objectKey
              ? this.functionObjectMap[item.funcObject.objectKey]
              : undefined;
          };
          ...
          TodoListSearchComponent.prototype.openTodoRows = function() {
            var _this = this;
            this.todoListTableDataSource.dataSelection.forEach(function(row) {
              return _this.openTodoRow(row);
            });
          };
          TodoListSearchComponent.prototype.exportTodoTable = function() {
            this.exportService.toExcel(
              this.todoListTableDataSource.sanitizedData.map(function(data) {
                var objLess = __assign({}, data);
                delete objLess.obj;
                return objLess;
              }),
              TodoListSearchComponent_1.TODO_LIST_TABLE_EXPORT_NAME,
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./todo-list-search.component.html */ './src/app/main/administration/todo-list/search/todo-list-search.component.html'
                )
              }),
              __metadata('design:paramtypes', [
                ...
                _workflow_management_form_workflow_management_form_service__WEBPACK_IMPORTED_MODULE_14__[
                  'WorkflowManagementFormService'
                ]
              ])
            ],
  ...
  \**********************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'TodoListSearchService', function() {
        ...
        var TodoListSearchService = /** @class */ (function(_super) {
          ...
          TodoListSearchService.prototype.refreshWholeTodoList = function() {
            ...
            this.getTodoList({}).subscribe(function(result) {
              return TodoListSearchService_1._todoList.next(result);
            });
          };
  ...
  \*******************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'TodoListModule', function() {
        ...
        /* harmony import */ var _shared_types_api_types_bidt_scenario_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ../../../shared/types/api-types/bidt-scenario.api */ './src/app/shared/types/api-types/bidt-scenario.api.ts'
        );
        ...
        /* harmony import */ var _workflow_management_workflow_management_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ../workflow-management/workflow-management.module */ './src/app/main/administration/workflow-management/workflow-management.module.ts'
        );
        /* harmony import */ var _search_todo_list_search_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
          /*! ./search/todo-list-search.component */ './src/app/main/administration/todo-list/search/todo-list-search.component.ts'
        );
        /* harmony import */ var _search_todo_list_search_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ./search/todo-list-search.service */ './src/app/main/administration/todo-list/search/todo-list-search.service.ts'
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
          function(decorators, target, key, desc) {
        ...
        var INTERNAL_MODULES = [
          ...
          _workflow_management_workflow_management_module__WEBPACK_IMPORTED_MODULE_8__['WorkflowManagementModule']
        ];
        /******************************************************************************
         * Components
         *************************************************************************** */
        ...
        var DYNAMIC_COMPONENTS = [
          _search_todo_list_search_component__WEBPACK_IMPORTED_MODULE_9__['TodoListSearchComponent']
        ];
        /******************************************************************************
         * Services
         *************************************************************************** */
