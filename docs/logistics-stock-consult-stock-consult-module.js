(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ['logistics-stock-consult-stock-consult-module'],
  {
  ...
  \***********************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _maintenance_airworthiness_control_search_search_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
          /*! ../../../maintenance/airworthiness-control/search/search.service */ './src/app/main/maintenance/airworthiness-control/search/search.service.ts'
        );
        /* harmony import */ var _material_form_material_form_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
          /*! ../../material/form/material-form.service */ './src/app/main/logistics/material/form/material-form.service.ts'
        );
        /* harmony import */ var _search_stock_consult_search_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
          /*! ../search/stock-consult-search.service */ './src/app/main/logistics/stock-consult/search/stock-consult-search.service.ts'
        );
        var __extends =
        ...
        var StockConsultFormComponent = /** @class */ (function(_super) {
          ...
          function StockConsultFormComponent(
            favoriteService,
            loaderService,
            messageService,
          ...
          StockConsultFormComponent.prototype.toggleFlightsExpand = function(row) {
            this.remainingTable = [];
            var stock = this.stockInformaionDtos.filter(function(fl) {
              return fl.pn === row.pn;
            });
          ...
          StockConsultFormComponent.prototype.openSerailNumber = function(selectedStockDto) {
            ...
            this.stockConsultSearchService
              .getEuipmentBYpnAndSN(this.searchEuipmentByPnAndSn)
              .subscribe(function(results) {
                _this.equipmentDtos = results;
                if (!!_this.equipmentDtos && _this.equipmentDtos.length === 1) {
                  _this.openEquipment(
                    _this.equipmentDtos[0],
                    _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__['ComponentOpenMode'].Read
                  );
                } else {
                  _this.messageService.showWarningMessage(
                    'Asset not found ! : ' +
                      _this.searchEuipmentByPnAndSn.pnCode +
                      '/' +
                      _this.searchEuipmentByPnAndSn.sn
                  );
                }
              });
          };
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./stock-consult-form.component.html */ './src/app/main/logistics/stock-consult/form/stock-consult-form.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./stock-consult-form.component.scss */ './src/app/main/logistics/stock-consult/form/stock-consult-form.component.scss'
                  )
                ]
              }),
  ...
  \***************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _maintenance_airworthiness_control_search_search_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
          /*! ../../../maintenance/airworthiness-control/search/search.service */ './src/app/main/maintenance/airworthiness-control/search/search.service.ts'
        );
        /* harmony import */ var _material_form_material_form_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
          /*! ../../material/form/material-form.service */ './src/app/main/logistics/material/form/material-form.service.ts'
        );
        /* harmony import */ var _stock_consult_search_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
          /*! ./stock-consult-search.service */ './src/app/main/logistics/stock-consult/search/stock-consult-search.service.ts'
        );
        var __extends =
          (undefined && undefined.__extends) ||
          (function() {
        ...
        var StockConsultSearchComponent = /** @class */ (function(_super) {
          ...
          function StockConsultSearchComponent(
            favoriteService,
            loaderService,
            messageService,
            serializationService,
            ...
            _this.SEARCH_CRITERIA_ID =
              _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_1__[
                'AppConstants'
              ].STOCK_CONSULT_SEARCH_CRITERIA_ID;
            return _this;
          }
          ...
          StockConsultSearchComponent.prototype.getSiteList = function() {
            ...
            this.materialFormService.findAllSites().subscribe(function(result) {
              ...
              _this.sites = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_14__['ListUtils']
                .orEmpty(result)
                .map(function(site) {
                  return {
          ...
          StockConsultSearchComponent.prototype.getWareHouseList = function() {
            ...
            this.searchService.findAllWarehouse().subscribe(function(results) {
              ...
              _this.warehouses = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_14__['ListUtils']
                .orEmpty(results)
          ...
          StockConsultSearchComponent.prototype.findStorageBinBYWarehouseId = function() {
            ...
            if (!!this.searchObject.warehouseId) {
              this.stockConsultSearchService
                .findBinStorageByWarehouseId(this.searchObject.warehouseId)
              ...
              var site = this.bidtWarehouseDTOs.filter(function(warehouseId) {
                return warehouseId.wareHouseId === _this.searchObject.warehouseId;
              });
              if (site && site.length > 0) {
                this.searchObject.siteId = site[0].bidtSiteId;
              }
              var whType = this.bidtWarehouseDTOs.filter(function(warehouseId) {
                return warehouseId.wareHouseId === _this.searchObject.warehouseId;
              });
          ...
          StockConsultSearchComponent = __decorate(
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./stock-consult-search.component.html */ './src/app/main/logistics/stock-consult/search/stock-consult-search.component.html'
                ),
                styles: [
                  __webpack_require__(
                    /*! ./stock-consult-search.component.scss */ './src/app/main/logistics/stock-consult/search/stock-consult-search.component.scss'
                  )
                ]
              }),
              __metadata('design:paramtypes', [
  ...
  \*************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _shared_api_bidt_stock_type_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../../../../shared/api/bidt-stock-type.api */ './src/app/shared/api/bidt-stock-type.api.ts'
        );
        /* harmony import */ var _shared_api_bidt_storage_bin_api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
        ...
        var StockConsultSearchService = /** @class */ (function(_super) {
          ...
          function StockConsultSearchService(
            http,
            appConfigService,
            bidtStorageBinApi,
            bidtStockTypeApi,
  ...
  \**********************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        'use strict';
        __webpack_require__.r(__webpack_exports__);
        /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'StockConsultModule', function() {
        ...
        /* harmony import */ var _shared_api_bidt_storage_bin_api__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! ../../../shared/api/bidt-storage-bin.api */ './src/app/shared/api/bidt-storage-bin.api.ts'
        );
        ...
        /* harmony import */ var _maintenance_airworthiness_control_search_search_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
          /*! ../../maintenance/airworthiness-control/search/search.service */ './src/app/main/maintenance/airworthiness-control/search/search.service.ts'
        );
        /* harmony import */ var _material_form_material_form_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
          /*! ../material/form/material-form.service */ './src/app/main/logistics/material/form/material-form.service.ts'
        );
        /* harmony import */ var _stock_consult_form_stock_consult_form_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
          /*! ../stock-consult/form/stock-consult-form.component */ './src/app/main/logistics/stock-consult/form/stock-consult-form.component.ts'
        );
        /* harmony import */ var _search_stock_consult_search_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
          /*! ./search/stock-consult-search.component */ './src/app/main/logistics/stock-consult/search/stock-consult-search.component.ts'
        );
        /* harmony import */ var _search_stock_consult_search_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
          /*! ./search/stock-consult-search.service */ './src/app/main/logistics/stock-consult/search/stock-consult-search.service.ts'
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
        ...
        var DYNAMIC_COMPONENTS = [
          _search_stock_consult_search_component__WEBPACK_IMPORTED_MODULE_23__['StockConsultSearchComponent'],
          _stock_consult_form_stock_consult_form_component__WEBPACK_IMPORTED_MODULE_22__['StockConsultFormComponent']
        ];
        /******************************************************************************
         * Services
         *************************************************************************** */
        var SERVICES = [
          _material_form_material_form_service__WEBPACK_IMPORTED_MODULE_21__['MaterialFormService'],
          _maintenance_airworthiness_control_search_search_service__WEBPACK_IMPORTED_MODULE_20__['SearchService'],
          _search_stock_consult_search_service__WEBPACK_IMPORTED_MODULE_24__['StockConsultSearchService'],
          _shared_api_bidt_storage_bin_api__WEBPACK_IMPORTED_MODULE_12__['BidtStorageBinApi']
        ];
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['NgModule'])({
                declarations: __spread(COMPONENTS, DYNAMIC_COMPONENTS, [
                  _stock_consult_form_stock_consult_form_component__WEBPACK_IMPORTED_MODULE_22__[
                    'StockConsultFormComponent'
                  ]
                ]),
                imports: __spread(
