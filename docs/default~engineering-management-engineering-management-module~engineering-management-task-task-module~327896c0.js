(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  ...
  \************************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ../../constants/aw-properties-constants */ './src/app/shared/constants/aw-properties-constants.ts'
        );
        /* harmony import */ var _constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
        ...
        /* harmony import */ var _services_properties_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
        ...
        /* harmony import */ var _utils_bido_family_variant_utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
          /*! ../../utils/bido-family-variant-utils */ './src/app/shared/utils/bido-family-variant-utils.ts'
        );
        ...
        /* harmony import */ var _utils_object_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
          /*! ../../utils/object-utils */ './src/app/shared/utils/object-utils.ts'
        );
        /* harmony import */ var _utils_string_utils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
          /*! ../../utils/string-utils */ './src/app/shared/utils/string-utils.ts'
        );
        /* harmony import */ var _dialog_search_evolution_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
          /*! ./dialog-search-evolution.service */ './src/app/shared/components/dialog-search-evolution/dialog-search-evolution.service.ts'
        );
        var __extends =
        ...
        var DialogSearchEvolutionComponent = /** @class */ (function(_super) {
          ...
          function DialogSearchEvolutionComponent(dialogSearchEvolutionService, propertiesService, translateService) {
            ...
            _this.structureType =
              _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__[
          ...
          Object.defineProperty(DialogSearchEvolutionComponent.prototype, 'familyVariantCode', {
            ...
            set: function(value) {
              ...
              if (this._familyVariantCode) {
                this.familyCode = _utils_bido_family_variant_utils__WEBPACK_IMPORTED_MODULE_10__[
                  'BidoFamilyVariantUtils'
                ].getFamilyCodeFromFamilyVariantCode(value);
                this.variantCode = _utils_bido_family_variant_utils__WEBPACK_IMPORTED_MODULE_10__[
                  'BidoFamilyVariantUtils'
                ].getVariantCodeFromFamilyVariantCode(value);
              }
            },
            enumerable: true,
            configurable: true
          ...
          DialogSearchEvolutionComponent.prototype.search = function() {
            ...
            if (
              _utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(this.evolutionSource) ||
              this.evolutionSource ===
                _constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_5__['BidoEvolutionConstants']
                  .CODE_EVOLUTION
            ) {
              if (!_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(this.equipmentCode)) {
                ...
                evolutionObservableList = __spread(evolutionObservableList, [
                  this.findEvolutionListByEquipment().pipe(
                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['map'])(function(result) {
                      return _this.postProcessEvolutionResultList(result);
                    })
                  )
                ]);
                ...
                !_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(this.variantCode)
              ) {
            ...
            if (
              _utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(this.evolutionSource) ||
              this.evolutionSource ===
                _constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_5__['BidoEvolutionConstants'].CODE_SB
            ) {
              if (!_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(this.equipmentCode)) {
                // If research is done for a particular Asset
                sbObservableList = __spread(sbObservableList, [
                  this.findSbListByEquipment().pipe(
                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['map'])(function(result) {
                      return _this.postProcessSbResultList(result);
                    })
                  )
                ]);
              } else if (
                ...
                sbObservableList = __spread(sbObservableList, [
                  this.findApplicableSbList().pipe(
                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['map'])(function(result) {
                      return _this.postProcessSbResultList(result);
                    })
                  )
                ...
                evolutionObservableList = __spread(evolutionObservableList, [
                  this.findSbListBySbIdAndDesignation().pipe(
                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['map'])(function(result) {
                      return _this.postProcessSbResultList(result);
                    })
                  )
            ...
            if (
              _utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(this.evolutionSource) ||
              this.evolutionSource ===
                _constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_5__['BidoEvolutionConstants'].CODE_AD
            ) {
              if (!_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(this.variantCode)) {
                ...
                sbObservableList = __spread(sbObservableList, [
                  this.findApplicableAdList().pipe(
                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['map'])(function(result) {
                      return _this.postProcessAdResultList(result);
                    })
                  )
                ]);
              } else {
            ...
            if (
              ...
              if (!_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(this.variantCode)) {
                ...
                modificationObservableList = __spread(modificationObservableList, [
                  this.findApplicableModificationList().pipe(
                    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__['map'])(function(result) {
                      return _this.postProcessModificationResultList(result);
                    })
                  )
                ]);
              } else {
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_2__['forkJoin'])({
              evolutionList: _utils_list_utils__WEBPACK_IMPORTED_MODULE_11__['ListUtils'].isEmpty(
                evolutionObservableList
              )
                ? Object(rxjs__WEBPACK_IMPORTED_MODULE_2__['of'])([])
                : Object(rxjs__WEBPACK_IMPORTED_MODULE_2__['forkJoin'])(evolutionObservableList),
              modificationList: _utils_list_utils__WEBPACK_IMPORTED_MODULE_11__['ListUtils'].isEmpty(
                modificationObservableList
              )
                ? Object(rxjs__WEBPACK_IMPORTED_MODULE_2__['of'])([])
                : Object(rxjs__WEBPACK_IMPORTED_MODULE_2__['forkJoin'])(modificationObservableList),
              sbList: _utils_list_utils__WEBPACK_IMPORTED_MODULE_11__['ListUtils'].isEmpty(sbObservableList)
                ? Object(rxjs__WEBPACK_IMPORTED_MODULE_2__['of'])([])
                : Object(rxjs__WEBPACK_IMPORTED_MODULE_2__['forkJoin'])(sbObservableList)
            }).subscribe({
              next: function(result) {
                return _this.processSearchResultList(result.evolutionList, result.modificationList, result.sbList);
              }
            });
          };
          ...
          DialogSearchEvolutionComponent.prototype.createEvolutionRowFromEvolution = function(evolution) {
            var compliance = this.evolutionComplianceList.find(function(elt) {
              return elt.value === evolution.evolutionCompliance;
            });
            var status = this.evolutionStatusList.find(function(elt) {
              return elt.value === evolution.statusState;
            });
            var evolutionRow = {
              compliance: compliance
                ? _utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].orEmpty(compliance.label)
                : '',
              designation: _utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].orEmpty(
                evolution.evolutionSummary
              ),
              number: _utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].orEmpty(
                evolution.evolutionNumber
              ),
              revisionNumber: _utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].orEmpty(
                evolution.evolutionRevisionNumber
              ),
              source: evolution.evolutionType,
              status: status
                ? _utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].orEmpty(status.label)
                : '',
              _obj: evolution
            };
            return evolutionRow;
          ...
          DialogSearchEvolutionComponent.prototype.createEvolutionRowFromModification = function(modification) {
            var status = this.evolutionStatusList.find(function(elt) {
              return elt.value === modification.statusState;
            });
            var evolutionRow = {
              compliance: '',
              designation: _utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].orEmpty(
                modification.modificationTitle
              ),
              number: _utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].orEmpty(
                modification.modificationNumber
              ),
              revisionNumber: _utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].orEmpty(
                modification.modificationRevisionNumber
              ),
          ...
          DialogSearchEvolutionComponent.prototype.createEvolutionRowFromSb = function(sb) {
            var compliance = this.evolutionComplianceList.find(function(elt) {
              return elt.value === sb.sbCompliance;
            });
            var status = this.evolutionStatusList.find(function(elt) {
              return elt.value === sb.statusState;
            });
            var evolutionRow = {
              compliance: compliance
                ? _utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].orEmpty(compliance.label)
          ...
          DialogSearchEvolutionComponent.prototype.init = function() {
            ...
            this.evolutionSource =
              _constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_5__['BidoEvolutionConstants'].CODE_EVOLUTION;
          ...
          DialogSearchEvolutionComponent.prototype.loadEvolutionComplianceList = function() {
            ...
            this.propertiesService
              ...
              .subscribe(function(results) {
                _this.evolutionComplianceList = _utils_list_utils__WEBPACK_IMPORTED_MODULE_11__['ListUtils'].orEmpty(
                  results
                );
              });
          };
          ...
          DialogSearchEvolutionComponent.prototype.loadEvolutionStatusList = function() {
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_2__['forkJoin'])([
              ...
              var _b = __read(_a, 2),
                funcObjectList = _b[0],
                objectList = _b[1];
              _this.evolutionStatusList = __spread(
                _utils_list_utils__WEBPACK_IMPORTED_MODULE_11__['ListUtils'].orEmpty(funcObjectList),
                _utils_list_utils__WEBPACK_IMPORTED_MODULE_11__['ListUtils'].orEmpty(objectList)
              );
            });
          };
          DialogSearchEvolutionComponent.prototype.processSearchResultList = function(
            evolutionResultList,
            ...
            var evolutionList = evolutionResultList
              ...
              .filter(function(evolution) {
                return !processedEvolutionList.has(_this.computeEvolutionKey(evolution));
              })
            ...
            var modificationList = modificationResultList
              ...
              .filter(function(modification) {
                return !processedEvolutionList.has(_this.computeModificationKey(modification));
              })
            ...
            var sbList = sbResultList
              ...
              .filter(function(sb) {
                return !processedEvolutionList.has(_this.computeSbKey(sb));
              })
              .map(function(sb) {
            ...
            this.evolutionTable.moreResults = [
              evolutionResultList.map(function(results) {
                return results.moreResults;
              }),
              modificationResultList.map(function(results) {
                return results.moreResults;
              }),
              sbResultList.map(function(results) {
                return results.moreResults;
              })
            ]
              .reduce(function(acc, x) {
          ...
          DialogSearchEvolutionComponent.prototype.filterAd = function(sb) {
            var criteriaNumber = !_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(
              this.searchCriteria.evolutionNumber
            );
            var criteriaRevisionNumber = !_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__[
              'StringUtils'
            ].isNullOrEmpty(this.searchCriteria.evolutionRevisionNumber);
            var criteriaTitle = !_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(
              this.searchCriteria.evolutionSummary
            );
            return (
              !_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(sb.sbType) &&
              sb.sbType ===
                _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__['AWPropertiesConstants']
                  .SB_TYPE_AD_KEY &&
              (!criteriaNumber ||
                (criteriaNumber &&
              ...
              (!criteriaRevisionNumber ||
                (criteriaRevisionNumber &&
                  !_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(
                    sb.sbRevisionNumber
                  ) &&
              ...
              (!criteriaRevisionNumber ||
                (criteriaRevisionNumber &&
                  !_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(
                    ...
                    evolution.evolutionRevisionNumber.includes(this.searchCriteria.evolutionRevisionNumber))) &&
              (!criteriaTitle ||
                (criteriaTitle &&
                  !_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(
                    evolution.evolutionSummary
              ...
              (!criteriaRevisionNumber ||
                (criteriaRevisionNumber &&
                  !_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(
                    ...
                    modification.modificationRevisionNumber.includes(this.searchCriteria.evolutionRevisionNumber))) &&
              (!criteriaTitle ||
                (criteriaTitle &&
                  !_utils_string_utils__WEBPACK_IMPORTED_MODULE_13__['StringUtils'].isNullOrEmpty(
                    modification.modificationTitle
          ...
          DialogSearchEvolutionComponent.prototype.findEvolutionListByEquipment = function() {
            return this.dialogSearchEvolutionService.findEvolutionListByEquipment(
              ...
              this.equipmentCode,
              _utils_object_utils__WEBPACK_IMPORTED_MODULE_12__['ObjectUtils'].isDefined(this.complianceStatus)
          ...
          DialogSearchEvolutionComponent.prototype.postProcessEvolutionResultList = function(result) {
            return this.postProcessResultList(result, this.filterEvolution.bind(this), function(evolution) {
              ...
              updatedEvolution.evolutionType =
                _constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_5__[
          ...
          DialogSearchEvolutionComponent.prototype.postProcessModificationResultList = function(result) {
            return this.postProcessResultList(result, this.filterModification.bind(this), function(modification) {
              ...
              updatedModification.modificationType =
                _constants_bido_evolution_constants__WEBPACK_IMPORTED_MODULE_5__[
                  'BidoEvolutionConstants'
                ].CODE_MODIFICATION;
          ...
          __decorate(
            ...
            DialogSearchEvolutionComponent.prototype,
            'complianceStatus',
            void 0
          );
          __decorate(
            ...
            [
              Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__['Component'])({
                ...
                template: __webpack_require__(
                  /*! ./dialog-search-evolution.component.html */ './src/app/shared/components/dialog-search-evolution/dialog-search-evolution.component.html'
                )
              }),
              __metadata('design:paramtypes', [
                _dialog_search_evolution_service__WEBPACK_IMPORTED_MODULE_14__['DialogSearchEvolutionService'],
  ...
  \*********************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _dialog_search_evolution_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ./dialog-search-evolution.component */ './src/app/shared/components/dialog-search-evolution/dialog-search-evolution.component.ts'
        );
        /* harmony import */ var _dialog_search_evolution_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
          /*! ./dialog-search-evolution.service */ './src/app/shared/components/dialog-search-evolution/dialog-search-evolution.service.ts'
        );
        var __decorate =
          (undefined && undefined.__decorate) ||
         ...
         *************************************************************************** */
        var COMPONENTS = [
          _dialog_search_evolution_component__WEBPACK_IMPORTED_MODULE_7__['DialogSearchEvolutionComponent']
        ];
        /******************************************************************************
         * Services
         *************************************************************************** */
  ...
  \**********************************************************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        var DialogSearchEvolutionService = /** @class */ (function(_super) {
          ...
          function DialogSearchEvolutionService(
            http,
            appConfigService,
            fleetBusinessApi,
           ...
           * Fleet business api
           *************************************************************************/
          DialogSearchEvolutionService.prototype.findEvolutionListByEquipment = function(
            familyVariantCode,
            equipmentCode,
          ...
          DialogSearchEvolutionService.prototype.findSbListByEquipment = function(
            familyVariantCode,
            equipmentCode,
            complianceStatusList,
            engineSerialNumber
           ...
           *************************************************************************/
          DialogSearchEvolutionService.prototype.findApplicableAdList = function(
            familyCode,
            variantCode,
            structureType,
            engineSerialNumber
          ...
          DialogSearchEvolutionService.prototype.findApplicableModificationList = function(
            familyCode,
            variantCode,
            structureType
          ) {
          ...
          DialogSearchEvolutionService.prototype.findApplicableSbList = function(
            familyCode,
            variantCode,
            structureType,
            engineSerialNumber
          ...
          DialogSearchEvolutionService.prototype.findRecursivelyAssociatedEvolutionListToItemAndPnCode = function(
            familyCode,
            variantCode,
            structureType,
            pnCode
          ...
          DialogSearchEvolutionService.prototype.findEvolutionListByFamilyCodeAndVariantCode = function(
            familyCode,
            variantCode,
            structureType
          ) {
          ...
          DialogSearchEvolutionService.prototype.findModificationListByModificationIdAndDesignation = function(
            evolutionCriteria,
            familyCode,
            structureType
          ) {
