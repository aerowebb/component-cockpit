        ...
        var Listbox = /** @class */ (function() {
          ...
          Listbox.prototype.removeOption = function(option) {
            ...
            this.value = this.value.filter(function(val) {
              return !objectutils_1.ObjectUtils.equals(val, option.value, _this.dataKey);
            });
          };
            ...
            get: function() {
              if (this.filterValue) return this.allFilteredSelected();
                ...
                return (
                  this.value &&
                  this.options &&
                  this.value.length > 0 && this.value.length === this.getEnabledOptionCount()
                );
            },
            enumerable: true,
            configurable: true
          ...
          Listbox.prototype.isItemVisible = function(option) {
            if (this.filterValue) {
              ...
              switch (this.filterMode) {
                case 'startsWith':
                  visible =
                    objectutils_1.ObjectUtils.removeAccents(option.label)
                      .toLowerCase()
          ...
          Listbox.prototype.findNextItem = function(item) {
            ...
            if (nextItem)
              return domhandler_1.DomHandler.hasClass(nextItem, 'ui-state-disabled') ||
          ...
          Listbox.prototype.findPrevItem = function(item) {
            ...
            if (prevItem)
              return domhandler_1.DomHandler.hasClass(prevItem, 'ui-state-disabled') ||
          ...
          __decorate([core_1.Input(), __metadata('design:type', String)], Listbox.prototype, 'ariaFilterLabel', void 0);
          __decorate(
          ...
          __decorate(
            [core_1.ViewChild('headerchkbox'), __metadata('design:type', core_1.ElementRef)],
            Listbox.prototype,
...
//# sourceMappingURL=default~engineering-management-engineering-management-module~engineering-management-operational-conf~14ad79ad.js.map
