(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~fleet-management-fleet-management-module~maintenance-airworthiness-control-airworthiness-con~545c1f60"],{

/***/ "./src/app/shared/components/dialog-search-event/dialog-search-event.component.html":
/*!******************************************************************************************!*\
  !*** ./src/app/shared/components/dialog-search-event/dialog-search-event.component.html ***!
  \******************************************************************************************/
...
/***/ "./src/app/shared/components/dialog-search-event/dialog-search-event.component.ts":
/*!****************************************************************************************!*\
  !*** ./src/app/shared/components/dialog-search-event/dialog-search-event.component.ts ***!
  \****************************************************************************************/
/*! exports provided: DialogSearchEventComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchEventComponent", function() { return DialogSearchEventComponent; });
...
/* harmony import */ var _utils_label_value_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/label-value-utils */ "./src/app/shared/utils/label-value-utils.ts");
/* harmony import */ var _dialog_search_event_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dialog-search-event.service */ "./src/app/shared/components/dialog-search-event/dialog-search-event.service.ts");
...
var DialogSearchEventComponent = /** @class */ (function (_super) {
    __extends(DialogSearchEventComponent, _super);
    function DialogSearchEventComponent(dialogSearchEventService, messageService) {
        var _this = _super.call(this, _enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Write, 'DialogSearchEventComponent') || this;
        _this.dialogSearchEventService = dialogSearchEventService;
        ...
        // Load DropDown
        _this.loadEventCategories();
        _this.loadEventStatus();
        _this.loadEventTypes();
        return _this;
    }
    Object.defineProperty(DialogSearchEventComponent.prototype, "eventCode", {
        set: function (eventCode) {
    ...
    /*
      ...
      */
    DialogSearchEventComponent.prototype.searchEvents = function () {
        var _this = this;
        this.dialogSearchEventService.findEvent(this.searchObject).subscribe(function (results) {
            if (results) {
                _this.selectedObject = {};
                results.list.forEach(function (element) {
                    _utils_label_value_utils__WEBPACK_IMPORTED_MODULE_4__["LabelValueUtils"].stringValueToLabel(element, 'eventCategory', _this.propertyCategory);
                    _utils_label_value_utils__WEBPACK_IMPORTED_MODULE_4__["LabelValueUtils"].stringValueToLabel(element, 'eventStatus', _this.propertyStatus);
                    _utils_label_value_utils__WEBPACK_IMPORTED_MODULE_4__["LabelValueUtils"].stringValueToLabel(element, 'eventType', _this.propertyTypes);
                });
    ...
    /*
      ...
      */
    DialogSearchEventComponent.prototype.onValidate = function () {
        _utils_label_value_utils__WEBPACK_IMPORTED_MODULE_4__["LabelValueUtils"].labelToStringValue(this.selectedObject, 'eventCategory', this.propertyCategory);
        _utils_label_value_utils__WEBPACK_IMPORTED_MODULE_4__["LabelValueUtils"].labelToStringValue(this.selectedObject, 'eventStatus', this.propertyStatus);
        _utils_label_value_utils__WEBPACK_IMPORTED_MODULE_4__["LabelValueUtils"].labelToStringValue(this.selectedObject, 'eventType', this.propertyTypes);
        this.onSelected.emit(this.selectedObject);
        this.selectedObject = {};
        this.display = false;
    };
    // Clean the selectedObject object if the row is unselect
    DialogSearchEventComponent.prototype.onRowUnselect = function () {
        this.selectedObject = {};
    };
    // Clean all the object on rerender
    DialogSearchEventComponent.prototype.onShow = function () {
        this.selectedObject = {};
        this.resultsTable = {
            list: [],
            moreResults: false
    ...
    /*
      ...
      */
    DialogSearchEventComponent.prototype.onCancel = function () {
        this.selectedObject = {};
        this.resultsTable = {
            list: [],
            moreResults: false
    ...
    DialogSearchEventComponent.prototype.isOneObjectSelected = function () {
        return !this.selectedObject.eventCode;
    };
    DialogSearchEventComponent.prototype.loadEventCategories = function () {
        var _this = this;
        this.dialogSearchEventService.getEventCaterogyValues().subscribe(function (results) {
            _this.propertyCategory = results;
        }, function () {
            _this.messageService.showErrorMessage(_this.getTranslateKey('errorOnCategoryList'));
        });
    };
    DialogSearchEventComponent.prototype.loadEventStatus = function () {
        var _this = this;
        this.dialogSearchEventService.getEventStatusValues().subscribe(function (results) {
            _this.propertyStatus = results;
        }, function () {
            _this.messageService.showErrorMessage(_this.getTranslateKey('errorOnStatusList'));
        });
    };
    DialogSearchEventComponent.prototype.loadEventTypes = function () {
        var _this = this;
        this.dialogSearchEventService.getEventTypesValues().subscribe(function (results) {
            _this.propertyTypes = results;
        }, function () {
            _this.messageService.showErrorMessage(_this.getTranslateKey('errorOnTypesList'));
        });
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], DialogSearchEventComponent.prototype, "onSelected", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('event-code'),
        __metadata("design:type", String),
        __metadata("design:paramtypes", [String])
    ], DialogSearchEventComponent.prototype, "eventCode", null);
    DialogSearchEventComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-search-event',
            template: __webpack_require__(/*! ./dialog-search-event.component.html */ "./src/app/shared/components/dialog-search-event/dialog-search-event.component.html")
        }),
        __metadata("design:paramtypes", [_dialog_search_event_service__WEBPACK_IMPORTED_MODULE_5__["DialogSearchEventService"],
            _services_message_service__WEBPACK_IMPORTED_MODULE_3__["MessageService"]])
    ], DialogSearchEventComponent);
    return DialogSearchEventComponent;
...
/***/ "./src/app/shared/components/dialog-search-event/dialog-search-event.module.ts":
/*!*************************************************************************************!*\
  !*** ./src/app/shared/components/dialog-search-event/dialog-search-event.module.ts ***!
  \*************************************************************************************/
/*! exports provided: DialogSearchEventModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchEventModule", function() { return DialogSearchEventModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _dialog_search_event_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./dialog-search-event.component */ "./src/app/shared/components/dialog-search-event/dialog-search-event.component.ts");
/* harmony import */ var _dialog_search_event_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./dialog-search-event.service */ "./src/app/shared/components/dialog-search-event/dialog-search-event.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Components
 *************************************************************************** */
var COMPONENTS = [_dialog_search_event_component__WEBPACK_IMPORTED_MODULE_7__["DialogSearchEventComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_dialog_search_event_service__WEBPACK_IMPORTED_MODULE_8__["DialogSearchEventService"]];
var DialogSearchEventModule = /** @class */ (function () {
    function DialogSearchEventModule() {
    }
    DialogSearchEventModule = __decorate([
    ...
    return DialogSearchEventModule;
}());
...
/***/ "./src/app/shared/components/dialog-search-event/dialog-search-event.service.ts":
/*!**************************************************************************************!*\
  !*** ./src/app/shared/components/dialog-search-event/dialog-search-event.service.ts ***!
  \**************************************************************************************/
/*! exports provided: DialogSearchEventService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchEventService", function() { return DialogSearchEventService; });
...
var DialogSearchEventService = /** @class */ (function (_super) {
    __extends(DialogSearchEventService, _super);
    function DialogSearchEventService(http, appConfigService, fleetManagementApi) {
        var _this = _super.call(this, http, appConfigService) || this;
        _this.fleetManagementApi = fleetManagementApi;
        return _this;
    }
    DialogSearchEventService.prototype.findEvent = function (criteria) {
        return _super.prototype.post.call(this, this.fleetManagementApi.findEventsBySearchCriteria, criteria);
    };
    DialogSearchEventService.prototype.getEventCaterogyValues = function () {
        return _super.prototype.post.call(this, this.fleetManagementApi.getEventCaterogyValues);
    };
    DialogSearchEventService.prototype.getEventStatusValues = function () {
        return _super.prototype.post.call(this, this.fleetManagementApi.getEventStatusValues);
    };
    DialogSearchEventService.prototype.getEventTypesValues = function () {
        return _super.prototype.post.call(this, this.fleetManagementApi.getEventTypesValues);
    };
    DialogSearchEventService = __decorate([
    ...
    ], DialogSearchEventService);
    return DialogSearchEventService;
...
//# sourceMappingURL=default~fleet-management-fleet-management-module~maintenance-airworthiness-control-airworthiness-con~545c1f60.js.map