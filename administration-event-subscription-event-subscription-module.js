(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["administration-event-subscription-event-subscription-module"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventSubscriptionComponent", function() { return EventSubscriptionComponent; });
...
/* harmony import */ var _event_subscription_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./event-subscription.service */ "./src/app/main/administration/event-subscription/event-subscription.service.ts");
...
var EventSubscriptionComponent = /** @class */ (function (_super) {
    ...
    function EventSubscriptionComponent(favoriteService, loaderService, messageService, serializationService, tabService, exportService, eventSubscriptionService, confirmationService) {
    ...
    EventSubscriptionComponent.prototype.initEvtSubscriptionsTableDataSource = function () {
        this.evtSubscriptionsTableDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_1__["TableDataSource"]({
    ...
    EventSubscriptionComponent.prototype.create = function () {
        this.openEventSubscription(undefined, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Create);
    };
        ...
        this.evtSubscriptionsTableDataSource.dataSelection.forEach(function (subscription) {
            if (subscription) {
                if (subscription.subscriptionName && subscription.subscriptionName.length > 0) {
                    _this.openEventSubscription(subscription, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Read);
                }
                else {
            ...
            accept: function () {
                ...
                _this.evtSubscriptionsTableDataSource.dataSelection.forEach(function (subscription) {
                    if (!!subscription.subscriptionId) {
                        ...
                        _super.prototype.throwUnboundLocalError.call(_this, 'deleteSelectedEventSubscription', 'subscription.subscriptionId');
                    }
                });
                _this.eventSubscriptionService.deleteSubscriptions(ids).subscribe(function (result) {
    ...
    EventSubscriptionComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./event-subscription.component.html */ "./src/app/main/administration/event-subscription/event-subscription.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventSubscriptionModule", function() { return EventSubscriptionModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_components_dialog_search_contact_dialog_search_contact_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../shared/components/dialog-search-contact/dialog-search-contact.module */ "./src/app/shared/components/dialog-search-contact/dialog-search-contact.module.ts");
...
/* harmony import */ var _event_subscription_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./event-subscription.component */ "./src/app/main/administration/event-subscription/event-subscription.component.ts");
/* harmony import */ var _event_subscription_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./event-subscription.service */ "./src/app/main/administration/event-subscription/event-subscription.service.ts");
/* harmony import */ var _event_subscripton_form_contacts_popup_contacts_popup_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./event-subscripton-form/contacts-popup/contacts-popup.component */ "./src/app/main/administration/event-subscription/event-subscripton-form/contacts-popup/contacts-popup.component.ts");
/* harmony import */ var _event_subscripton_form_event_subscripton_form_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./event-subscripton-form/event-subscripton-form.component */ "./src/app/main/administration/event-subscription/event-subscripton-form/event-subscripton-form.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var INTERNAL_MODULES = [
    ...
    _shared_components_dialog_search_contact_dialog_search_contact_module__WEBPACK_IMPORTED_MODULE_12__["DialogSearchContactModule"],
 ...
 * Components
 *************************************************************************** */
var COMPONENTS = [_event_subscripton_form_contacts_popup_contacts_popup_component__WEBPACK_IMPORTED_MODULE_19__["ContactsPopupComponent"]];
var DYNAMIC_COMPONENTS = [_event_subscription_component__WEBPACK_IMPORTED_MODULE_17__["EventSubscriptionComponent"], _event_subscripton_form_event_subscripton_form_component__WEBPACK_IMPORTED_MODULE_20__["EventSubscriptonFormComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventSubscriptionService", function() { return EventSubscriptionService; });
...
var EventSubscriptionService = /** @class */ (function (_super) {
    ...
    EventSubscriptionService.prototype.loadEventTypes = function () {
        return _super.prototype.post.call(this, this.fleetManagementApi.findAllBidoNotificationTypeByTypeCategoryCatalog);
    };
    ...
    EventSubscriptionService.prototype.loadSubscription = function (id) {
        return _super.prototype.post.call(this, this.fleetManagementApi.getSubscriptionDataAndContactListBySubscriptionId, id);
    };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ContactsPopupComponent", function() { return ContactsPopupComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var ContactsPopupComponent = /** @class */ (function (_super) {
    ...
    function ContactsPopupComponent(messageService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__["ComponentOpenMode"].Write, 'ContactsPopupComponent') || this;
    ...
    ], ContactsPopupComponent.prototype, "displayChange", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], ContactsPopupComponent.prototype, "contact", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ContactsPopupComponent.prototype, "onCreate", void 0);
    ContactsPopupComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-contacts-popup',
            template: __webpack_require__(/*! ./contacts-popup.component.html */ "./src/app/main/administration/event-subscription/event-subscripton-form/contacts-popup/contacts-popup.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventSubscriptonFormComponent", function() { return EventSubscriptonFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../shared/components/table/table-data-source */ "./src/app/shared/components/table/table-data-source.ts");
/* harmony import */ var _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../shared/enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
/* harmony import */ var _shared_services_confirmation_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../shared/services/confirmation.service */ "./src/app/shared/services/confirmation.service.ts");
...
/* harmony import */ var _shared_utils_bido_family_variant_utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../shared/utils/bido-family-variant-utils */ "./src/app/shared/utils/bido-family-variant-utils.ts");
/* harmony import */ var _event_subscription_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../event-subscription.service */ "./src/app/main/administration/event-subscription/event-subscription.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var EventSubscriptonFormComponent = /** @class */ (function (_super) {
    ...
    function EventSubscriptonFormComponent(favoriteService, loaderService, messageService, serializationService, tabService, eventSubscriptionService, confirmationService, propertiesService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Read, favoriteService, loaderService, messageService, serializationService, tabService) || this;
        _this.eventSubscriptionService = eventSubscriptionService;
        _this.confirmationService = confirmationService;
    ...
    EventSubscriptonFormComponent.prototype.initContactsTableDataSource = function () {
        this.contactsTableDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_1__["TableDataSource"]({
            allowMultiSelect: true,
            columns: [
    ...
    EventSubscriptonFormComponent.prototype.loadEventTypes = function () {
        var _this = this;
        this.eventSubscriptionService.loadEventTypes().subscribe(function (results) {
    ...
    EventSubscriptonFormComponent.prototype.loadFamilyVariants = function () {
        var _this = this;
        this.eventSubscriptionService.loadFamilyVariants().subscribe(function (results) {
            results.forEach(function (result) {
                ...
                var value = _shared_utils_bido_family_variant_utils__WEBPACK_IMPORTED_MODULE_11__["BidoFamilyVariantUtils"].buildFamilyVariantCode(result.familyCode, result.variantCode);
                if (!!label && !!value) {
                    var familyVariant = {
                        label: label,
                        value: value
    ...
    EventSubscriptonFormComponent.prototype.loadEventPriorities = function () {
        var _this = this;
        this.propertiesService.getValue('getEventPriorityMap').subscribe(function (results) {
        ...
        if (!!this.componentData && !!this.componentData.objectId) {
            ...
            this.eventSubscriptionService.loadSubscription(subscriptionId_1).subscribe(function (results) {
                if (!!results.bidoSubscriptionDTO && !!results.bidoContactDTO) {
                    ...
                    _this.eventSubscriptionService.findBidoCustomersBySearchCriteria(bidoCustomerDTO).subscribe(function (result) {
                        if (result) {
        ...
        this.eventSubscriptionService.loadEventSubscriptionTableData().subscribe(function (results) {
            results.list.forEach(function (result) {
                if (!!result.subscriptionName) {
                    ...
                    _super.prototype.throwUnboundLocalError.call(_this, 'getExistingSubscriptionName', 'result.subscriptionName');
                }
            });
        });
    };
            ...
            if (!_this.subscription.subscriptionName || _this.subscription.subscriptionName.trim().length === 0) {
                ...
                if (!!_this.componentData && _this.componentData.openMode === create) {
                    if (_this.existingSubscriptions.includes(_this.subscription.subscriptionName)) {
                        ...
                        _this.eventSubscriptionService.saveCatalog(input).subscribe(function (result) {
                            ...
                            _this.eventSubscriptionService.loadEventSubscriptionTableData().subscribe(function (results) {
                                results.list.forEach(function (re) {
                                    if (!!input.bidoSubscriptionList &&
                                        ...
                                        re.subscriptionId) {
                                        _this.eventSubscriptionService.loadSubscription(re.subscriptionId).subscribe(function (res) {
                                            if (!!res.bidoSubscriptionDTO &&
                                                !!res.bidoContactDTO &&
                            ...
                            if (!!_this.componentData) {
                                ...
                                if (!!_this.subscription.subscriptionName) {
                                    ...
                                    _super.prototype.throwUnboundLocalError.call(_this, 'saveSubscription', 'this.subscription.subscriptionName');
                                }
                            }
                            else {
        ...
        this.confirmationService.confirmDelete({
            ...
            accept: function () {
                _this.contactsTableDataSource.dataSelection.forEach(function (selectedContact) {
                    _this.contactsTableDataSource.setData(_this.contactsTableDataSource.data.filter(function (contact) { return contact.contactName !== selectedContact.contactName; }));
                    _this.contactsTableDataSource.update();
                });
    ...
    EventSubscriptonFormComponent.prototype.createContact = function (event) {
        var inContactsTable = this.contactsTableDataSource.data.filter(function (contact) { return contact.contactName === event.contactName; });
    ...
    EventSubscriptonFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./event-subscripton-form.component.html */ "./src/app/main/administration/event-subscription/event-subscripton-form/event-subscripton-form.component.html")
        }),
