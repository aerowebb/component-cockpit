(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["collaborative-cockpit-data-enrichment-data-enrichment-module"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DataEnrichmentModule", function() { return DataEnrichmentModule; });
...
/* harmony import */ var _form_data_enrichment_form_standard_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./form/data-enrichment-form-standard.service */ "./src/app/main/collaborative-cockpit/data-enrichment/form/data-enrichment-form-standard.service.ts");
/* harmony import */ var _form_data_enrichment_form_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./form/data-enrichment-form.component */ "./src/app/main/collaborative-cockpit/data-enrichment/form/data-enrichment-form.component.ts");
/* harmony import */ var _form_data_enrichment_form_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./form/data-enrichment-form.service */ "./src/app/main/collaborative-cockpit/data-enrichment/form/data-enrichment-form.service.ts");
 ...
 *************************************************************************** */
var COMPONENTS = [];
var DYNAMIC_COMPONENTS = [_form_data_enrichment_form_component__WEBPACK_IMPORTED_MODULE_13__["DataEnrichmentFormComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_form_data_enrichment_form_service__WEBPACK_IMPORTED_MODULE_14__["DataEnrichmentFormService"], _form_data_enrichment_form_standard_service__WEBPACK_IMPORTED_MODULE_12__["DataEnrichmentFormStandardService"]];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DataEnrichmentFormStandardService", function() { return DataEnrichmentFormStandardService; });
...
module.exports = ":host .custom-margin {\n  margin-top: 0.5em !important; }\n\n:host .report-name {\n  cursor: pointer;\n  text-decoration: underline;\n  color: blue; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DataEnrichmentFormComponent", function() { return DataEnrichmentFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_utils_bire_family_variant_utils__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../../shared/utils/bire-family-variant-utils */ "./src/app/shared/utils/bire-family-variant-utils.ts");
...
/* harmony import */ var _data_enrichment_form_standard_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./data-enrichment-form-standard.service */ "./src/app/main/collaborative-cockpit/data-enrichment/form/data-enrichment-form-standard.service.ts");
/* harmony import */ var _data_enrichment_form_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./data-enrichment-form.service */ "./src/app/main/collaborative-cockpit/data-enrichment/form/data-enrichment-form.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DataEnrichmentFormComponent = /** @class */ (function (_super) {
    ...
    function DataEnrichmentFormComponent(favoriteService, loaderService, messageService, serializationService, tabService, translateService, confirmationService, sessionService, dataEnrichmentFormService, dataEnrichmentFormStandardService, propertiesService) {
    ...
    DataEnrichmentFormComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_5__["ComponentConstants"].COL_DATA_ENRICHMENT_FORM;
    };
    ...
    DataEnrichmentFormComponent.prototype.loadMaintenancePlanDropDowns = function () {
        var _this = this;
        this.dataEnrichmentFormService.findBireMaintenancePlans().subscribe(function (results) {
            var list = [];
    ...
    DataEnrichmentFormComponent.prototype.loadFamilyVariantDropdowns = function () {
        ...
        this.dataEnrichmentFormStandardService.getBireFamilyVariant(familyVariantInput).subscribe(function (results) {
            var list = [];
    ...
    DataEnrichmentFormComponent.prototype.deleteReports = function () {
        ...
        if (this.selectedReports !== []) {
            ...
            this.confirmationService.confirmDelete({
                ...
                accept: function () {
                    _this.dataEnrichmentFormService.removeDataReportsByReportId(removeDataInput_1).subscribe(function (result) {
    ...
    DataEnrichmentFormComponent.prototype.exportDataEnrichment = function () {
        ...
        var exportData = this.selectedData === this.engineManualData
            ? {
                wbName: this.name,
                        ...
                        if (familyObject.familyLabelValueDTO.label === _this.selectedFamily) {
                            familyObject.variantLabelValueDTO.forEach(function (variantObject) {
                                if (variantObject.variantLabelValue.label === variant.value) {
                                    ...
                                    _this.selectedFamilyVariantCode = _shared_utils_bire_family_variant_utils__WEBPACK_IMPORTED_MODULE_17__["BireFamilyVariantUtil"].buildFamilyVariantCodeWithStructureType(variantObject.familyCode, variantObject.structureType, variantObject.variantCode);
    ...
    DataEnrichmentFormComponent.prototype.loadImportReportList = function () {
        ...
        if (!!reportCode) {
            ...
            this.dataEnrichmentFormService.fetchXmlDataLoadingReport(loadImportReportsInput).subscribe(function (results) {
    ...
    DataEnrichmentFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./data-enrichment-form.component.html */ "./src/app/main/collaborative-cockpit/data-enrichment/form/data-enrichment-form.component.html"),
            styles: [__webpack_require__(/*! ./data-enrichment-form.component.scss */ "./src/app/main/collaborative-cockpit/data-enrichment/form/data-enrichment-form.component.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_favorite_service__WEBPACK_IMPORTED_MODULE_9__["FavoriteService"],
            ...
            _data_enrichment_form_standard_service__WEBPACK_IMPORTED_MODULE_19__["DataEnrichmentFormStandardService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DataEnrichmentFormService", function() { return DataEnrichmentFormService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_api_mhiael_import_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../shared/api/mhiael/import.api */ "./src/app/shared/api/mhiael/import.api.ts");
/* harmony import */ var _shared_http_abstract_aw_mhiael_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../shared/http/abstract-aw-mhiael-http */ "./src/app/shared/http/abstract-aw-mhiael-http.ts");
...
var DataEnrichmentFormService = /** @class */ (function (_super) {
    ...
    DataEnrichmentFormService.prototype.fetchXmlDataLoadingReport = function (refreshArchivedImportReportInput) {
        return _super.prototype.post.call(this, this.mhiaelImportApi.fetchXmlDataLoadingReport, refreshArchivedImportReportInput);
    };
