...
declare module 'bryntum-gantt' {
  ...
  export class Model implements TreeNode, ModelStm {
    ...
    insertChild(childRecord: Model | Array<any>, beforeRecord?: Model, silent?: boolean): Model | Array<any>;
  ...
  export class DomHelper {
    ...
    static sync(config: string | HTMLElement | object, targetElement: HTMLElement): HTMLElement;
  ...
  export class ObjectHelper {
    ...
    static toFixed(number: number, digits: number): any;
  }
  ...
  export class DependencyStore extends SchedulerDependencyStore implements PartOfProject {
    // properties
    assignmentStore: AssignmentStore;
    calendarManagerStore: CalendarManagerStore;
    dependencyStore: DependencyStore;
    ...
    getDependencyForSourceAndTargetTasks(
      sourceTask: TaskModel | string,
      targetTask: TaskModel | string
    ): DependencyModel;
  ...
  export class TaskStore extends AjaxStore implements EventStoreMixin, PartOfProject {
    ...
    assignEventToResource(
      ...
      resource: ResourceModel | string | number | Array<any> | Array<any> | Array<any>
    ): void;
    unassignEventFromResource(event: EventModel | string | number, resource: ResourceModel | string | number): void;
    reassignEventFromResourceToResource(
      event: EventModel,
      oldResource: ResourceModel | Array<any>,
      newResource: ResourceModel | Array<any>
    ): void;
  ...
  export class GanttCrudManager implements Events, AbstractCrudManagerMixin, AjaxTransport, JsonEncoder {
    ...
    addCrudStore(
      store: Store | string | object | Array<any> | Array<any> | Array<any>,
      position?: number,
      fromStore?: string | Store | object
    ): void;
    removeCrudStore(store: object | string | Store): void;
    addStoreToApplySequence(
      store: Store | object | Array<any> | Array<any>,
      position?: number,
      fromStore?: string | Store | object
    ): void;
  ...
  export class Gantt extends TimelineBase
    implements GanttDom, GanttRegions, GanttScroll, GanttState, GanttStores, EventNavigation, TaskNavigation {
    // properties
  ...
  export class SchedulerDependencyStore extends AjaxStore {
    ...
    isValidDependency(
      dependencyOrFromId: DependencyModel | number | string,
      toId?: number | string,
      type?: number
    ): boolean;
  ...
  export class Scheduler extends TimelineBase
    implements
      EventNavigation,
      EventSelection,
      SchedulerDom,
    ...
    resolveResourceRecord(elementOrEvent: HTMLElement | Event, xy?: Array<any>): ResourceModel;
  ...
  export abstract class TimelineBase extends Grid
    implements
      TimelineDateMapper,
      TimelineDomEvents,
      TimelineEventRendering,
