(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["administration-monitoring-monitoring-module"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogLibrairiesReportComponent", function() { return DialogLibrairiesReportComponent; });
...
var DialogLibrairiesReportComponent = /** @class */ (function () {
    ...
    ], DialogLibrairiesReportComponent.prototype, "display", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogLibrairiesReportComponent.prototype, "displayChange", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogLibrairiesReportComponent.prototype, "importReportMessage", void 0);
    DialogLibrairiesReportComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-librairies-report',
            template: __webpack_require__(/*! ./dialog-librairies-report.component.html */ "./src/app/main/administration/monitoring/form/dialog-librairies-report/dialog-librairies-report.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MonitoringFormComponent", function() { return MonitoringFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _monitoring_form_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./monitoring-form.service */ "./src/app/main/administration/monitoring/form/monitoring-form.service.ts");
...
var MonitoringFormComponent = /** @class */ (function (_super) {
    ...
    // ****************************************************************************
    function MonitoringFormComponent(favoriteService, loaderService, messageService, serializationService, tabService, sessionService, pageTocService, translateService, monitoringFormService) {
    ...
    MonitoringFormComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_3__["ComponentConstants"].ADM_MONITORING;
    };
    ...
    MonitoringFormComponent.prototype.setTableOfContent = function () {
        ...
        this.translateService.get([springKey, databaseKey, performanceKey, librariesKey]).subscribe(function (results) {
    ...
    MonitoringFormComponent.prototype.loadMonitoringData = function () {
        ...
        this.monitoringFormService.adminMonitoring().subscribe(function (data) {
    ...
    MonitoringFormComponent.prototype.fetchStats = function (stat) {
        ...
        switch (stat) {
            case 0: {
                ...
                this.monitoringFormService.reset().subscribe(function (data) {
            ...
            case 1: {
                ...
                this.monitoringFormService.refresh().subscribe(function (data) {
                    _this.monitoringData.serviceReport = data;
            ...
            default: {
                ...
                this.monitoringFormService.detailed().subscribe(function (data) {
                    _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_12__["FileUtils"].downloadFile(data.content, data.fileName);
    ...
    MonitoringFormComponent.prototype.changeLogLevel = function (conf) {
        var _this = this;
        this.monitoringFormService.changeLogLevel(conf).subscribe(function () {
            // TODO
        }, function (error) {
            _this.detailedStatLoader = false;
        });
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(MonitoringFormComponent_1.SPRING_ANCHOR_ID),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], MonitoringFormComponent.prototype, "springEltRef", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(MonitoringFormComponent_1.DATABASE_ANCHOR_ID),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], MonitoringFormComponent.prototype, "dbEltRef", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(MonitoringFormComponent_1.SERVICE_PERFORMANCE_ANCHOR_ID),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], MonitoringFormComponent.prototype, "performanceEltRef", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(MonitoringFormComponent_1.LIBRARIES_ANCHOR_ID),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], MonitoringFormComponent.prototype, "librariesEltRef", void 0);
    MonitoringFormComponent = MonitoringFormComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-monitoring-form',
            template: __webpack_require__(/*! ./monitoring-form.component.html */ "./src/app/main/administration/monitoring/form/monitoring-form.component.html"),
            styles: [__webpack_require__(/*! ./monitoring-form.component.scss */ "./src/app/main/administration/monitoring/form/monitoring-form.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MonitoringFormService", function() { return MonitoringFormService; });
...
/* harmony import */ var _shared_components_component_sidebar_component_sidebar_mdule__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../shared/components/component-sidebar/component-sidebar.mdule */ "./src/app/shared/components/component-sidebar/component-sidebar.mdule.ts");
/* harmony import */ var _shared_components_modal_modal_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../shared/components/modal/modal.module */ "./src/app/shared/components/modal/modal.module.ts");
...
/* harmony import */ var _form_dialog_librairies_report_dialog_librairies_report_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./form/dialog-librairies-report/dialog-librairies-report.component */ "./src/app/main/administration/monitoring/form/dialog-librairies-report/dialog-librairies-report.component.ts");
/* harmony import */ var _form_monitoring_form_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./form/monitoring-form.component */ "./src/app/main/administration/monitoring/form/monitoring-form.component.ts");
/* harmony import */ var _form_monitoring_form_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./form/monitoring-form.service */ "./src/app/main/administration/monitoring/form/monitoring-form.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EXTERNAL_MODULES = [
    ...
    _shared_components_component_sidebar_component_sidebar_mdule__WEBPACK_IMPORTED_MODULE_8__["ComponentSidebarModule"]
];
var INTERNAL_MODULES = [];
/******************************************************************************
 * Components
 *************************************************************************** */
var COMPONENTS = [_form_dialog_librairies_report_dialog_librairies_report_component__WEBPACK_IMPORTED_MODULE_11__["DialogLibrairiesReportComponent"]];
var DYNAMIC_COMPONENTS = [_form_monitoring_form_component__WEBPACK_IMPORTED_MODULE_12__["MonitoringFormComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
    ...
    MonitoringModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: __spread([
                ...
                _dynamic_component_loader_dynamic_component_loader_module__WEBPACK_IMPORTED_MODULE_10__["DynamicComponentLoaderModule"].forChild(DYNAMIC_COMPONENTS)
