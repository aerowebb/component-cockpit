(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~engineering-management-engineering-management-module~logistics-goods-movement-goods-movement~dc75f919"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProcurementRequestPopupComponent", function() { return ProcurementRequestPopupComponent; });
...
/* harmony import */ var _shared_types_dialog_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../../../shared/types/dialog-component */ "./src/app/shared/types/dialog-component.ts");
...
/* harmony import */ var _shared_utils_logistic_utils__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../../../shared/utils/logistic-utils */ "./src/app/shared/utils/logistic-utils.ts");
/* harmony import */ var _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../../../shared/utils/number-utils */ "./src/app/shared/utils/number-utils.ts");
/* harmony import */ var _logistics_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../logistics.service */ "./src/app/main/logistics/logistics.service.ts");
...
var ProcurementRequestPopupComponent = /** @class */ (function (_super) {
    ...
    function ProcurementRequestPopupComponent(sessionService, confirmationService, logisticsService, messageService, propertiesService, serializationService, tabService, translateService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_7__["ComponentOpenMode"].Read, 'ProcurementRequestPopupComponent') || this;
        ...
        _this.loadSites();
        _this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].ENGINEERING_PN_TYPES_MAP).subscribe({
            next: function (pnTypes) {
                _this.engineeringPnTypes = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_16__["ListUtils"].orEmpty(pnTypes);
            }
        });
        return _this;
    }
    ProcurementRequestPopupComponent.prototype.ngOnInit = function () {
        ...
        if (this.inputProcurementRequest) {
            ...
            this.procurementRequest = {
                procStatus: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_RELEASED,
    ...
    ProcurementRequestPopupComponent.prototype.onSelectPn = function (pn) {
        ...
        if (this.isWorkOrderContext) {
            this.procurementRequest.procType =
                pn.sparePartClassCode === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].SPC_REPAIRABLE_KEY
                    ? _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_TYPE_MAINTENANCE_ES
                    : _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_TYPE_MAINTENANCE;
        }
    };
    ProcurementRequestPopupComponent.prototype.onSelectWo = function (workOrder) {
        ...
        if (this.procurementRequest.procType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_TYPE_MAINTENANCE_ES) {
    ...
    ProcurementRequestPopupComponent.prototype.validate = function () {
        var _this = this;
        if (moment__WEBPACK_IMPORTED_MODULE_2__(this.procurementRequest.requestedDate).isBefore(moment__WEBPACK_IMPORTED_MODULE_2__(), 'day')) {
    ...
    ProcurementRequestPopupComponent.prototype.checkSimilarProcurementRequestThenUpdate = function () {
        ...
        var procurementRequestCriteria = {
            ...
            procReqStatusExcluded: [
                _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_CANCELED,
                _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_CLOSED
            ]
        };
        this.logisticsService.findProcurementRequestsByCriteria(procurementRequestCriteria).subscribe({
            next: function (existingProcurementRequests) {
                if (_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_16__["ListUtils"].isNullOrEmpty(existingProcurementRequests)) {
    ...
    ProcurementRequestPopupComponent.prototype.isPnTypePresentInEngineeringPnTypes = function (pn) {
        return this.engineeringPnTypes.some(function (pnType) { return pnType.value === pn.pnType; });
    };
        ...
        if (!this.isWorkOrderContext || !this.isPnTypePresentInEngineeringPnTypes(this.pn)) {
            ...
            if (this.inputWorkPackage && this.inputWorkPackage.assetCode) {
                this.logisticsService
                    ...
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatMap"])(function (equipment) {
                    var input = {
                        familyCode: _shared_utils_bido_family_variant_utils__WEBPACK_IMPORTED_MODULE_15__["BidoFamilyVariantUtils"].getFamilyCodeFromFamilyVariantCode(equipment.familyVariantCode),
                        structureType: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].STRUCTURE_TYPE_IPC_KEY,
                        variantCode: _shared_utils_bido_family_variant_utils__WEBPACK_IMPORTED_MODULE_15__["BidoFamilyVariantUtils"].getVariantCodeFromFamilyVariantCode(equipment.familyVariantCode),
                    ...
                    next: function (bireVersionPns) {
                        if (_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_16__["ListUtils"].isNullOrEmpty(bireVersionPns)) {
                            _this.confirmationService.confirm({
    ...
    ProcurementRequestPopupComponent.prototype.addItemDataToProcurementRequest = function () {
        ...
        if (!!this.inputProcurementRequest &&
            ...
            this.procurementRequest.bidtProcReqItems[0] = __assign({}, this.procurementRequest.bidtProcReqItems[0], { birePn: this.pn, birePnPnCode: this.pn ? this.pn.pnCode : undefined, requestedQuantity: this.requestedQuantity });
        }
        else {
            this.procurementRequest.bidtProcReqItems = [
                {
    ...
    ProcurementRequestPopupComponent.prototype.initWithProcurementRequest = function () {
        ...
        this.requestedQuantity =
            this.procurementRequest.bidtProcReqItems &&
                ...
                ? _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_18__["NumberUtils"].roundNumber(_shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_18__["NumberUtils"].fromString(this.procurementRequest.bidtProcReqItems[0].requestedQuantity), 2).toString()
                : undefined;
        if (this.pn) {
            this.loadUnits(this.pn);
        }
    };
    ProcurementRequestPopupComponent.prototype.initWithWorkOrder = function (workPackage, workOrder, workOrderStatus) {
        var _this = this;
        if (workPackage && workOrder) {
            this.procurementRequest.procType = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_TYPE_MAINTENANCE;
            this.procurementRequest.requestedDate = workOrder.woScheduledStartDate || this.procurementRequest.requestedDate;
            this.wo = workOrder;
            this.logisticsService.findAllBireSite().subscribe({
                next: function (sites) {
                    var matchingSite = sites.find(function (site) { return site.siteCode === workPackage.bireRepairCenterCode; });
                    if (matchingSite) {
            ...
            if (workOrderStatus &&
                (workOrderStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_PLANNED ||
                    workOrderStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_RELEASED)) {
                this.procurementRequest.procStatus =
                    workOrderStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_PLANNED
                        ? _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_PLANNED
                        : _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_RELEASED;
            }
        }
    };
    ProcurementRequestPopupComponent.prototype.loadCriticalities = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].LOGISTICAL_CRITICALITY_MAP).subscribe({
            next: function (criticalities) {
                _this.criticalities = _shared_utils_logistic_utils__WEBPACK_IMPORTED_MODULE_17__["LogisticalUtils"].sortCriticities(criticalities);
            }
        });
    };
    ProcurementRequestPopupComponent.prototype.loadProcurementRequestStatuses = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].PROCUREMENT_REQUEST_STATUS_MAP).subscribe({
            next: function (procurementRequestStatuses) {
                var draftStatus = procurementRequestStatuses.find(function (e) { return e.value === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_DRAFT; });
                var plannedStatus = procurementRequestStatuses.find(function (e) { return e.value === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_PLANNED; });
                var releasedStatus = procurementRequestStatuses.find(function (e) { return e.value === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_RELEASED; });
                _this.procurementRequestStatuses = [draftStatus];
                if ((_this.isWorkOrderContext && _this.inputWorkOrder) || !!_this.wo) {
                    if (_this.inputWorkOrderStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_PLANNED ||
                        (!!_this.wo && _this.wo.calculatedStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_PLANNED)) {
                        _this.procurementRequestStatuses.push(plannedStatus);
                    }
                    else if (_this.inputWorkOrderStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_RELEASED ||
                        (!!_this.wo && _this.wo.calculatedStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_RELEASED)) {
    ...
    ProcurementRequestPopupComponent.prototype.loadProcurementRequestTypes = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].PROCUREMENT_REQUEST_TYPE_MAP).subscribe({
            next: function (types) {
                var allowedTypes = _this.isWorkOrderContext
                    ? [
                        _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_TYPE_MAINTENANCE,
                        _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_TYPE_MAINTENANCE_WITH_EXCHANCE,
                        _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_TYPE_MAINTENANCE_ES
                    ]
                    : types.map(function (type) { return type.value; });
                _this.procurementRequestTypes = types
                    .filter(function (type) { return allowedTypes.includes(type.value); })
        ...
        this.sessionService.getUserWarehouseId().subscribe({
            next: function (warehouse) {
                if (warehouse && warehouse.wareHouseId) {
                    ...
                    _this.procurementRequest.bidtWarehouseByBidtWarehouseReceiptId = warehouse ? warehouse.wareHouseId : undefined;
                }
            }
        });
    };
    ProcurementRequestPopupComponent.prototype.loadWarehouses = function (siteId) {
        ...
        this.logisticsService.getWarehousesBySiteId(siteId).subscribe({
            next: function (warehouses) {
                var whCategory = _this.procurementRequest.procType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_TYPE_MAINTENANCE ||
                    _this.procurementRequest.procType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_TYPE_MAINTENANCE_WITH_EXCHANCE
                    ? _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].WAREHOUSE_CATEGORY_WORKSHOP
                    : _this.procurementRequest.procType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_TYPE_STOCK_LEVELING ||
                        _this.procurementRequest.procType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PROCUREMENT_REQUEST_TYPE_DEPLOYEMENT_BATCH
                        ? _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].WAREHOUSE_CATEGORY_WAREHOUSE
                        : undefined;
                _this.warehouses = warehouses
                    .filter(function (warehouse) { return !whCategory || warehouse.whCategory === whCategory; })
    ...
    ProcurementRequestPopupComponent.prototype.isExpectedSnVisible = function () {
        return (!!this.pn &&
            ...
            (this.pn.traceability === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PN_TRACEABILITY_BY_BATCH ||
                this.pn.traceability === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PN_TRACEABILITY_BY_SN ||
                this.pn.traceability === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].PN_TRACEABILITY_BY_PACKAGING_BATCH_AND_SN));
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('pn'),
        __metadata("design:type", Object)
    ], ProcurementRequestPopupComponent.prototype, "inputPn", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('procurementRequest'),
        __metadata("design:type", Object)
    ], ProcurementRequestPopupComponent.prototype, "inputProcurementRequest", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('bidtProcReqItem'),
        __metadata("design:type", Object)
    ], ProcurementRequestPopupComponent.prototype, "inputBidtProcReqItem", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('workOrder'),
        __metadata("design:type", Object)
    ], ProcurementRequestPopupComponent.prototype, "inputWorkOrder", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('workOrderStatus'),
        __metadata("design:type", String)
    ], ProcurementRequestPopupComponent.prototype, "inputWorkOrderStatus", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('workPackage'),
        __metadata("design:type", Object)
    ], ProcurementRequestPopupComponent.prototype, "inputWorkPackage", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ProcurementRequestPopupComponent.prototype, "onValidate", void 0);
    ProcurementRequestPopupComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-procurement-request-popup',
            template: __webpack_require__(/*! ./procurement-request-popup.component.html */ "./src/app/main/logistics/procurement-request/search/procurement-request-popup/procurement-request-popup.component.html")
        }),
        __metadata("design:paramtypes", [_shared_services_session_service__WEBPACK_IMPORTED_MODULE_12__["SessionService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProcurementRequestPopupModule", function() { return ProcurementRequestPopupModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_components_dialog_search_pn_dialog_search_pn_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../../../shared/components/dialog-search-pn/dialog-search-pn.module */ "./src/app/shared/components/dialog-search-pn/dialog-search-pn.module.ts");
/* harmony import */ var _shared_components_dialog_search_work_order_dialog_search_work_order_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../../../shared/components/dialog-search-work-order/dialog-search-work-order.module */ "./src/app/shared/components/dialog-search-work-order/dialog-search-work-order.module.ts");
...
/* harmony import */ var _procurement_request_popup_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./procurement-request-popup.component */ "./src/app/main/logistics/procurement-request/search/procurement-request-popup/procurement-request-popup.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var INTERNAL_MODULES = [_shared_components_dialog_search_pn_dialog_search_pn_module__WEBPACK_IMPORTED_MODULE_14__["DialogSearchPnModule"], _shared_components_dialog_search_work_order_dialog_search_work_order_module__WEBPACK_IMPORTED_MODULE_15__["DialogSearchWorkOrderModule"]];
var ProcurementRequestPopupModule = /** @class */ (function () {
    ...
    ProcurementRequestPopupModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            exports: [_procurement_request_popup_component__WEBPACK_IMPORTED_MODULE_19__["ProcurementRequestPopupComponent"]],
            declarations: [_procurement_request_popup_component__WEBPACK_IMPORTED_MODULE_19__["ProcurementRequestPopupComponent"]],
            imports: __spread([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchWorkOrderComponent", function() { return DialogSearchWorkOrderComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
/* harmony import */ var _main_logistics_logistics_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../main/logistics/logistics.service */ "./src/app/main/logistics/logistics.service.ts");
/* harmony import */ var _main_maintenance_work_package_form_popups_dialog_work_order_edition_dialog_work_order_edition_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../main/maintenance/work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.service */ "./src/app/main/maintenance/work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.service.ts");
...
/* harmony import */ var _constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../constants/bido-function-type-constants */ "./src/app/shared/constants/bido-function-type-constants.ts");
...
/* harmony import */ var _services_message_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../services/message.service */ "./src/app/shared/services/message.service.ts");
/* harmony import */ var _services_session_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../services/session.service */ "./src/app/shared/services/session.service.ts");
/* harmony import */ var _dialog_search_work_order_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./dialog-search-work-order.service */ "./src/app/shared/components/dialog-search-work-order/dialog-search-work-order.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DialogSearchWorkOrderComponent = /** @class */ (function (_super) {
    ...
    function DialogSearchWorkOrderComponent(dialogSearchWorkOrderService, sessionService, translateService, messageService, logisticsService, dialogWorkOrderEditService) {
        var _this = _super.call(this, _enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_7__["ComponentOpenMode"].Write, 'DialogSearchWorkOrderComponent') || this;
    ...
    DialogSearchWorkOrderComponent.prototype.searchWorkOrders = function () {
        var _this = this;
        this.isLoading = true;
        var site = this.sitesList.find(function (s) { return s.siteId === Number(_this.bidtSiteId); });
        if (!!site) {
            this.searchObject.projectCriteria.bireRepairCenterCode = site.siteCode;
        }
        this.dialogSearchWorkOrderService.findWorkOrder(this.searchObject).subscribe(function (results) {
            if (results) {
    ...
    DialogSearchWorkOrderComponent.prototype.loadPrCategories = function () {
        var _this = this;
        this.dialogSearchWorkOrderService.getAirmWorkOrderTypeList().subscribe(function (result) {
    ...
    DialogSearchWorkOrderComponent.prototype.loadStatus = function () {
        this.status.push({
            value: _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_SIMULATED,
            label: this.translateService.instant('simulated')
        });
        this.status.push({
            value: _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_PLANNED,
            label: this.translateService.instant('planned')
        });
        this.status.push({
            value: _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_RELEASED,
            label: this.translateService.instant('released')
        });
        this.status.push({
            value: _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_ONGOING,
            label: this.translateService.instant('onGoing')
        });
        this.status.push({
            value: _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_TO_BE_CONFIRMED,
            label: this.translateService.instant('toBeConfirmed')
        });
        this.status.push({
            value: _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_PERFORMED,
            label: this.translateService.instant('performed')
        });
        this.status.push({
            value: _constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].AIRM_PROJECT_STATUS_CLOSE,
    ...
    DialogSearchWorkOrderComponent.prototype.loadUser = function () {
        var _this = this;
        var param = {
            useCaseCode: _constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_6__["BidoFunctionTypeConstants"].UC_AIRM_RECEPTION
        };
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], DialogSearchWorkOrderComponent.prototype, "onSelected", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogSearchWorkOrderComponent.prototype, "sourceSearchObject", void 0);
    DialogSearchWorkOrderComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-search-work-order',
            template: __webpack_require__(/*! ./dialog-search-work-order.component.html */ "./src/app/shared/components/dialog-search-work-order/dialog-search-work-order.component.html")
        }),
        __metadata("design:paramtypes", [_dialog_search_work_order_service__WEBPACK_IMPORTED_MODULE_10__["DialogSearchWorkOrderService"],
            ...
            _main_maintenance_work_package_form_popups_dialog_work_order_edition_dialog_work_order_edition_service__WEBPACK_IMPORTED_MODULE_3__["DialogWorkOrderEditService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchWorkOrderModule", function() { return DialogSearchWorkOrderModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var primeng_calendar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! primeng/calendar */ "./node_modules/primeng/calendar.js");
/* harmony import */ var primeng_calendar__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(primeng_calendar__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _main_logistics_logistics_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../main/logistics/logistics.service */ "./src/app/main/logistics/logistics.service.ts");
/* harmony import */ var _main_maintenance_work_package_form_popups_dialog_work_order_edition_dialog_work_order_edition_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../main/maintenance/work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.service */ "./src/app/main/maintenance/work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.service.ts");
...
/* harmony import */ var _dialog_search_pn_dialog_search_pn_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../dialog-search-pn/dialog-search-pn.module */ "./src/app/shared/components/dialog-search-pn/dialog-search-pn.module.ts");
...
/* harmony import */ var _dialog_search_work_order_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./dialog-search-work-order.component */ "./src/app/shared/components/dialog-search-work-order/dialog-search-work-order.component.ts");
/* harmony import */ var _dialog_search_work_order_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./dialog-search-work-order.service */ "./src/app/shared/components/dialog-search-work-order/dialog-search-work-order.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Modules
 *************************************************************************** */
var EXTERNAL_MODULES = [primeng_calendar__WEBPACK_IMPORTED_MODULE_1__["CalendarModule"], primeng_dropdown__WEBPACK_IMPORTED_MODULE_2__["DropdownModule"], primeng_table__WEBPACK_IMPORTED_MODULE_3__["TableModule"]];
var INTERNAL_MODULES = [_dialog_search_pn_dialog_search_pn_module__WEBPACK_IMPORTED_MODULE_9__["DialogSearchPnModule"], _modal_modal_module__WEBPACK_IMPORTED_MODULE_10__["ModalModule"]];
/******************************************************************************
 * Components
 *************************************************************************** */
var COMPONENTS = [_dialog_search_work_order_component__WEBPACK_IMPORTED_MODULE_11__["DialogSearchWorkOrderComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_dialog_search_work_order_service__WEBPACK_IMPORTED_MODULE_12__["DialogSearchWorkOrderService"], _main_maintenance_work_package_form_popups_dialog_work_order_edition_dialog_work_order_edition_service__WEBPACK_IMPORTED_MODULE_5__["DialogWorkOrderEditService"], _main_logistics_logistics_service__WEBPACK_IMPORTED_MODULE_4__["LogisticsService"]];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchWorkOrderService", function() { return DialogSearchWorkOrderService; });
