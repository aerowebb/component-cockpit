(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~logistics-goods-movement-goods-movement-module~maintenance-forecast-forecast-module~maintena~5d9237f0"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaterialAvailabilityIndicatorsComponent", function() { return MaterialAvailabilityIndicatorsComponent; });
...
/* harmony import */ var _procurement_requests_table_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../procurement-requests-table.service */ "./src/app/main/maintenance/procurement-request/procurement-requests-table.service.ts");
...
var MaterialAvailabilityIndicatorsComponent = /** @class */ (function (_super) {
    ...
    function MaterialAvailabilityIndicatorsComponent(procurementRequestsTableService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__["ComponentOpenMode"].Read) || this;
    ...
    Object.defineProperty(MaterialAvailabilityIndicatorsComponent.prototype, "procurementRequests", {
        set: function (procurementRequests) {
            if (!_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_5__["ListUtils"].isNullOrEmpty(procurementRequests)) {
    ...
    MaterialAvailabilityIndicatorsComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_2__["ComponentConstants"].MAI_MATERIAL_AVAILABILITY_INDICATORS;
    };
    ...
    MaterialAvailabilityIndicatorsComponent.prototype.loadProcurementRequestAndQuantity = function () {
        var _this = this;
        if (!_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_5__["ListUtils"].isNullOrEmpty(this.procurementRequestsTab)) {
            ...
            this.procurementRequestsTableService
                ...
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["finalize"])(function () { return (_this.isLoadingProcurementRequestData = false); }))
    ...
    ], MaterialAvailabilityIndicatorsComponent.prototype, "workOrder", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [Array])
    ], MaterialAvailabilityIndicatorsComponent.prototype, "workPackages", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [Array])
    ], MaterialAvailabilityIndicatorsComponent.prototype, "workPackageIds", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [Array])
    ], MaterialAvailabilityIndicatorsComponent.prototype, "procurementRequests", null);
    MaterialAvailabilityIndicatorsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-material-availability-indicators',
            template: __webpack_require__(/*! ./material-availability-indicators.component.html */ "./src/app/main/maintenance/procurement-request/material-availability-indicators/material-availability-indicators.component.html"),
            styles: [__webpack_require__(/*! ./material-availability-indicators.component.scss */ "./src/app/main/maintenance/procurement-request/material-availability-indicators/material-availability-indicators.component.scss")]
        }),
        __metadata("design:paramtypes", [_procurement_requests_table_service__WEBPACK_IMPORTED_MODULE_6__["ProcurementRequestsTableService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProcurementRequestsTableComponent", function() { return ProcurementRequestsTableComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_constants_bidt_stock_mvt_type_constants__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../shared/constants/bidt-stock-mvt-type-constants */ "./src/app/shared/constants/bidt-stock-mvt-type-constants.ts");
...
/* harmony import */ var _shared_types_generic_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../shared/types/generic-component */ "./src/app/shared/types/generic-component.ts");
...
/* harmony import */ var _logistics_logistics_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../logistics/logistics.service */ "./src/app/main/logistics/logistics.service.ts");
/* harmony import */ var _procurement_requests_table_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./procurement-requests-table.service */ "./src/app/main/maintenance/procurement-request/procurement-requests-table.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ProcurementRequestsTableComponent = /** @class */ (function (_super) {
    ...
    function ProcurementRequestsTableComponent(serializationService, tabService, sessionService, logisticsService, propertiesService, translateService, procurementRequestsTableService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_10__["ComponentOpenMode"].Write) || this;
    ...
    ProcurementRequestsTableComponent.prototype.init = function () {
        ...
        this.awPropertiesConstants = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"];
    ...
    ProcurementRequestsTableComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_8__["ComponentConstants"].MAI_PROCUREMENT_REQUESTS_TABLE;
    };
    ProcurementRequestsTableComponent.prototype.loadProcurementStatusMap = function () {
        var _this = this;
        this.procurementRequestStatusList = [];
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_9__["GenericPropertyConstants"].PROCUREMENT_REQUEST_STATUS_MAP).subscribe(function (res) {
    ...
    ProcurementRequestsTableComponent.prototype.loadProcurementTypeMap = function () {
        ...
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_9__["GenericPropertyConstants"].PROCUREMENT_REQUEST_TYPE_MAP).subscribe(function (res) {
            _this.procurementRequestTypes = res;
        });
    };
    ProcurementRequestsTableComponent.prototype.getProcurementRequestAndQuantityAsObservable = function (bidmWorkOrder, workPackageDTOIdsTab) {
        return this.procurementRequestsTableService.findProcReqItemsAndStockQuantityIndicators(bidmWorkOrder, workPackageDTOIdsTab);
    };
    ProcurementRequestsTableComponent.prototype.loadProcurementRequestAndQuantity = function () {
        var _this = this;
        if (!_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_16__["ListUtils"].isNullOrEmpty(this.procurementRequestsFromInput)) {
    ...
    ProcurementRequestsTableComponent.prototype.createProcReqItemRow = function (procurementRequest) {
        ...
        if (!_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_16__["ListUtils"].isNullOrEmpty(procurementRequest.procReqItemsAndQtyIndicatorsDTO)) {
            ...
            if (stockMvts) {
                servedMaterialNb = stockMvts
                    ...
                    return stockMvt.mvtStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].MM_MVT_STATUS_EXECUTED_KEY &&
                        ((stockMvt.bidtStockMvtTypeId === _shared_constants_bidt_stock_mvt_type_constants__WEBPACK_IMPORTED_MODULE_7__["BidtStockMvtTypeConstant"].RECEIPT &&
                            procurementRequest.bidtWarehouseReceipt.whCategory ===
                                _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].WAREHOUSE_CATEGORY_WAREHOUSE) ||
                            (stockMvt.bidtStockMvtTypeId === _shared_constants_bidt_stock_mvt_type_constants__WEBPACK_IMPORTED_MODULE_7__["BidtStockMvtTypeConstant"].WORKSHOP_ENTRY &&
                                procurementRequest.bidtWarehouseReceipt.whCategory ===
                                    _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].WAREHOUSE_CATEGORY_WORKSHOP));
                })
                    .filter(function (stockMvt) { return stockMvt.stockMvtQuantity; })
                    .map(function (stockMvt) { return _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_18__["NumberUtils"].fromString(stockMvt.stockMvtQuantity); })
                    .reduce(function (a, b) { return a + b; }, 0);
                reservedMaterialNb = stockMvts
                    .filter(function (stockMvt) {
                    return stockMvt.mvtStatus !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].MM_MVT_STATUS_EXECUTED_KEY &&
                        stockMvt.mvtStatus !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].MM_MVT_STATUS_CANCELED_KEY &&
        ...
        var servedIndicators = _shared_utils_logistic_utils__WEBPACK_IMPORTED_MODULE_17__["LogisticalUtils"].getServedIndicators(bidtProcurementRequestDTO);
        return procurementRequest.procReqItemsAndQtyIndicatorsDTO.map(function (procReqItemsAndQtyIndicatorsDTO) {
            var procReqItemAndQtyRow = {
                ...
                requestedQuantity: procReqItemsAndQtyIndicatorsDTO.requestedQuantity
                    ? _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_18__["NumberUtils"].roundNumber(_shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_18__["NumberUtils"].fromString(procReqItemsAndQtyIndicatorsDTO.requestedQuantity), 2).toString()
                    : '',
                notReversedNb: 0,
                reversedNb: 0,
            ...
            var procurementRequestItems = _shared_utils_logistic_utils__WEBPACK_IMPORTED_MODULE_17__["LogisticalUtils"].buildProcurementRequestItemsRows(procReqItemAndQtyRow._obj);
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["forkJoin"])(reverseObservables$).subscribe(function (results) {
                var transferOrder = results
                    ...
                    .find(function (to) { return to.torType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].TRANSFER_ORDER_TYPE_REVERSE_MVT; });
                if (transferOrder) {
                    var reverseProcurementRequestItems = transferOrder.bidtTorItems.map(function (torItem) {
                        // Compute reverse item progress
                        var progress = _shared_utils_logistic_utils__WEBPACK_IMPORTED_MODULE_17__["LogisticalUtils"].computeProcurementRequestReverseItemProgress(torItem.pickingMovements);
                        return {
                            obj: torItem,
                    ...
                    var tmp = _this.procReqItemsTableDataSource.dataSrc.find(function (d) { return d.id === procReqItemAndQtyRow.id; });
                    if (!!tmp) {
                        _this.procReqItemsTableDataSource.replaceData(tmp, procReqItemAndQtyRow);
                    }
                }
            });
            if (_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_CLOSED !== procurementRequest.procStatus) {
                ...
                _this.translateService.get([qLabel_1]).subscribe(function (results) {
                    ...
                    procReqItemAndQtyRow = __assign({}, procReqItemAndQtyRow, { availableQuantity: availableQuantity, ok: procReqItemsAndQtyIndicatorsDTO.ok, nok: procReqItemsAndQtyIndicatorsDTO.nok, warning: procReqItemsAndQtyIndicatorsDTO.warning });
                });
            }
    ...
    Object.defineProperty(ProcurementRequestsTableComponent.prototype, "enableOpenProcurementOnAdd", {
        get: function () {
            return (this.procReqItemsTableDataSource.dataSelectionCount === 0 && !!this.bidmWorkOrderFromInput && !this.statusState);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(ProcurementRequestsTableComponent.prototype, "enableOpenProcurementOnEdit", {
        get: function () {
            if (this.procReqItemsTableDataSource.hasDataSelection) {
                ...
                return (this.procReqItemsTableDataSource.dataSelectionCount === 1 &&
                    !!selectedProcurementRequest.bidmWorkOrder &&
                    (selectedProcurementRequest.procStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_DRAFT ||
                        selectedProcurementRequest.procStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_PLANNED ||
                        selectedProcurementRequest.procStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_RELEASED) &&
                    !this.isReadOpenMode);
            }
            else {
                return false;
    ...
    ProcurementRequestsTableComponent.prototype.getStatusLabel = function (statusValue) {
        var matchingStatus = this.procurementRequestStatusList.find(function (status) { return status.value === statusValue; });
        return matchingStatus ? _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_20__["StringUtils"].orEmpty(matchingStatus.label) : '';
    };
    ProcurementRequestsTableComponent.prototype.openProcurementDetails = function (rowData) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_8__["ComponentConstants"].LOG_PROCUREMENT_REQUEST_FORM,
            objectId: rowData && rowData.procurementRequest
    ...
    ProcurementRequestsTableComponent.prototype.isDeleteButtonVisible = function () {
        var _this = this;
        return (this.procReqItemsTableDataSource.hasDataSelection &&
            this.procReqItemsTableDataSource.dataSelection.reduce(function (sum, next) { return sum && _this.isDeletableRow(next); }, true) &&
            !this.statusState);
    };
    ProcurementRequestsTableComponent.prototype.isDeletableRow = function (elt) {
        return ((elt._obj.procStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_DRAFT ||
            elt._obj.procStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_CANCELED) &&
    ...
    ProcurementRequestsTableComponent.prototype.deleteProcurementRequest = function () {
        var _this = this;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["forkJoin"])(this.procReqItemsTableDataSource.dataSelection.map(function (element) {
    ...
    ProcurementRequestsTableComponent.prototype.isCancelButtonVisible = function () {
        var _this = this;
        return (this.procReqItemsTableDataSource.hasDataSelection &&
            this.procReqItemsTableDataSource.dataSelection.reduce(function (sum, next) { return sum && _this.isCancelableRow(next); }, true));
    };
    ProcurementRequestsTableComponent.prototype.isCancelableRow = function (elt) {
        return ((elt._obj.procStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_SIMULATED ||
            elt._obj.procStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_PLANNED ||
            elt._obj.procStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_RELEASED) &&
            this.sessionService.hasUserRightByUseCase(_shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_6__["BidoFunctionTypeConstants"].UC_MM_PROCUREMENT, _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_6__["BidoFunctionTypeConstants"].DEGREE_MANAGE));
    };
    ProcurementRequestsTableComponent.prototype.cancelProcurementRequest = function () {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["forkJoin"])(this.procReqItemsTableDataSource.dataSelection.map(function (element) {
            ...
            rowToUpdateStatusAtCanceled.forEach(function (element) {
                element.procStatus = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].PROCUREMENT_REQUEST_STATUS_CANCELED;
            });
            _this.procReqItemsTableDataSource.deleteDataSelection();
    ...
    ProcurementRequestsTableComponent.prototype.initProcurementRequestsTableDataSource = function () {
        this.procReqItemsTableDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_4__["TableDataSource"]({
            ...
            columns: [
                ...
                },
                {
                    ...
                    alignment: _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_4__["ColumnAlignment"].RIGHT,
                    width: '5%'
                },
                {
                    field: 'status',
    ...
    ProcurementRequestsTableComponent.prototype.openPart = function (row) {
        if (row.materials) {
            var data = {
                componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_8__["ComponentConstants"].ENG_PART_NUMBER_FORM,
                id: this.tabService.generateId(),
    ...
    ProcurementRequestsTableComponent.prototype.openProcurementManagmentPage = function () {
        if (this.procReqItemsTableDataSource.dataSelectionCount === 1 &&
            ...
            var data = {
                id: this.tabService.generateId(),
                componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_8__["ComponentConstants"].LOG_MATERIAL_REQUEST_MANAGEMENT_FORM,
        ...
        this.translateService.get([wpKey, msnKey]).subscribe(function (results) {
            _this.originalProcReqRow.forEach(function (procReqItemAndQtyRow) {
                ...
                procReqItemAndQtyRow._obj.procReqItemsAndQtyIndicatorsDTO.forEach(function () {
                    ...
                    var workPackage = _this.wpFiltersList.find(function (wp) { return (wp.value = selectedItem.value); });
    ...
    ProcurementRequestsTableComponent.prototype.filterStockMvtTableByCriteria = function () {
        ...
        if (!!this.procReqItemFiltersAvailabilityList) {
            this.procReqItemFiltersAvailabilityList.forEach(function (key) {
                if (key === _this.okKey) {
                    dataToShow = __spread(dataToShow, _this.originalProcReqRow.filter(function (row) { return row.ok; }));
                }
                if (key === _this.warningKey) {
                    dataToShow = __spread(dataToShow, _this.originalProcReqRow.filter(function (row) { return row.warning; }));
                }
                if (key === _this.nOkKey) {
                    dataToShow = __spread(dataToShow, _this.originalProcReqRow.filter(function (row) { return row.nok; }));
                }
            });
        }
        if (!!this.selectedProcReqFilterStatusValue) {
            var dataStatusFilter = [];
            dataStatusFilter = dataToShow.filter(function (row) { return _this.selectedProcReqFilterStatusValue === row._obj.procStatus; });
        ...
        if (!!this.selectedProcReqFilterWPValue) {
            var dataWPFilter = [];
            dataWPFilter = dataToShow.filter(function (row) { return _this.selectedProcReqFilterWPValue === row.procurementRequestId; });
            if (dataWPFilter.length > 0) {
                dataToShow = __spread(dataWPFilter);
            }
        }
        dataToShow = dataToShow.reduce(function (unique, item) { return (unique.every(function (elt) { return elt.id !== item.id; }) ? __spread(unique, [item]) : unique); }, []);
    ...
    ], ProcurementRequestsTableComponent.prototype, "statusState", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], ProcurementRequestsTableComponent.prototype, "workOrder", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [Array])
    ], ProcurementRequestsTableComponent.prototype, "workPackages", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [Array])
    ], ProcurementRequestsTableComponent.prototype, "workPackageIds", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [Array])
    ], ProcurementRequestsTableComponent.prototype, "procurementRequests", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String),
        __metadata("design:paramtypes", [String])
    ], ProcurementRequestsTableComponent.prototype, "requestManagementKey", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ProcurementRequestsTableComponent.prototype, "askParentRefresh", void 0);
    ProcurementRequestsTableComponent = ProcurementRequestsTableComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-procurement-requests-table',
            template: __webpack_require__(/*! ./procurement-requests-table.component.html */ "./src/app/main/maintenance/procurement-request/procurement-requests-table.component.html"),
            styles: [__webpack_require__(/*! ./procurement-requests-table.component.scss */ "./src/app/main/maintenance/procurement-request/procurement-requests-table.component.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_serialization_service__WEBPACK_IMPORTED_MODULE_12__["SerializationService"],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ProcurementRequestsTableModule", function() { return ProcurementRequestsTableModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_api_aircraft_maintenance_api__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../shared/api/aircraft-maintenance.api */ "./src/app/shared/api/aircraft-maintenance.api.ts");
/* harmony import */ var _shared_api_am_project_management_api__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../shared/api/am-project-management.api */ "./src/app/shared/api/am-project-management.api.ts");
/* harmony import */ var _shared_api_bidt_procurement_request_api__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../shared/api/bidt-procurement-request.api */ "./src/app/shared/api/bidt-procurement-request.api.ts");
...
/* harmony import */ var _logistics_procurement_request_search_procurement_request_popup_procurement_request_popup_module__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../logistics/procurement-request/search/procurement-request-popup/procurement-request-popup.module */ "./src/app/main/logistics/procurement-request/search/procurement-request-popup/procurement-request-popup.module.ts");
/* harmony import */ var _material_availability_indicators_material_availability_indicators_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./material-availability-indicators/material-availability-indicators.component */ "./src/app/main/maintenance/procurement-request/material-availability-indicators/material-availability-indicators.component.ts");
/* harmony import */ var _procurement_requests_table_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./procurement-requests-table.component */ "./src/app/main/maintenance/procurement-request/procurement-requests-table.component.ts");
/* harmony import */ var _procurement_requests_table_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./procurement-requests-table.service */ "./src/app/main/maintenance/procurement-request/procurement-requests-table.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var INTERNAL_MODULES = [_shared_components_table_table_module__WEBPACK_IMPORTED_MODULE_18__["TableModule"], _logistics_procurement_request_search_procurement_request_popup_procurement_request_popup_module__WEBPACK_IMPORTED_MODULE_20__["ProcurementRequestPopupModule"]];
/******************************************************************************
 * Components
 *************************************************************************** */
var COMPONENTS = [_procurement_requests_table_component__WEBPACK_IMPORTED_MODULE_22__["ProcurementRequestsTableComponent"], _material_availability_indicators_material_availability_indicators_component__WEBPACK_IMPORTED_MODULE_21__["MaterialAvailabilityIndicatorsComponent"]];
var DYNAMIC_COMPONENTS = [];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_procurement_requests_table_service__WEBPACK_IMPORTED_MODULE_23__["ProcurementRequestsTableService"]];
var API_PROVIDERS = [_shared_api_bidt_procurement_request_api__WEBPACK_IMPORTED_MODULE_16__["BidtProcurementRequestApi"], _shared_api_am_project_management_api__WEBPACK_IMPORTED_MODULE_15__["AMProjectManagementApi"], _shared_api_aircraft_maintenance_api__WEBPACK_IMPORTED_MODULE_14__["AircraftMaintenanceApi"]];
