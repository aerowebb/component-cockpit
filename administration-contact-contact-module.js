(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["administration-contact-contact-module"],{
...
/* harmony import */ var _shared_components_dialog_status_dialog_status_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../shared/components/dialog-status/dialog-status.module */ "./src/app/shared/components/dialog-status/dialog-status.module.ts");
...
/* harmony import */ var _form_contact_form_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./form/contact-form.component */ "./src/app/main/administration/contact/form/contact-form.component.ts");
/* harmony import */ var _form_contact_form_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./form/contact-form.service */ "./src/app/main/administration/contact/form/contact-form.service.ts");
/* harmony import */ var _search_contact_search_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./search/contact-search.component */ "./src/app/main/administration/contact/search/contact-search.component.ts");
/* harmony import */ var _search_contact_search_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./search/contact-search.service */ "./src/app/main/administration/contact/search/contact-search.service.ts");
 ...
 * Modules
 *************************************************************************** */
var EXTERNAL_MODULES = [primeng_checkbox__WEBPACK_IMPORTED_MODULE_1__["CheckboxModule"], primeng_inputtextarea__WEBPACK_IMPORTED_MODULE_2__["InputTextareaModule"], primeng_keyfilter__WEBPACK_IMPORTED_MODULE_3__["KeyFilterModule"], primeng_table__WEBPACK_IMPORTED_MODULE_4__["TableModule"], primeng_tooltip__WEBPACK_IMPORTED_MODULE_5__["TooltipModule"]];
var INTERNAL_MODULES = [_shared_components_dialog_search_customer_dialog_search_customer_module__WEBPACK_IMPORTED_MODULE_9__["DialogSearchCustomerModule"], _shared_components_dialog_status_dialog_status_module__WEBPACK_IMPORTED_MODULE_10__["DialogStatusModule"], _shared_components_modal_modal_module__WEBPACK_IMPORTED_MODULE_12__["ModalModule"], _shared_components_table_table_module__WEBPACK_IMPORTED_MODULE_13__["TableModule"]];
/******************************************************************************
 * Components
 *************************************************************************** */
var DYNAMIC_COMPONENTS = [_form_contact_form_component__WEBPACK_IMPORTED_MODULE_15__["ContactFormComponent"], _search_contact_search_component__WEBPACK_IMPORTED_MODULE_17__["ContactSearchComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_form_contact_form_service__WEBPACK_IMPORTED_MODULE_16__["ContactFormService"], _search_contact_search_service__WEBPACK_IMPORTED_MODULE_18__["ContactSearchService"]];
...
/* harmony import */ var _search_contact_search_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../search/contact-search.service */ "./src/app/main/administration/contact/search/contact-search.service.ts");
/* harmony import */ var _contact_form_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./contact-form.service */ "./src/app/main/administration/contact/form/contact-form.service.ts");
...
var ContactFormComponent = /** @class */ (function (_super) {
    ...
    function ContactFormComponent(favoriteService, loaderService, messageService, serializationService, tabService, contactFormService, contactSearchService) {
    ...
    ContactFormComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_1__["ComponentConstants"].ADM_CONTACT_FORM;
    };
    ...
    ContactFormComponent.prototype.saveContact = function () {
        ...
        if (this.validateContact()) {
            var isUpdate_1 = !!this.componentData && this.componentData.openMode === _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Create ? '' : 'update';
            ...
            this.contactFormService.saveContact(saveContactInput).subscribe(function (result) {
                ...
                if (!!_this.componentData && isUpdate_1 === '') {
                    ...
                    _this.componentData.openMode = _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Read;
                }
    ...
    ContactFormComponent.prototype.validateContact = function () {
        if (!this.contactListOutputDTO.firstName ||
    ...
    ContactFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./contact-form.component.html */ "./src/app/main/administration/contact/form/contact-form.component.html")
        }),
...
/* harmony import */ var _contact_search_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./contact-search.service */ "./src/app/main/administration/contact/search/contact-search.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ContactSearchComponent = /** @class */ (function (_super) {
    ...
    function ContactSearchComponent(favoriteService, loaderService, messageService, serializationService, tabService, contactSearchService, confirmationService) {
        ...
        _this.CONTACT_SEARCH_CRITERIA_ID = _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_2__["AppConstants"].CONTACT_SEARCH_CRITERIA_ID;
        _this.showCustomerDialog = false;
        _this.initContactTableDataSource();
        return _this;
    }
    ContactSearchComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_3__["ComponentConstants"].ADM_CONTACT_SEARCH;
    };
    ...
    ContactSearchComponent.prototype.initContactTableDataSource = function () {
        this.contactTableDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_1__["TableDataSource"]({
    ...
    ContactSearchComponent.prototype.openNewContact = function () {
        this.openContacts(undefined, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__["ComponentOpenMode"].Create);
    };
    /** Open Selected Contact */
    ContactSearchComponent.prototype.openContacts = function (objectId, openMode) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_3__["ComponentConstants"].ADM_CONTACT_FORM,
            openMode: openMode
        };
        if (!!objectId) {
    ...
    ContactSearchComponent.prototype.openSelectedContacts = function () {
        ...
        this.contactTableDataSource.dataSelection.forEach(function (contact) {
            if (!!contact) {
                _this.openContacts(contact, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__["ComponentOpenMode"].Read);
            }
        });
    };
    ...
    ContactSearchComponent.prototype.deleteContacts = function () {
        var _this = this;
        var confirmMessageKey = this.contactTableDataSource.dataSelectionCount > 1
    ...
    ], ContactSearchComponent.prototype, "resultsContainerAnchor", void 0);
    ContactSearchComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-contact-search',
            template: __webpack_require__(/*! ./contact-search.component.html */ "./src/app/main/administration/contact/search/contact-search.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ContactSearchService", function() { return ContactSearchService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_api_fleet_management_api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../shared/api/fleet-management.api */ "./src/app/shared/api/fleet-management.api.ts");
/* harmony import */ var _shared_http_abstract_aw_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../shared/http/abstract-aw-http */ "./src/app/shared/http/abstract-aw-http.ts");
