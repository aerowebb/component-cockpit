(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~administration-attributes-attributes-module~administration-business-partner-business-partner~1045786c"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DynamicAttributesHistoryComponent", function() { return DynamicAttributesHistoryComponent; });
...
/* harmony import */ var _services_confirmation_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/confirmation.service */ "./src/app/shared/services/confirmation.service.ts");
...
/* harmony import */ var _services_loader_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/loader.service */ "./src/app/shared/services/loader.service.ts");
/* harmony import */ var _utils_string_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../utils/string-utils */ "./src/app/shared/utils/string-utils.ts");
/* harmony import */ var _dynamic_attributes_dynamic_attributes_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../dynamic-attributes/dynamic-attributes.service */ "./src/app/shared/components/dynamic-attributes/dynamic-attributes.service.ts");
/* harmony import */ var _dynamic_attributes_history_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./dynamic-attributes-history.service */ "./src/app/shared/components/dynamic-attributes-history/dynamic-attributes-history.service.ts");
...
var DynamicAttributesHistoryComponent = /** @class */ (function (_super) {
    ...
    function DynamicAttributesHistoryComponent(translateService, confirmationService, dateService, dynamicAttributesHistoryService, dynamicAttributesService, loaderService) {
        var _this = _super.call(this, _enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__["ComponentOpenMode"].Write, 'DynamicAttributesHistoryComponent') || this;
    ...
    DynamicAttributesHistoryComponent.prototype.ngOnInit = function () {
        ...
        this.attributes = this.dynamicAttributesService.getLeafs(this.dynamicAttributes).map(function (dynamicAttribute) {
            var attribute = {
        ...
        this.confirmationService.confirmDelete({
            ...
            accept: function () {
                _this.selectedRows.forEach(function (selectedRow) {
                    ...
                    if (!!attribute) {
                        _this.dynamicAttributesHistoryService.removeAttributeHistory(_this.deleteApi, attribute).subscribe(function (_) {
            ...
            if (!!selection) {
                this.formattedTableRows = selection.map(function (obj) {
                    var formattedObject = {
                        ...
                        attributeValue: _utils_string_utils__WEBPACK_IMPORTED_MODULE_8__["StringUtils"].orEmpty(obj.attributeValue),
                        statusDate: _this.dateService.dateWithHourMinSecToString(obj.statusDate),
                        statusState: _utils_string_utils__WEBPACK_IMPORTED_MODULE_8__["StringUtils"].orEmpty(obj.statusState),
    ...
    ], DynamicAttributesHistoryComponent.prototype, "deleteApi", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('attributes'),
        __metadata("design:type", Array)
    ], DynamicAttributesHistoryComponent.prototype, "dynamicAttributes", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('history'),
        __metadata("design:type", rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"])
    ], DynamicAttributesHistoryComponent.prototype, "historyObservable", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DynamicAttributesHistoryComponent.prototype, "showDelete", void 0);
    DynamicAttributesHistoryComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dynamic-attributes-history',
            template: __webpack_require__(/*! ./dynamic-attributes-history.component.html */ "./src/app/shared/components/dynamic-attributes-history/dynamic-attributes-history.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DynamicAttributesHistoryModule", function() { return DynamicAttributesHistoryModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _dynamic_attributes_history_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./dynamic-attributes-history.component */ "./src/app/shared/components/dynamic-attributes-history/dynamic-attributes-history.component.ts");
/* harmony import */ var _dynamic_attributes_history_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./dynamic-attributes-history.service */ "./src/app/shared/components/dynamic-attributes-history/dynamic-attributes-history.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Components
 *************************************************************************** */
var COMPONENTS = [_dynamic_attributes_history_component__WEBPACK_IMPORTED_MODULE_8__["DynamicAttributesHistoryComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_dynamic_attributes_history_service__WEBPACK_IMPORTED_MODULE_9__["DynamicAttributesHistoryService"]];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DynamicAttributesHistoryService", function() { return DynamicAttributesHistoryService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _http_abstract_aw_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../http/abstract-aw-http */ "./src/app/shared/http/abstract-aw-http.ts");
/* harmony import */ var _services_app_config_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/app-config.service */ "./src/app/shared/services/app-config.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DynamicAttributesHistoryService = /** @class */ (function (_super) {
    ...
    DynamicAttributesHistoryService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"], _services_app_config_service__WEBPACK_IMPORTED_MODULE_3__["AppConfigService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DynamicAttributeComponent", function() { return DynamicAttributeComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_session_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../services/session.service */ "./src/app/shared/services/session.service.ts");
/* harmony import */ var _enums_dynamic_attribute_type_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../enums/dynamic-attribute-type.enum */ "./src/app/shared/components/dynamic-attributes/enums/dynamic-attribute-type.enum.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DynamicAttributeComponent = /** @class */ (function () {
    ...
    DynamicAttributeComponent.prototype.isCalendarAttribute = function (attribute) {
        return attribute.type === _enums_dynamic_attribute_type_enum__WEBPACK_IMPORTED_MODULE_2__["DynamicAttributeType"].Date;
    };
    DynamicAttributeComponent.prototype.isCheckboxAttribute = function (attribute) {
        return attribute.type === _enums_dynamic_attribute_type_enum__WEBPACK_IMPORTED_MODULE_2__["DynamicAttributeType"].Boolean;
    };
    DynamicAttributeComponent.prototype.isDropdownAttribute = function (attribute) {
        return attribute.type === _enums_dynamic_attribute_type_enum__WEBPACK_IMPORTED_MODULE_2__["DynamicAttributeType"].List;
    };
    DynamicAttributeComponent.prototype.isInputAttribute = function (attribute) {
        return attribute.type === _enums_dynamic_attribute_type_enum__WEBPACK_IMPORTED_MODULE_2__["DynamicAttributeType"].Text;
    };
    ...
    ], DynamicAttributeComponent.prototype, "workflowControl", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DynamicAttributeComponent.prototype, "attribute", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DynamicAttributeComponent.prototype, "isReadOpenMode", void 0);
    DynamicAttributeComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dynamic-attribute',
            template: __webpack_require__(/*! ./dynamic-attribute.component.html */ "./src/app/shared/components/dynamic-attributes/dynamic-attribute/dynamic-attribute.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DynamicAttributesComponent", function() { return DynamicAttributesComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var _utils_workflow_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utils/workflow-utils */ "./src/app/shared/utils/workflow-utils.ts");
/* harmony import */ var _dynamic_attributes_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dynamic-attributes.service */ "./src/app/shared/components/dynamic-attributes/dynamic-attributes.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DynamicAttributesComponent = /** @class */ (function () {
        ...
        set: function (workflowControls) {
            ...
            if (this._workflowControls) {
                this._workflowControls.forEach(function (control) {
                    var attributeId = _utils_workflow_utils__WEBPACK_IMPORTED_MODULE_2__["WorkflowUtils"].getAttributeId(control);
                    if (attributeId) {
    ...
    ], DynamicAttributesComponent.prototype, "historyObservable", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], DynamicAttributesComponent.prototype, "deleteApi", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DynamicAttributesComponent.prototype, "isReadOpenMode", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DynamicAttributesComponent.prototype, "showHistory", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('workflowControls'),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], DynamicAttributesComponent.prototype, "workflowControls", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('attributes'),
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [Array])
    ], DynamicAttributesComponent.prototype, "attributesNodes", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('columnWidth'),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], DynamicAttributesComponent.prototype, "columnWidth", null);
    DynamicAttributesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dynamic-attributes',
            template: __webpack_require__(/*! ./dynamic-attributes.component.html */ "./src/app/shared/components/dynamic-attributes/dynamic-attributes.component.html")
        }),
        __metadata("design:paramtypes", [_dynamic_attributes_service__WEBPACK_IMPORTED_MODULE_3__["DynamicAttributesService"]])
...
/* harmony import */ var _dynamic_attributes_history_dynamic_attributes_history_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../dynamic-attributes-history/dynamic-attributes-history.module */ "./src/app/shared/components/dynamic-attributes-history/dynamic-attributes-history.module.ts");
/* harmony import */ var _dynamic_attribute_dynamic_attribute_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./dynamic-attribute/dynamic-attribute.component */ "./src/app/shared/components/dynamic-attributes/dynamic-attribute/dynamic-attribute.component.ts");
/* harmony import */ var _dynamic_attributes_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./dynamic-attributes.component */ "./src/app/shared/components/dynamic-attributes/dynamic-attributes.component.ts");
/* harmony import */ var _dynamic_attributes_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./dynamic-attributes.service */ "./src/app/shared/components/dynamic-attributes/dynamic-attributes.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Modules
 *************************************************************************** */
var EXTERNAL_MODULES = [primeng_calendar__WEBPACK_IMPORTED_MODULE_1__["CalendarModule"], primeng_checkbox__WEBPACK_IMPORTED_MODULE_2__["CheckboxModule"], primeng_dropdown__WEBPACK_IMPORTED_MODULE_3__["DropdownModule"], primeng_tooltip__WEBPACK_IMPORTED_MODULE_4__["TooltipModule"]];
var INTERNAL_MODULES = [_dynamic_attributes_history_dynamic_attributes_history_module__WEBPACK_IMPORTED_MODULE_8__["DynamicAttributesHistoryModule"]];
/******************************************************************************
 * Components
 *************************************************************************** */
var COMPONENTS = [_dynamic_attribute_dynamic_attribute_component__WEBPACK_IMPORTED_MODULE_9__["DynamicAttributeComponent"]];
var EXPORTED_COMPONENTS = [_dynamic_attributes_component__WEBPACK_IMPORTED_MODULE_10__["DynamicAttributesComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DynamicAttributesService", function() { return DynamicAttributesService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _constants_bido_attribute_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../constants/bido-attribute-constants */ "./src/app/shared/constants/bido-attribute-constants.ts");
/* harmony import */ var _constants_lang_constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../constants/lang-constants */ "./src/app/shared/constants/lang-constants.ts");
...
/* harmony import */ var _utils_list_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../utils/list-utils */ "./src/app/shared/utils/list-utils.ts");
...
/* harmony import */ var _enums_dynamic_attribute_type_enum__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./enums/dynamic-attribute-type.enum */ "./src/app/shared/components/dynamic-attributes/enums/dynamic-attribute-type.enum.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DynamicAttributesService = /** @class */ (function (_super) {
    ...
    DynamicAttributesService.prototype.attributeValueToString = function (attribute) {
        if (attribute.value && attribute.type === _enums_dynamic_attribute_type_enum__WEBPACK_IMPORTED_MODULE_10__["DynamicAttributeType"].Date) {
            return moment__WEBPACK_IMPORTED_MODULE_3__(attribute.value).format(DynamicAttributesService_1.DATE_FORMAT);
        }
    ...
    DynamicAttributesService.prototype.setValues = function (nodes, attributes) {
        ...
        attributes.forEach(function (attribute) {
            var matchingLeaf = leafs.find(function (leaf) { return leaf.id === attribute.attributeId; });
            if (matchingLeaf) {
    ...
    //   });
    // }
    DynamicAttributesService.prototype.toBireEvolutionAttribute = function (evolutionNumber, evolutionRevisionNumber, attributes) {
        var _this = this;
        return this.getLeafs(attributes).map(function (attribute) {
    ...
    DynamicAttributesService.prototype.toBireVariantAttribute = function (familyCode, variantCode, structureType, attributes) {
        var _this = this;
        return this.getLeafs(attributes).map(function (attribute) {
    ...
    DynamicAttributesService.prototype.toBireItemAttribute = function (familyCode, variantCode, structureType, chapter, marks, section, sheet, subject, attributes) {
        var _this = this;
        return this.getLeafs(attributes).map(function (attribute) {
    ...
    DynamicAttributesService.prototype.toBireOperationAttributeId = function (opeCode, rangeCode, opeVersion, attributes) {
        var _this = this;
        return this.getLeafs(attributes).map(function (attribute) {
            var bireEvolutionAttributeId = {
                attributeId: attribute.id,
    ...
    DynamicAttributesService.prototype.toBireEvolutionAttributeId = function (evolutionNumber, evolutionRevisionNumber, attributes) {
        return this.getLeafs(attributes).map(function (attribute) {
            var bireEvolutionAttributeId = {
                attributeId: attribute.id,
                evolutionRevisionNumber: evolutionRevisionNumber,
    ...
    DynamicAttributesService.prototype.toBireModificationAttributeId = function (modificationNumber, modificationRevisionNumber, modificationType, familyCode, structureType, attributes) {
        return this.getLeafs(attributes).map(function (attribute) {
            var bireEvolutionAttributeId = {
                attributeId: attribute.id,
    ...
    DynamicAttributesService.prototype.computeAttributeValue = function (type, value) {
        if (!!value) {
            if (type === _enums_dynamic_attribute_type_enum__WEBPACK_IMPORTED_MODULE_10__["DynamicAttributeType"].Boolean) {
                return value === 'true';
            }
            else if (type === _enums_dynamic_attribute_type_enum__WEBPACK_IMPORTED_MODULE_10__["DynamicAttributeType"].Date) {
    ...
    DynamicAttributesService.prototype.computeDefaultAttributeValue = function (type) {
        ...
        else if (type === _enums_dynamic_attribute_type_enum__WEBPACK_IMPORTED_MODULE_10__["DynamicAttributeType"].Text) {
            return '';
        }
        else {
            return undefined;
    ...
    DynamicAttributesService.prototype.getAttributeType = function (bidoAttribute) {
        switch (bidoAttribute.attributeType) {
            case _constants_bido_attribute_constants__WEBPACK_IMPORTED_MODULE_4__["BidoAttributeConstants"].ATTRIBUTE_TYPE_BOOLEAN:
                return _enums_dynamic_attribute_type_enum__WEBPACK_IMPORTED_MODULE_10__["DynamicAttributeType"].Boolean;
            case _constants_bido_attribute_constants__WEBPACK_IMPORTED_MODULE_4__["BidoAttributeConstants"].ATTRIBUTE_TYPE_DATE:
                return _enums_dynamic_attribute_type_enum__WEBPACK_IMPORTED_MODULE_10__["DynamicAttributeType"].Date;
            case _constants_bido_attribute_constants__WEBPACK_IMPORTED_MODULE_4__["BidoAttributeConstants"].ATTRIBUTE_TYPE_LIST:
                return _enums_dynamic_attribute_type_enum__WEBPACK_IMPORTED_MODULE_10__["DynamicAttributeType"].List;
            case _constants_bido_attribute_constants__WEBPACK_IMPORTED_MODULE_4__["BidoAttributeConstants"].ATTRIBUTE_TYPE_TEXT:
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DynamicAttributeType", function() { return DynamicAttributeType; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BidoAttributeConstants", function() { return BidoAttributeConstants; });
