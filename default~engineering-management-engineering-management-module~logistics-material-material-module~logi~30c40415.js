(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~engineering-management-engineering-management-module~logistics-material-material-module~logi~30c40415"],{
...
module.exports = ":host .custom-icon {\n  font-size: 10em;\n  cursor: pointer; }\n\n:host .custom-align {\n  text-align: center; }\n\n:host .section-with-no-padding {\n  padding: 0em !important;\n  margin-top: 2em; }\n\n:host .custom-width {\n  max-width: -webkit-fit-content;\n  max-width: -moz-fit-content;\n  max-width: fit-content; }\n\n:host .error-context {\n  color: red; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TransferOrderPopupComponent", function() { return TransferOrderPopupComponent; });
...
/* harmony import */ var _shared_utils_logistic_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../../shared/utils/logistic-utils */ "./src/app/shared/utils/logistic-utils.ts");
...
/* harmony import */ var _shared_transfer_order_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../shared/transfer-order-service */ "./src/app/main/logistics/transfer-order/shared/transfer-order-service.ts");
...
var TransferOrderPopupComponent = /** @class */ (function (_super) {
    ...
    function TransferOrderPopupComponent(sessionService, messageService, propertiesService, logisticsService, translateService, transferOrderService, dfSearchService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_6__["ComponentOpenMode"].Read, 'TransferOrderPopupComponent') || this;
        ...
        _this.whType = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].WAREHOUSE_CATEGORY_WAREHOUSE;
    ...
    TransferOrderPopupComponent.prototype.autoFillFields = function () {
        ...
        if (this.createTransferOrderInput.procurmentRequest.requestedDate) {
            this.bidtTransferOrderDTOInput.receiptExpectedDate = moment__WEBPACK_IMPORTED_MODULE_2__(this.createTransferOrderInput.procurmentRequest.requestedDate)
                .subtract(1, 'days')
                .toDate();
        }
        if (this.createTransferOrderInput.procurmentRequest.requestedPotential) {
            this.formattedRequestedPotential = _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_13__["NumberUtils"].roundNumber(_shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_13__["NumberUtils"].fromString(this.createTransferOrderInput.procurmentRequest.requestedPotential), 2).toString();
        }
        // fill criticality
    ...
    TransferOrderPopupComponent.prototype.init = function () {
        ...
        this.bidtTransferOrderDTOInput.torStatus = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].TRANSFER_ORDER_STATUS_PLANNED;
    };
    ...
    TransferOrderPopupComponent.prototype.loadDropdown = function () {
        ...
        this.transferOrderService.fetchTypeObjectList().subscribe(function (types) {
            _this.typeList = types.sort(function (a, b) { return a.label.localeCompare(b.label); });
            // fill type
            if (_this.createTransferOrderInput) {
                _this.selectedTransferOrderType = _this.typeList.filter(function (type) { return type.value.id === Number(_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].TRANSFER_ORDER_TYPE_INTER_SITE); })[0].value;
            }
        });
    };
    /************************************
    ...
    TransferOrderPopupComponent.prototype.loadLogisticType = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].WAREHOUSE_CATEGORY_MAP).subscribe(function (res) {
            if (res && res.length) {
    ...
    TransferOrderPopupComponent.prototype.loadCriticity = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].LOGISTICAL_CRITICALITY_MAP).subscribe(function (res) {
            if (res && res.length) {
                _this.criticityList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__["ListUtils"].orEmpty(res);
                _this.criticityList = _shared_utils_logistic_utils__WEBPACK_IMPORTED_MODULE_12__["LogisticalUtils"].sortCriticities(_this.criticityList);
            }
        });
    };
    ...
    TransferOrderPopupComponent.prototype.onChangeShipperSite = function () {
        ...
        if (!!this.selectedTransferOrderType &&
            this.selectedTransferOrderType.transferType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].MM_TRANSFER_TYPE_INTRA_SITE_KEY) {
            this.selectedRecipientSite = this.selectedShipperSite;
            this.onChangeRecipientSite();
        }
        if (!!this.selectedTransferOrderType &&
            this.selectedTransferOrderType.transferType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].MM_TRANSFER_TYPE_INTER_SITE_KEY) {
            if (this.selectedShipperSite === this.selectedRecipientSite) {
                this.selectedRecipientSite = undefined;
                this.onChangeRecipientSite();
            }
            this.sitesRecipient = this.sitesShipment;
            this.sitesRecipient = this.sitesShipment.filter(function (site) { return site.value !== _this.selectedShipperSite; });
        }
    };
            ...
            if (onlyMain) {
                return _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__["ListUtils"].orEmpty(warehouses)
                    ...
                    return warehouse.whCategory === warehouseCategory &&
                        warehouse.whType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].MM_WAREHOUSE_TYPE_MAIN;
                })
    ...
    TransferOrderPopupComponent.prototype.loadSites = function () {
        ...
        this.dfSearchService.findAllBireSite().subscribe({
            next: function (sitesShipment) {
                _this.sitesShipment = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_11__["ListUtils"].orEmpty(sitesShipment)
                    .map(function (site) {
                    return {
                ...
                if (_this.createTransferOrderInput &&
                    ...
                    _this.sitesShipment = _this.sitesShipment.filter(function (site) { return site.value !== _this.createTransferOrderInput.procurmentRequest.bidtSiteByBidtSiteIssueId; });
                }
            }
        });
    };
    TransferOrderPopupComponent.prototype.canValidate = function () {
        return (this.selectedTransferOrderType &&
    ...
    TransferOrderPopupComponent.prototype.validate = function () {
        ...
        var input = {
            ...
            torType: this.selectedTransferOrderType && this.selectedTransferOrderType.id
    ...
    TransferOrderPopupComponent.prototype.onSelectTranferType = function () {
        ...
        this.sitesRecipient = this.sitesShipment;
        if (!!this.selectedTransferOrderType) {
            if (this.selectedTransferOrderType.transferType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].MM_TRANSFER_TYPE_INTRA_SITE_KEY) {
            ...
            this.showPartnerDialogInput =
                this.selectedTransferOrderType.transferType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].MM_TRANSFER_TYPE_INTRA_SITE_KEY ||
                    ...
                    ? false
                    : true;
            if (this.selectedTransferOrderType.transferType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].MM_TRANSFER_TYPE_INTER_SITE_KEY) {
                this.selectedRecipientWarehouseCategory = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_4__["AWPropertiesConstants"].WAREHOUSE_CATEGORY_WAREHOUSE;
                if (!!this.selectedShipperSite) {
    ...
    ], TransferOrderPopupComponent.prototype, "createTransferOrderInput", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], TransferOrderPopupComponent.prototype, "pn", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], TransferOrderPopupComponent.prototype, "onValidate", void 0);
    TransferOrderPopupComponent = TransferOrderPopupComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-transfer-order-popup',
            template: __webpack_require__(/*! ./transfer-order-popup.component.html */ "./src/app/main/logistics/transfer-order/search/transfer-order-popup/transfer-order-popup.component.html"),
            styles: [__webpack_require__(/*! ./transfer-order-popup.component.scss */ "./src/app/main/logistics/transfer-order/search/transfer-order-popup/transfer-order-popup.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TransferOrderPopupModule", function() { return TransferOrderPopupModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _goods_receipt_delivery_folder_search_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../goods-receipt/delivery-folder-search.service */ "./src/app/main/logistics/goods-receipt/delivery-folder-search.service.ts");
/* harmony import */ var _transfer_order_search_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../transfer-order-search.service */ "./src/app/main/logistics/transfer-order/search/transfer-order-search.service.ts");
/* harmony import */ var _transfer_order_popup_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./transfer-order-popup.component */ "./src/app/main/logistics/transfer-order/search/transfer-order-popup/transfer-order-popup.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var INTERNAL_MODULES = [_shared_components_dialog_search_pn_dialog_search_pn_module__WEBPACK_IMPORTED_MODULE_15__["DialogSearchPnModule"]];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_transfer_order_search_service__WEBPACK_IMPORTED_MODULE_20__["TransferOrderSearchService"], _goods_receipt_delivery_folder_search_service__WEBPACK_IMPORTED_MODULE_19__["DeliveryFolderSearchService"]];
var TransferOrderPopupModule = /** @class */ (function () {
    ...
    TransferOrderPopupModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_transfer_order_popup_component__WEBPACK_IMPORTED_MODULE_21__["TransferOrderPopupComponent"]],
            imports: __spread([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TransferOrderSearchService", function() { return TransferOrderSearchService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_api_bidt_df_type_api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../shared/api/bidt-df-type.api */ "./src/app/shared/api/bidt-df-type.api.ts");
...
var TransferOrderSearchService = /** @class */ (function (_super) {
    ...
    function TransferOrderSearchService(http, appConfigService, bidtSite, bidtWarehouseApi, propertiesService, bidtDfTypeApi, bidtProductStructureManagementTypeApi) {
    ...
    TransferOrderSearchService.prototype.fetchWarehouseList = function () {
        return this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_6__["GenericPropertyConstants"].WAREHOUSE_CATEGORY_MAP);
    };
