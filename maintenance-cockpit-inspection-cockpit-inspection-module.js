(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["maintenance-cockpit-inspection-cockpit-inspection-module"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CockpitInspectionModule", function() { return CockpitInspectionModule; });
...
/* harmony import */ var _shared_components_add_edit_inventory_add_edit_inventory_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../shared/components/add-edit-inventory/add-edit-inventory.module */ "./src/app/shared/components/add-edit-inventory/add-edit-inventory.module.ts");
/* harmony import */ var _shared_components_component_measure_component_measure_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../shared/components/component-measure/component-measure.module */ "./src/app/shared/components/component-measure/component-measure.module.ts");
...
/* harmony import */ var _form_cockpit_inspection_form_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./form/cockpit-inspection-form.component */ "./src/app/main/maintenance/cockpit-inspection/form/cockpit-inspection-form.component.ts");
/* harmony import */ var _form_cockpit_inspection_form_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./form/cockpit-inspection-form.service */ "./src/app/main/maintenance/cockpit-inspection/form/cockpit-inspection-form.service.ts");
/* harmony import */ var _form_info_sub_assembly_info_sub_assembly_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./form/info-sub-assembly/info-sub-assembly.component */ "./src/app/main/maintenance/cockpit-inspection/form/info-sub-assembly/info-sub-assembly.component.ts");
/* harmony import */ var _form_sub_assembly_table_filters_sub_assembly_table_filters_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./form/sub-assembly-table-filters/sub-assembly-table-filters.component */ "./src/app/main/maintenance/cockpit-inspection/form/sub-assembly-table-filters/sub-assembly-table-filters.component.ts");
/* harmony import */ var _form_technical_quotation_table_filters_technical_quotation_table_filters_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./form/technical-quotation-table-filters/technical-quotation-table-filters.component */ "./src/app/main/maintenance/cockpit-inspection/form/technical-quotation-table-filters/technical-quotation-table-filters.component.ts");
/* harmony import */ var _form_tree_sub_assembly_tree_sub_assembly_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./form/tree-sub-assembly/tree-sub-assembly.component */ "./src/app/main/maintenance/cockpit-inspection/form/tree-sub-assembly/tree-sub-assembly.component.ts");
...
var EXTERNAL_MODULES = [
    ...
    _shared_components_component_measure_component_measure_module__WEBPACK_IMPORTED_MODULE_15__["ComponentMeasureModule"],
    ...
    _shared_components_add_edit_inventory_add_edit_inventory_module__WEBPACK_IMPORTED_MODULE_14__["AddEditInventoryModule"]
];
...
var DYNAMIC_COMPONENTS = [
    ...
    _form_sub_assembly_table_filters_sub_assembly_table_filters_component__WEBPACK_IMPORTED_MODULE_21__["SubAssemblyTableFiltersComponent"],
    _form_technical_quotation_table_filters_technical_quotation_table_filters_component__WEBPACK_IMPORTED_MODULE_22__["TechnicalQuotationTableFiltersComponent"],
    _form_tree_sub_assembly_tree_sub_assembly_component__WEBPACK_IMPORTED_MODULE_23__["TreeSubAssemblyComponent"]
];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_form_cockpit_inspection_form_service__WEBPACK_IMPORTED_MODULE_19__["CockpitInspectionFormService"]];
/******************************************************************************
 * Api's
 *************************************************************************** */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CockpitInspectionFormComponent", function() { return CockpitInspectionFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_utils_bido_family_variant_utils__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../../shared/utils/bido-family-variant-utils */ "./src/app/shared/utils/bido-family-variant-utils.ts");
...
/* harmony import */ var _cockpit_inspection_form_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./cockpit-inspection-form.service */ "./src/app/main/maintenance/cockpit-inspection/form/cockpit-inspection-form.service.ts");
...
var CockpitInspectionFormComponent = /** @class */ (function (_super) {
    ...
    function CockpitInspectionFormComponent(favoriteService, loaderService, messageService, serializationService, tabService, cockpitInspectionFormService, translateService, sessionService) {
    ...
    CockpitInspectionFormComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_6__["ComponentConstants"].MAI_COCKPIT_INSPECTION_FORM;
    };
    ...
    CockpitInspectionFormComponent.prototype.loadFamilyVariants = function () {
        var _this = this;
        this.familyVariants = [];
        this.cockpitInspectionFormService.loadFamilyVariants().subscribe(function (results) {
            results.forEach(function (result) {
                ...
                var value = _shared_utils_bido_family_variant_utils__WEBPACK_IMPORTED_MODULE_15__["BidoFamilyVariantUtils"].buildFamilyVariantCode(result.familyCode, result.variantCode);
                if (!!label && !!value) {
                    var familyVariant = {
                        label: label,
                        value: value
        ...
        if (!!this.componentData && !!this.componentData.objectId) {
            ...
            this.cockpitInspectionFormService
                ...
                _this.mroCenter = !result.repairCenterCode
                    ? undefined
                    : _this.mroCenters.filter(function (res) { return res.value === result.repairCenterCode; })[0].label;
                result.customerCode = !result.customerCode
                    ? undefined
                    : _this.customerList.filter(function (res) { return res.value === result.customerCode; })[0].label;
                _this.bsdeProjectDTO = result;
                // Setting Context of screen
                if (!!result.projectNumber) {
                    _this.subtitle = [
                        _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_16__["StringUtils"].isNullOrEmpty(result.projectNumber.toString()) ? '' : "N\u00B0 " + result.projectNumber,
                        _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_16__["StringUtils"].isNullOrEmpty(result.projectPn) ? '' : "P/N " + result.projectPn,
                        _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_16__["StringUtils"].isNullOrEmpty(result.projectSn) ? '' : "S/N " + result.projectSn
                    ]
                        .filter(function (s) { return !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_16__["StringUtils"].isEmpty(s); })
                        .join(' | ');
                }
    ...
    CockpitInspectionFormComponent.prototype.initChart = function () {
        ...
        this.chartData = {
            datasets: [
                {
                    data: [],
                    backgroundColor: [_shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_4__["AppConstants"].COLOR_GREEN, _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_4__["AppConstants"].COLOR_ORANGE],
                    hoverBackgroundColor: [_shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_4__["AppConstants"].COLOR_GREEN, _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_4__["AppConstants"].COLOR_ORANGE]
                }
            ],
            labels: []
        };
    ...
    CockpitInspectionFormComponent.prototype.openItemChildren = function (item) {
        var data = {
            ...
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_6__["ComponentConstants"].MAI_INFO_SUB_ASSEMBLY_FORM,
            ...
            this.cockpitInspectionFormService.getPartNumberStructure(bireVersionPnDTO_1).subscribe(function (res) {
                if (!!res && res.length > 0) {
                    ...
                    if (!!partNum && partNum.length > 0) {
                        ...
                        _this.openItemPartNumber(bireVersionPnDTO_1, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_7__["ComponentOpenMode"].Read);
                    }
                }
            });
        }
    ...
    CockpitInspectionFormComponent.prototype.openSNLink = function () {
        if (!!this.bidoEquipmentDTO && !!this.bidoEquipmentDTO.equipmentCode) {
            var functionNm = this.bidoEquipmentDTO.equipmentFunction || _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].FAMILY_FUNCTION_TOOL_KEY;
            this.openEquipment(this.bidoEquipmentDTO.equipmentCode, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_7__["ComponentOpenMode"].Read, functionNm);
        }
    };
    CockpitInspectionFormComponent.prototype.openEquipment = function (objectId, openMode, functionNm) {
        var labelKey;
        var componentName;
        if (!functionNm || functionNm === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].FAMILY_FUNCTION_MAJOR_EQUIPMENT_KEY) {
            labelKey = "transaction." + _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_6__["ComponentConstants"].FLE_EQUIPMENT_FORM;
            componentName = _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_6__["ComponentConstants"].FLE_EQUIPMENT_FORM;
        }
        else {
            if (functionNm === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].FAMILY_FUNCTION_ENGINE_KEY) {
                labelKey = "transaction." + _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_6__["ComponentConstants"].FLE_ENGINE_FORM;
                componentName = _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_6__["ComponentConstants"].FLE_ENGINE_FORM;
            }
            else if (functionNm === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].FAMILY_FUNCTION_AIRCRAFT_KEY) {
                labelKey = "transaction." + _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_6__["ComponentConstants"].FLE_AIRCRAFT_FORM;
                componentName = _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_6__["ComponentConstants"].FLE_AIRCRAFT_FORM;
            }
            else if (functionNm === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].FAMILY_FUNCTION_TOOL_KEY) {
                labelKey = "transaction." + _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_6__["ComponentConstants"].LOG_TOOL_FORM;
                componentName = _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_6__["ComponentConstants"].LOG_TOOL_FORM;
            }
            else {
    ...
    CockpitInspectionFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./cockpit-inspection-form.component.html */ "./src/app/main/maintenance/cockpit-inspection/form/cockpit-inspection-form.component.html"),
            styles: [__webpack_require__(/*! ./cockpit-inspection-form.component.scss */ "./src/app/main/maintenance/cockpit-inspection/form/cockpit-inspection-form.component.scss"), __webpack_require__(/*! ./shared/shared.scss */ "./src/app/main/maintenance/cockpit-inspection/form/shared/shared.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CockpitInspectionFormService", function() { return CockpitInspectionFormService; });
...
var CockpitInspectionFormService = /** @class */ (function (_super) {
    ...
    function CockpitInspectionFormService(http, appConfigService, projectManagementApi, cockpitComponentApi, productStructureManagementApi, fleetManagementApi) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InfoSubAssemblyComponent", function() { return InfoSubAssemblyComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../shared/constants/app-constants */ "./src/app/shared/constants/app-constants.ts");
...
/* harmony import */ var _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../../../shared/utils/file-utils */ "./src/app/shared/utils/file-utils.ts");
/* harmony import */ var _shared_utils_image_utils__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../../../../shared/utils/image-utils */ "./src/app/shared/utils/image-utils.ts");
/* harmony import */ var _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../../../../shared/utils/string-utils */ "./src/app/shared/utils/string-utils.ts");
/* harmony import */ var _cockpit_inspection_form_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../cockpit-inspection-form.service */ "./src/app/main/maintenance/cockpit-inspection/form/cockpit-inspection-form.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var InfoSubAssemblyComponent = /** @class */ (function (_super) {
    ...
    function InfoSubAssemblyComponent(favoriteService, loaderService, messageService, serializationService, tabService, domSanitizer, sessionService, translateService, propertiesService, cockpitInspectionFormService) {
    ...
    InfoSubAssemblyComponent.prototype.ngOnInit = function () {
        ...
        if (!!this.subAssemblyPageData.selectedBireItem) {
            ...
            this.displayComponentContext(item.chapter + "-" + item.section + "-" + item.subject + "-" + item.sheet + "-" + item.marks, this.isCreateOpenMode);
        }
    ...
    InfoSubAssemblyComponent.prototype.loadItemStructureNodeIllustrationList = function (result) {
        ...
        return this.domSanitizer.bypassSecurityTrustResourceUrl("" + _shared_utils_image_utils__WEBPACK_IMPORTED_MODULE_20__["ImageUtils"].getBase64Prefix(doc.docType) + doc.docFile);
    };
    ...
    InfoSubAssemblyComponent.prototype.fetchDropdown = function () {
        var _this = this;
        this.propertiesService.resetCache(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_9__["GenericPropertyConstants"].TASK_TYPE_MAP);
        this.setSearchControlList();
        this.setSearchSentenceDecisionList();
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_9__["GenericPropertyConstants"].ITEM_FAMILY_CODE_MAP).subscribe(function (res) {
            _this.familyCodeMap = res;
        });
        this.cockpitInspectionFormService.findMROCenter().subscribe(function (res) {
            _this.mroCenters = res;
        });
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_9__["GenericPropertyConstants"].TASK_TYPE_MAP).subscribe(function (results) {
    ...
    InfoSubAssemblyComponent.prototype.initChart = function () {
        ...
        this.chartData = {
            datasets: [
                {
                    data: [],
                    backgroundColor: [_shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_6__["AppConstants"].COLOR_GREEN, _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_6__["AppConstants"].COLOR_ORANGE],
                    hoverBackgroundColor: [_shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_6__["AppConstants"].COLOR_GREEN, _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_6__["AppConstants"].COLOR_ORANGE]
                }
            ],
            labels: []
        };
    ...
    InfoSubAssemblyComponent.prototype.setChartOptions = function () {
        this.chartOptions = {
            ...
            tooltips: {
                bodyFontColor: _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_6__["AppConstants"].COLOR_BACKGROUND_PRIMARY
            }
        };
    };
    /**********************************
    ...
    InfoSubAssemblyComponent.prototype.getTechnicalQuotation = function () {
        ...
        this.cockpitInspectionFormService
            ...
            _this.technicalQuotationDBList = Object(lodash_es__WEBPACK_IMPORTED_MODULE_3__["cloneDeep"])(techQuotationData.technicalQuotationList);
            _this.technicalQuotationList = _this.customizeTechnicalTableData(techQuotationData.technicalQuotationList);
                ...
                if (row.iwbFindingsToDisplay.length > 0) {
                    ...
                    findings.forEach(function (res) {
                        row.iwbFindingsToDisplay.push([
                            _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(res.damageCode) ? '' : res.damageCode,
                            _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(res.quantity) ? '' : res.quantity,
                            _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(res.criticality) ? '' : res.criticality
                        ]
                            .filter(function (s) { return !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isEmpty(s); })
                            .join(' / '));
                        row.iwbFindingsToDisplayHover += [
                            _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(res.damageCode) ? '' : res.damageCode,
                            _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(res.quantity) ? '' : res.quantity,
                            _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(res.criticality) ? '' : res.criticality,
                            _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(res.findingComment) ? '\n' : res.findingComment + "\n"
                        ]
                            .filter(function (s) { return !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isEmpty(s); })
                            .join(' / ');
                    });
            ...
            if (!!row.iwbTask) {
                if (row.iwbTask.length > 0) {
                    ...
                    tasks.forEach(function (res) {
                        row.iwbTask.push(_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(res.taskCode) ? '' : res.taskCode);
                        row.iwbTaskHover += [
                            _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(res.taskCode) ? '' : res.taskCode,
                            _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(res.taskDescription) ? '\n' : res.taskDescription + "\n"
                        ]
                            .filter(function (s) { return !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isEmpty(s); })
                            .join(' / ');
                    });
    ...
    InfoSubAssemblyComponent.prototype.loadItemInformation = function () {
        ...
        if (!!this.selectedSubAssembly.itemFamilyCode) {
            ...
            this.isSerialized = "" + (!!this.selectedSubAssembly
    ...
    InfoSubAssemblyComponent.prototype.setSiblingSelection = function () {
        ...
        this.siblingsList.forEach(function (res) {
            var item = bireItem.chapter + "-" + bireItem.section + "-" + bireItem.subject + "-" + bireItem.sheet + "-" + bireItem.marks;
            if (res.label === item) {
    ...
    InfoSubAssemblyComponent.prototype.openItemChildren = function (item) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_7__["ComponentConstants"].MAI_INFO_SUB_ASSEMBLY_FORM,
    ...
    InfoSubAssemblyComponent.prototype.openItemInventory = function (item) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_7__["ComponentConstants"].MAI_ITEM_INVENTORY,
            openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_10__["ComponentOpenMode"].Read
        };
        if (!!item) {
            data.objectId = this.serializationService.serialize(item);
    ...
    InfoSubAssemblyComponent.prototype.openMeasure = function () {
        ...
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_7__["ComponentConstants"].MAI_MEASURE_COMPONENT,
            openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_10__["ComponentOpenMode"].Read
        };
    ...
    InfoSubAssemblyComponent.prototype.loadSibling = function () {
        ...
        if (!!this.selectedSibling) {
            this.selectedSibling.itemFamilyCode = !!this.selectedSibling.itemFamilyCode
                ? this.familyCodeMap.filter(function (res) { return _this.selectedSibling.itemFamilyCode === res.value; })[0].label
                : undefined;
        }
    ...
    InfoSubAssemblyComponent.prototype.openPartNumberLink = function (pnCode) {
        this.openPN(pnCode, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_10__["ComponentOpenMode"].Read);
    };
    InfoSubAssemblyComponent.prototype.openPN = function (objectId, openMode) {
        var labelKey = 'transaction.' + _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_7__["ComponentConstants"].ENG_PART_NUMBER_FORM;
        var data = {
            id: this.tabService.generateId(),
    ...
    InfoSubAssemblyComponent.prototype.openWorkOrderLink = function (rowData) {
        if (!!rowData.woId && !!rowData.woProjectId) {
            ...
            this.openWorkOrder(workOrderDTOId, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_10__["ComponentOpenMode"].Read);
        }
    };
    ...
    InfoSubAssemblyComponent.prototype.setSearchControlList = function () {
        var _this = this;
        var OK = _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_8__["ControlConfigConstants"].ICON_GREEN_LED_CODE;
        var NOK = _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_8__["ControlConfigConstants"].ICON_RED_LED_CODE;
        var WARNING = _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_8__["ControlConfigConstants"].ICON_YELLOW_LED_CODE;
    ...
    InfoSubAssemblyComponent.prototype.filterWithCriteria = function () {
        if (Object.keys(this.searchCriteria).length === 0) {
            this.technicalQuotationList = this.customizeTechnicalTableData(Object(lodash_es__WEBPACK_IMPORTED_MODULE_3__["cloneDeep"])(this.technicalQuotationDBList));
        }
        else {
    ...
    InfoSubAssemblyComponent.prototype.setControlGlobalFilter = function () {
        ...
        this.searchQuotationGlobalFilterChanged
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(InfoSubAssemblyComponent_1.SEARCH_TEXT_DEBOUNCE_TIME), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.unsubscribe))
            .subscribe(function () {
    ...
    InfoSubAssemblyComponent.prototype.matchFilters = function (row, searchCriteria) {
        ...
        if (!!row.sentenceValue) {
            var sentenceLabel = this.sentenceList.filter(function (res) { return res.label === row.sentenceValue; })[0].value;
    ...
    InfoSubAssemblyComponent.prototype.updateQuotationTableDisplayed = function () {
        var _this = this;
        this.technicalQuotationList = [];
        this.technicalQuotationList = Object(lodash_es__WEBPACK_IMPORTED_MODULE_3__["cloneDeep"])(this.technicalQuotationDBList);
        this.technicalQuotationList = this.customizeTechnicalTableData(this.technicalQuotationList.filter(function (elt) { return _this.matchFilters(elt, _this.searchCriteria); }));
    };
    ...
    InfoSubAssemblyComponent.prototype.calculateProgressChartData = function () {
        ...
        if (!!this.selectedSubAssembly.expectedQuantity &&
            !!this.technicalQuotationList &&
            ...
            var totalInventoryQty = this.technicalQuotationList.reduce(function (acc, val) { return acc + parseInt(val.quantity, 10); }, 0);
            var missingQuantities = Number(this.selectedSubAssembly.expectedQuantity) > Number(this.selectedSubAssembly.realQuantity)
    ...
    InfoSubAssemblyComponent.prototype.getSentenceValue = function (label) {
        var dto = this.sentenceList.filter(function (res) { return res.label === label; });
    ...
    InfoSubAssemblyComponent.prototype.getDecisionValue = function (label) {
        var dto = this.decisionList.filter(function (res) { return res.label === label; });
        return !!dto && dto.length > 0 ? dto[0].value : undefined;
    };
    /********************************************
     * Load PN list
    ...
    InfoSubAssemblyComponent = InfoSubAssemblyComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./info-sub-assembly.component.html */ "./src/app/main/maintenance/cockpit-inspection/form/info-sub-assembly/info-sub-assembly.component.html"),
            styles: [__webpack_require__(/*! ./info-sub-assembly.component.scss */ "./src/app/main/maintenance/cockpit-inspection/form/info-sub-assembly/info-sub-assembly.component.scss"), __webpack_require__(/*! ../shared/shared.scss */ "./src/app/main/maintenance/cockpit-inspection/form/shared/shared.scss")]
        }),
...
module.exports = ".display--flex-column {\n  display: flex !important;\n  flex-direction: column !important; }\n\n.display--flex-row {\n  display: flex !important;\n  flex-direction: row !important; }\n\n.display--none {\n  display: none !important; }\n\n.height--100 {\n  height: 100%; }\n\n.min-width--fit-content {\n  min-width: -webkit-fit-content !important;\n  min-width: -moz-fit-content !important;\n  min-width: fit-content !important; }\n\n.position--relative {\n  position: relative !important; }\n\n.scroll-y--none {\n  overflow-y: hidden !important; }\n\n.text--unselectable {\n  -webkit-user-select: none !important;\n     -moz-user-select: none !important;\n      -ms-user-select: none !important;\n          user-select: none !important; }\n\n.visibility--hidden {\n  visibility: hidden !important; }\n\n.width--10 {\n  width: 10%; }\n\n.width--20 {\n  width: 20%; }\n\n.width--30 {\n  width: 30%; }\n\n.width--40 {\n  width: 50%; }\n\n.width--50 {\n  width: 50%; }\n\n.width--60 {\n  width: 60%; }\n\n.width--70 {\n  width: 70%; }\n\n.width--80 {\n  width: 80%; }\n\n.width--90 {\n  width: 90%; }\n\n.width--100 {\n  width: 100%; }\n\n.flex--1 {\n  flex: 1 !important; }\n\n.flex--2 {\n  flex: 2 !important; }\n\n.flex--3 {\n  flex: 3 !important; }\n\n.flex--4 {\n  flex: 4 !important; }\n\n.flex--5 {\n  flex: 5 !important; }\n\n.flex--auto {\n  flex: auto !important; }\n\n.flex-row--align-center {\n  align-items: center !important; }\n\n.flex-row--align-end {\n  align-items: flex-end !important; }\n\n.flex-row--align-start {\n  align-items: flex-start !important; }\n\n.flex-row--justify-center {\n  justify-content: center !important; }\n\n.flex-row--justify-end {\n  justify-content: flex-end !important; }\n\n.flex-row--justify-start {\n  justify-content: flex-start !important; }\n\n:host .alert {\n  display: inline-block;\n  max-width: 7rem;\n  text-transform: uppercase;\n  width: 100%;\n  font-weight: 600;\n  text-align: center;\n  width: 5rem;\n  margin-left: 0.6em; }\n\n:host .alert.alert--ok {\n    background-color: #4caf50; }\n\n:host .alert.alert--warning {\n    background-color: #ffc107; }\n\n:host .alert.alert--nok {\n    background-color: #f6685e; }\n\n:host .alert.alert--none {\n    background-color: #c8d4d6; }\n\n:host .custom-span {\n  color: #01579b; }\n\n:host .code {\n  display: inline-table; }\n\n:host .top {\n  margin-bottom: 2em;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap; }\n\n:host ::ng-deep .name {\n  font-style: italic;\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  max-width: 15em; }\n\n:host .cursor-class {\n  cursor: pointer !important; }\n\n:host .action-buttons {\n  margin-bottom: 1em;\n  display: flex;\n  float: right; }\n\n:host .custom-row {\n  display: flex;\n  padding-bottom: 1em; }\n\n:host .expanded-img-class {\n  max-width: 100em;\n  max-height: 50em; }\n\n:host .custom-padding {\n  margin-right: 1em !important; }\n\n:host .table-filters-overlay {\n  display: flex;\n  flex-direction: row; }\n\n:host .table-filters-overlay .column {\n    margin: 0 16px; }\n\n:host .table-filters-overlay .filters {\n    display: flex;\n    flex-direction: column; }\n\n:host .table-filters-overlay .filters > * {\n      margin: 8px 0 !important; }\n\n:host .table-filters-overlay .filters .aw-dropdown {\n      overflow: visible !important; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SubAssemblyTableFiltersComponent", function() { return SubAssemblyTableFiltersComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var SubAssemblyTableFiltersComponent = /** @class */ (function (_super) {
    ...
    ], SubAssemblyTableFiltersComponent.prototype, "progressList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], SubAssemblyTableFiltersComponent.prototype, "configurationList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], SubAssemblyTableFiltersComponent.prototype, "itemFamilyList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], SubAssemblyTableFiltersComponent.prototype, "searchCriteria", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], SubAssemblyTableFiltersComponent.prototype, "onFilter", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], SubAssemblyTableFiltersComponent.prototype, "onReset", void 0);
    SubAssemblyTableFiltersComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-sub-assembly-table-filters',
            template: __webpack_require__(/*! ./sub-assembly-table-filters.component.html */ "./src/app/main/maintenance/cockpit-inspection/form/sub-assembly-table-filters/sub-assembly-table-filters.component.html"),
            styles: [__webpack_require__(/*! ../shared/shared.scss */ "./src/app/main/maintenance/cockpit-inspection/form/shared/shared.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TechnicalQuotationTableFiltersComponent", function() { return TechnicalQuotationTableFiltersComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var TechnicalQuotationTableFiltersComponent = /** @class */ (function (_super) {
    ...
    TechnicalQuotationTableFiltersComponent.prototype.init = function () {
        ...
        this.configurationList.push({ label: 'OK', value: TechnicalQuotationTableFiltersComponent_1.OK }, { label: 'WARNING', value: TechnicalQuotationTableFiltersComponent_1.WARNING }, { label: 'NOK', value: TechnicalQuotationTableFiltersComponent_1.NOK });
    };
    var TechnicalQuotationTableFiltersComponent_1;
    TechnicalQuotationTableFiltersComponent.OK = _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_1__["ControlConfigConstants"].ICON_GREEN;
    TechnicalQuotationTableFiltersComponent.WARNING = _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_1__["ControlConfigConstants"].ICON_YELLOW;
    TechnicalQuotationTableFiltersComponent.NOK = _shared_constants_control_config_constants__WEBPACK_IMPORTED_MODULE_1__["ControlConfigConstants"].ICON_RED;
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], TechnicalQuotationTableFiltersComponent.prototype, "decisionList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], TechnicalQuotationTableFiltersComponent.prototype, "sentenceList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], TechnicalQuotationTableFiltersComponent.prototype, "configurationList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], TechnicalQuotationTableFiltersComponent.prototype, "pnList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], TechnicalQuotationTableFiltersComponent.prototype, "woCodeList", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], TechnicalQuotationTableFiltersComponent.prototype, "searchCriteria", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], TechnicalQuotationTableFiltersComponent.prototype, "onFilter", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], TechnicalQuotationTableFiltersComponent.prototype, "onReset", void 0);
    TechnicalQuotationTableFiltersComponent = TechnicalQuotationTableFiltersComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./technical-quotation-table-filters.component.html */ "./src/app/main/maintenance/cockpit-inspection/form/technical-quotation-table-filters/technical-quotation-table-filters.component.html"),
            styles: [__webpack_require__(/*! ../shared/shared.scss */ "./src/app/main/maintenance/cockpit-inspection/form/shared/shared.scss")]
        }),
...
module.exports = ".display--flex-column {\n  display: flex !important;\n  flex-direction: column !important; }\n\n.display--flex-row {\n  display: flex !important;\n  flex-direction: row !important; }\n\n.display--none {\n  display: none !important; }\n\n.height--100 {\n  height: 100%; }\n\n.min-width--fit-content {\n  min-width: -webkit-fit-content !important;\n  min-width: -moz-fit-content !important;\n  min-width: fit-content !important; }\n\n.position--relative {\n  position: relative !important; }\n\n.scroll-y--none {\n  overflow-y: hidden !important; }\n\n.text--unselectable {\n  -webkit-user-select: none !important;\n     -moz-user-select: none !important;\n      -ms-user-select: none !important;\n          user-select: none !important; }\n\n.visibility--hidden {\n  visibility: hidden !important; }\n\n.width--10 {\n  width: 10%; }\n\n.width--20 {\n  width: 20%; }\n\n.width--30 {\n  width: 30%; }\n\n.width--40 {\n  width: 50%; }\n\n.width--50 {\n  width: 50%; }\n\n.width--60 {\n  width: 60%; }\n\n.width--70 {\n  width: 70%; }\n\n.width--80 {\n  width: 80%; }\n\n.width--90 {\n  width: 90%; }\n\n.width--100 {\n  width: 100%; }\n\n.flex--1 {\n  flex: 1 !important; }\n\n.flex--2 {\n  flex: 2 !important; }\n\n.flex--3 {\n  flex: 3 !important; }\n\n.flex--4 {\n  flex: 4 !important; }\n\n.flex--5 {\n  flex: 5 !important; }\n\n.flex--auto {\n  flex: auto !important; }\n\n.flex-row--align-center {\n  align-items: center !important; }\n\n.flex-row--align-end {\n  align-items: flex-end !important; }\n\n.flex-row--align-start {\n  align-items: flex-start !important; }\n\n.flex-row--justify-center {\n  justify-content: center !important; }\n\n.flex-row--justify-end {\n  justify-content: flex-end !important; }\n\n.flex-row--justify-start {\n  justify-content: flex-start !important; }\n\n:host .list-with-details .details,\n:host .list-with-details .list {\n  max-height: 50rem; }\n\n:host .list-with-details .details {\n  flex-grow: 1; }\n\n:host .list-with-details .details .item-structure-node-action-list {\n    justify-content: flex-end; }\n\n:host .list-with-details .details .item-structure-node-action-list > button {\n      margin-right: 8px; }\n\n:host .list-with-details .details .item-structure-node-action-list > button:last-of-type {\n        margin-right: 0; }\n\n:host .list-with-details .details .item-structure-node-image > img {\n    max-width: 100%;\n    min-width: 100%; }\n\n:host .list-with-details .list {\n  min-width: 25rem; }\n\n:host ::ng-deep .chapter {\n  display: inline-block;\n  color: #01579b;\n  font-weight: 600; }\n\n:host ::ng-deep .info {\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap; }\n\n:host .illustration {\n  text-align: center; }\n\n:host .img-class {\n  max-height: 3rem;\n  cursor: pointer; }\n\n:host /deep/ p-progressbar.pla .ui-progressbar-value {\n  background: #c8d4d6; }\n\n:host /deep/ p-progressbar.ong .ui-progressbar-value {\n  background: #b8d0e8; }\n\n:host /deep/ p-progressbar.tbc .ui-progressbar-value {\n  background: #b8d0e8; }\n\n:host /deep/ p-progressbar.per .ui-progressbar-value {\n  background: #006ea9; }\n\n:host /deep/ p-progressbar.clo .ui-progressbar-value {\n  background: #4caf50; }\n\n:host /deep/ p-progressbar.pos .ui-progressbar-value {\n  background: #4caf50; }\n\n:host /deep/ p-progressbar.por .ui-progressbar-value {\n  background: #dddf00; }\n\n:host .loader {\n  position: absolute;\n  right: 2em;\n  z-index: 1000;\n  top: 1.5em; }\n\n:host .item-class {\n  display: inline-grid; }\n\n:host .action-button {\n  width: 50%;\n  margin: 0 auto; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TreeSubAssemblyComponent", function() { return TreeSubAssemblyComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/platform-browser */ "./node_modules/@angular/platform-browser/fesm5/platform-browser.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lodash-es */ "./node_modules/lodash-es/lodash.js");
...
/* harmony import */ var _shared_services_tab_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../../../shared/services/tab.service */ "./src/app/shared/services/tab.service.ts");
/* harmony import */ var _shared_types_page_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../../../shared/types/page-component */ "./src/app/shared/types/page-component.ts");
/* harmony import */ var _shared_utils_image_utils__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../../../shared/utils/image-utils */ "./src/app/shared/utils/image-utils.ts");
...
var TreeSubAssemblyComponent = /** @class */ (function (_super) {
    ...
    function TreeSubAssemblyComponent(favoriteService, loaderService, messageService, serializationService, tabService, domSanitizer, sessionService, translateService, cockpitInspectionFormService, propertiesService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_10__["ComponentOpenMode"].Write, favoriteService, loaderService, messageService, serializationService, tabService) || this;
        _this.domSanitizer = domSanitizer;
        _this.sessionService = sessionService;
        _this.translateService = translateService;
    ...
    TreeSubAssemblyComponent.prototype.emptyChildrens = function (treeNode) {
        treeNode.forEach(function (node) { return (node.children = []); });
        return treeNode;
    };
    /**********************************
     * TREE TABLE COLUMNS
            ...
            data.forEach(function (elt) {
                ...
                if (!!eleClone) {
                    if (!!eleClone.itemFamilyCode) {
                        var dto = _this.familyCodeMap.filter(function (res) { return eleClone.itemFamilyCode === res.value; })[0];
                        if (!!dto) {
                ...
                toReturn.push({
                    data: eleClone,
                    children: _this.buildTree(_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_20__["ListUtils"].orEmpty(elt.children)),
                    bireItemDTO: elt.bireItemDTO,
                    sentenceAndDecisionList: elt.sentenceAndDecisionList,
                    expanded: !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(_this.searchGlobalFilter)
                });
            });
        }
        return toReturn;
    ...
    TreeSubAssemblyComponent.prototype.loadItemStructureNodeIllustrationList = function (result) {
        var doc = result.bireDocumentDTO;
        return this.domSanitizer.bypassSecurityTrustResourceUrl("" + _shared_utils_image_utils__WEBPACK_IMPORTED_MODULE_19__["ImageUtils"].getBase64Prefix(doc.docType) + doc.docFile);
    };
    /**********************************
        ...
        data.forEach(function (elt) {
            if (!!elt && !!elt.data) {
                ...
                if ((expectedQty != undefined && parseInt(expectedQty, 10) > parseInt(realQty, 10)) ||
                    ...
                    _this.progressCounter.notCompleted += parseInt(expectedQty, 10) - (elt.data.totalCompletedInventory || 0);
                }
    ...
    TreeSubAssemblyComponent.prototype.setControlGlobalFilter = function () {
        ...
        this.searchSubAssemblyGlobalFilterChanged
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(TreeSubAssemblyComponent_1.SEARCH_TEXT_DEBOUNCE_TIME), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.unsubscribe))
            .subscribe(function () {
    ...
    TreeSubAssemblyComponent.prototype.treeNodeMatchFilters = function (node, searchCriteria) {
        ...
        if (!_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_20__["ListUtils"].isNullOrEmpty(searchCriteria.configuration)) {
        ...
        var family = true;
        if (!!nodeData.itemFamilyCode && !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(searchCriteria.family)) {
            var familyLabel = this.familyCodeMap.filter(function (res) { return nodeData.itemFamilyCode === res.label; })[0].value;
            family = searchCriteria.family === familyLabel;
        }
        var completed = true;
        if (!_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_20__["ListUtils"].isNullOrEmpty(searchCriteria.progress)) {
        ...
        var functionCodeMatch = !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.searchGlobalFilter) &&
            functionCode.includes(this.searchGlobalFilter.toLowerCase());
        var item = nodeData.chapter + "-" + nodeData.section + "-" + nodeData.subject + "-" + nodeData.sheet + "-" + nodeData.marks;
        var itemMatch = !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.searchGlobalFilter) && item.includes(this.searchGlobalFilter.toLowerCase());
        var itemNumber = nodeData.itemNumber ? nodeData.itemNumber.toLowerCase() : '';
        var itemNumberMatch = !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.searchGlobalFilter) && itemNumber.includes(this.searchGlobalFilter.toLowerCase());
        var name = nodeData.name ? nodeData.name.toLowerCase() : '';
        var nameMatch = !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.searchGlobalFilter) && name.includes(this.searchGlobalFilter.toLowerCase());
        var familyCode = nodeData.itemFamilyCode ? nodeData.itemFamilyCode.toLowerCase() : '';
        var familyMatch = !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.searchGlobalFilter) && familyCode.includes(this.searchGlobalFilter.toLowerCase());
        var expected = !!nodeData.expectedQuantity ? nodeData.expectedQuantity : '';
        var expectedMatch = !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.searchGlobalFilter) && expected.includes(this.searchGlobalFilter.toLowerCase());
        var real = !!nodeData.realQuantity ? nodeData.realQuantity : '';
        var realMatch = !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.searchGlobalFilter) && real.includes(this.searchGlobalFilter.toLowerCase());
        var serialized = nodeData.serializedPart ? 'serialized' : 'not serialized';
        var serializedMatch = !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.searchGlobalFilter) && serialized.includes(this.searchGlobalFilter.toLowerCase());
        if (_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.searchGlobalFilter)) {
            if (!!node.sentenceAndDecisionList && node.sentenceAndDecisionList.length > 0) {
                var filterSuccess = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_20__["ListUtils"].orEmpty(node.children).length > 0 || (controlMatch && family && completed);
                node.expanded = filterSuccess ? true : false;
                return filterSuccess;
            }
            else {
                var filterSuccess = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_20__["ListUtils"].orEmpty(node.children).length > 0 || (controlMatch && family);
                node.expanded = filterSuccess ? true : false;
                return filterSuccess;
            }
        }
        else {
            var filterSuccess = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_20__["ListUtils"].orEmpty(node.children).length > 0 ||
                functionCodeMatch ||
                itemNumberMatch ||
                familyMatch ||
                expectedMatch ||
    ...
    TreeSubAssemblyComponent.prototype.updateTreeDisplayed = function () {
        ...
        this.itemStructureDisplayed = [];
        var acTreeData = !!this.subAssemblys && this.subAssemblys.length > 0 ? this.subAssemblys : this.acTreeData;
        this.itemStructureDisplayed = this.buildTree(Object(lodash_es__WEBPACK_IMPORTED_MODULE_3__["cloneDeep"])(acTreeData));
        if (_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.searchGlobalFilter) && this.itemStructureDisplayed.length > 0) {
            this.itemStructureDisplayed[0].expanded = true;
        }
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], TreeSubAssemblyComponent.prototype, "openImageEmitter", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], TreeSubAssemblyComponent.prototype, "openSubAssemblyEmitter", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], TreeSubAssemblyComponent.prototype, "bireItemDTOEmitter", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], TreeSubAssemblyComponent.prototype, "renderProgress", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], TreeSubAssemblyComponent.prototype, "bsdeProjectDTO", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], TreeSubAssemblyComponent.prototype, "subAssemblys", void 0);
    TreeSubAssemblyComponent = TreeSubAssemblyComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-tree-sub-assembly',
            template: __webpack_require__(/*! ./tree-sub-assembly.component.html */ "./src/app/main/maintenance/cockpit-inspection/form/tree-sub-assembly/tree-sub-assembly.component.html"),
            styles: [__webpack_require__(/*! ./tree-sub-assembly.component.scss */ "./src/app/main/maintenance/cockpit-inspection/form/tree-sub-assembly/tree-sub-assembly.component.scss"), __webpack_require__(/*! ../shared/shared.scss */ "./src/app/main/maintenance/cockpit-inspection/form/shared/shared.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_favorite_service__WEBPACK_IMPORTED_MODULE_11__["FavoriteService"],
            _shared_services_loader_service__WEBPACK_IMPORTED_MODULE_12__["LoaderService"],
            _shared_services_message_service__WEBPACK_IMPORTED_MODULE_13__["MessageService"],
