(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~maintenance-airworthiness-control-airworthiness-control-module~maintenance-maintenance-modul~1daf179e"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkOrderFormService", function() { return WorkOrderFormService; });
...
/* harmony import */ var _shared_api_airworthiness_management_api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../shared/api/airworthiness-management.api */ "./src/app/shared/api/airworthiness-management.api.ts");
/* harmony import */ var _shared_api_am_project_management_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../shared/api/am-project-management.api */ "./src/app/shared/api/am-project-management.api.ts");
/* harmony import */ var _shared_api_bidm_wo_assignment_api__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../shared/api/bidm-wo-assignment.api */ "./src/app/shared/api/bidm-wo-assignment.api.ts");
...
/* harmony import */ var _shared_api_bidt_work_center_api__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../shared/api/bidt-work-center.api */ "./src/app/shared/api/bidt-work-center.api.ts");
/* harmony import */ var _shared_api_fleet_business_api__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../../shared/api/fleet-business.api */ "./src/app/shared/api/fleet-business.api.ts");
/* harmony import */ var _shared_api_fleet_management_api__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../../shared/api/fleet-management.api */ "./src/app/shared/api/fleet-management.api.ts");
/* harmony import */ var _shared_api_operation_history_api__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../../shared/api/operation-history.api */ "./src/app/shared/api/operation-history.api.ts");
/* harmony import */ var _shared_api_product_structure_management_api__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../../shared/api/product-structure-management.api */ "./src/app/shared/api/product-structure-management.api.ts");
/* harmony import */ var _shared_api_task_management_api__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../../shared/api/task-management.api */ "./src/app/shared/api/task-management.api.ts");
/* harmony import */ var _shared_api_user_profile_management_api__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../../shared/api/user-profile-management.api */ "./src/app/shared/api/user-profile-management.api.ts");
/* harmony import */ var _shared_api_wo_asset_management_api__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../../shared/api/wo-asset-management.api */ "./src/app/shared/api/wo-asset-management.api.ts");
/* harmony import */ var _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../../../shared/constants/bido-function-type-constants */ "./src/app/shared/constants/bido-function-type-constants.ts");
/* harmony import */ var _shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../../../shared/constants/generic-property-constants */ "./src/app/shared/constants/generic-property-constants.ts");
/* harmony import */ var _shared_http_abstract_aw_http__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../../../shared/http/abstract-aw-http */ "./src/app/shared/http/abstract-aw-http.ts");
/* harmony import */ var _shared_services_app_config_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../../../shared/services/app-config.service */ "./src/app/shared/services/app-config.service.ts");
/* harmony import */ var _shared_services_properties_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../../../../shared/services/properties.service */ "./src/app/shared/services/properties.service.ts");
/* harmony import */ var _shared_utils_array_utils__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../../../../shared/utils/array-utils */ "./src/app/shared/utils/array-utils.ts");
...
var WorkOrderFormService = /** @class */ (function (_super) {
    ...
    function WorkOrderFormService(http, appConfigService, aircraftMaintenanceApi, airworthinessManagementApi, propertiesService, userProfileManagementApi, fleetBusinessApi, bidtEmployeeApi, bidtStockMvtApi, productStructureManagementApi, taskManagementApi, fleetManagementApi, amProjectManagementApi, bidtWorkCenterApi, bidtWarehouseApi, bidmWoAssignmentApi, woAssetManagementApi, operationHistoryApi, bidtSiteApi) {
    ...
    WorkOrderFormService.prototype.loadGenProps = function (key) {
        return this.propertiesService.getValue(key).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (results) {
            return !!results ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_26__["SelectItemUtils"].fromLabelValues(results) : [];
        }));
    };
    WorkOrderFormService.prototype.loadUserList = function (projectId) {
        return this.findUsersForWorkOrder(projectId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (results) {
            return !!results
                ? results
                    .map(function (user) {
                    return {
                    ...
                    .sort(_shared_utils_array_utils__WEBPACK_IMPORTED_MODULE_25__["ArrayUtils"].compareValues('label'))
                : [];
        }));
    };
    WorkOrderFormService.prototype.findUsersForWorkOrder = function (projectId) {
        var param = {
            useCaseCode: _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_20__["BidoFunctionTypeConstants"].UC_AIRM_EXECUTION,
            projectId: projectId
        };
    ...
    WorkOrderFormService.prototype.loadMROCenterList = function () {
        return this.findAuthorizedBireSite().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (results) {
            var mroCenterList = !!results ? _shared_utils_select_item_utils__WEBPACK_IMPORTED_MODULE_26__["SelectItemUtils"].fromLabelValues(results) : [];
    ...
    ***********************************/
    WorkOrderFormService.prototype.findBidmWorkOrder = function (bidmWorkOrderDTOId) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["forkJoin"])({
            woTypeList: this.loadGenProps(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_21__["GenericPropertyConstants"].AIRM_WORK_ORDER_TYPES_MAP),
            woStatusList: this.loadGenProps(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_21__["GenericPropertyConstants"].AIRM_OPERATION_STATUS_MAP),
    ...
    WorkOrderFormService.prototype.updateWorkOrder = function (param) {
        return _super.prototype.post.call(this, this.aircraftMaintenanceApi.updateBidmWorkOrder, param)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res; }));
    };
    WorkOrderFormService.prototype.setWoToBeConfirmed = function (param) {
        return _super.prototype.post.call(this, this.aircraftMaintenanceApi.setWoToBeConfirmed, param)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res; }));
    };
    WorkOrderFormService.prototype.unsetWoToBeConfirmed = function (param) {
        return _super.prototype.post.call(this, this.aircraftMaintenanceApi.unsetWoToBeConfirmed, param)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res; }));
    };
    ...
    WorkOrderFormService.prototype.calculateAndUpdateBidmWorkOrderStatus = function (input) {
        return _super.prototype.post.call(this, this.aircraftMaintenanceApi.calculateAndUpdateBidmWorkOrderStatus, input);
    };
    ...
    WorkOrderFormService.prototype.updateMaintenancePlanFromWorkOrder = function (bidmWorkOrderDTO) {
        return _super.prototype.post.call(this, this.aircraftMaintenanceApi.updateMaintenancePlanFromWorkOrder, bidmWorkOrderDTO);
    };
    WorkOrderFormService.prototype.updateLogbookFromWorkOrderInput = function (updateLogbookFromWorkOrderInput) {
        return _super.prototype.post.call(this, this.aircraftMaintenanceApi.updateLogbookFromWorkOrderInput, updateLogbookFromWorkOrderInput);
    };
    WorkOrderFormService.prototype.initializeUpdateLogbookFromWorkOrderInput = function (bidmWorkOrderDTO) {
        return _super.prototype.post.call(this, this.aircraftMaintenanceApi.initializeUpdateLogbookFromWorkOrderInput, bidmWorkOrderDTO);
    };
    WorkOrderFormService.prototype.deleteLogbookNotificationFromWorkOrder = function (bidmWorkOrderDTOId) {
        return _super.prototype.post.call(this, this.aircraftMaintenanceApi.deleteLogbookNotificationFromWorkOrder, bidmWorkOrderDTOId);
    };
    /***********************************
     user profile api
    ***********************************/
    WorkOrderFormService.prototype.findUsersWithUseCase = function () {
        return _super.prototype.post.call(this, this.userProfileManagementApi.findBidoUsersWithUseCase, _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_20__["BidoFunctionTypeConstants"].UC_AIRM_RECEPTION);
    };
    ...
    ***********************************/
    WorkOrderFormService.prototype.findBidmWoAssignmentsByWorkOrder = function (workOrderId) {
        return _super.prototype.post.call(this, this.bidmWoAssignmentApi.findBidmWoAssignmentsByWorkOrder, workOrderId);
    };
    ...
    WorkOrderFormService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"],
            ...
            _shared_api_product_structure_management_api__WEBPACK_IMPORTED_MODULE_16__["ProductStructureManagementApi"],
