(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["logistics-material-request-management-material-request-management-module"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaterialRequestManagementFormComponent", function() { return MaterialRequestManagementFormComponent; });
...
/* harmony import */ var _shared_services_file_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../../shared/services/file.service */ "./src/app/shared/services/file.service.ts");
...
/* harmony import */ var _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../../../../shared/utils/bido-equipment-utils */ "./src/app/shared/utils/bido-equipment-utils.ts");
/* harmony import */ var _shared_utils_image_utils__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../../../../shared/utils/image-utils */ "./src/app/shared/utils/image-utils.ts");
...
/* harmony import */ var _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../../../../shared/utils/number-utils */ "./src/app/shared/utils/number-utils.ts");
/* harmony import */ var _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ../../../../shared/utils/object-utils */ "./src/app/shared/utils/object-utils.ts");
/* harmony import */ var _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ../../../../shared/utils/string-utils */ "./src/app/shared/utils/string-utils.ts");
...
/* harmony import */ var _procurement_request_search_procurement_request_search_service__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ../../procurement-request/search/procurement-request-search.service */ "./src/app/main/logistics/procurement-request/search/procurement-request-search.service.ts");
/* harmony import */ var _material_request_management_form_service__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./material-request-management-form.service */ "./src/app/main/logistics/material-request-management/form/material-request-management-form.service.ts");
...
var MaterialRequestManagementFormComponent = /** @class */ (function (_super) {
    ...
    /* ***************************************************************************/
    function MaterialRequestManagementFormComponent(favoriteService, loaderService, messageService, serializationService, tabService, sessionService, dateService, translateService, confirmationService, domSanitizer, fileService, logisticsService, propertiesService, materialRequestManagementFormService, procurementRequestSearchService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_12__["ComponentOpenMode"].Read, favoriteService, loaderService, messageService, serializationService, tabService) || this;
        ...
        _this.componentOpenMode = _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_12__["ComponentOpenMode"];
        _this.candidateAssetCategory = CandidateAssetCategory;
        _this.bidoFunctionTypeConstants = _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_7__["BidoFunctionTypeConstants"];
        _this.init();
        _this.initMaterialProposedTableCols();
        _this.materialRequestManagementFormService.findAllSite().subscribe(function (sites) {
            _this.sites = sites;
        });
        _this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_11__["GenericPropertyConstants"].PROCUREMENT_REQUEST_STATUS_MAP).subscribe(function (statusList) {
            _this.statusList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(statusList).sort(function (s1, s2) { return s1.label.localeCompare(s2.label); });
        });
        _this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_11__["GenericPropertyConstants"].OPERATIONAL_STATUS_MAP).subscribe(function (statusList) {
            _this.equipmentStatusList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(statusList).sort(function (s1, s2) { return s1.label.localeCompare(s2.label); });
        });
        _this.materialRequestManagementFormService.getOperationalStatusMap(' ').subscribe(function (statusList) {
            _this.equipmentStatusListFilter = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(statusList).sort(function (s1, s2) { return s1.label.localeCompare(s2.label); });
        });
        ...
        _this.procurementRequestSearchService.findAllBireSite().subscribe({
            next: function (sites) {
                _this.siteList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(sites)
                    .filter(function (site) { return !!site.siteId && !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_29__["StringUtils"].isNullOrEmpty(site.siteName); })
                    .map(function (site) {
                    return {
    ...
    MaterialRequestManagementFormComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_10__["ComponentConstants"].LOG_MATERIAL_REQUEST_MANAGEMENT_FORM;
    };
    ...
    MaterialRequestManagementFormComponent.prototype.load = function () {
        ...
        if (!this.isCreateOpenMode && this.componentData.objectId) {
            var _a = this.serializationService.deserialize(this.componentData.objectId), prId = _a.prId, prItemId_1 = _a.prItemId;
            this.logisticsService.findProcurementRequestByIdWithAllObjects({ id: prId }).subscribe(function (procurementRequest) {
                var matchingProcurementRequestItem = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(procurementRequest.bidtProcReqItems).find(function (procurementRequestItem) { return procurementRequestItem.id === prItemId_1; });
                if (matchingProcurementRequestItem) {
                    ...
                    _this.subtitle = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_29__["StringUtils"].orEmpty(procurementRequest.procCode);
                    _this.displayComponentContext(_this.isCreateOpenMode ? 'tab.createMode' : _this.subtitle, _this.isCreateOpenMode);
                ...
                if (_this.procurementRequest.requestedPotential) {
                    _this.formattedRequestedPotential = _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].roundNumber(_shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].fromString(_this.procurementRequest.requestedPotential), 2).toString();
                }
                if (_this.procurementRequest.bidmWorkOrder && _this.procurementRequest.bidmWorkOrder.projectId) {
                    _this.logisticsService
                        ...
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])(function (workPackage) {
                        ...
                        _this.workPackageAssetName = _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_24__["BidoEquipmentUtils"].createAssetRepresentation(workPackageAsset);
                    });
                }
                _this.isProRecSupplierWarehouse = true;
                if (_this.procurementRequestItem.bidtWarehouseId !== null && !!_this.procurementRequestItem.bidtWarehouseId) {
    ...
    MaterialRequestManagementFormComponent.prototype.openEquipment = function (equipment) {
        if (equipment) {
            var componentId = equipment.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].ITEM_FAMILY_CODE_AIRCRAFT_KEY
                ? _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_10__["ComponentConstants"].FLE_AIRCRAFT_FORM
                : equipment.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].ITEM_FAMILY_CODE_ENGINE_KEY
                    ? _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_10__["ComponentConstants"].FLE_ENGINE_FORM
                    : _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_10__["ComponentConstants"].FLE_EQUIPMENT_FORM;
            var data = {
    ...
    MaterialRequestManagementFormComponent.prototype.openPart = function (candidateAsset) {
        if (candidateAsset.pn) {
            var data = {
                componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_10__["ComponentConstants"].ENG_PART_NUMBER_FORM,
                id: this.tabService.generateId(),
    ...
    MaterialRequestManagementFormComponent.prototype.calculateSituation = function () {
        var _this = this;
        var stockMvts = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(this.procurementRequestItem.workshopEntries).filter(function (stockMvt) { return stockMvt.stockMvtWay === _shared_constants_bidt_stock_mvt_constants__WEBPACK_IMPORTED_MODULE_8__["BidtStockMvtConstants"].MVT_WAY_CREDIT; });
        this.servedStockMvts = stockMvts.filter(function (stockMvt) { return stockMvt.mvtStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].MM_MVT_STATUS_EXECUTED_KEY; });
        ...
        this.bookedNb = this.candidateAssets
            .map(function (candidateAsset) { return _this.getBookedQty(candidateAsset); })
            .map(function (qty) { return (_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_29__["StringUtils"].isNullOrEmpty(qty) ? 0 : Number(qty)); })
            .reduce(function (acc, x) { return acc + x; }, 0);
        if (!_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_29__["StringUtils"].isNullOrEmpty(this.procurementRequestItem.requestedQuantity)) {
            this.notServedNb = Math.max(0, _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].fromString(this.procurementRequestItem.requestedQuantity) - this.servedNb - this.bookedNb);
        }
    };
    MaterialRequestManagementFormComponent.prototype.loadPreemptionRight = function (candidateAsset) {
        ...
        if (candidateAsset.stockInformation && candidateAsset.stockInformation.siteId) {
            this.materialRequestManagementFormService
                ...
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["concatMap"])(function (site) {
                return _this.materialRequestManagementFormService.hasDisplayRights({
                    useCaseCode: _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_7__["BidoFunctionTypeConstants"].UC_MM_PREEMPTION,
    ...
    MaterialRequestManagementFormComponent.prototype.loadCandidateAssets = function () {
        ...
        if (this.selectedcandidateAssetCategory === CandidateAssetCategory.WAREHOUSE) {
            var searchCandidateWarehouse$ = this.logisticsService.searchWarehouseCandidateAssets({
                bidtProcurementRequest: __assign({}, this.procurementRequest, { potentialUnit: this.potentialUnitSelected }),
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["forkJoin"])([searchCandidateWarehouse$, calculateRemaining$]).subscribe({
                next: function (_a) {
                    var _b = __read(_a, 2), searchCandidateWarehouse = _b[0], calculateRemaining = _b[1];
            ...
            var calculateRemaining$ = this.logisticsService.calculateRemainingQuantity(inputRemainigQuantity);
            Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["forkJoin"])([searchCandidateLocal$, calculateRemaining$]).subscribe({
                next: function (_a) {
                    var _b = __read(_a, 2), searchCandidateLocal = _b[0], calculateRemaining = _b[1];
            ...
            var calculateRemaining$ = this.logisticsService.calculateRemainingQuantity(inputRemainigQuantity);
            Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["forkJoin"])([searchCandidateGlobal$, calculateRemaining$]).subscribe({
                next: function (_a) {
                    var _b = __read(_a, 2), searchCandidateGlobal = _b[0], calculateRemaining = _b[1];
            ...
            var calculateRemaining$ = this.logisticsService.calculateRemainingQuantity(inputRemainigQuantity);
            Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["forkJoin"])([searchCandidateCanibalism$, calculateRemaining$]).subscribe({
                next: function (_a) {
                    var _b = __read(_a, 2), searchCandidateCanibalism = _b[0], calculateRemaining = _b[1];
    ...
    MaterialRequestManagementFormComponent.prototype.sortCandidateAssets = function (candidateAssets) {
        ...
        return candidateAssets.sort(function (c1, c2) {
            if (_this.isCandidateAssetServed(c1) && !_this.isCandidateAssetServed(c2)) {
                ...
                if (c1.bookingProcurementRequest &&
                ...
                else if (c2.bookingProcurementRequest &&
                    ...
                    if (r1 > r2) {
                        ...
                        var e1 = c1.equipment ? _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_29__["StringUtils"].orEmpty(c1.equipment.sn) : '';
                        var e2 = c2.equipment ? _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_29__["StringUtils"].orEmpty(c2.equipment.sn) : '';
    ...
    MaterialRequestManagementFormComponent.prototype.loadItemIllustration = function (procurementRequestItem) {
        var _this = this;
        if (procurementRequestItem.birePn && !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_29__["StringUtils"].isNullOrEmpty(procurementRequestItem.birePn.pnCode)) {
            this.fileService.findBireDocItemByPnCode(procurementRequestItem.birePn.pnCode).subscribe({
                next: function (docItem) {
                    if (docItem &&
                        ...
                        _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_28__["ObjectUtils"].isDefined(docItem.bireDocumentDTO.docFile) &&
                        !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_29__["StringUtils"].isNullOrEmpty(docItem.bireDocumentDTO.docType)) {
                        _this.itemIllustration = _this.domSanitizer.bypassSecurityTrustResourceUrl("" + _shared_utils_image_utils__WEBPACK_IMPORTED_MODULE_25__["ImageUtils"].getBase64Prefix(docItem.bireDocumentDTO.docType) + docItem.bireDocumentDTO.docFile);
                    }
                }
            });
        }
    ...
    MaterialRequestManagementFormComponent.prototype.satisfactoryRateAvailableAtDateCriteria = function (elt) {
        return (this.searchFilterObject.availableAtDate === SatisfactoryRateFilterState.UNDEFINED || // UNDEFINED
            (this.searchFilterObject.availableAtDate === SatisfactoryRateFilterState.YES && // YES
                !_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_28__["ObjectUtils"].isDefined(elt.plannedAvailabilityDate)) ||
    ...
    MaterialRequestManagementFormComponent.prototype.satisfactoryRatePotentialCriteria = function (elt) {
        return (this.searchFilterObject.potential === SatisfactoryRateFilterState.UNDEFINED || // UNDEFINED
            (this.searchFilterObject.potential === SatisfactoryRateFilterState.YES && // YES
                ((!this.procurementRequest.requestedPotential &&
                    (!elt.potentialValue || _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].fromString(elt.potentialValue) > 0)) ||
                    (!!elt.potentialValue &&
                        !!this.procurementRequest.requestedPotential &&
                        _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].fromString(elt.potentialValue) >
                            _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].fromString(this.procurementRequest.requestedPotential)))) ||
    ...
    MaterialRequestManagementFormComponent.prototype.satisfactoryRateCalendarPotentialCriteria = function (elt) {
        return (this.searchFilterObject.calendarPotential === SatisfactoryRateFilterState.UNDEFINED || // UNDEFIND
            (this.searchFilterObject.calendarPotential === SatisfactoryRateFilterState.YES && // YES
                ((!!this.procurementRequest.requestedDate &&
                    ...
                    moment__WEBPACK_IMPORTED_MODULE_3__(elt.calendarPotential).isAfter(moment__WEBPACK_IMPORTED_MODULE_3__(this.procurementRequest.calendarPotential))) ||
                    !(!!this.procurementRequest.requestedDate &&
                        !!this.procurementRequest.calendarPotential &&
                        !!elt.calendarPotential))) ||
    ...
    MaterialRequestManagementFormComponent.prototype.statifactoryRateBookingStatusCriteria = function (elt) {
        return (this.searchFilterObject.bookingStatus === SatisfactoryRateFilterState.UNDEFINED || // UNDEFINED
            (this.searchFilterObject.bookingStatus === SatisfactoryRateFilterState.YES && // YES
                (!_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_28__["ObjectUtils"].isDefined(elt.bookingProcurementRequest) ||
    ...
    MaterialRequestManagementFormComponent.prototype.satisfactoryRateNoUnconfirmedFailureCriteria = function (elt) {
        return (this.searchFilterObject.noUnconfirmedFailure === SatisfactoryRateFilterState.UNDEFINED || // UNDEFINED
            (this.searchFilterObject.noUnconfirmedFailure === SatisfactoryRateFilterState.YES && // YES
                !_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_28__["ObjectUtils"].isDefined(elt.unconfirmedFailure)) ||
    ...
    MaterialRequestManagementFormComponent.prototype.onGoBack = function () {
        ...
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_10__["ComponentConstants"].LOG_MATERIAL_REQUEST_MANAGEMENT_SEARCH,
            openMode: openMode
        };
        var labelKey = 'transaction.' + data.componentId;
        this.tabService.open(this.tabService.create(data, labelKey, true));
    ...
    MaterialRequestManagementFormComponent.prototype.formatEquipmentStatus = function (statusValue) {
        ...
        return matchingStatus ? _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_29__["StringUtils"].orEmpty(matchingStatus.label) : '';
    };
    ...
    MaterialRequestManagementFormComponent.prototype.formatQuantity = function (quantity) {
        return quantity ? _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].roundNumber(_shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].fromString(quantity), 2).toString() : '';
    };
    MaterialRequestManagementFormComponent.prototype.formatPotential = function (potential) {
        return potential ? _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].roundNumber(_shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].fromString(potential), 2).toString() : '';
    };
    ...
    MaterialRequestManagementFormComponent.prototype.isAvailableAtDate = function (candidateAsset) {
        return !_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_28__["ObjectUtils"].isDefined(candidateAsset.plannedAvailabilityDate);
    };
    MaterialRequestManagementFormComponent.prototype.calculateSatisfactionRate = function (candidateAsset) {
        ...
        rate(!_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_28__["ObjectUtils"].isDefined(candidateAsset.bookingProcurementRequest) ||
            candidateAsset.bookingProcurementRequest.id === this.procurementRequest.id);
        // Potential
        rate(!this.procurementRequest.requestedPotential ||
            (!!candidateAsset.potentialValue &&
                _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].fromString(candidateAsset.potentialValue) >=
                    _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].fromString(this.procurementRequest.requestedPotential)));
        // Same site
        ...
        rate(!_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_28__["ObjectUtils"].isDefined(candidateAsset.unconfirmedFailure));
        // Calendar potential
        if (!candidateAsset.calendarPotential) {
            rate(true);
        }
        else {
            rate(moment__WEBPACK_IMPORTED_MODULE_3__(candidateAsset.calendarPotential).isAfter(moment__WEBPACK_IMPORTED_MODULE_3__(this.procurementRequest.calendarPotential || this.procurementRequest.requestedDate)));
        }
        // tslint:disable-next-line:no-magic-numbers
        return _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].roundNumber((rates.filter(function (value) { return value === 1; }).length / rates.length) * 100, 0);
    };
    MaterialRequestManagementFormComponent.prototype.setPotentialUnitList = function (pnMeasures) {
        var _this = this;
        this.potentialUnitList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_26__["ListUtils"].orEmpty(pnMeasures)
            .map(function (pnMeasure) { return pnMeasure.counterCode; })
            .filter(function (counterCode) { return !!counterCode; })
            .sort(function (c1, c2) { return c1.localeCompare(c2); })
    ...
    MaterialRequestManagementFormComponent.prototype.formatSite = function (siteCode) {
        ...
        return matchingSite ? _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_29__["StringUtils"].orEmpty(matchingSite.siteName) : '';
    };
    ...
    MaterialRequestManagementFormComponent.prototype.openTransferOrder = function (transferOrder) {
        if (transferOrder) {
            var data = {
                id: this.tabService.generateId(),
                componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_10__["ComponentConstants"].LOG_TRANSFER_ORDER_FORM,
    ...
    MaterialRequestManagementFormComponent.prototype.cancelPicking = function (rowData) {
        ...
        if (rowData.currentBidmProject && rowData.currentBidmProject.projectId) {
            this.logisticsService.removeBidmProject({ projectId: rowData.currentBidmProject.projectId }).subscribe(function () {
    ...
    MaterialRequestManagementFormComponent.prototype.isSelectBtnVisible = function () {
        var procurementRequestQty = this.procurementRequestItem.requestedQuantity
            ? _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_27__["NumberUtils"].fromString(this.procurementRequestItem.requestedQuantity)
            : undefined;
        return (_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_28__["ObjectUtils"].isDefined(procurementRequestQty) && this.bookedNb + this.servedNb < procurementRequestQty);
    };
    MaterialRequestManagementFormComponent.prototype.bookCandidateAsset = function (candidateAsset) {
        ...
        if (candidateAsset.equipment) {
            ...
            var quantity = candidateAsset.equipment.sn
                ? '1'
                : this.procurementRequest.procType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].PROCUREMENT_REQUEST_TYPE_STOCK_LEVELING ||
                    this.procurementRequest.procType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].PROCUREMENT_REQUEST_TYPE_DEPLOYEMENT_BATCH
                    ? (candidateAsset.equipment.quantity || 0).toString()
                    : Math.min(this.notServedNb, candidateAsset.equipment.quantity || 0).toString();
            this.logisticsService
                .bookCandidateAsset({ quantity: quantity, candidateAsset: candidateAsset, bidtProcReqItem: this.procurementRequestItem })
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
    ...
    MaterialRequestManagementFormComponent.prototype.preemptCandidateAsset = function (candidateAsset) {
        ...
        if (candidateAsset.equipment) {
            ...
            var quantity = candidateAsset.equipment.sn
                ...
                : Math.min(this.notServedNb, candidateAsset.equipment.quantity || 0).toString();
            this.logisticsService
                .preemptCandidateAsset({ quantity: quantity, candidateAsset: candidateAsset, bidtProcReqItem: this.procurementRequestItem })
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
                candidateAsset._bookCandidateAssetLoading = false;
            }))
                .subscribe({
    ...
    MaterialRequestManagementFormComponent.prototype.openWorkPackageAsset = function () {
        if (this.workPackageAsset) {
            ...
            if (this.workPackageAsset.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].ITEM_FAMILY_CODE_AIRCRAFT_KEY) {
                componentId = _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_10__["ComponentConstants"].FLE_AIRCRAFT_FORM;
            }
            else if (this.workPackageAsset.equipmentFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].ITEM_FAMILY_CODE_ENGINE_KEY) {
        ...
        return (!!candidateAsset.equipment &&
            ...
            !!candidateAsset.transferOrder.bidtTorItems
                ...
                return candidateAsset.equipment.sn === stockMvt.stockMvtSn &&
                    ...
                    stockMvt.mvtStatus !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].MM_MVT_STATUS_ON_GOING_KEY;
            }));
    };
    ...
    MaterialRequestManagementFormComponent.prototype.loadWareHouses = function (siteId, warehouseCategory) {
        return this.procurementRequestSearchService.getWarehousesBySiteId(siteId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (warehouses) {
            return warehouses
    ...
    MaterialRequestManagementFormComponent.prototype.getBookedQty = function (candidateAsset) {
        if (candidateAsset.transferOrder && candidateAsset.transferOrder.bidtTorItems) {
            ...
            if (matchingStockMvt) {
                return _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_29__["StringUtils"].orEmpty(matchingStockMvt.stockMvtQuantity);
            }
        }
        return '';
    };
    ...
    ], MaterialRequestManagementFormComponent.prototype, "resultsContainerAnchor", void 0);
    MaterialRequestManagementFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-material-request-management-form',
            template: __webpack_require__(/*! ./material-request-management-form.component.html */ "./src/app/main/logistics/material-request-management/form/material-request-management-form.component.html"),
            styles: [__webpack_require__(/*! ../shared/style.scss */ "./src/app/main/logistics/material-request-management/shared/style.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_favorite_service__WEBPACK_IMPORTED_MODULE_15__["FavoriteService"],
            ...
            _material_request_management_form_service__WEBPACK_IMPORTED_MODULE_32__["MaterialRequestManagementFormService"],
            _procurement_request_search_procurement_request_search_service__WEBPACK_IMPORTED_MODULE_31__["ProcurementRequestSearchService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaterialRequestManagementFormService", function() { return MaterialRequestManagementFormService; });
...
var MaterialRequestManagementFormService = /** @class */ (function (_super) {
    ...
    function MaterialRequestManagementFormService(http, appConfigService, bidtSiteApi, userProfileBusinessApi, productStructureManagementApi, fleetManagementApi, bidtWarehouseApi) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChangeCustomerPopupFormComponent", function() { return ChangeCustomerPopupFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _material_request_management_form_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../material-request-management-form.service */ "./src/app/main/logistics/material-request-management/form/material-request-management-form.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ChangeCustomerPopupFormComponent = /** @class */ (function (_super) {
    ...
    function ChangeCustomerPopupFormComponent(inputValidationService, messageService, sessionService, propertiesService, materialRequestManagementFormService, logisticsService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__["ComponentOpenMode"].Read, 'ChangeCustomerPopupFormComponent') || this;
    ...
    ], ChangeCustomerPopupFormComponent.prototype, "procurementRequest", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ChangeCustomerPopupFormComponent.prototype, "onValidated", void 0);
    ChangeCustomerPopupFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-change-customer-popup-form',
            template: __webpack_require__(/*! ./change-customer-popup-form.component.html */ "./src/app/main/logistics/material-request-management/form/popups/change-customer-popup-form/change-customer-popup-form.component.html")
        }),
        __metadata("design:paramtypes", [_shared_services_input_validation_service__WEBPACK_IMPORTED_MODULE_2__["InputValidationService"],
            ...
            _material_request_management_form_service__WEBPACK_IMPORTED_MODULE_8__["MaterialRequestManagementFormService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChangeWarehouseAndQuantityPopupFormComponent", function() { return ChangeWarehouseAndQuantityPopupFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _material_request_management_form_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../material-request-management-form.service */ "./src/app/main/logistics/material-request-management/form/material-request-management-form.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ChangeWarehouseAndQuantityPopupFormComponent = /** @class */ (function (_super) {
    ...
    function ChangeWarehouseAndQuantityPopupFormComponent(inputValidationService, messageService, sessionService, propertiesService, materialRequestManagementFormService, logisticsService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Read, 'ChangeWarehouseAndQuantityPopupFormComponent') || this;
        _this.inputValidationService = inputValidationService;
        _this.messageService = messageService;
        _this.sessionService = sessionService;
        _this.propertiesService = propertiesService;
                    ...
                    _this.materialRequestManagementFormService
                        ...
                        _this.warehouses = warehousesList
                            ...
                            return !!warehouse.whCode &&
                                !!warehouse.whName &&
                                !!warehouse.whCategory &&
                                warehouse.whCategory === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_1__["AWPropertiesConstants"].WAREHOUSE_CATEGORY_WAREHOUSE;
                        })
                            .map(function (warehouse) {
                            return {
                                label: warehouse.whCode + " - " + warehouse.whName,
                        ...
                        _this.logisticsService.createProcurementRequestItem(input).subscribe(function (newItem) {
                            if (!!_this.newWarehouse) {
                                ...
                                _this.logisticsService.addOrUpdateItem(newItem).subscribe({
                                    next: function () {
                                        _this.onValidated.emit();
                                        _this.messageService.showSuccessMessage(_this.getTranslateKey('successOnChangeSupplierAndQuantity'));
                                        _this.cancel();
                                    }
                                });
                            }
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], ChangeWarehouseAndQuantityPopupFormComponent.prototype, "procurementRequest", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], ChangeWarehouseAndQuantityPopupFormComponent.prototype, "procurementRequestItem", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Number)
    ], ChangeWarehouseAndQuantityPopupFormComponent.prototype, "oldQuantity", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Number)
    ], ChangeWarehouseAndQuantityPopupFormComponent.prototype, "totalQuantity", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ChangeWarehouseAndQuantityPopupFormComponent.prototype, "onValidated", void 0);
    ChangeWarehouseAndQuantityPopupFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-change-warehouse-and-quantity-popup-form',
            template: __webpack_require__(/*! ./change-warehouse-and-quantity-popup-form.component.html */ "./src/app/main/logistics/material-request-management/form/popups/change-warehouse-and-quantity-popup-form/change-warehouse-and-quantity-popup-form.component.html")
        }),
        __metadata("design:paramtypes", [_shared_services_input_validation_service__WEBPACK_IMPORTED_MODULE_3__["InputValidationService"],
            ...
            _material_request_management_form_service__WEBPACK_IMPORTED_MODULE_9__["MaterialRequestManagementFormService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSatisfactionRateComponent", function() { return DialogSatisfactionRateComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../../shared/utils/number-utils */ "./src/app/shared/utils/number-utils.ts");
...
var DialogSatisfactionRateComponent = /** @class */ (function (_super) {
    ...
    function DialogSatisfactionRateComponent() {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Read, 'DialogSatisfactionRateComponent') || this;
        _this.candidateAsset = {};
        _this.procurementRequest = {};
        return _this;
    }
    DialogSatisfactionRateComponent.prototype.isAvailableAtDate = function () {
        return !_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].isDefined(this.candidateAsset.plannedAvailabilityDate);
    };
    DialogSatisfactionRateComponent.prototype.calculateSatisfactionRate = function () {
        ...
        // Not booked by another procurement request
        this.bookingStatus =
            !_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].isDefined(this.candidateAsset.bookingProcurementRequest) ||
        ...
        this.potential =
            !this.procurementRequest.requestedPotential ||
                (!!this.candidateAsset.potentialValue &&
                    _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_4__["NumberUtils"].fromString(this.candidateAsset.potentialValue) >=
                        _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_4__["NumberUtils"].fromString(this.procurementRequest.requestedPotential));
        rate(this.potential);
        // Same site
        this.sameSite =
        ...
        rate(this.sameSite);
        // No Unconfirmed Failure
        this.noUnconfirmedFailure = !_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].isDefined(this.candidateAsset.unconfirmedFailure);
        ...
        if (!this.candidateAsset.calendarPotential) {
            ...
            this.calendarPotential = moment__WEBPACK_IMPORTED_MODULE_1__(this.candidateAsset.calendarPotential).isAfter(moment__WEBPACK_IMPORTED_MODULE_1__(this.procurementRequest.calendarPotential || this.procurementRequest.requestedDate));
        }
        rate(this.calendarPotential);
        // tslint:disable-next-line:no-magic-numbers
        return _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_4__["NumberUtils"].roundNumber((rates.filter(function (value) { return value === 1; }).length / rates.length) * 100, 0);
    };
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogSatisfactionRateComponent.prototype, "candidateAsset", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogSatisfactionRateComponent.prototype, "procurementRequest", void 0);
    DialogSatisfactionRateComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-satisfaction-rate',
            template: __webpack_require__(/*! ./dialog-satisfaction-rate.component.html */ "./src/app/main/logistics/material-request-management/form/popups/dialog-satisfaction-rate/dialog-satisfaction-rate.component.html"),
            styles: [__webpack_require__(/*! ./dialog-satisfaction-rate.component.scss */ "./src/app/main/logistics/material-request-management/form/popups/dialog-satisfaction-rate/dialog-satisfaction-rate.component.scss"), __webpack_require__(/*! ../../../shared/style.scss */ "./src/app/main/logistics/material-request-management/shared/style.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaterialRequestManagementModule", function() { return MaterialRequestManagementModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _procurement_request_search_procurement_request_search_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../procurement-request/search/procurement-request-search.service */ "./src/app/main/logistics/procurement-request/search/procurement-request-search.service.ts");
...
/* harmony import */ var _transfer_order_shared_transfer_order_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ../transfer-order/shared/transfer-order-service */ "./src/app/main/logistics/transfer-order/shared/transfer-order-service.ts");
/* harmony import */ var _form_material_request_management_form_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./form/material-request-management-form.component */ "./src/app/main/logistics/material-request-management/form/material-request-management-form.component.ts");
/* harmony import */ var _form_material_request_management_form_service__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./form/material-request-management-form.service */ "./src/app/main/logistics/material-request-management/form/material-request-management-form.service.ts");
/* harmony import */ var _form_popups_change_customer_popup_form_change_customer_popup_form_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./form/popups/change-customer-popup-form/change-customer-popup-form.component */ "./src/app/main/logistics/material-request-management/form/popups/change-customer-popup-form/change-customer-popup-form.component.ts");
/* harmony import */ var _form_popups_change_warehouse_and_quantity_popup_form_change_warehouse_and_quantity_popup_form_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./form/popups/change-warehouse-and-quantity-popup-form/change-warehouse-and-quantity-popup-form.component */ "./src/app/main/logistics/material-request-management/form/popups/change-warehouse-and-quantity-popup-form/change-warehouse-and-quantity-popup-form.component.ts");
/* harmony import */ var _form_popups_dialog_satisfaction_rate_dialog_satisfaction_rate_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./form/popups/dialog-satisfaction-rate/dialog-satisfaction-rate.component */ "./src/app/main/logistics/material-request-management/form/popups/dialog-satisfaction-rate/dialog-satisfaction-rate.component.ts");
/* harmony import */ var _search_material_request_management_search_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./search/material-request-management-search.component */ "./src/app/main/logistics/material-request-management/search/material-request-management-search.component.ts");
/* harmony import */ var _search_material_request_management_search_service__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./search/material-request-management-search.service */ "./src/app/main/logistics/material-request-management/search/material-request-management-search.service.ts");
/* harmony import */ var _shared_popups_dialog_image_dialog_image_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./shared/popups/dialog-image/dialog-image.component */ "./src/app/main/logistics/material-request-management/shared/popups/dialog-image/dialog-image.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var INTERNAL_MODULES = [_shared_components_modal_modal_module__WEBPACK_IMPORTED_MODULE_21__["ModalModule"], _transfer_order_search_transfer_order_popup_transfer_order_popup_module__WEBPACK_IMPORTED_MODULE_25__["TransferOrderPopupModule"]];
/******************************************************************************
 * Components
 *************************************************************************** */
var COMPONENTS = [
    _shared_popups_dialog_image_dialog_image_component__WEBPACK_IMPORTED_MODULE_34__["DialogImageComponent"],
    _form_popups_change_customer_popup_form_change_customer_popup_form_component__WEBPACK_IMPORTED_MODULE_29__["ChangeCustomerPopupFormComponent"],
    _form_popups_change_warehouse_and_quantity_popup_form_change_warehouse_and_quantity_popup_form_component__WEBPACK_IMPORTED_MODULE_30__["ChangeWarehouseAndQuantityPopupFormComponent"],
    _form_popups_dialog_satisfaction_rate_dialog_satisfaction_rate_component__WEBPACK_IMPORTED_MODULE_31__["DialogSatisfactionRateComponent"]
];
var DYNAMIC_COMPONENTS = [_search_material_request_management_search_component__WEBPACK_IMPORTED_MODULE_32__["MaterialRequestManagementSearchComponent"], _form_material_request_management_form_component__WEBPACK_IMPORTED_MODULE_27__["MaterialRequestManagementFormComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [
    _search_material_request_management_search_service__WEBPACK_IMPORTED_MODULE_33__["MaterialRequestManagementSearchService"],
    _form_material_request_management_form_service__WEBPACK_IMPORTED_MODULE_28__["MaterialRequestManagementFormService"],
    _shared_services_file_service__WEBPACK_IMPORTED_MODULE_22__["FileService"],
    _procurement_request_search_procurement_request_search_service__WEBPACK_IMPORTED_MODULE_24__["ProcurementRequestSearchService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaterialRequestManagementSearchComponent", function() { return MaterialRequestManagementSearchComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _material_request_management_search_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./material-request-management-search.service */ "./src/app/main/logistics/material-request-management/search/material-request-management-search.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var MaterialRequestManagementSearchComponent = /** @class */ (function (_super) {
    ...
    /* ***************************************************************************/
    function MaterialRequestManagementSearchComponent(favoriteService, loaderService, messageService, serializationService, tabService, sessionService, dateService, translateService, materialRequestManagementSearchService) {
        ...
        _this.SEARCH_CRITERIA_ID = _shared_constants_app_constants__WEBPACK_IMPORTED_MODULE_2__["AppConstants"].GOODS_MOVEMENT_SEARCH_CRITERIA_ID;
    ...
    MaterialRequestManagementSearchComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_3__["ComponentConstants"].LOG_MATERIAL_REQUEST_MANAGEMENT_SEARCH;
    };
    ...
    MaterialRequestManagementSearchComponent.prototype.loadSites = function () {
        ...
        this.materialRequestManagementSearchService.findAllSiteList().subscribe({
            next: function (siteList) {
                _this.materialRequestSites = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(siteList)
                    .filter(function (site) { return _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_14__["ObjectUtils"].isDefined(site.siteId); })
                    .map(function (site) {
                    return {
                        label: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_15__["StringUtils"].isNullOrEmpty(site.siteName) ? site.siteCode : site.siteCode + " - " + site.siteName,
                        value: site.siteId
                    };
                });
            }
    ...
    MaterialRequestManagementSearchComponent.prototype.search = function () {
        var _this = this;
        this.materialRequestTable = [];
        this.materialRequestManagementSearchService.findMaterialsRequested(this.searchObject).subscribe(function (result) {
            if (result) {
    ...
    MaterialRequestManagementSearchComponent.prototype.manageMaterialRequest = function (rowData) {
        var openMode = _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_4__["ComponentOpenMode"].Write;
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_3__["ComponentConstants"].LOG_MATERIAL_REQUEST_MANAGEMENT_FORM,
            openMode: openMode
        };
        if (!!rowData) {
    ...
    MaterialRequestManagementSearchComponent.prototype.openNewMaterialRequestSearch = function () {
        ...
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_3__["ComponentConstants"].LOG_MATERIAL_REQUEST_MANAGEMENT_SEARCH,
            openMode: openMode
        };
        var labelKey = 'transaction.' + data.componentId;
        this.tabService.open(this.tabService.create(data, labelKey, true));
    ...
    MaterialRequestManagementSearchComponent.prototype.populateWarehouseList = function (warehouseList) {
        this.materialRequestWorkCenters = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_13__["ListUtils"].orEmpty(warehouseList)
            .filter(function (warehouse) { return _shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_14__["ObjectUtils"].isDefined(warehouse.whCode); })
            .map(function (warehouse) {
            return {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('resultsContainerAnchor'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], MaterialRequestManagementSearchComponent.prototype, "resultsContainerAnchor", void 0);
    MaterialRequestManagementSearchComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-material-request-management-search',
            template: __webpack_require__(/*! ./material-request-management-search.component.html */ "./src/app/main/logistics/material-request-management/search/material-request-management-search.component.html"),
            styles: [__webpack_require__(/*! ../shared/style.scss */ "./src/app/main/logistics/material-request-management/shared/style.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_favorite_service__WEBPACK_IMPORTED_MODULE_6__["FavoriteService"],
            ...
            _material_request_management_search_service__WEBPACK_IMPORTED_MODULE_16__["MaterialRequestManagementSearchService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MaterialRequestManagementSearchService", function() { return MaterialRequestManagementSearchService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var _shared_api_bidt_site_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../shared/api/bidt-site.api */ "./src/app/shared/api/bidt-site.api.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogImageComponent", function() { return DialogImageComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../../shared/enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
...
var DialogImageComponent = /** @class */ (function (_super) {
    ...
    function DialogImageComponent() {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__["ComponentOpenMode"].Read, 'DialogImageComponent') || this;
        _this.displayChange = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        return _this;
    }
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], DialogImageComponent.prototype, "imgSrc", void 0);
    DialogImageComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-image',
            template: __webpack_require__(/*! ./dialog-image.component.html */ "./src/app/main/logistics/material-request-management/shared/popups/dialog-image/dialog-image.component.html"),
            styles: [__webpack_require__(/*! ../popup-form.component.scss */ "./src/app/main/logistics/material-request-management/shared/popups/popup-form.component.scss")]
        }),
        __metadata("design:paramtypes", [])
