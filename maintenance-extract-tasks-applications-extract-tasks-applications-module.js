(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["maintenance-extract-tasks-applications-extract-tasks-applications-module"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExtractTasksApplicationsModule", function() { return ExtractTasksApplicationsModule; });
...
/* harmony import */ var _shared_components_dialog_search_equipment_dialog_search_equipment_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../shared/components/dialog-search-equipment/dialog-search-equipment.module */ "./src/app/shared/components/dialog-search-equipment/dialog-search-equipment.module.ts");
/* harmony import */ var _shared_components_dialog_search_task_dialog_search_task_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../shared/components/dialog-search-task/dialog-search-task.module */ "./src/app/shared/components/dialog-search-task/dialog-search-task.module.ts");
/* harmony import */ var _dynamic_component_loader_dynamic_component_loader_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../dynamic-component-loader/dynamic-component-loader.module */ "./src/app/main/dynamic-component-loader/dynamic-component-loader.module.ts");
/* harmony import */ var _search_extract_tasks_applications_search_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./search/extract-tasks-applications-search.component */ "./src/app/main/maintenance/extract-tasks-applications/search/extract-tasks-applications-search.component.ts");
/* harmony import */ var _search_extract_tasks_applications_search_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./search/extract-tasks-applications-search.service */ "./src/app/main/maintenance/extract-tasks-applications/search/extract-tasks-applications-search.service.ts");
 ...
 * Modules
 *************************************************************************** */
var EXTERNAL_MODULES = [primeng_tooltip__WEBPACK_IMPORTED_MODULE_3__["TooltipModule"], primeng_table__WEBPACK_IMPORTED_MODULE_2__["TableModule"], primeng_calendar__WEBPACK_IMPORTED_MODULE_1__["CalendarModule"]];
var INTERNAL_MODULES = [_shared_components_dialog_search_task_dialog_search_task_module__WEBPACK_IMPORTED_MODULE_8__["DialogSearchTaskModule"], _shared_components_dialog_search_equipment_dialog_search_equipment_module__WEBPACK_IMPORTED_MODULE_7__["DialogSearchEquipmentModule"]];
/******************************************************************************
 * Components
 *************************************************************************** */
var COMPONENTS = [];
var DYNAMIC_COMPONENTS = [_search_extract_tasks_applications_search_component__WEBPACK_IMPORTED_MODULE_10__["ExtractTasksApplicationsSearchComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_search_extract_tasks_applications_search_service__WEBPACK_IMPORTED_MODULE_11__["ExtractTasksApplicationsSearchService"]];
    ...
    ExtractTasksApplicationsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: __spread([
                ...
                _dynamic_component_loader_dynamic_component_loader_module__WEBPACK_IMPORTED_MODULE_9__["DynamicComponentLoaderModule"].forChild(DYNAMIC_COMPONENTS)
...
module.exports = ":host .padding-class {\n  padding-right: 0.5em; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExtractTasksApplicationsSearchComponent", function() { return ExtractTasksApplicationsSearchComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _extract_tasks_applications_search_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./extract-tasks-applications-search.service */ "./src/app/main/maintenance/extract-tasks-applications/search/extract-tasks-applications-search.service.ts");
...
var ExtractTasksApplicationsSearchComponent = /** @class */ (function (_super) {
    ...
    function ExtractTasksApplicationsSearchComponent(favoriteService, loaderService, messageService, serializationService, tabService, sessionService, confirmationService, propertiesService, exportService, extractTasksApplicationsSearchService) {
    ...
    ExtractTasksApplicationsSearchComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_4__["ComponentConstants"].MAI_EXTRACT_TASKS_APPLICATIONS;
    };
    ...
    ExtractTasksApplicationsSearchComponent.prototype.loadDropdowns = function () {
        var _this = this;
        var getTaskTypeMap = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].TASK_TYPE_MAP);
        var getFuncObjectStatusMap = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].FUNC_OBJECT_STATUS_MAP);
        var applicability = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].TASK_APPLICABILITY_CODE_MAP);
        var propertyStatus = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].OPERATIONAL_STATUS_MAP);
        var propertyFunction = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].ITEM_FAMILY_CODE_MAP);
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["forkJoin"])([
            ...
            var _b = __read(_a, 6), getTaskTypeResult = _b[0], getFuncObjectStatusResult = _b[1], getApplicability = _b[2], getPropertyStatus = _b[3], getPropertyFunction = _b[4], getTaskGroupResult = _b[5];
            _this.taskTypeList = getTaskTypeResult.filter(function (obj) {
                return obj.value !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].TASK_TYPE_VISIT_KEY;
            });
    ...
    ExtractTasksApplicationsSearchComponent.prototype.formatKeyToLabel = function (key, list) {
        if (!!key) {
            var selectedData = list.find(function (data) { return data.value === key; });
    ...
    ExtractTasksApplicationsSearchComponent.prototype.exportTable = function () {
        ...
        this.exportService.toExcel(table, ExtractTasksApplicationsSearchComponent_1.TASK_TABLE_EXPORT_NAME, this.componentData.componentId);
    };
    ...
    ExtractTasksApplicationsSearchComponent = ExtractTasksApplicationsSearchComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./extract-tasks-applications-search.component.html */ "./src/app/main/maintenance/extract-tasks-applications/search/extract-tasks-applications-search.component.html"),
            styles: [__webpack_require__(/*! ./extract-tasks-applications-search.component.scss */ "./src/app/main/maintenance/extract-tasks-applications/search/extract-tasks-applications-search.component.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_favorite_service__WEBPACK_IMPORTED_MODULE_9__["FavoriteService"],
            ...
            _extract_tasks_applications_search_service__WEBPACK_IMPORTED_MODULE_17__["ExtractTasksApplicationsSearchService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExtractTasksApplicationsSearchService", function() { return ExtractTasksApplicationsSearchService; });
...
var ExtractTasksApplicationsSearchService = /** @class */ (function (_super) {
    ...
    function ExtractTasksApplicationsSearchService(http, appConfigService, airworthinessManagementApi, taskManagementApi, fleetManagementApi) {
     ...
     *************************************************************************/
    ExtractTasksApplicationsSearchService.prototype.extractTasksApplicationsFromAssetCodeListAndTaskKeyList = function (input) {
        return _super.prototype.post.call(this, this.airworthinessManagementApi.extractTasksApplicationsFromAssetCodeListAndTaskKeyList, input);
    };
