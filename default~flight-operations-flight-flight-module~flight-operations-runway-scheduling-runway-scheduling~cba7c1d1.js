(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~flight-operations-flight-flight-module~flight-operations-runway-scheduling-runway-scheduling~cba7c1d1"],{
...
/* harmony import */ var _shared_api_user_profile_management_api__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../../shared/api/user-profile-management.api */ "./src/app/shared/api/user-profile-management.api.ts");
...
var FlightFormService = /** @class */ (function (_super) {
    ...
    function FlightFormService(http, appConfigService, airworthinessManagementApi, bidtEmployeeApi, fleetBusinessApi, fleetHistoryApi, fleetManagementApi, productStructureManagementApi, propertiesService, userProfileManagementApi) {
    ...
    FlightFormService.prototype.calculatePostFlightRecordsInformations = function (input) {
        return _super.prototype.post.call(this, this.fleetBusinessApi.calculatePostFlightRecordsInformations, input);
    };
    ...
    FlightFormService.prototype.findAllBireMeasureReferenceOfStructureByEquipmentCode = function (input) {
        return _super.prototype.post.call(this, this.fleetBusinessApi.findBireMeasureReferencesOfStructureByEquipmentCode, input);
    };
    FlightFormService.prototype.findAllEquipmentInStructureByEquipmentCode = function (input) {
        return _super.prototype.post.call(this, this.fleetBusinessApi.findAllEquipmentsInStructureByEquipmentCode, input);
    };
    ...
    FlightFormService.prototype.findAllBidoNotificationAttributeByNotificationCode = function (input) {
        return _super.prototype.post.call(this, this.fleetManagementApi.findAllBidoNotificationAttributeByNotificationCode, input);
    };
    FlightFormService.prototype.findAllBidoNotificationTypesByTypeCategory = function (input) {
        return _super.prototype.post.call(this, this.fleetManagementApi.findAllBidoNotificationTypeByTypeCategory, input);
    };
    ...
    FlightFormService.prototype.getFlightArea = function (propertiesId) {
        return _super.prototype.post.call(this, this.userProfileManagementApi.findBidoPropertiesValuesByPropertiesId, propertiesId);
    };
