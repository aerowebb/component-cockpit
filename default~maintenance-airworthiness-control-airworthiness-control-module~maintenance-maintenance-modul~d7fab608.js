(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~maintenance-airworthiness-control-airworthiness-control-module~maintenance-maintenance-modul~d7fab608"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogWorkOrderEditComponent", function() { return DialogWorkOrderEditComponent; });
...
/* harmony import */ var _shared_types_dialog_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../../../shared/types/dialog-component */ "./src/app/shared/types/dialog-component.ts");
/* harmony import */ var _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../../../../shared/utils/number-utils */ "./src/app/shared/utils/number-utils.ts");
...
/* harmony import */ var _human_resources_employee_form_employee_form_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../../../human-resources/employee-form/employee-form.service */ "./src/app/main/human-resources/employee-form/employee-form.service.ts");
/* harmony import */ var _logistics_logistics_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../../../logistics/logistics.service */ "./src/app/main/logistics/logistics.service.ts");
/* harmony import */ var _procurement_request_procurement_requests_table_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../../procurement-request/procurement-requests-table.service */ "./src/app/main/maintenance/procurement-request/procurement-requests-table.service.ts");
/* harmony import */ var _work_order_form_work_order_form_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../../work-order/form/work-order-form.service */ "./src/app/main/maintenance/work-order/form/work-order-form.service.ts");
/* harmony import */ var _work_package_form_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../work-package-form.service */ "./src/app/main/maintenance/work-package/form/work-package-form.service.ts");
/* harmony import */ var _dialog_work_order_edition_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./dialog-work-order-edition.service */ "./src/app/main/maintenance/work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.service.ts");
...
var DialogWorkOrderEditComponent = /** @class */ (function (_super) {
    ...
    function DialogWorkOrderEditComponent(sessionService, logisticsService, messageService, wpFormService, dialogWorkOrderEditService, employeeFormService, workOrderFormService, procurementRequestsTableService, propertiesService, translateService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_9__["ComponentOpenMode"].Write, 'DialogWorkOrderEditComponent') || this;
    ...
    Object.defineProperty(DialogWorkOrderEditComponent.prototype, "workPackage", {
        ...
        set: function (workPackage) {
            ...
            this.dialogWorkOrderEditService.loadWarehouseList(workPackage.bireRepairCenterCode).subscribe(function (result) {
            ...
            this.logisticsService.findAllBireSite().subscribe(function (sites) {
                var selectedSites = sites.filter(function (site) { return site.siteCode === workPackage.bireRepairCenterCode; });
                ...
                if (_this.bidtSiteDTO && _this.bidtSiteDTO.siteId) {
                    _this.logisticsService.getWarehousesBySiteId(_this.bidtSiteDTO.siteId).subscribe(function (warehouses) {
    ...
    DialogWorkOrderEditComponent.prototype.initDropDowns = function () {
        var _this = this;
        // Load Status List
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].PROCUREMENT_REQUEST_STATUS_MAP).subscribe(function (res) {
            _this.procurementRequestStatusList = res;
        });
        this.procurementRequestTypes = [];
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_5__["GenericPropertyConstants"].PROCUREMENT_REQUEST_TYPE_MAP).subscribe(function (res) {
        ...
        this.procurementRequestCriticalityList = [
            {
                ...
                value: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].LOGISTICAL_CRITICALITY_IMMEDIATE
            },
            {
                label: this.translateService.instant(this.getTranslateKey('urgent')),
                value: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].LOGISTICAL_CRITICALITY_URGENT
            },
            {
                label: this.translateService.instant(this.getTranslateKey('routine')),
                value: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].LOGISTICAL_CRITICALITY_ROUTINE
            }
        ];
    };
    DialogWorkOrderEditComponent.prototype.ngOnInit = function () {
            ...
            this.dialogWorkOrderEditService.findBidmWorkOrder(this._bidmWorkOrderDTOId).subscribe(function (wo) {
                ...
                if (_this.workOrder.warrantyProvider) {
                    _this.dialogWorkOrderEditService
                        ...
                        .subscribe(function (customer) { return (_this.warrantyProviderName = customer.customerName); });
                }
                _this.dialogWorkOrderEditService
                    ...
                    _this.dialogWorkOrderEditService
                        ...
                        if (_this.workOrder.woType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_TASK &&
                        ...
                        else if (_this.workOrder.woType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_TASK &&
                        ...
                        else if (_this.workOrder.woType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_DEFECT) {
                            if (_this.workOrder.woSource) {
                                _this.eventCode = _this.workOrder.woSource.split('#')[0];
                            }
                            _this.fillRelatedAssetsList();
                        }
                        else if (_this.workOrder.woType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_EVOLUTION) {
                            if (_this.workOrder.woSource) {
                    ...
                    _this.procurementRequestsTableService
                        ...
                        _this.procurementRequests.forEach(function (proqReq) {
                            var _a;
                            (_a = _this.procurementRequestRows).push.apply(_a, __spread(_this.createProcReqItemRow(proqReq)));
                        });
                    });
                });
        ...
        this.wpFormService.woTypeList$.subscribe(function (list) {
            _this.typeList = _this._isFromMaintenancePlanning
                ? list.filter(function (a) { return a.value === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_SN_CHANGE; })
                : list;
        });
        if (this._isFromMaintenancePlanning) {
            this.workOrder.woType = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_SN_CHANGE;
        }
    };
    ...
    DialogWorkOrderEditComponent.prototype.getUsersList = function () {
        var _this = this;
        var param = {
            useCaseCode: _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_8__["BidoFunctionTypeConstants"].UC_AIRM_RECEPTION
        };
        if (!!this.task) {
        ...
        this.dialogWorkOrderEditService.findUsersWithUseCaseForWorkOrder(param).subscribe(function (data) {
            ...
            if (!!_this.workOrder.woAssignedTo) {
                var inList = _this.userList.find(function (elem) { return elem.value === _this.workOrder.woAssignedTo; });
                _this.workOrder.woAssignedTo = !!inList ? inList.value : undefined;
            }
        });
    };
    DialogWorkOrderEditComponent.prototype.validate = function () {
        if (_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_14__["StringUtils"].isNullOrEmpty(this.workOrder.woType)) {
            this.messageService.showWarningMessage(this.getComponentName() + '.errorOnWoType');
        }
        else if (this.workOrder.woType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_TASK &&
        ...
        else if (moment__WEBPACK_IMPORTED_MODULE_3__(this.workOrder.woScheduledStartDate).isAfter(moment__WEBPACK_IMPORTED_MODULE_3__(this.workOrder.woScheduledEndDate))) {
            this.messageService.showWarningMessage(this.getComponentName() + '.errorOnDates');
        }
        else if (this.showDefectSection && _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_14__["StringUtils"].isNullOrEmpty(this.eventCode)) {
            this.messageService.showWarningMessage(this.getComponentName() + '.errorOnDefect');
        }
        else if (this.showEvolutionSection && _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_14__["StringUtils"].isNullOrEmpty(this.evolution.evolutionNumber)) {
    ...
    DialogWorkOrderEditComponent.prototype.saveWorkOrder = function () {
        ...
        var bidmOperations = this.opTable.map(function (operationRow) { return operationRow.bidmOperation; });
        var woProcurementRequestInputDTOs = this.procurementRequestRows
            .filter(function (row) { return !row.procurementRequestId; })
            .map(function (row) {
            var input = {
        ...
        this.dialogWorkOrderEditService
            ...
            _this.messageService.showErrorMessage(err.error && err.error.errorDetail ? err.error.errorDetail : _this.getTranslateKey('errorOnAddingWO'));
        });
    };
    DialogWorkOrderEditComponent.prototype.updateType = function (keepValues) {
        this.showTaskSection = this.workOrder.woType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_TASK;
        this.showDefectSection = this.workOrder.woType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_DEFECT;
        this.showEvolutionSection = this.workOrder.woType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_EVOLUTION;
        this.showOperationSection =
            this.workOrder.woType !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_SUBCONTRACTING &&
                !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_14__["StringUtils"].isNullOrEmpty(this.workOrder.woType);
    ...
    DialogWorkOrderEditComponent.prototype.insertOpTableIfNotExist = function (operationList, createProcurementRequest, bireTaskDTO) {
        var _this = this;
        var e_1, _a;
        var _loop_1 = function (op) {
            if (!this_1.opTable.some(function (o) { return Object(lodash_es__WEBPACK_IMPORTED_MODULE_2__["isEqual"])(o.code, op.code) && Object(lodash_es__WEBPACK_IMPORTED_MODULE_2__["isEqual"])(o.version, op.version); })) {
                this_1.opTable.push(op);
            }
        };
        var this_1 = this;
        try {
            for (var operationList_1 = __values(operationList), operationList_1_1 = operationList_1.next(); !operationList_1_1.done; operationList_1_1 = operationList_1.next()) {
            ...
            try {
                if (operationList_1_1 && !operationList_1_1.done && (_a = operationList_1.return)) _a.call(operationList_1);
            }
            ...
            this.dialogWorkOrderEditService
                ...
                results.forEach(function (input) {
                    var row = {
                        ...
                        requestedQuantity: input.quantity ? _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_13__["NumberUtils"].roundNumber(input.quantity, 2) : 1,
                        expectedOn: _this.workOrder.woScheduledStartDate,
                        criticality: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].LOGISTICAL_CRITICALITY_ROUTINE,
                        recepient: !!_this.bidtSiteDTO ? _this.bidtSiteDTO.siteName : '',
                        recepientDesc: !!_this.bidtWarehouseDTOs && !!_this.workOrder.bidtWarehouseId
                            ? _this.bidtWarehouseDTOs.filter(function (warehouse) { return warehouse.wareHouseId === _this.workOrder.bidtWarehouseId; })[0].whName
                            : ''
                    };
                    _this.loadUnits(row);
    ...
    DialogWorkOrderEditComponent.prototype.deleteOperation = function () {
        var _this = this;
        this.opTable = this.opTable.filter(function (op) { return !_this.selectedOperations.includes(op); });
        this.selectedOperations = [];
    };
    ...
    DialogWorkOrderEditComponent.prototype.init = function () {
        ...
        this.procurementRequestTypes = [];
        this.awPropertiesConstants = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"];
    ...
    DialogWorkOrderEditComponent.prototype.fillOperationListFromTask = function () {
        ...
        this.dialogWorkOrderEditService.findOperationsFromTaskAndRelatedTasks(bireTaskDTOId).subscribe(function (operationList) {
            _this.convertBireOperationsAndInsertIfNotExist(operationList, _this.task);
        });
    };
    DialogWorkOrderEditComponent.prototype.convertBireOperationsAndInsertIfNotExist = function (operationList, bireTaskDTO) {
    ...
    DialogWorkOrderEditComponent.prototype.fillOperationListFromEvol = function () {
        var _this = this;
        this.dialogWorkOrderEditService.findOperationsFromEvolution(this.evolution).subscribe(function (operationList) {
    ...
    DialogWorkOrderEditComponent.prototype.fillRelatedItemsList = function () {
        var _this = this;
        if (this.workOrder.woType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_TASK) {
            var bireTaskDTOId = {
                taskCode: this.task.taskCode || '',
                taskVersion: this.task.taskVersion || ''
            };
            this.dialogWorkOrderEditService.findRelatedItemsFromTask(bireTaskDTOId).subscribe(function (relatedItemList) {
                _this.updateRelatedItemList(relatedItemList);
            });
        }
        else if (this.workOrder.woType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_EVOLUTION) {
            this.dialogWorkOrderEditService.findRelatedItemsFromEvolution(this.evolution).subscribe(function (relatedItemList) {
                _this.updateRelatedItemList(relatedItemList);
            });
        }
    };
    ...
    DialogWorkOrderEditComponent.prototype.fillRelatedAssetsList = function () {
        ...
        if (this._workPackage.assetCode) {
            ...
            this.dialogWorkOrderEditService.findRelatedAssets(findRelatedAssetsInput).subscribe(function (relatedAssetList) {
        ...
        return procurementRequest.procReqItemsAndQtyIndicatorsDTO.map(function (procReqItemsAndQtyIndicatorsDTO) {
            var row = {
                ...
                requestedQuantity: procReqItemsAndQtyIndicatorsDTO.requestedQuantity
                    ? _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_13__["NumberUtils"].roundNumber(_shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_13__["NumberUtils"].fromString(procReqItemsAndQtyIndicatorsDTO.requestedQuantity), 2)
                    : 1,
                ...
                requestedPotential: procurementRequest.requestedPotential
                    ? _shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_13__["NumberUtils"].roundNumber(_shared_utils_number_utils__WEBPACK_IMPORTED_MODULE_13__["NumberUtils"].fromString(procurementRequest.requestedPotential), 2)
                    : undefined
            };
            return row;
        });
    ...
    DialogWorkOrderEditComponent.prototype.addProcurementRequest = function () {
        ...
        this.procurementRequestRows.push({
            ...
            recepientDesc: !!this.bidtWarehouseDTOs && !!this.workOrder.bidtWarehouseId
                ? this.bidtWarehouseDTOs.filter(function (warehouse) { return warehouse.wareHouseId === _this.workOrder.bidtWarehouseId; })[0]
                    .whName
                : ''
        });
    };
    ...
    DialogWorkOrderEditComponent.prototype.deleteProcurementRequest = function (row) {
        this.procurementRequestRows = this.procurementRequestRows.filter(function (pr) { return pr !== row; });
    };
    ...
    ], DialogWorkOrderEditComponent.prototype, "workPackage", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean),
        __metadata("design:paramtypes", [Boolean])
    ], DialogWorkOrderEditComponent.prototype, "isFromMaintenancePlanning", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], DialogWorkOrderEditComponent.prototype, "workOrderSelected", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], DialogWorkOrderEditComponent.prototype, "addWorkOrder", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [Array])
    ], DialogWorkOrderEditComponent.prototype, "workOrders", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], DialogWorkOrderEditComponent.prototype, "familyCode", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], DialogWorkOrderEditComponent.prototype, "variantCode", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogWorkOrderEditComponent.prototype, "onValidated", void 0);
    DialogWorkOrderEditComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-work-order-edition',
            template: __webpack_require__(/*! ./dialog-work-order-edition.component.html */ "./src/app/main/maintenance/work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.component.html"),
            styles: [__webpack_require__(/*! ./dialog-work-order-edition.component.scss */ "./src/app/main/maintenance/work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.component.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_session_service__WEBPACK_IMPORTED_MODULE_11__["SessionService"],
            ...
            _human_resources_employee_form_employee_form_service__WEBPACK_IMPORTED_MODULE_15__["EmployeeFormService"],
            _work_order_form_work_order_form_service__WEBPACK_IMPORTED_MODULE_18__["WorkOrderFormService"],
            _procurement_request_procurement_requests_table_service__WEBPACK_IMPORTED_MODULE_17__["ProcurementRequestsTableService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogWorkOrderEditionModule", function() { return DialogWorkOrderEditionModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_components_dialog_search_customer_dialog_search_customer_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../../../shared/components/dialog-search-customer/dialog-search-customer.module */ "./src/app/shared/components/dialog-search-customer/dialog-search-customer.module.ts");
/* harmony import */ var _shared_components_dialog_search_defect_events_dialog_search_defect_events_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../../../shared/components/dialog-search-defect-events/dialog-search-defect-events.module */ "./src/app/shared/components/dialog-search-defect-events/dialog-search-defect-events.module.ts");
/* harmony import */ var _shared_components_dialog_search_event_dialog_search_event_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../../../shared/components/dialog-search-event/dialog-search-event.module */ "./src/app/shared/components/dialog-search-event/dialog-search-event.module.ts");
/* harmony import */ var _shared_components_dialog_search_evolution_dialog_search_evolution_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../../../../shared/components/dialog-search-evolution/dialog-search-evolution.module */ "./src/app/shared/components/dialog-search-evolution/dialog-search-evolution.module.ts");
/* harmony import */ var _shared_components_dialog_search_operation_dialog_search_operation_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../../../shared/components/dialog-search-operation/dialog-search-operation.module */ "./src/app/shared/components/dialog-search-operation/dialog-search-operation.module.ts");
/* harmony import */ var _shared_components_dialog_search_pn_dialog_search_pn_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../../../../shared/components/dialog-search-pn/dialog-search-pn.module */ "./src/app/shared/components/dialog-search-pn/dialog-search-pn.module.ts");
/* harmony import */ var _shared_components_dialog_search_task_dialog_search_task_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../../../../shared/components/dialog-search-task/dialog-search-task.module */ "./src/app/shared/components/dialog-search-task/dialog-search-task.module.ts");
...
/* harmony import */ var _dialog_work_order_edition_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./dialog-work-order-edition.component */ "./src/app/main/maintenance/work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.component.ts");
/* harmony import */ var _dialog_work_order_edition_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./dialog-work-order-edition.service */ "./src/app/main/maintenance/work-package/form/popups/dialog-work-order-edition/dialog-work-order-edition.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EXTERNAL_MODULES = [
    ...
    _shared_components_dialog_search_defect_events_dialog_search_defect_events_module__WEBPACK_IMPORTED_MODULE_9__["DialogSearchDefectEventsModule"],
    _shared_components_dialog_search_customer_dialog_search_customer_module__WEBPACK_IMPORTED_MODULE_8__["DialogSearchCustomerModule"]
];
var INTERNAL_MODULES = [_shared_components_modal_modal_module__WEBPACK_IMPORTED_MODULE_15__["ModalModule"], _shared_components_dialog_search_pn_dialog_search_pn_module__WEBPACK_IMPORTED_MODULE_13__["DialogSearchPnModule"]];
/******************************************************************************
 * Components
 *************************************************************************** */
var COMPONENTS = [_dialog_work_order_edition_component__WEBPACK_IMPORTED_MODULE_16__["DialogWorkOrderEditComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
    ...
    DialogWorkOrderEditionModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: __spread([
                ...
                _shared_components_dialog_search_task_dialog_search_task_module__WEBPACK_IMPORTED_MODULE_14__["DialogSearchTaskModule"],
                _shared_components_dialog_search_evolution_dialog_search_evolution_module__WEBPACK_IMPORTED_MODULE_11__["DialogSearchEvolutionModule"],
                _shared_components_dialog_search_event_dialog_search_event_module__WEBPACK_IMPORTED_MODULE_10__["DialogSearchEventModule"],
                _shared_components_dialog_search_operation_dialog_search_operation_module__WEBPACK_IMPORTED_MODULE_12__["DialogSearchOperationModule"]
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchDefectEventsComponent", function() { return DialogSearchDefectEventsComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _dialog_search_defect_events_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dialog-search-defect-events.service */ "./src/app/shared/components/dialog-search-defect-events/dialog-search-defect-events.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DialogSearchDefectEventsComponent = /** @class */ (function (_super) {
    ...
    function DialogSearchDefectEventsComponent(dialogSearchDefectEventsService, sessionService, messageService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Write, 'DialogSearchDefectEventsComponent') || this;
                ...
                _this.resultsTable = results.map(function (findDefectEventsByEquipmentCodeOutput) {
                    ...
                    return {
                        ...
                        date: notification.reportingPeriodStartDate
                            ? moment__WEBPACK_IMPORTED_MODULE_1__(notification.reportingPeriodStartDate).format(_this.sessionService.dateTimeFormatMomentJS)
                            : '',
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", Object)
    ], DialogSearchDefectEventsComponent.prototype, "onSelected", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], DialogSearchDefectEventsComponent.prototype, "equipmentCode", void 0);
    DialogSearchDefectEventsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-search-defect-events',
            template: __webpack_require__(/*! ./dialog-search-defect-events.component.html */ "./src/app/shared/components/dialog-search-defect-events/dialog-search-defect-events.component.html")
        }),
        __metadata("design:paramtypes", [_dialog_search_defect_events_service__WEBPACK_IMPORTED_MODULE_6__["DialogSearchDefectEventsService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchDefectEventsModule", function() { return DialogSearchDefectEventsModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _dialog_search_defect_events_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dialog-search-defect-events.component */ "./src/app/shared/components/dialog-search-defect-events/dialog-search-defect-events.component.ts");
/* harmony import */ var _dialog_search_defect_events_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./dialog-search-defect-events.service */ "./src/app/shared/components/dialog-search-defect-events/dialog-search-defect-events.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Components
 *************************************************************************** */
var COMPONENTS = [_dialog_search_defect_events_component__WEBPACK_IMPORTED_MODULE_6__["DialogSearchDefectEventsComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_dialog_search_defect_events_service__WEBPACK_IMPORTED_MODULE_7__["DialogSearchDefectEventsService"]];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogSearchDefectEventsService", function() { return DialogSearchDefectEventsService; });
