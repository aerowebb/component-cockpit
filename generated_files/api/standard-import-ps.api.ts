...
export class StandardImportPsApi extends AbstractApi {
	...
	// public readonly getImportAttributeValuesBireXLS: string = super.appendToBaseUrl('/get_import_attribute_values_bire_xls');
	...
	// public readonly importAttributeValuesBireFromExcel: string = super.appendToBaseUrl('/import_attribute_values_bire_from_excel');
