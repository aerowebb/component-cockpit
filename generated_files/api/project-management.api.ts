...
export class ProjectManagementApi extends AbstractApi {
	...
	// public readonly findBsdeTargetsSelectedByItemAndItemFatherAndConfigurationNumberAndProjectId: string = super.appendToBaseUrl('/find_bsde_targets_selected_by_item_and_item_father_and_configuration_number_and_project_id');

	// public readonly findBsdeAvailabilitysByProjectAndAvailabilityTypeAndAvailabilityCode: string = super.appendToBaseUrl('/find_bsde_availabilitys_by_project_and_availability_type_and_availability_code');

	// public readonly findBsdeProjectsByProjectCriteria: string = super.appendToBaseUrl('/find_bsde_projects_by_project_criteria');
	...
	// public readonly findBsdeProjectAttributesByProject: string = super.appendToBaseUrl('/find_bsde_project_attributes_by_project');
	...
	// public readonly findBsdeProjectAttributeByProjectId: string = super.appendToBaseUrl('/find_bsde_project_attribute_by_project_id');
	...
	// public readonly findBsdeProjectByProjectNumber: string = super.appendToBaseUrl('/find_bsde_project_by_project_number');
