(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["human-resources-human-resources-module"],{
...
/* harmony import */ var _shared_constants_bido_notification_type_constants__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../shared/constants/bido-notification-type-constants */ "./src/app/shared/constants/bido-notification-type-constants.ts");
...
/* harmony import */ var _shared_services_export_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../shared/services/export.service */ "./src/app/shared/services/export.service.ts");
...
/* harmony import */ var _shared_services_page_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../../shared/services/page.service */ "./src/app/shared/services/page.service.ts");
...
/* harmony import */ var _employee_form_service__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./employee-form.service */ "./src/app/main/human-resources/employee-form/employee-form.service.ts");
...
var EmployeeFormComponent = /** @class */ (function (_super) {
    ...
    function EmployeeFormComponent(favoriteService, loaderService, messageService, serializationService, tabService, pageTocService, dynamicAttributesService, inputValidationService, sessionService, translateService, confirmationService, employeeFormService, propertiesService, pageService, dateService, exportService) {
    ...
    EmployeeFormComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_10__["ComponentConstants"].HR_EMPLOYEE_FORM;
    };
    ...
    EmployeeFormComponent.prototype.initQualificationRenewalTableDataSource = function () {
        this.qualificationRenewalTableDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_7__["TableDataSource"]({
    ...
    EmployeeFormComponent.prototype.registerPageTocEntrySelectedObservable = function () {
        var _this = this;
        this.pageTocService.pageTocEntrySelected$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.unsubscribe)).subscribe(function (pageTocEntrySelected) {
    ...
    EmployeeFormComponent.prototype.loadExpenseType = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_11__["GenericPropertyConstants"].HR_EXPENSE_TYPE_MAP).subscribe(function (results) {
            _this.expenseTypes = results;
        });
    };
    EmployeeFormComponent.prototype.loadHolidayStatus = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_11__["GenericPropertyConstants"].HR_ABSENCE_STATUS_MAP).subscribe(function (results) {
            _this.holidayStatusList = results;
        });
    };
    EmployeeFormComponent.prototype.loadAbsenceType = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_11__["GenericPropertyConstants"].HR_ABSENCE_TYPE_MAP).subscribe(function (results) {
            _this.absenceTypes = results;
        });
    };
    EmployeeFormComponent.prototype.loadEvaluationType = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_11__["GenericPropertyConstants"].HR_EVALUATION_TYPE_MAP).subscribe(function (results) {
            _this.evaluationTypes = results;
        });
    };
    EmployeeFormComponent.prototype.loadRequestedbyList = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_11__["GenericPropertyConstants"].HR_TRAINING_ASKED_BY_MAP).subscribe(function (results) {
    ...
    EmployeeFormComponent.prototype.showHeaderText = function (col) {
        ...
        var headerTextObj = this.categoryLevels &&
    ...
    EmployeeFormComponent.prototype.initTableColumnField = function () {
        ...
        var getCategoryTypeMap = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_11__["GenericPropertyConstants"].HR_CATEGORY_TYPE_MAP);
        var getCategorylevelMap = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_11__["GenericPropertyConstants"].HR_CATEGORY_LEVEL_MAP);
        Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["forkJoin"])([getCategoryTypeMap, getCategorylevelMap]).subscribe(function (results) {
    ...
    EmployeeFormComponent.prototype.checkValidation = function () {
        ...
        if (!!this.employeeFormData.employeeFirstName &&
    ...
    EmployeeFormComponent.prototype.loadContractTypes = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_11__["GenericPropertyConstants"].HR_CONTRACT_TYPE_MAP).subscribe(function (results) {
    ...
    EmployeeFormComponent.prototype.loadContractTypesOnChange = function () {
        ...
        if (this.selectedContractName) {
            ...
            var contractName = this.contractTypes &&
    ...
    EmployeeFormComponent.prototype.loadSalaryDevices = function () {
        var _this = this;
        var getCurrenciesObservable = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_11__["GenericPropertyConstants"].CURRENCY_MAP);
        var defaultCurrencyObservable = this.employeeFormService.getLocalCurrency();
        Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["forkJoin"])([defaultCurrencyObservable, getCurrenciesObservable]).subscribe(function (results) {
            _this.salaryDevises = results[1];
            var selectedCurrency = _this.salaryDevises &&
    ...
    EmployeeFormComponent.prototype.displaySalaryCurrency = function (salaryDeviseId) {
        if (salaryDeviseId !== null && salaryDeviseId !== undefined) {
            var selectedCurrency = this.salaryDevises &&
    ...
    EmployeeFormComponent.prototype.loadEmployee = function () {
        ...
        var periodObservable = this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_11__["GenericPropertyConstants"].HR_SALARY_PERIOD_MAP);
        Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["forkJoin"])([companiesObservable, siteObservable, periodObservable]).subscribe(function (results) {
            var periodIndex = 2;
            ...
            if (_this.componentData.objectId || _this.empID) {
                ...
                if (employeeTemp.id) {
                    _this.employeeFormService.getEmployeeDetails(employeeTemp.id).subscribe(function (result) {
                        ...
                        if (_this.employeeDetails) {
                            ...
                            var selectedSite = _this.siteDTOList &&
                                _this.siteDTOList.filter(function (siteObj) {
                                    return (_this.employeeDetails.bidtEmployeeDTO &&
                            ...
                            if (_this.employeeFormData.contractEmployeeStartDate) {
                                _this.selectedContractEmployeeStartDate = new Date(_this.employeeFormData.contractEmployeeStartDate);
                            }
                            if (_this.employeeFormData.contractEmployeeEndDate) {
                                _this.selectedContractEmployeeEndDate = new Date(_this.employeeFormData.contractEmployeeEndDate);
                            }
                            ...
                            var contractName = _this.contractNames &&
    ...
    EmployeeFormComponent.prototype.onExportWorks = function () {
        ...
        var name = this.employeeFormData.employeeLastName + "-" + this.employeeFormData.employeeFirstName + "-Works-List";
    ...
    EmployeeFormComponent.prototype.initOnEmployeeLoad = function () {
        ...
        if (this.employeeDetails.bidtEmployeeDTO && this.employeeDetails.bidtEmployeeDTO.id) {
            ...
            this.employeeFormService.findAbsenceByEmployeeId(this.employeeDetails.bidtEmployeeDTO.id).subscribe(function (results) {
                _this.bidtAbsenceDisplayed = [];
                if (results !== null && results !== undefined) {
                    results.forEach(function (obj) {
            ...
            this.employeeFormService.findExpenseByEmployeeId(this.employeeDetails.bidtEmployeeDTO.id).subscribe(function (results) {
                _this.bidtExpenseDisplayed = [];
                if (results !== null && results !== undefined) {
                    results.forEach(function (obj) {
            ...
            var acrsEventListInput = {
                status: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_8__["AWPropertiesConstants"].EVENT_STATUS_CLOSED_KEY,
                typeCode: _shared_constants_bido_notification_type_constants__WEBPACK_IMPORTED_MODULE_9__["BidoNotificationTypeConstants"].ACRS_TYPE_CODE,
            ...
            Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["forkJoin"])([
                ...
                if (_shared_utils_object_utils__WEBPACK_IMPORTED_MODULE_29__["ObjectUtils"].isDefined(results[2])) {
                    ...
                    _this.acrsEventTable.list = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_28__["ListUtils"].orEmpty(results[2].list).map(function (notification) {
                        var matchingStatus = _this.eventStatusList.find(function (elt) { return elt.value === notification.status; });
                        var acrsEventRow = {
                            asset: '',
                            eventCode: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_30__["StringUtils"].orEmpty(notification.notificationCode),
                            eventDate: _this.dateService.dateToString(notification.reportingDate),
                            eventDescription: _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_30__["StringUtils"].orEmpty(notification.notificationDescription),
                            eventStatus: matchingStatus ? matchingStatus.label : _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_30__["StringUtils"].orEmpty(notification.status),
                            _obj: notification
                        };
                        _this.employeeFormService
                            .findBidoEquipment({ equipmentCode: notification.equipmentCode })
                            .subscribe(function (equipment) {
                            acrsEventRow.asset = _shared_utils_bido_equipment_utils__WEBPACK_IMPORTED_MODULE_26__["BidoEquipmentUtils"].toString(equipment);
                        });
                        return acrsEventRow;
                    });
                }
    ...
    EmployeeFormComponent.prototype.editEmployeeCard = function () {
        var _this = this;
        this.employeeFormService.generateEmployeeCard(this.employeeFormData).subscribe(function (result) {
            var file = result || {};
            if (!!file.fileContent && !!file.fileName) {
                ...
                var fileURL = URL.createObjectURL(new Blob([new Uint8Array(byteNumbers)], { type: 'application/pdf' }));
                window.open(fileURL);
            }
        }, function (error) {
    ...
    EmployeeFormComponent.prototype.saveEmployee = function () {
        ...
        if (this.bidtTrainingDisplayed.length > 0) {
            this.bidtTrainingDisplayed.forEach(function (training) {
                ...
                var typeValue = _this.requestedByList &&
        ...
        if (this.bidtExpenseDisplayed.length > 0) {
            this.bidtExpenseDisplayed.forEach(function (expense) {
                ...
                var typeValue = _this.expenseTypes &&
        ...
        if (this.bidtAbsenceDisplayed.length > 0) {
            this.bidtAbsenceDisplayed.forEach(function (absence) {
                ...
                var typeValue = _this.absenceTypes &&
        ...
        if (this.bidtHolidayDisplayed.length > 0) {
            this.bidtHolidayDisplayed.forEach(function (holiday) {
                var holidayStatusValue = _this.holidayStatusList &&
        ...
        if (this.bidtEvaluationDisplayed.length > 0) {
            this.bidtEvaluationDisplayed.forEach(function (evaluation) {
                if (evaluation._obj.bidtEvaluationDTO !== null && evaluation._obj.bidtEvaluationDTO !== undefined) {
                    ...
                    var evaluationTypeValue = _this.evaluationTypes &&
        ...
        this.employeeFormService
            ...
            if (_this.isCreateOpenMode) {
                ...
                _this.employeeName = _this.employeeFormData.employeeFirstName + " " + _this.employeeFormData.employeeLastName;
    ...
    EmployeeFormComponent.prototype.addNewDocument = function (newDocument) {
        var searchInDisplayedList = this.bidtDocumentDisplayed.find(function (value) { return value.documentName === newDocument.documentName; });
        ...
        this.confirmationService.confirmDelete({
            ...
            accept: function () {
                _this.selectedDocuments.forEach(function (element) {
                    var searchInAddedList = _this.bidtDocumentAddedList.find(function (value) { return value.documentName === element.documentName; });
                    var searchInUpdatedList = _this.bidtDocumentUpdatedList.find(function (value) { return value.documentName === element.documentName; });
    ...
    EmployeeFormComponent.prototype.updateDocument = function (updatedDocument) {
        ...
        var searchInAddedList = this.bidtDocumentAddedList.find(function (value) { return value.documentName === previousDocumentObject.documentName; });
        var searchInUpdatedList = this.bidtDocumentUpdatedList.find(function (value) { return value.documentCode === previousDocumentObject._obj.documentCode; });
        if (searchInAddedList) {
    ...
    EmployeeFormComponent.prototype.showDocExtension = function (document) {
        return _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_27__["FileUtils"].getExtension(document.documentName).toUpperCase();
    };
    EmployeeFormComponent.prototype.showDocSize = function (document) {
        return document.documentContent ? _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_27__["FileUtils"].getFormattedSize(document.documentContent.length) : '';
    };
    EmployeeFormComponent.prototype.uploadDocument = function (event, fileUploader) {
        var _this = this;
        if (event.files) {
            var file_1 = event.files[0];
            _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_27__["FileUtils"].getFileContentAsBase64(file_1, function (fileContent) {
                if (fileContent) {
                    var document_1 = {
    ...
    EmployeeFormComponent.prototype.downloadFiles = function () {
        this.selectedDocuments.forEach(function (document) {
            if (!!document._obj.documentContent) {
                _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_27__["FileUtils"].downloadFile(document._obj.documentContent, document.documentName);
            }
        });
    };
    /***********************************************************************************
    ...
    EmployeeFormComponent.prototype.openMedicalExamination = function () {
        ...
        if (this.selectedMedicalExaminations.length === 1) {
            ...
            this.currentMedicalExaminationIndex = this.bidtMedicalExaminationDisplayed.indexOf(this.selectedMedicalExaminations[0]);
    ...
    EmployeeFormComponent.prototype.saveMedicalExamination = function (medicalExamObj) {
        if (!!medicalExamObj) {
            if (this.currentMedicalExaminationIndex > -1) {
                this.bidtMedicalExaminationDisplayed[this.currentMedicalExaminationIndex] = this.convertToMedicalExaminationRowObj(medicalExamObj);
            }
            else {
    ...
    EmployeeFormComponent.prototype.saveAbsence = function (absenceObj) {
        if (!!absenceObj) {
            if (this.currentAbsenceIndex > -1) {
                ...
                this.bidtAbsenceDisplayed = __spread(this.bidtAbsenceDisplayed, [this.convertToAbsenceRowObj(absenceObj)]);
            }
        }
        this.currentAbsenceIndex = -1;
    ...
    EmployeeFormComponent.prototype.saveEvaluation = function (evaluationObj) {
        if (!!evaluationObj) {
            if (this.currentEvaluationIndex > -1) {
                ...
                this.bidtEvaluationDisplayed = __spread(this.bidtEvaluationDisplayed, [this.convertToEvaluationRowObj(evaluationObj)]);
            }
        }
        this.currentEvaluationIndex = -1;
    ...
    EmployeeFormComponent.prototype.saveExpense = function (expenseObj) {
        if (!!expenseObj) {
            if (this.currentExpenseIndex > -1) {
                ...
                this.bidtExpenseDisplayed = __spread(this.bidtExpenseDisplayed, [this.convertToExpenseRowObj(expenseObj)]);
            }
        }
        this.currentExpenseIndex = -1;
    ...
    EmployeeFormComponent.prototype.saveHoliday = function (holidayObj) {
        if (!!holidayObj) {
            if (this.currentHolidayIndex > -1) {
                ...
                this.bidtHolidayDisplayed = __spread(this.bidtHolidayDisplayed, [this.convertToHolidayRowObj(holidayObj)]);
            }
        }
        this.currentHolidayIndex = -1;
    ...
    EmployeeFormComponent.prototype.saveQualification = function (qualificationObj) {
        if (!!qualificationObj) {
            if (this.currentQualificationIndex > -1) {
                this.bidtQualifEmployeeDisplayed[this.currentQualificationIndex] = this.convertToQualificationRowObj(qualificationObj);
            }
            else {
    ...
    EmployeeFormComponent.prototype.saveTraining = function (trainingObj) {
        if (!!trainingObj) {
            if (this.currentTrainingIndex > -1) {
                ...
                this.bidtTrainingDisplayed = __spread(this.bidtTrainingDisplayed, [this.convertToTrainingRowObj(trainingObj)]);
            }
        }
        this.currentTrainingIndex = -1;
    ...
    EmployeeFormComponent.prototype.convertToTrainingRowObj = function (obj) {
        return {
            ...
            trainingEndDate: obj.trainingEndDate && moment__WEBPACK_IMPORTED_MODULE_2__(obj.trainingEndDate).format('YYYY/MM/DD A'),
            trainingInstructor: obj.trainingInstructor,
            trainingPerformed: obj.trainingPerformed && obj.trainingPerformed === 1 ? true : false,
            trainingStartDate: obj.trainingStartDate && moment__WEBPACK_IMPORTED_MODULE_2__(obj.trainingStartDate).format('YYYY/MM/DD A'),
            _obj: obj
        };
    };
    EmployeeFormComponent.prototype.convertToQualificationRowObj = function (obj) {
        return {
            qualifEmployeeEndDate: obj.bidtQualifEmployeeDTO &&
            ...
            qualifEmployeeStartDate: obj.bidtQualifEmployeeDTO &&
    ...
    EmployeeFormComponent.prototype.convertToAbsenceRowObj = function (obj) {
        return {
            ...
            absenceEndDate: obj.absenceEndDate && moment__WEBPACK_IMPORTED_MODULE_2__(obj.absenceEndDate).format('YYYY/MM/DD A'),
            absenceStartDate: obj.absenceStartDate && moment__WEBPACK_IMPORTED_MODULE_2__(obj.absenceStartDate).format('YYYY/MM/DD A'),
    ...
    EmployeeFormComponent.prototype.convertToEvaluationRowObj = function (obj) {
        return {
            ...
            evaluationDate: obj.bidtEvaluationDTO &&
    ...
    EmployeeFormComponent.prototype.convertToHolidayRowObj = function (obj) {
        return {
            holidayEndDate: obj.holidayEndDate && moment__WEBPACK_IMPORTED_MODULE_2__(obj.holidayEndDate).format('YYYY/MM/DD A'),
            holidayStartDate: obj.holidayStartDate && moment__WEBPACK_IMPORTED_MODULE_2__(obj.holidayStartDate).format('YYYY/MM/DD A'),
    ...
    EmployeeFormComponent.prototype.convertToDocumentRowObj = function (obj) {
        return {
            ...
            documentPublicationDate: obj.documentPublicationDate && this.dateService.dateToString(new Date(obj.documentPublicationDate)),
    ...
    EmployeeFormComponent.prototype.openOrigin = function (row) {
        var openMode = _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_12__["ComponentOpenMode"].Read;
        if (row._obj && row.origin && row._obj.bidmWorkOrderData) {
            ...
            if (_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_8__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_TASK === bidmWorkOrderData.woType) {
                var objectId = {
                    taskCode: arr[0],
                    taskVersion: arr[1]
                };
            ...
            else if (_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_8__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_EVOLUTION === bidmWorkOrderData.woType) {
                var objectId = {
            ...
            else if (_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_8__["AWPropertiesConstants"].AIRM_WORK_ORDER_TYPE_DEFECT === bidmWorkOrderData.woType) {
                var data = {
                    id: this.tabService.generateId(),
                    componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_10__["ComponentConstants"].FLE_DEFECT_FORM,
                    openMode: _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_12__["ComponentOpenMode"].Read
                };
                var defectId = {
    ...
    EmployeeFormComponent.prototype.openRelatedItem = function (row) {
        ...
        if (!!row && row._obj.bidmWorkOrderData) {
            var itemFormId = {
                ...
                structureType: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_8__["AWPropertiesConstants"].STRUCTURE_TYPE_IPC_KEY,
    ...
    EmployeeFormComponent.prototype.loadEventStatus = function () {
        ...
        this.employeeFormService.getEventStatusValues().subscribe(function (results) {
            _this.eventStatusList = _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_28__["ListUtils"].orEmpty(results);
        });
    };
    EmployeeFormComponent.prototype.openEvent = function (acrsEventRow) {
        var data = {
            id: this.tabService.generateId(),
            componentId: acrsEventRow._obj.bidoNotificationTypeDTO &&
                acrsEventRow._obj.bidoNotificationTypeDTO.typeCategory === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_8__["AWPropertiesConstants"].EVENT_CATEGORY_DEFECT_KEY
                ? _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_10__["ComponentConstants"].FLE_DEFECT_FORM
                : _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_10__["ComponentConstants"].FLE_EVENT_CREATE,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AbsencePopupFormComponent", function() { return AbsencePopupFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var AbsencePopupFormComponent = /** @class */ (function (_super) {
    ...
    function AbsencePopupFormComponent(messageService, sessionService, propertiesService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__["ComponentOpenMode"].Read, 'AbsencePopupFormComponent') || this;
    ...
    AbsencePopupFormComponent.prototype.loadAbsenceType = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_2__["GenericPropertyConstants"].HR_ABSENCE_TYPE_MAP).subscribe(function (results) {
            _this.absenceTypes = JSON.parse(JSON.stringify(results));
            _this.absenceTypes = _this.absenceTypes.filter(function (element) {
                return element.value !== _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_1__["AWPropertiesConstants"].HR_ABSENCE_TYPE_HOLIDAY;
            });
    ...
    ], AbsencePopupFormComponent.prototype, "display", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], AbsencePopupFormComponent.prototype, "isReadOnlyForm", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], AbsencePopupFormComponent.prototype, "displayChange", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], AbsencePopupFormComponent.prototype, "onValidated", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('component-data'),
        __metadata("design:type", Object)
    ], AbsencePopupFormComponent.prototype, "componentData", void 0);
    AbsencePopupFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-absence-popup-form',
            template: __webpack_require__(/*! ./absence-popup-form.component.html */ "./src/app/main/human-resources/employee-form/popups/absence-popup-form/absence-popup-form.component.html"),
            styles: [__webpack_require__(/*! ../../employee-form.component.scss */ "./src/app/main/human-resources/employee-form/employee-form.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EvaluationPopupFormComponent", function() { return EvaluationPopupFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var EvaluationPopupFormComponent = /** @class */ (function (_super) {
    ...
    function EvaluationPopupFormComponent(messageService, sessionService, propertiesService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Read, 'EvaluationPopupFormComponent') || this;
        _this.messageService = messageService;
        _this.sessionService = sessionService;
        _this.propertiesService = propertiesService;
    ...
    EvaluationPopupFormComponent.prototype.loadEvaluationType = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_1__["GenericPropertyConstants"].HR_EVALUATION_TYPE_MAP).subscribe(function (results) {
    ...
    __decorate([
        ...
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], EvaluationPopupFormComponent.prototype, "display", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], EvaluationPopupFormComponent.prototype, "displayChange", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], EvaluationPopupFormComponent.prototype, "isReadOnlyForm", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], EvaluationPopupFormComponent.prototype, "onValidated", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('component-data'),
        __metadata("design:type", Object)
    ], EvaluationPopupFormComponent.prototype, "componentData", void 0);
    EvaluationPopupFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-evaluation-popup-form',
            template: __webpack_require__(/*! ./evaluation-popup-form.component.html */ "./src/app/main/human-resources/employee-form/popups/evaluation-popup-form/evaluation-popup-form.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ExpensePopupFormComponent", function() { return ExpensePopupFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../shared/constants/generic-property-constants */ "./src/app/shared/constants/generic-property-constants.ts");
/* harmony import */ var _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../shared/enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
...
var ExpensePopupFormComponent = /** @class */ (function (_super) {
    ...
    function ExpensePopupFormComponent(inputValidationService, messageService, sessionService, propertiesService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Read, 'ExpensePopupFormComponent') || this;
        _this.inputValidationService = inputValidationService;
        _this.messageService = messageService;
        _this.sessionService = sessionService;
        _this.propertiesService = propertiesService;
    ...
    ExpensePopupFormComponent.prototype.loadExpenseType = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_1__["GenericPropertyConstants"].HR_EXPENSE_TYPE_MAP).subscribe(function (results) {
    ...
    __decorate([
        ...
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], ExpensePopupFormComponent.prototype, "display", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], ExpensePopupFormComponent.prototype, "isReadOnlyForm", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ExpensePopupFormComponent.prototype, "displayChange", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], ExpensePopupFormComponent.prototype, "onValidated", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('component-data'),
        __metadata("design:type", Object)
    ], ExpensePopupFormComponent.prototype, "componentData", void 0);
    ExpensePopupFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-expense-popup-form',
            template: __webpack_require__(/*! ./expense-popup-form.component.html */ "./src/app/main/human-resources/employee-form/popups/expense-popup-form/expense-popup-form.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HolidaysPopupFormComponent", function() { return HolidaysPopupFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../shared/constants/generic-property-constants */ "./src/app/shared/constants/generic-property-constants.ts");
/* harmony import */ var _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../shared/enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
/* harmony import */ var _shared_services_message_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../shared/services/message.service */ "./src/app/shared/services/message.service.ts");
...
var HolidaysPopupFormComponent = /** @class */ (function (_super) {
    ...
    function HolidaysPopupFormComponent(messageService, sessionService, propertiesService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Read, 'HolidaysPopupFormComponent') || this;
        _this.messageService = messageService;
        _this.sessionService = sessionService;
        _this.propertiesService = propertiesService;
    ...
    HolidaysPopupFormComponent.prototype.loadHolidayStatus = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_1__["GenericPropertyConstants"].HR_ABSENCE_STATUS_MAP).subscribe(function (results) {
    ...
    __decorate([
        ...
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], HolidaysPopupFormComponent.prototype, "display", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], HolidaysPopupFormComponent.prototype, "isReadOnlyForm", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], HolidaysPopupFormComponent.prototype, "displayChange", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], HolidaysPopupFormComponent.prototype, "onValidated", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('component-data'),
        __metadata("design:type", Object)
    ], HolidaysPopupFormComponent.prototype, "componentData", void 0);
    HolidaysPopupFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-holidays-popup-form',
            template: __webpack_require__(/*! ./holidays-popup-form.component.html */ "./src/app/main/human-resources/employee-form/popups/holidays-popup-form/holidays-popup-form.component.html"),
            styles: [__webpack_require__(/*! ../../employee-form.component.scss */ "./src/app/main/human-resources/employee-form/employee-form.component.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_message_service__WEBPACK_IMPORTED_MODULE_3__["MessageService"],
            _shared_services_session_service__WEBPACK_IMPORTED_MODULE_5__["SessionService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HourlyCostsPopupFormComponent", function() { return HourlyCostsPopupFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../shared/constants/generic-property-constants */ "./src/app/shared/constants/generic-property-constants.ts");
/* harmony import */ var _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../shared/enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
/* harmony import */ var _shared_services_input_validation_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../shared/services/input-validation.service */ "./src/app/shared/services/input-validation.service.ts");
...
/* harmony import */ var _shared_services_session_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../shared/services/session.service */ "./src/app/shared/services/session.service.ts");
/* harmony import */ var _shared_types_dialog_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../../shared/types/dialog-component */ "./src/app/shared/types/dialog-component.ts");
/* harmony import */ var _employee_form_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../employee-form.service */ "./src/app/main/human-resources/employee-form/employee-form.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var HourlyCostsPopupFormComponent = /** @class */ (function (_super) {
    ...
    function HourlyCostsPopupFormComponent(inputValidationService, messageService, sessionService, propertiesService, employeeFormService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Read, 'HourlyCostsPopupFormComponent') || this;
        _this.inputValidationService = inputValidationService;
        _this.messageService = messageService;
        _this.sessionService = sessionService;
        _this.propertiesService = propertiesService;
    ...
    HourlyCostsPopupFormComponent.prototype.validate = function () {
        ...
        if (this.hourlyCostsDTO.hcDayType && Number(this.hourlyCostsDTO.hcCost) >= 0) {
            ...
            var costText = parseFloat((Math.round(Number(this.hourlyCostsDTO.hcCost) * decimalFactor) / decimalFactor).toString()).toFixed(decimalPrecision);
    ...
    HourlyCostsPopupFormComponent.prototype.loadHourlyCostType = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_1__["GenericPropertyConstants"].HR_HC_DAY_TYPE_MAP).subscribe(function (results) {
    ...
    __decorate([
        ...
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], HourlyCostsPopupFormComponent.prototype, "display", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], HourlyCostsPopupFormComponent.prototype, "isReadOnlyForm", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], HourlyCostsPopupFormComponent.prototype, "displayChange", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], HourlyCostsPopupFormComponent.prototype, "onValidated", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('component-data'),
        __metadata("design:type", Object)
    ], HourlyCostsPopupFormComponent.prototype, "componentData", void 0);
    HourlyCostsPopupFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-hourly-costs-popup-form',
            template: __webpack_require__(/*! ./hourly-costs-popup-form.component.html */ "./src/app/main/human-resources/employee-form/popups/hourly-costs-popup-form/hourly-costs-popup-form.component.html")
        }),
        __metadata("design:paramtypes", [_shared_services_input_validation_service__WEBPACK_IMPORTED_MODULE_3__["InputValidationService"],
            _shared_services_message_service__WEBPACK_IMPORTED_MODULE_4__["MessageService"],
            _shared_services_session_service__WEBPACK_IMPORTED_MODULE_6__["SessionService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MedicalExaminationPopupFormComponent", function() { return MedicalExaminationPopupFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var MedicalExaminationPopupFormComponent = /** @class */ (function (_super) {
    ...
    function MedicalExaminationPopupFormComponent(messageService, sessionService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__["ComponentOpenMode"].Read, 'MedicalExaminationPopupFormComponent') || this;
        _this.messageService = messageService;
        _this.sessionService = sessionService;
        _this.displayChange = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        _this.onValidated = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    ...
    __decorate([
        ...
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], MedicalExaminationPopupFormComponent.prototype, "display", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], MedicalExaminationPopupFormComponent.prototype, "isReadOnlyForm", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], MedicalExaminationPopupFormComponent.prototype, "displayChange", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], MedicalExaminationPopupFormComponent.prototype, "onValidated", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('component-data'),
        __metadata("design:type", Object)
    ], MedicalExaminationPopupFormComponent.prototype, "componentData", void 0);
    MedicalExaminationPopupFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-medical-examination-popup-form',
            template: __webpack_require__(/*! ./medical-examination-popup-form.component.html */ "./src/app/main/human-resources/employee-form/popups/medical-examination-popup-form/medical-examination-popup-form.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QualificationPopupFormComponent", function() { return QualificationPopupFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../shared/constants/generic-property-constants */ "./src/app/shared/constants/generic-property-constants.ts");
/* harmony import */ var _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../shared/enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
/* harmony import */ var _shared_services_message_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../shared/services/message.service */ "./src/app/shared/services/message.service.ts");
...
/* harmony import */ var _shared_services_session_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../shared/services/session.service */ "./src/app/shared/services/session.service.ts");
/* harmony import */ var _shared_types_dialog_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../shared/types/dialog-component */ "./src/app/shared/types/dialog-component.ts");
/* harmony import */ var _qualification_popup_form_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./qualification-popup-form.service */ "./src/app/main/human-resources/employee-form/popups/qualification-popup-form/qualification-popup-form.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var QualificationPopupFormComponent = /** @class */ (function (_super) {
    ...
    function QualificationPopupFormComponent(qualificationPopupFormService, messageService, sessionService, propertiesService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Read, 'QualificationPopupFormComponent') || this;
    ...
    QualificationPopupFormComponent.prototype.loadQualificationType = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_1__["GenericPropertyConstants"].HR_QUALIFICATION_TYPE_MAP).subscribe(function (results) {
    ...
    QualificationPopupFormComponent.prototype.loadTitles = function () {
        ...
        if (this.selectedQualificationType) {
            ...
            titlesTemp.forEach(function (title) {
                _this.qualificationTitles.push({ label: title.labelValueList.label, value: title.labelValueList.value });
            });
            // show selected title
    ...
    __decorate([
        ...
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], QualificationPopupFormComponent.prototype, "display", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], QualificationPopupFormComponent.prototype, "isReadOnlyForm", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], QualificationPopupFormComponent.prototype, "displayChange", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], QualificationPopupFormComponent.prototype, "onValidated", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('component-data'),
        __metadata("design:type", Object)
    ], QualificationPopupFormComponent.prototype, "componentData", void 0);
    QualificationPopupFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-qualification-popup-form',
            template: __webpack_require__(/*! ./qualification-popup-form.component.html */ "./src/app/main/human-resources/employee-form/popups/qualification-popup-form/qualification-popup-form.component.html")
        }),
        __metadata("design:paramtypes", [_qualification_popup_form_service__WEBPACK_IMPORTED_MODULE_7__["QualificationPopupFormService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QualificationPopupFormService", function() { return QualificationPopupFormService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_api_bidt_qualification_api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../shared/api/bidt-qualification.api */ "./src/app/shared/api/bidt-qualification.api.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TrainingPopupFormComponent", function() { return TrainingPopupFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../shared/constants/generic-property-constants */ "./src/app/shared/constants/generic-property-constants.ts");
/* harmony import */ var _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../shared/enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
/* harmony import */ var _shared_services_message_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../shared/services/message.service */ "./src/app/shared/services/message.service.ts");
...
var TrainingPopupFormComponent = /** @class */ (function (_super) {
    ...
    function TrainingPopupFormComponent(messageService, sessionService, propertiesService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_2__["ComponentOpenMode"].Read, 'TrainingPopupFormComponent') || this;
        _this.messageService = messageService;
        _this.sessionService = sessionService;
        _this.propertiesService = propertiesService;
        _this.displayChange = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
    ...
    TrainingPopupFormComponent.prototype.loadRequestedbyList = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_1__["GenericPropertyConstants"].HR_TRAINING_ASKED_BY_MAP).subscribe(function (results) {
            _this.requestedByList = JSON.parse(JSON.stringify(results));
    ...
    __decorate([
        ...
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], TrainingPopupFormComponent.prototype, "display", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], TrainingPopupFormComponent.prototype, "isReadOnlyForm", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], TrainingPopupFormComponent.prototype, "displayChange", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], TrainingPopupFormComponent.prototype, "onValidated", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('component-data'),
        __metadata("design:type", Object)
    ], TrainingPopupFormComponent.prototype, "componentData", void 0);
    TrainingPopupFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-training-popup-form',
            template: __webpack_require__(/*! ./training-popup-form.component.html */ "./src/app/main/human-resources/employee-form/popups/training-popup-form/training-popup-form.component.html")
        }),
        __metadata("design:paramtypes", [_shared_services_message_service__WEBPACK_IMPORTED_MODULE_3__["MessageService"],
            _shared_services_session_service__WEBPACK_IMPORTED_MODULE_5__["SessionService"],
            _shared_services_properties_service__WEBPACK_IMPORTED_MODULE_4__["PropertiesService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WorkFlightTableFiltersComponent", function() { return WorkFlightTableFiltersComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../shared/enums/component-open-mode.enum */ "./src/app/shared/enums/component-open-mode.enum.ts");
...
var WorkFlightTableFiltersComponent = /** @class */ (function (_super) {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], WorkFlightTableFiltersComponent.prototype, "searchCriteria", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], WorkFlightTableFiltersComponent.prototype, "onFilter", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], WorkFlightTableFiltersComponent.prototype, "onReset", void 0);
    WorkFlightTableFiltersComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-work-flight-table-filters',
            template: __webpack_require__(/*! ./work-flight-table-filters.component.html */ "./src/app/main/human-resources/employee-form/work-flight-table-filters/work-flight-table-filters.component.html"),
            styles: [__webpack_require__(/*! ./work-flight-table-filters.component.scss */ "./src/app/main/human-resources/employee-form/work-flight-table-filters/work-flight-table-filters.component.scss")]
        }),
...
/* harmony import */ var _employee_search_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./employee-search.service */ "./src/app/main/human-resources/employee-search/employee-search.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var EmployeeSearchComponent = /** @class */ (function (_super) {
    ...
    function EmployeeSearchComponent(favoriteService, loaderService, messageService, serializationService, tabService, employeeSearchService, exportService, confirmationService) {
    ...
    EmployeeSearchComponent.prototype.deleteSelectedEmployees = function () {
        ...
        this.confirmationService.confirmDelete({
            ...
            accept: function () {
                ...
                _this.employeeSearchService.deleteEmployees(selectedBidtEmployees).subscribe(function (result) {
                    _this.search();
    ...
    EmployeeSearchComponent.prototype.openNewEmployee = function () {
        this.openEmployee(_shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__["ComponentOpenMode"].Create);
    };
    EmployeeSearchComponent.prototype.openSelectedEmployees = function () {
        var _this = this;
        this.selectedEmployees.forEach(function (employee) {
            _this.openEmployee(_shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_1__["ComponentOpenMode"].Read, employee);
        });
        this.selectedEmployees = [];
    };
    ...
    EmployeeSearchComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./employee-search.component.html */ "./src/app/main/human-resources/employee-search/employee-search.component.html"),
            styles: [__webpack_require__(/*! ./employee-search.component.scss */ "./src/app/main/human-resources/employee-search/employee-search.component.scss")]
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmployeeSearchService", function() { return EmployeeSearchService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_api_bidt_contract_api__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../shared/api/bidt-contract.api */ "./src/app/shared/api/bidt-contract.api.ts");
/* harmony import */ var _shared_api_bidt_employee_api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../shared/api/bidt-employee.api */ "./src/app/shared/api/bidt-employee.api.ts");
...
var EmployeeSearchService = /** @class */ (function (_super) {
    ...
    function EmployeeSearchService(http, appConfigService, bidtCompanyApi, bidtEmployeeApi, bidtSiteApi, bidtContractApi) {
        var _this = _super.call(this, http, appConfigService) || this;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HumanResourcesModule", function() { return HumanResourcesModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var primeng_tristatecheckbox__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! primeng/tristatecheckbox */ "./node_modules/primeng/tristatecheckbox.js");
/* harmony import */ var primeng_tristatecheckbox__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(primeng_tristatecheckbox__WEBPACK_IMPORTED_MODULE_14__);
...
/* harmony import */ var _shared_components_dialog_search_employee_dialog_search_employee_module__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../shared/components/dialog-search-employee/dialog-search-employee.module */ "./src/app/shared/components/dialog-search-employee/dialog-search-employee.module.ts");
/* harmony import */ var _shared_components_dynamic_attributes_dynamic_attributes_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../shared/components/dynamic-attributes/dynamic-attributes.service */ "./src/app/shared/components/dynamic-attributes/dynamic-attributes.service.ts");
...
/* harmony import */ var _employee_form_employee_form_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./employee-form/employee-form.component */ "./src/app/main/human-resources/employee-form/employee-form.component.ts");
/* harmony import */ var _employee_form_employee_form_service__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./employee-form/employee-form.service */ "./src/app/main/human-resources/employee-form/employee-form.service.ts");
/* harmony import */ var _employee_form_popups_absence_popup_form_absence_popup_form_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./employee-form/popups/absence-popup-form/absence-popup-form.component */ "./src/app/main/human-resources/employee-form/popups/absence-popup-form/absence-popup-form.component.ts");
/* harmony import */ var _employee_form_popups_document_popup_form_document_popup_form_module__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./employee-form/popups/document-popup-form/document-popup-form.module */ "./src/app/main/human-resources/employee-form/popups/document-popup-form/document-popup-form.module.ts");
/* harmony import */ var _employee_form_popups_document_url_popup_form_document_url_popup_form_module__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./employee-form/popups/document-url-popup-form/document-url-popup-form.module */ "./src/app/main/human-resources/employee-form/popups/document-url-popup-form/document-url-popup-form.module.ts");
/* harmony import */ var _employee_form_popups_evaluation_popup_form_evaluation_popup_form_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./employee-form/popups/evaluation-popup-form/evaluation-popup-form.component */ "./src/app/main/human-resources/employee-form/popups/evaluation-popup-form/evaluation-popup-form.component.ts");
/* harmony import */ var _employee_form_popups_expense_popup_form_expense_popup_form_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./employee-form/popups/expense-popup-form/expense-popup-form.component */ "./src/app/main/human-resources/employee-form/popups/expense-popup-form/expense-popup-form.component.ts");
/* harmony import */ var _employee_form_popups_holidays_popup_form_holidays_popup_form_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./employee-form/popups/holidays-popup-form/holidays-popup-form.component */ "./src/app/main/human-resources/employee-form/popups/holidays-popup-form/holidays-popup-form.component.ts");
/* harmony import */ var _employee_form_popups_hourly_costs_popup_form_hourly_costs_popup_form_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./employee-form/popups/hourly-costs-popup-form/hourly-costs-popup-form.component */ "./src/app/main/human-resources/employee-form/popups/hourly-costs-popup-form/hourly-costs-popup-form.component.ts");
/* harmony import */ var _employee_form_popups_medical_examination_popup_form_medical_examination_popup_form_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./employee-form/popups/medical-examination-popup-form/medical-examination-popup-form.component */ "./src/app/main/human-resources/employee-form/popups/medical-examination-popup-form/medical-examination-popup-form.component.ts");
/* harmony import */ var _employee_form_popups_qualification_popup_form_qualification_popup_form_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./employee-form/popups/qualification-popup-form/qualification-popup-form.component */ "./src/app/main/human-resources/employee-form/popups/qualification-popup-form/qualification-popup-form.component.ts");
/* harmony import */ var _employee_form_popups_qualification_popup_form_qualification_popup_form_service__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./employee-form/popups/qualification-popup-form/qualification-popup-form.service */ "./src/app/main/human-resources/employee-form/popups/qualification-popup-form/qualification-popup-form.service.ts");
/* harmony import */ var _employee_form_popups_training_popup_form_training_popup_form_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./employee-form/popups/training-popup-form/training-popup-form.component */ "./src/app/main/human-resources/employee-form/popups/training-popup-form/training-popup-form.component.ts");
/* harmony import */ var _employee_form_work_flight_table_filters_work_flight_table_filters_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./employee-form/work-flight-table-filters/work-flight-table-filters.component */ "./src/app/main/human-resources/employee-form/work-flight-table-filters/work-flight-table-filters.component.ts");
/* harmony import */ var _employee_planning_employee_planning_module__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./employee-planning/employee-planning.module */ "./src/app/main/human-resources/employee-planning/employee-planning.module.ts");
/* harmony import */ var _employee_search_employee_search_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./employee-search/employee-search.component */ "./src/app/main/human-resources/employee-search/employee-search.component.ts");
/* harmony import */ var _employee_search_employee_search_service__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./employee-search/employee-search.service */ "./src/app/main/human-resources/employee-search/employee-search.service.ts");
/* harmony import */ var _staff_alert_staff_alert_module__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./staff-alert/staff-alert.module */ "./src/app/main/human-resources/staff-alert/staff-alert.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var COMPONENTS = [_employee_form_work_flight_table_filters_work_flight_table_filters_component__WEBPACK_IMPORTED_MODULE_37__["WorkFlightTableFiltersComponent"]];
var DYNAMIC_COMPONENTS = [
    ...
    _employee_form_popups_absence_popup_form_absence_popup_form_component__WEBPACK_IMPORTED_MODULE_26__["AbsencePopupFormComponent"],
    _employee_form_popups_evaluation_popup_form_evaluation_popup_form_component__WEBPACK_IMPORTED_MODULE_29__["EvaluationPopupFormComponent"],
    _employee_form_popups_expense_popup_form_expense_popup_form_component__WEBPACK_IMPORTED_MODULE_30__["ExpensePopupFormComponent"],
    _employee_form_popups_holidays_popup_form_holidays_popup_form_component__WEBPACK_IMPORTED_MODULE_31__["HolidaysPopupFormComponent"],
    _employee_form_popups_hourly_costs_popup_form_hourly_costs_popup_form_component__WEBPACK_IMPORTED_MODULE_32__["HourlyCostsPopupFormComponent"],
    _employee_form_popups_medical_examination_popup_form_medical_examination_popup_form_component__WEBPACK_IMPORTED_MODULE_33__["MedicalExaminationPopupFormComponent"],
    _employee_form_popups_qualification_popup_form_qualification_popup_form_component__WEBPACK_IMPORTED_MODULE_34__["QualificationPopupFormComponent"],
    _employee_form_popups_training_popup_form_training_popup_form_component__WEBPACK_IMPORTED_MODULE_36__["TrainingPopupFormComponent"]
];
var SERVICES = [_employee_search_employee_search_service__WEBPACK_IMPORTED_MODULE_40__["EmployeeSearchService"], _employee_form_employee_form_service__WEBPACK_IMPORTED_MODULE_25__["EmployeeFormService"], _employee_form_popups_qualification_popup_form_qualification_popup_form_service__WEBPACK_IMPORTED_MODULE_35__["QualificationPopupFormService"], _shared_components_dynamic_attributes_dynamic_attributes_service__WEBPACK_IMPORTED_MODULE_20__["DynamicAttributesService"]];
    ...
    HumanResourcesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            imports: __spread([
                ...
                _shared_components_dialog_search_employee_dialog_search_employee_module__WEBPACK_IMPORTED_MODULE_19__["DialogSearchEmployeeModule"],
                _employee_form_popups_document_popup_form_document_popup_form_module__WEBPACK_IMPORTED_MODULE_27__["DocumentPopupFormModule"],
                _employee_form_popups_document_url_popup_form_document_url_popup_form_module__WEBPACK_IMPORTED_MODULE_28__["DocumentUrlPopupFormModule"],
