(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["engineering-management-operational-configuration-operational-configuration-module"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperationalConfigurationFormComponent", function() { return OperationalConfigurationFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _modules_purchase_contract_utils_label_value_helper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../modules/purchase-contract/utils/label-value-helper */ "./src/app/modules/purchase-contract/utils/label-value-helper.ts");
...
/* harmony import */ var _shared_pipes_format_select_option_pipe__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../shared/pipes/format-select-option.pipe */ "./src/app/shared/pipes/format-select-option.pipe.ts");
...
/* harmony import */ var _engineering_management_functional_location_form_functional_location_form_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../../engineering-management/functional-location-form/functional-location-form.service */ "./src/app/main/engineering-management/functional-location-form/functional-location-form.service.ts");
/* harmony import */ var _engineering_management_functional_location_search_functional_location_search_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../../../engineering-management/functional-location-search/functional-location-search.service */ "./src/app/main/engineering-management/functional-location-search/functional-location-search.service.ts");
...
/* harmony import */ var _operational_configuration_form_service__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./operational-configuration-form.service */ "./src/app/main/engineering-management/operational-configuration/form/operational-configuration-form.service.ts");
...
var OperationalConfigurationFormComponent = /** @class */ (function (_super) {
    ...
    function OperationalConfigurationFormComponent(favoriteService, loaderService, messageService, serializationService, tabService, inputValidationService, sessionService, translateService, confirmationService, operationalConfigurationFormService, functionalLocationFormService, functionalLocationSearchService, propertiesService, overlayService, formatSelectOption) {
    ...
    OperationalConfigurationFormComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_7__["ComponentConstants"].ENG_OPERATIONAL_CONFIGURATION_FORM;
    };
        ...
        if (this.componentData) {
            ...
            if (this.componentData.objectId && this.componentData.objectId.length > 0) {
                ...
                this.selectedFunctionalLocationComponent = {
                    flFunction: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].FAMILY_FUNCTION_AIRCRAFT_KEY,
                    statusState: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].FLOC_STATUS_DRAFT_KEY
                };
    ...
    OperationalConfigurationFormComponent.prototype.save = function () {
        var _this = this;
        if (!_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.selectedFunctionalLocationComponent.flCode) &&
            !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.selectedFunctionalLocationComponent.flDescription) &&
            !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.familyVariantCode) &&
            !_shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].isNullOrEmpty(this.selectedFunctionalLocationComponent.statusState)) {
            ...
            this.functionalLocationFormService.saveFlData(saveFunctionalLocationInput).subscribe(function (result) {
                if (!_this.isCreateOpenMode) {
                    _this.operationalConfigurationFormService.updateBidoOpeConfFls(_this.bidoOpeConfFlStructure).subscribe(function () {
    ...
    OperationalConfigurationFormComponent.prototype.setSubTitle = function () {
        this.subTitle = _shared_utils_string_utils__WEBPACK_IMPORTED_MODULE_21__["StringUtils"].orEmpty(this.selectedFunctionalLocationComponent.flDescription);
    ...
    OperationalConfigurationFormComponent.prototype.onFlStatusChanged = function (event) {
        var _this = this;
        if (event.value === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].FLOC_STATUS_CANCEL_KEY ||
            event.value === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].FLOC_STATUS_VALIDATED_KEY) {
    ...
    OperationalConfigurationFormComponent.prototype.loadFlFunction = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_8__["GenericPropertyConstants"].ITEM_FAMILY_CODE_MAP).subscribe(function (results) {
            _this.flFunctions = results || [];
        });
    };
    OperationalConfigurationFormComponent.prototype.loadFlStatusList = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_8__["GenericPropertyConstants"].FLOC_STATUS_MAP).subscribe(function (results) {
    ...
    OperationalConfigurationFormComponent.prototype.loadFamilyVariants = function () {
        ...
        this.functionalLocationSearchService.findBireVariantVersionsByFamilyFunctionAlternative().subscribe(function (results) {
            _this.familyVariants = results.map(function (element) { return element.labelValue; });
        });
    };
    ...
    OperationalConfigurationFormComponent.prototype.findBidoFlVariantsByFlCode = function () {
        ...
        if (!!this.selectedFunctionalLocationComponent.flCode) {
            ...
            this.functionalLocationFormService.findFamilyVariantByFlCode(bidoFlDTOId).subscribe(function (results) {
                if (results) {
    ...
    OperationalConfigurationFormComponent.prototype.findAndFetchStructureByFlCode = function (familyVariantCode) {
        ...
        this.operationalConfigurationFormService.findOpeConfFlTreeNode(bidoFlDTOId).subscribe(function (results) {
            if (!!results.data) {
        ...
        flTrees.forEach(function (tree) {
            if (tree.data) {
                ...
                if ((treeNode.children && treeNode.children.length > 0) ||
                    tree.data.flFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].ITEM_FAMILY_CODE_HARDPOINT_KEY) {
                    var opeConfFl = {};
    ...
    OperationalConfigurationFormComponent.prototype.cleanDuplicates = function (results) {
        ...
        results.forEach(function (bidoOpeConfFl) {
            var _bidoOpeConfFl = results.find(function (_opeConfFl) {
                return _opeConfFl.flCode === bidoOpeConfFl.flCode && _opeConfFl.superiorFlCode !== bidoOpeConfFl.superiorFlCode;
            });
            if (_bidoOpeConfFl) {
                ...
                if (!res.find(function (opeConf) { return opeConf.flCode === bidoOpeConfFl.flCode; })) {
                    res.push(bidoOpeConfFl);
                }
            }
        });
    ...
    OperationalConfigurationFormComponent.prototype.opeConfFLHasMoreParentThan = function (bidoOpeConfFl, _bidoOpeConfFl, results, counter) {
        if (bidoOpeConfFl &&
            _bidoOpeConfFl &&
            bidoOpeConfFl.superiorFlCode &&
            _bidoOpeConfFl.superiorFlCode &&
            counter < results.length) {
            return this.opeConfFLHasMoreParentThan(results.find(function (opeConf) { return opeConf.flCode === bidoOpeConfFl.superiorFlCode; }), results.find(function (opeConf) { return opeConf.flCode === _bidoOpeConfFl.superiorFlCode; }), results, counter + 1);
        }
    ...
    OperationalConfigurationFormComponent.prototype.fetchOpeConfFlChild = function (results, parentFlCode, children) {
        var _this = this;
        if (children) {
            children.forEach(function (treeNode) {
                if (treeNode.data && treeNode.data.flFunction === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_6__["AWPropertiesConstants"].ITEM_FAMILY_CODE_HARDPOINT_KEY) {
        ...
        if (!!opeConfFl && opeConfFl.length > 0) {
            ...
            this.operationalConfigurationFormService.createAllBidoOpeConfFl(opeConfFl).subscribe(function () {
                if (_this.selectedFunctionalLocationComponent.flCode) {
                    ...
                    _this.operationalConfigurationFormService.findOpeConfFlTreeNode(bidoFlDTOId).subscribe(function (opeConfTree) {
                        if (!!opeConfTree) {
        ...
        table.map(function (result) {
            if (result.data.flFunction) {
                result.data.flFunction =
                    _modules_purchase_contract_utils_label_value_helper__WEBPACK_IMPORTED_MODULE_4__["LabelValueHelper"].getLabelByValue(_this.flFunctions, result.data.flFunction) || result.data.flFunction;
            }
            if (result.children) {
    ...
    OperationalConfigurationFormComponent.prototype.addNewStructure = function (concernedStructure) {
        ...
        if (this.selectedStructure[0] && this.selectedStructure[0].data.flCode) {
            if (concernedStructure.flCode) {
                this.functionalLocationFormService.findStructureByFlCode(concernedStructure.flCode).subscribe(function (flTree) {
                    if (flTree.data) {
    ...
    OperationalConfigurationFormComponent.prototype.addTreeNodeToStructure = function (tempTree) {
        ...
        if (!!bireStructureChild) {
            ...
            if (!searchInStructureTableChildren) {
                ...
                this.getTranslateKey('errorAlreadyConcernedStructureExist'), "(" + searchInStructureTableChildren.join(', ') + ")");
            }
        }
    };
    OperationalConfigurationFormComponent.prototype.addAllBidoOpeConfFlFromTree = function (tempTree, flCode) {
        ...
        if (tempTree.children && tempTree.children.length > 0) {
            tempTree.children.forEach(function (childTmpTree) { return _this.addAllBidoOpeConfFlFromTree(childTmpTree, tempTree.data.flCode); });
        }
    };
    OperationalConfigurationFormComponent.prototype.searchRecursively = function (tempTree, result) {
        var _this = this;
        if (result === void 0) { result = { isPresent: undefined }; }
        if (!!this.bidoOpeConfFlStructure.find(function (value) { return value.flCode === tempTree.data.flCode; })) {
            if (!result.isPresent) {
                result.isPresent = [];
            }
    ...
    OperationalConfigurationFormComponent.prototype.updateConcernedStructure = function (concernedStructure) {
        var _this = this;
        var searchInStructureTableChildren = this.bidoOpeConfFlStructure.find(function (value) { return value.flCode === concernedStructure.flCode; });
        if (!searchInStructureTableChildren) {
            var opeConfToUpdate_1 = this.bidoOpeConfFlStructure.find(function (value) { return value.flCode === _this.selectedStructure[0].data.flCode; });
            if (opeConfToUpdate_1) {
                this.bidoOpeConfFlStructure
                    .filter(function (opeConf) { return opeConf.superiorFlCode === opeConfToUpdate_1.flCode; })
        ...
        this.confirmationService.confirmDelete({
            ...
            accept: function () {
                _this.selectedStructure.forEach(function (element) {
                    _this.deleteCascadeOpeConf(_this.bidoOpeConfFlStructure.find(function (opeConf) { return opeConf.flCode === element.data.flCode; }));
    ...
    OperationalConfigurationFormComponent.prototype.deleteCascadeOpeConf = function (flCode) {
        if (flCode) {
            ...
            this.bidoOpeConfFlStructure = this.bidoOpeConfFlStructure.filter(function (opeConf) { return !listOfFlCodeToDelete_1.find(function (opeConfToDelete) { return opeConf.flCode === opeConfToDelete.flCode; }); });
        }
    };
    OperationalConfigurationFormComponent.prototype.fetchListOfFlCodeToDelete = function (listOfFlCodeToDelete, flCode, counter) {
        var _this = this;
        if (counter === void 0) { counter = 0; }
        var childToDelete = this.bidoOpeConfFlStructure.filter(function (confOpe) { return confOpe.superiorFlCode === flCode.flCode; });
    ...
    OperationalConfigurationFormComponent.prototype.showStatus = function () {
        ...
        var overlayRef = this.overlayService.openWithPositionCenter({
            ...
            data: {
                ...
                currentStatus: {
                    label: this.formatSelectOption.transform(this.selectedFunctionalLocationComponent.statusState, this.flStatusList),
    ...
    OperationalConfigurationFormComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./operational-configuration-form.component.html */ "./src/app/main/engineering-management/operational-configuration/form/operational-configuration-form.component.html"),
            styles: [__webpack_require__(/*! ./operational-configuration-form.component.scss */ "./src/app/main/engineering-management/operational-configuration/form/operational-configuration-form.component.scss")]
        }),
        __metadata("design:paramtypes", [_shared_services_favorite_service__WEBPACK_IMPORTED_MODULE_12__["FavoriteService"],
            ...
            _operational_configuration_form_service__WEBPACK_IMPORTED_MODULE_26__["OperationalConfigurationFormService"],
            _engineering_management_functional_location_form_functional_location_form_service__WEBPACK_IMPORTED_MODULE_22__["FunctionalLocationFormService"],
            _engineering_management_functional_location_search_functional_location_search_service__WEBPACK_IMPORTED_MODULE_23__["FunctionalLocationSearchService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperationalConfigurationFormService", function() { return OperationalConfigurationFormService; });
...
var OperationalConfigurationFormService = /** @class */ (function (_super) {
    ...
    OperationalConfigurationFormService.prototype.findFlsTreeNodeByFamilyVariant = function (familyVariant) {
        return _super.prototype.post.call(this, this.fleetManagementApi.findFlsTreeNodeByFamilyVariant, familyVariant);
    };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperationalConfigurationModule", function() { return OperationalConfigurationModule; });
...
/* harmony import */ var _shared_components_dialog_search_customer_dialog_search_customer_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../shared/components/dialog-search-customer/dialog-search-customer.module */ "./src/app/shared/components/dialog-search-customer/dialog-search-customer.module.ts");
/* harmony import */ var _shared_components_dialog_search_functional_location_dialog_search_functional_location_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../shared/components/dialog-search-functional-location/dialog-search-functional-location.module */ "./src/app/shared/components/dialog-search-functional-location/dialog-search-functional-location.module.ts");
/* harmony import */ var _shared_components_dialog_search_item_dialog_search_item_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../../shared/components/dialog-search-item/dialog-search-item.module */ "./src/app/shared/components/dialog-search-item/dialog-search-item.module.ts");
/* harmony import */ var _shared_components_dialog_search_model_dialog_search_model_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../shared/components/dialog-search-model/dialog-search-model.module */ "./src/app/shared/components/dialog-search-model/dialog-search-model.module.ts");
/* harmony import */ var _shared_components_dialog_status_dialog_status_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../shared/components/dialog-status/dialog-status.module */ "./src/app/shared/components/dialog-status/dialog-status.module.ts");
...
/* harmony import */ var _flight_operations_flight_search_search_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../flight-operations/flight/search/search.service */ "./src/app/main/flight-operations/flight/search/search.service.ts");
/* harmony import */ var _functional_location_form_functional_location_form_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../functional-location-form/functional-location-form.service */ "./src/app/main/engineering-management/functional-location-form/functional-location-form.service.ts");
/* harmony import */ var _functional_location_search_functional_location_search_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../functional-location-search/functional-location-search.service */ "./src/app/main/engineering-management/functional-location-search/functional-location-search.service.ts");
/* harmony import */ var _form_operational_configuration_form_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./form/operational-configuration-form.component */ "./src/app/main/engineering-management/operational-configuration/form/operational-configuration-form.component.ts");
/* harmony import */ var _form_operational_configuration_form_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./form/operational-configuration-form.service */ "./src/app/main/engineering-management/operational-configuration/form/operational-configuration-form.service.ts");
/* harmony import */ var _search_operational_configuration_search_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./search/operational-configuration-search.component */ "./src/app/main/engineering-management/operational-configuration/search/operational-configuration-search.component.ts");
/* harmony import */ var _search_operational_configuration_search_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./search/operational-configuration-search.service */ "./src/app/main/engineering-management/operational-configuration/search/operational-configuration-search.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var INTERNAL_MODULES = [
    ...
    _shared_components_dialog_search_item_dialog_search_item_module__WEBPACK_IMPORTED_MODULE_11__["DialogSearchItemModule"],
    _shared_components_dialog_search_model_dialog_search_model_module__WEBPACK_IMPORTED_MODULE_12__["DialogSearchModelModule"],
    _shared_components_dialog_search_functional_location_dialog_search_functional_location_module__WEBPACK_IMPORTED_MODULE_10__["DialogSearchFunctionalLocationModule"],
 ...
 *************************************************************************** */
var COMPONENTS = [];
var DYNAMIC_COMPONENTS = [_search_operational_configuration_search_component__WEBPACK_IMPORTED_MODULE_22__["OperationalConfigurationSearchComponent"], _form_operational_configuration_form_component__WEBPACK_IMPORTED_MODULE_20__["OperationalConfigurationFormComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [
    _flight_operations_flight_search_search_service__WEBPACK_IMPORTED_MODULE_17__["SearchService"],
    _functional_location_form_functional_location_form_service__WEBPACK_IMPORTED_MODULE_18__["FunctionalLocationFormService"],
    _functional_location_search_functional_location_search_service__WEBPACK_IMPORTED_MODULE_19__["FunctionalLocationSearchService"],
    _form_operational_configuration_form_service__WEBPACK_IMPORTED_MODULE_21__["OperationalConfigurationFormService"],
    _search_operational_configuration_search_service__WEBPACK_IMPORTED_MODULE_23__["OperationalConfigurationSearchService"]
];
    ...
    OperationalConfigurationModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: __spread([
                ...
                _shared_components_dialog_search_customer_dialog_search_customer_module__WEBPACK_IMPORTED_MODULE_9__["DialogSearchCustomerModule"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperationalConfigurationSearchComponent", function() { return OperationalConfigurationSearchComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _modules_purchase_contract_utils_label_value_helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../modules/purchase-contract/utils/label-value-helper */ "./src/app/modules/purchase-contract/utils/label-value-helper.ts");
...
/* harmony import */ var _engineering_management_functional_location_search_functional_location_search_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../engineering-management/functional-location-search/functional-location-search.service */ "./src/app/main/engineering-management/functional-location-search/functional-location-search.service.ts");
/* harmony import */ var _operational_configuration_search_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./operational-configuration-search.service */ "./src/app/main/engineering-management/operational-configuration/search/operational-configuration-search.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var OperationalConfigurationSearchComponent = /** @class */ (function (_super) {
    ...
    function OperationalConfigurationSearchComponent(favoriteService, loaderService, messageService, serializationService, tabService, functionalLocationSearchService, operationalConfigurationSearchService, propertiesService, exportService, confirmationService) {
    ...
    OperationalConfigurationSearchComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_3__["ComponentConstants"].ENG_OPERATIONAL_CONFIGURATION_SEARCH;
    };
    ...
    OperationalConfigurationSearchComponent.prototype.loadFlStatusList = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_4__["GenericPropertyConstants"].FLOC_STATUS_MAP).subscribe(function (results) {
            _this.flStatusList = results || [];
        });
    };
    ...
    OperationalConfigurationSearchComponent.prototype.loadFunctionalLocations = function () {
        ...
        this.operationalConfigurationSearchService.searchOperationalConfigurationList(criteria).subscribe(function (results) {
            if (results) {
                var rows = results.list.map(function (result) { return ({
                    ...
                    familyVariantLabel: _modules_purchase_contract_utils_label_value_helper__WEBPACK_IMPORTED_MODULE_1__["LabelValueHelper"].getLabelByValue(_this.familyVariants, result.familyVariantCode),
                    statusStateLabel: _modules_purchase_contract_utils_label_value_helper__WEBPACK_IMPORTED_MODULE_1__["LabelValueHelper"].getLabelByValue(_this.flStatusList, (result.bidoFlDTO || {}).statusState)
                }); });
    ...
    OperationalConfigurationSearchComponent.prototype.openOperationalconfigurationLink = function (functionLocation) {
        if (functionLocation) {
            ...
            this.openOperationalconfiguration(selectedObjectId, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_5__["ComponentOpenMode"].Read);
        }
    };
    ...
    OperationalConfigurationSearchComponent.prototype.openSelectedOperationalconfiguration = function () {
        ...
        this.resultsTableDataSource.dataSelection.forEach(function (opConfigRow) {
            if (opConfigRow && opConfigRow.bidoFlDTO) {
                ...
                _this.openOperationalconfiguration(selectedObjectId, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_5__["ComponentOpenMode"].Read);
            }
        });
    };
                    ...
                    _this.resultsTableDataSource.dataSelection.forEach(function (opConfigRow) {
                        if (opConfigRow && opConfigRow.bidoFlDTO) {
                            ...
                            if (!!flCode) {
                                ...
                                _super.prototype.throwUnboundLocalError.call(_this, 'deleteSelectedOperationalConfiguration', 'functionLocation.flCode');
                            }
                        }
                    });
    ...
    OperationalConfigurationSearchComponent.prototype.exportTable = function () {
        if (!!this.componentData) {
            this.exportService.toExcel(this.resultsTableDataSource.sanitizedData.map(function (opConfRow) { return ({
    ...
    OperationalConfigurationSearchComponent.prototype.openNewFunctionalLocation = function () {
        this.openOperationalconfiguration(undefined, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_5__["ComponentOpenMode"].Create);
    };
    // tslint:disable-next-line:no-any
    OperationalConfigurationSearchComponent.prototype.openOperationalconfiguration = function (objectId, openMode) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_3__["ComponentConstants"].ENG_OPERATIONAL_CONFIGURATION_FORM,
    ...
    OperationalConfigurationSearchComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./operational-configuration-search.component.html */ "./src/app/main/engineering-management/operational-configuration/search/operational-configuration-search.component.html")
        }),
        __metadata("design:paramtypes", [_shared_services_favorite_service__WEBPACK_IMPORTED_MODULE_8__["FavoriteService"],
            ...
            _engineering_management_functional_location_search_functional_location_search_service__WEBPACK_IMPORTED_MODULE_15__["FunctionalLocationSearchService"],
            _operational_configuration_search_service__WEBPACK_IMPORTED_MODULE_16__["OperationalConfigurationSearchService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperationalConfigurationSearchService", function() { return OperationalConfigurationSearchService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_api_fleet_management_api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../shared/api/fleet-management.api */ "./src/app/shared/api/fleet-management.api.ts");
/* harmony import */ var _shared_http_abstract_aw_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../shared/http/abstract-aw-http */ "./src/app/shared/http/abstract-aw-http.ts");
...
var OperationalConfigurationSearchService = /** @class */ (function (_super) {
    ...
    OperationalConfigurationSearchService.prototype.searchOperationalConfigurationList = function (criteria) {
        return _super.prototype.post.call(this, this.fleetManagementApi.findOperationalConfigurationBySearchCriteria, criteria);
    };
...
var SearchService = /** @class */ (function (_super) {
    ...
    SearchService.prototype.findAllEmployeeByQualificationCode = function (qualificationCode) {
        return _super.prototype.post.call(this, this.bidtEmployeeApi.findAllEmployeeByQualificationCode, qualificationCode);
    };
    ...
    SearchService.prototype.findEquipmentEngineListByEquipmentCode = function (input) {
        return _super.prototype.post.call(this, this.fleetManagementApi.findEquipmentEngineListByEquipmentCode, input);
    };
    SearchService.prototype.findReplenishmentByMissionEquipmentAndTypeAndEquipmentCode = function (input) {
        return _super.prototype.post.call(this, this.fleetManagementApi.findReplenishmentByMissionEquipmentAndTypeAndEquipmentCode, input);
    };
