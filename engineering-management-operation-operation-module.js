(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["engineering-management-operation-operation-module"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DialogComponentsComponent", function() { return DialogComponentsComponent; });
...
/* harmony import */ var _shared_constants_lang_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../shared/constants/lang-constants */ "./src/app/shared/constants/lang-constants.ts");
...
/* harmony import */ var _shared_utils_label_value_utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../../../shared/utils/label-value-utils */ "./src/app/shared/utils/label-value-utils.ts");
/* harmony import */ var _operation_form_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../operation-form.service */ "./src/app/main/engineering-management/operation/form/operation-form.service.ts");
...
var DialogComponentsComponent = /** @class */ (function (_super) {
    ...
    function DialogComponentsComponent(inputValidationService, loaderService, operationFormService, translateService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_5__["ComponentOpenMode"].Read, 'DialogComponentsComponent') || this;
        ...
        _this.ingredientToolType = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_INGREDIENT_KEY;
        _this.partType = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_PART_KEY;
        _this.subcontractingType = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_SUBCONTRACTING_KEY;
        _this.loadPnTypes();
        _this.translateService.onLangChange.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(_this.unsubscribe)).subscribe(function () {
    ...
    DialogComponentsComponent.prototype.ngOnInit = function () {
        ...
        if (!!this.operationComponent && !!this.operationComponent.pnCode) {
            _shared_utils_label_value_utils__WEBPACK_IMPORTED_MODULE_9__["LabelValueUtils"].labelToStringValue(this.operationComponent, 'type', this.pnTypes);
            switch (this.operationComponent.type) {
                case _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_PART_KEY: {
                    this.partPnCode = this.operationComponent.pnCode;
                    break;
                }
                case _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_SUBCONTRACTING_KEY: {
    ...
    DialogComponentsComponent.prototype.setLayout = function () {
        if (this.isNewComponentForm) {
            ...
            if (!!this.operationComponent) {
                ...
                if (this.operationComponent.type === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_PART_KEY) {
                    this.partPnCode = this.operationComponent.pnCode;
                }
                else if (this.operationComponent.type === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_SUBCONTRACTING_KEY) {
                    this.subcontractingPnCode = this.operationComponent.pnCode;
                }
                else {
                    this.ingredientToolPnCode = this.operationComponent.pnCode;
        ...
        if (!!this.operationComponent) {
            switch ($event.value) {
                case _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_PART_KEY: {
                    ...
                    this.operationComponent.type = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_PART_KEY;
                    break;
                }
                case _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_SUBCONTRACTING_KEY: {
                    ...
                    this.partPnCode = '';
                    this.componentQuantity = '';
                    this.operationComponent.type = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_SUBCONTRACTING_KEY;
                    break;
                }
                case _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_STANDARD_TOOL_KEY: {
                    this.operationComponent.componentType = this.ingredientToolType;
                    this.partPnCode = '';
                    this.subcontractingPnCode = '';
                    this.componentQuantity = '';
                    this.operationComponent.type = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_STANDARD_TOOL_KEY;
                    break;
                }
                case _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_SPECIFIC_TOOL_KEY: {
                    this.operationComponent.componentType = this.ingredientToolType;
                    this.partPnCode = '';
                    this.subcontractingPnCode = '';
                    this.componentQuantity = '';
                    this.operationComponent.type = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_SPECIFIC_TOOL_KEY;
                    break;
                }
                default: {
                    this.operationComponent.componentType = this.ingredientToolType;
    ...
    DialogComponentsComponent.prototype.loadComponentTypeList = function () {
        if (this.translateService.currentLang === _shared_constants_lang_constants__WEBPACK_IMPORTED_MODULE_4__["LangConstants"].ENGLISH_CODE) {
            this.componentTypeList = [
                { label: 'Ingredient/Tool', value: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_INGREDIENT_KEY },
                { label: 'Part', value: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_PART_KEY },
                { label: 'Subcontracting', value: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_SUBCONTRACTING_KEY }
            ];
        }
        else if (this.translateService.currentLang === _shared_constants_lang_constants__WEBPACK_IMPORTED_MODULE_4__["LangConstants"].FRENCH_CODE) {
            this.componentTypeList = [
                { label: 'Ingrédient/Outil', value: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_INGREDIENT_KEY },
                { label: 'Article', value: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_PART_KEY },
                { label: 'Sous-traitance', value: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_SUBCONTRACTING_KEY }
            ];
        }
    };
    ...
    DialogComponentsComponent.prototype.cancel = function () {
        ...
        this.operationFormService.getPnTypeMap().subscribe(function (results) {
            ...
            if (!!_this.operationComponent && !!_this.operationComponent.type) {
                _this.operationComponent.type = pnTypesList.filter(function (pnType) { return !!_this.operationComponent && pnType.value === _this.operationComponent.type; })[0].label;
            }
        });
        this.display = false;
    };
    DialogComponentsComponent.prototype.searchIngredientTool = function () {
        this.partsSearch = {
            type: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_INGREDIENT_KEY
        };
    ...
    DialogComponentsComponent.prototype.searchPart = function () {
        this.partsSearch = {
            type: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_PART_KEY
        };
        this.selectedPnType = this.partsSearch.type;
        this.showPnAfterDialog = true;
    };
    DialogComponentsComponent.prototype.searchSubcontracting = function () {
        this.partsSearch = {
            type: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_SUBCONTRACTING_KEY
        };
        this.selectedPnType = this.partsSearch.type;
        this.showPnAfterDialog = true;
    };
    ...
    DialogComponentsComponent.prototype.onSelectedComponent = function (data) {
        ...
        if (!!this.operationComponent && !!pn) {
            ...
            this.isValid =
                !!this.operationComponent && !!this.operationComponent.pnCode && this.operationComponent.pnCode.length > 0;
            if (!!this.operationComponent && this.operationComponent.type === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_PART_KEY) {
                this.ingredientToolType = '';
                this.partType = this.operationComponent.type;
                this.subcontractingType = '';
                this.partPnCode = this.operationComponent.pnCode;
            }
            else if (!!this.operationComponent &&
                this.operationComponent.type === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_SUBCONTRACTING_KEY) {
                this.ingredientToolType = '';
                this.partType = '';
                ...
                this.ingredientToolType = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_3__["AWPropertiesConstants"].PN_TYPE_INGREDIENT_KEY;
                this.operationComponent.componentType = this.ingredientToolType;
                this.partType = '';
                this.subcontractingType = '';
    ...
    __decorate([
        ...
        __metadata("design:type", Object)
    ], DialogComponentsComponent.prototype, "operationComponent", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], DialogComponentsComponent.prototype, "isReadOnlyComponentDialog", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], DialogComponentsComponent.prototype, "onValidated", void 0);
    DialogComponentsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-dialog-component',
            template: __webpack_require__(/*! ./dialog-components.component.html */ "./src/app/main/engineering-management/operation/form/dialog-components/dialog-components.component.html")
        }),
...
/* harmony import */ var _shared_utils_settings_utils__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ../../../../shared/utils/settings-utils */ "./src/app/shared/utils/settings-utils.ts");
...
/* harmony import */ var _operation_form_service__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./operation-form.service */ "./src/app/main/engineering-management/operation/form/operation-form.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var OperationFormComponent = /** @class */ (function (_super) {
    ...
    function OperationFormComponent(messageService, tabService, loaderService, favoriteService, pageTocService, serializationService, inputValidationService, confirmationService, updateHistoricService, propertiesService, updateHistoricApi, dynamicAttributesService, translateService, operationFormService, dateService, _overlayService, _formatSelectOption) {
    ...
    OperationFormComponent.prototype.initComponentsTableDataSource = function () {
        this.componentsTableDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_6__["TableDataSource"]({
    ...
    OperationFormComponent.prototype.initDocumentsTableDataSource = function () {
        this.documentsTableDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_6__["TableDataSource"]({
            allowMultiSelect: true,
            columns: [
                {
                    field: 'docName',
    ...
    OperationFormComponent.prototype.ngOnInit = function () {
        ...
        if (this.componentData) {
            ...
            var context = !!this.componentData.objectId
                ? this.serializationService.deserialize(this.componentData.objectId).opeCode + "|" + this.serializationService.deserialize(this.componentData.objectId).opeVersion + "|" + this.serializationService.deserialize(this.componentData.objectId).rangeCode
                : 'tab.createMode';
    ...
    OperationFormComponent.prototype.openStatusUpdatesPopup = function () {
        ...
        var columns = [
            { field: 'timestamp', width: '200px', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input, isDate: true },
            { field: 'statusUser', width: '200px', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'action', width: '200px', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'statusState', width: '250px', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'opeSequenceNumber', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'opeDesignation', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'opeDescription', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'opeChapter', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'opeSection', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'opeSubject', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'opeSheet', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'opeMark', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'opeCost', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'opeDurationTime', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'opeWorkcenter', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'opeManHour', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'opeQualification', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'technicalLevel', alignment: 'left', width: '6.25rem', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input }
        ];
    ...
    OperationFormComponent.prototype.loadOperation = function () {
        ...
        var observables = [
            ...
            this.getDynamicAttributesObservable(_shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].MCH_ATTRIBUTE_CATEGORY_OPERATION_KEY)
        ];
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["forkJoin"])(observables).subscribe(function (results) {
            if (results) {
                ...
                if (!!_this.componentData.objectId && !_this.isCreateOpenMode) {
                    ...
                    _this.operationFormService.findBireOperation(_this.operationId).subscribe(function (result) {
                        _this.operation = result;
                        if (_this.operation && _this.operation.opeCode && _this.operation.opeVersion && _this.operation.rangeCode) {
                            ...
                            if (_this.operation.opeQualification) {
                                _this.qualif = _this.qualifications.find(function (qualification) { return qualification.qualificationCode === _this.operation.opeQualification; });
                    ...
                    _this.operation.statusState = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].AIRM_OPERATION_STATUS_ONGOING;
                }
            }
        });
    };
    OperationFormComponent.prototype.loadOperationStatus = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_9__["GenericPropertyConstants"].FUNC_OBJECT_STATUS_MAP).subscribe(function (results) {
    ...
    OperationFormComponent.prototype.saveOperation = function () {
        var _this = this;
        if (this.operation.opeCode === null ||
            ...
            var componentsUpdated = this.components.filter(function (component) {
                return !_this.addedComponentsList.some(function (addedComponents) {
                    return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__["DTOUtils"].equalsBireOperationPnDTO(component, addedComponents);
                });
            });
            ...
            var documentsUpdated = this.documentsTableDataSource.dataSrc.filter(function (document) {
                return !_this.documentsAdded.some(function (documentAdded) {
                    return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__["DTOUtils"].equalsBireDocumentDTO(document._obj, documentAdded._obj);
                });
            });
            this.bireOperationAttributes = this.dynamicAttributesService.toBireOperationAttributeId(this.operation.opeCode, this.operation.rangeCode, this.operation.opeVersion, this.dynamicAttributes);
    ...
    OperationFormComponent.prototype.createOperation = function (saveBireOperationInput) {
        ...
        if (!!this.componentData) {
            ...
            this.operationFormService.createBireOperation(saveBireOperationInput).subscribe(function () {
                _this.save();
    ...
    OperationFormComponent.prototype.updateOperation = function (saveBireOperationInput) {
        var _this = this;
        this.showSaveSpinner = true;
        this.operationFormService.updateBireOperation(saveBireOperationInput).subscribe(function () {
            _this.save();
    ...
    OperationFormComponent.prototype.searchRangeCode = function () {
        var rangeCodeTableCols = [
            { field: 'rangeCode', alignment: 'left', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input },
            { field: 'description', alignment: 'left', filterMode: _shared_enums_table_column_filter_mode_enum__WEBPACK_IMPORTED_MODULE_11__["TableColumnFilterMode"].Input }
        ];
        try {
            this.rangeCodeTableData = {
                ...
                dataKey: undefined,
                selectionMode: _shared_enums_table_selection_mode_enum__WEBPACK_IMPORTED_MODULE_12__["TableSelectionMode"].Single,
                globalFilter: true
            };
    ...
    OperationFormComponent.prototype.loadTechnicalLevelsList = function () {
        var _this = this;
        this.operationFormService.findAllBireTils(undefined).subscribe(function (results) {
    ...
    OperationFormComponent.prototype.onTilSelected = function (event) {
        if (!!this.til) {
            ...
            if (this.operation.technicalLevel !== undefined) {
                var til = this.technicalLevelsToDisplayList.filter(function (name) { return name.value.toString() === event.value; })[0];
                if (!!til) {
    ...
    OperationFormComponent.prototype.loadQualificationsList = function () {
        var _this = this;
        this.operationFormService.findAllBireQualificationDatas(undefined).subscribe(function (results) {
            ...
            results.forEach(function (result) {
                if (!!result.qualificationCode) {
                    ...
                    _super.prototype.throwUnboundLocalError.call(_this, 'loadQualificationsList', 'result.qualificationCode');
                }
            });
        }, function () {
    ...
    OperationFormComponent.prototype.loadWorkCenterList = function () {
        var _this = this;
        this.operationFormService.findByCriteriaWorkshop().subscribe(function (results) {
            results.forEach(function (result) {
    ...
    OperationFormComponent.prototype.setHasHourlyRateValue = function () {
        ...
        if (this.operation.opeQualification) {
            var selectedQualification = this.qualifications.find(function (qualification) { return qualification.qualificationCode === _this.operation.opeQualification; });
    ...
    OperationFormComponent.prototype.onChangeQualification = function (event) {
        ...
        if (event.value !== undefined) {
            var qual = this.qualificationsToDisplayList.filter(function (name) { return name.value === event.value; })[0];
            this.qualif = {
            ...
            if (this.operation.opeQualification) {
                this.qualif = this.qualifications.find(function (qualification) { return qualification.qualificationCode === _this.operation.opeQualification; });
    ...
    OperationFormComponent.prototype.setQualifRateCurrencyLabelByValue = function () {
        var _this = this;
        this.operationFormService.getCurrencyMap().subscribe(function (results) {
            var index = results.findIndex(function (element) { return !!_this.qualif && (+element - 1).toString() === _this.qualif.rateCurrency; });
                ...
                if (cost !== undefined && cost !== 0) {
                    ...
                    if (!!_this.operation &&
                        ...
                        _this.operationFormService
                            .calculateCostOfBireOperationForAircraftMaintenance(_this.operation.opeManHour, _this.operation.opeQualification, _this.operation.opeDurationTime, _this.operation)
    ...
    OperationFormComponent.prototype.loadComponents = function () {
        ...
        this.operationFormService.findBireOperationPnsByOperation(this.operationId).subscribe(function (resultsFindBireOperationPnsByOperation) {
            var e_1, _a;
    ...
    OperationFormComponent.prototype.editComponents = function () {
        ...
        if (this.componentsTableDataSource.dataSelectionCount === 1) {
            var selectedCompo_1 = this.buildBireOperationPnDTOFromOperationPnElement(this.componentsTableDataSource.dataSelection[0]);
            this.currentComponentIndex = this.components.findIndex(function (component) {
                return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__["DTOUtils"].equalsBireOperationPnDTO(component, selectedCompo_1);
            });
            ...
            if (!!this.currentComponent && !!this.currentComponent.type) {
                var type = this.pnTypes.filter(function (pnType) { return !!_this.currentComponent && pnType.label === _this.currentComponent.type; })[0];
                if (!!type) {
    ...
    OperationFormComponent.prototype.deleteComponents = function () {
        var _this = this;
        var partialMessageKey = this.componentsTableDataSource.dataSelectionCount > 1
            ...
            accept: function () {
                _this.componentsTableDataSource.dataSelection.forEach(function (selectedOperationPn) {
                    ...
                    var componentsAddedWithoutSelection = _this.addedComponentsList.filter(function (componentAdded) {
                        return !_shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__["DTOUtils"].equalsBireOperationPnDTO(selectedComponent, componentAdded);
                    });
                ...
                _this.components = _this.components.filter(function (component) {
                    return !_this.componentsTableDataSource.dataSelection.some(function (selectedOperationPn) {
                        var selectedComponent = _this.buildBireOperationPnDTOFromOperationPnElement(selectedOperationPn);
                        return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__["DTOUtils"].equalsBireOperationPnDTO(component, selectedComponent);
                    });
                });
                _this.componentsTableDataSource.setData(_this.componentsTableDataSource.dataSrc.filter(function (operationPn) {
                    return !_this.componentsTableDataSource.dataSelection.some(function (selectedOperationPn) {
                        return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__["DTOUtils"].equalsBireOperationPnDTO(operationPn, selectedOperationPn);
                    });
                }));
    ...
    OperationFormComponent.prototype.onValidateComponent = function (opeCompo) {
        if (!!opeCompo) {
            if (opeCompo.type === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].PN_TYPE_SUBCONTRACTING_KEY) {
            ...
            if (this.currentComponentIndex !== -1) {
                if (this.currentComponentIndex !== null && this.currentComponentIndex !== undefined) {
                    if (!!opeCompo.type) {
                        opeCompoTyped.type =
                            this.pnTypes.filter(function (pnType) { return pnType.value === opeCompo.type; })[0] &&
                                this.pnTypes.filter(function (pnType) { return pnType.value === opeCompo.type; })[0].label;
                    }
                    this.components[this.currentComponentIndex] = operationPn_1;
                    this.componentsTableDataSource.replaceData(this.componentsTableDataSource.dataSelection[0], this.addComponentRow(opeCompoTyped));
                    var updatedOperationComponentIndex = this.updatedComponentsList.findIndex(function (updatedComponent) {
                        return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__["DTOUtils"].equalsBireOperationPnDTO(updatedComponent, operationPn_1);
                    });
                    ...
                    _super.prototype.throwUnboundLocalError.call(this, 'onValidateComponent', 'this.currentComponentIndex');
                }
            }
            else {
                var rowWithPnCodeExists = this.componentsTableDataSource.dataSrc.some(function (comp) { return comp.pnCode === opeCompo.pnCode; });
                if (!rowWithPnCodeExists) {
                    var isAdded = this.addedComponentsList.some(function (newAddedOperationPn) {
                        return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__["DTOUtils"].equalsBireOperationPnDTO(operationPn_1, newAddedOperationPn);
                    });
                    if (isAdded) {
        ...
        if (!!component && !!component.pnCode) {
            ...
            this.operationFormService.findBirePn(pnId).subscribe(function (resultsFindBirePn) {
                ...
                if (componentPnDTO.pnType !== null && componentPnDTO.pnType !== undefined) {
                    var type = _this.pnTypes.filter(function (pnType) { return pnType.value === componentPnDTO.pnType; })[0];
                    if (!!type) {
                ...
                switch (componentPnDTO.pnType) {
                    case _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].PN_TYPE_PART_KEY:
                        operationComponentTyped.componentType = componentPnDTO.pnType;
                        break;
                    case _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].PN_TYPE_SUBCONTRACTING_KEY:
                        operationComponentTyped.componentType = componentPnDTO.pnType;
                        break;
                    default:
                        operationComponentTyped.componentType = _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].PN_TYPE_INGREDIENT_KEY;
                        break;
                }
    ...
    OperationFormComponent.prototype.redirect = function (rowData) {
        var _this = this;
        if (rowData.componentType === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].PN_TYPE_PART_KEY) {
            this.goToPartNumber(rowData.pnCode, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_10__["ComponentOpenMode"].Read);
        }
        else {
            if (!!rowData.pnCode) {
                var pnId = { pnCode: rowData.pnCode };
                this.operationFormService.findBirePn(pnId).subscribe(function (result) {
                    _this.goToMaterial(result, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_10__["ComponentOpenMode"].Read);
                });
            }
        }
    };
    ...
    OperationFormComponent.prototype.goToMaterial = function (objectId, openMode) {
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_8__["ComponentConstants"].LOG_MATERIAL_FORM,
            openMode: openMode
        };
        if (!!objectId) {
            var materialFormId = {
    ...
    OperationFormComponent.prototype.loadDocuments = function (operationId) {
        ...
        this.operationFormService.findBireDocumentByOperation(operationId).subscribe(function (results) {
            results.forEach(function (result) {
    ...
    OperationFormComponent.prototype.formatDocExtension = function (document) {
        return _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_26__["FileUtils"].getExtension(document.docName).toUpperCase();
    };
    OperationFormComponent.prototype.formatDocSize = function (document) {
        return !!document.docFile ? _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_26__["FileUtils"].getFormattedSize(document.docFile.length) : '';
    };
    OperationFormComponent.prototype.uploadDocument = function (event, fileUploader) {
        ...
        if (event.files) {
            ...
            if (fileExists) {
                ...
                _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_26__["FileUtils"].getFileContentAsBase64(file_1, function (fileContent) {
                    if (fileContent) {
                        var document_1 = {
                            docFile: fileContent,
                            docName: file_1.name,
    ...
    OperationFormComponent.prototype.editDocument = function () {
        ...
        if (this.documentsTableDataSource.dataSelectionCount === 1) {
            this.currentDocumentIndex = this.documentsTableDataSource.dataSrc.findIndex(function (document) {
                return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__["DTOUtils"].equalsBireDocOperationDTO(document._obj, _this.documentsTableDataSource.dataSelection[0]._obj);
            });
            ...
            accept: function () {
                _this.documentsTableDataSource.dataSelection.forEach(function (selectedDocument) {
                    var documentsAddedWithoutSelection = _this.documentsAdded.filter(function (documentAdded) {
                        return !_shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__["DTOUtils"].equalsBireDocOperationDTO(selectedDocument._obj, documentAdded._obj);
                    });
                    // list of added objects contains the selection
                ...
                _this.documentsTableDataSource.setData(_this.documentsTableDataSource.dataSrc.filter(function (document) {
                    return !_this.documentsTableDataSource.dataSelection.some(function (selectedDocument) {
                        return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__["DTOUtils"].equalsBireDocOperationDTO(document._obj, selectedDocument._obj);
                    });
                }));
        ...
        if (document) {
            if (this.currentDocumentIndex !== undefined) {
                ...
                var isAdded = this.documentsAdded.some(function (documentAdded) {
                    return _shared_utils_dto_utils__WEBPACK_IMPORTED_MODULE_25__["DTOUtils"].equalsBireDocOperationDTO(document._obj, documentAdded._obj);
                });
                if (isAdded) {
    ...
    OperationFormComponent.prototype.loadAttributes = function () {
        var _this = this;
        this.operationFormService.findBireOperationAttributesByOperation(this.operation).subscribe(function (results) {
    ...
    OperationFormComponent.prototype.initCostSettingDisplay = function () {
        ...
        this.propertiesService
            .getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_9__["GenericPropertyConstants"].AEROWEBB_CONFIGURATION_MAP)
            .subscribe(function (awConfiguration) {
            _this.isCostSettingEnabled = _shared_utils_settings_utils__WEBPACK_IMPORTED_MODULE_27__["SettingsUtils"].isPropertyEnabled(awConfiguration, _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_7__["AWPropertiesConstants"].DISPLAY_COST);
        });
    };
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], OperationFormComponent.prototype, "componentData", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(OperationFormComponent_1.MAIN_INFORMATION_ANCHOR_ID),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], OperationFormComponent.prototype, "mainInformationElRef", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(OperationFormComponent_1.ADD_INFORMATION_ANCHOR_ID),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], OperationFormComponent.prototype, "addInformationElRef", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(OperationFormComponent_1.COMPONENTS_ANCHOR_ID),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], OperationFormComponent.prototype, "componentsElRef", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(OperationFormComponent_1.DOCUMENTS_ANCHOR_ID),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], OperationFormComponent.prototype, "documentsElRef", void 0);
    OperationFormComponent = OperationFormComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-operation-form',
            template: __webpack_require__(/*! ./operation-form.component.html */ "./src/app/main/engineering-management/operation/form/operation-form.component.html")
        }),
        __metadata("design:paramtypes", [_shared_services_message_service__WEBPACK_IMPORTED_MODULE_19__["MessageService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperationFormService", function() { return OperationFormService; });
...
/* harmony import */ var _shared_api_status_management_api__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../shared/api/status-management.api */ "./src/app/shared/api/status-management.api.ts");
...
var OperationFormService = /** @class */ (function (_super) {
    ...
    function OperationFormService(http, appConfigService, aircraftMaintenanceApi, productStructureManagementApi, taskManagementApi, propertiesService, userProfileBusinessApi, statusManagementApi, bidtWarehouseApi) {
     ...
     *************************************************************************/
    OperationFormService.prototype.calculateCostOfBireOperationForAircraftMaintenance = function (operationManHour, qualificationCode, duration, operationDTO) {
        var params = {
    ...
    OperationFormService.prototype.findBireOperationAttributesByOperation = function (operation) {
        return _super.prototype.post.call(this, this.taskManagementApi.findBireOperationAttributesByOperation, operation);
    };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperationImportPopupComponent", function() { return OperationImportPopupComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var OperationImportPopupComponent = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", Object),
        __metadata("design:paramtypes", [Object])
    ], OperationImportPopupComponent.prototype, "display", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], OperationImportPopupComponent.prototype, "displayChange", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Object)
    ], OperationImportPopupComponent.prototype, "document", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Boolean)
    ], OperationImportPopupComponent.prototype, "isReadOnlyForm", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"])
    ], OperationImportPopupComponent.prototype, "onValidated", void 0);
    OperationImportPopupComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'aw-operation-import-popup',
            template: __webpack_require__(/*! ./operation-import-popup.component.html */ "./src/app/main/engineering-management/operation/form/operation-import-popup/operation-import-popup.component.html")
        }),
...
/* harmony import */ var _shared_components_dialog_bire_document_dialog_bire_document_module__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../shared/components/dialog-bire-document/dialog-bire-document.module */ "./src/app/shared/components/dialog-bire-document/dialog-bire-document.module.ts");
/* harmony import */ var _shared_components_dialog_search_part_dialog_search_part_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../shared/components/dialog-search-part/dialog-search-part.module */ "./src/app/shared/components/dialog-search-part/dialog-search-part.module.ts");
...
/* harmony import */ var _shared_components_status_update_history_status_update_history_module__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../shared/components/status-update-history/status-update-history.module */ "./src/app/shared/components/status-update-history/status-update-history.module.ts");
...
/* harmony import */ var _form_dialog_components_dialog_components_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./form/dialog-components/dialog-components.component */ "./src/app/main/engineering-management/operation/form/dialog-components/dialog-components.component.ts");
/* harmony import */ var _form_operation_form_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./form/operation-form.component */ "./src/app/main/engineering-management/operation/form/operation-form.component.ts");
/* harmony import */ var _form_operation_form_service__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./form/operation-form.service */ "./src/app/main/engineering-management/operation/form/operation-form.service.ts");
/* harmony import */ var _form_operation_import_popup_operation_import_popup_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./form/operation-import-popup/operation-import-popup.component */ "./src/app/main/engineering-management/operation/form/operation-import-popup/operation-import-popup.component.ts");
/* harmony import */ var _search_operation_search_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./search/operation-search.component */ "./src/app/main/engineering-management/operation/search/operation-search.component.ts");
/* harmony import */ var _search_operation_search_service__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./search/operation-search.service */ "./src/app/main/engineering-management/operation/search/operation-search.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var EXTERNAL_MODULES = [
    ...
    _shared_components_dialog_search_part_dialog_search_part_module__WEBPACK_IMPORTED_MODULE_15__["DialogSearchPartModule"]
];
var INTERNAL_MODULES = [
    _shared_components_dialog_bire_document_dialog_bire_document_module__WEBPACK_IMPORTED_MODULE_14__["DialogBireDocumentModule"],
    ...
    _shared_components_status_update_history_status_update_history_module__WEBPACK_IMPORTED_MODULE_19__["StatusUpdateHistoryModule"],
    _shared_components_table_table_module__WEBPACK_IMPORTED_MODULE_20__["TableModule"]
];
/******************************************************************************
 * Components
 *************************************************************************** */
var COMPONENTS = [_form_dialog_components_dialog_components_component__WEBPACK_IMPORTED_MODULE_22__["DialogComponentsComponent"], _form_operation_import_popup_operation_import_popup_component__WEBPACK_IMPORTED_MODULE_25__["OperationImportPopupComponent"]];
var DYNAMIC_COMPONENTS = [_form_operation_form_component__WEBPACK_IMPORTED_MODULE_23__["OperationFormComponent"], _search_operation_search_component__WEBPACK_IMPORTED_MODULE_26__["OperationSearchComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_form_operation_form_service__WEBPACK_IMPORTED_MODULE_24__["OperationFormService"], _search_operation_search_service__WEBPACK_IMPORTED_MODULE_27__["OperationSearchService"]];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperationSearchComponent", function() { return OperationSearchComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _operation_search_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./operation-search.service */ "./src/app/main/engineering-management/operation/search/operation-search.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var OperationSearchComponent = /** @class */ (function (_super) {
    ...
    function OperationSearchComponent(favoriteService, loaderService, messageService, serializationService, tabService, confirmationService, exportService, operationSearchService) {
    ...
    OperationSearchComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_2__["ComponentConstants"].ENG_OPERATION_SEARCH;
    };
    ...
    OperationSearchComponent.prototype.initOperationTableDataSource = function () {
        this.operationTableDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_1__["TableDataSource"]({
            allowMultiSelect: true,
            columns: [
                {
                    field: 'opeCode',
    ...
    OperationSearchComponent.prototype.openOperationLink = function (object) {
        this.openOperation(object, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__["ComponentOpenMode"].Read);
    };
    OperationSearchComponent.prototype.createNewOperation = function () {
        this.openOperation(undefined, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__["ComponentOpenMode"].Create);
    };
        ...
        this.operationTableDataSource.dataSelection.forEach(function (selectedOperation) {
            if (selectedOperation) {
                if (selectedOperation.opeCode && selectedOperation.opeVersion && selectedOperation.rangeCode) {
                    ...
                    _this.openOperation(selectedOperationId, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_3__["ComponentOpenMode"].Read);
                }
                else {
    ...
    OperationSearchComponent.prototype.search = function () {
        ...
        this.operationSearchService.findBireOperationsBySearchCriteria(this.searchObject).subscribe(function (result) {
            _this.isLoading = false;
    ...
    OperationSearchComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./operation-search.component.html */ "./src/app/main/engineering-management/operation/search/operation-search.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OperationSearchService", function() { return OperationSearchService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
