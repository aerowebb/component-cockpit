(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["engineering-management-dea-dia-dea-dia-module"],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeaDiaFormComponent", function() { return DeaDiaFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modules_purchase_contract_utils_table_data_source_with_history__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../modules/purchase-contract/utils/table-data-source-with-history */ "./src/app/modules/purchase-contract/utils/table-data-source-with-history.ts");
...
/* harmony import */ var _shared_services_input_validation_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../shared/services/input-validation.service */ "./src/app/shared/services/input-validation.service.ts");
...
/* harmony import */ var _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../../../shared/utils/file-utils */ "./src/app/shared/utils/file-utils.ts");
/* harmony import */ var _shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../../../shared/utils/list-utils */ "./src/app/shared/utils/list-utils.ts");
/* harmony import */ var _dea_dia_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../dea-dia.service */ "./src/app/main/engineering-management/dea-dia/dea-dia.service.ts");
...
var DeaDiaFormComponent = /** @class */ (function (_super) {
    ...
    function DeaDiaFormComponent(favoriteService, loaderService, messageService, serializationService, tabService, pageTocService, inputValidationService, translateService, confirmationService, propertiesService, sessionService, deadiaFormService) {
    ...
    DeaDiaFormComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_7__["ComponentConstants"].ENG_DEA_DIA_FORM;
    };
    ...
    DeaDiaFormComponent.prototype.loadIsCreatorIsController = function () {
        ...
        this.isController = this.sessionService.hasUserRightByUseCase(_shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_6__["BidoFunctionTypeConstants"].UC_DEA_DIA_CONTROLLER, _shared_constants_bido_function_type_constants__WEBPACK_IMPORTED_MODULE_6__["BidoFunctionTypeConstants"].DEGREE_UPDATE);
    };
    DeaDiaFormComponent.prototype.loadPartGuidelineTypes = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_8__["GenericPropertyConstants"].PART_GUIDELINE_TYPE_MAP).subscribe(function (results) {
    ...
    DeaDiaFormComponent.prototype.loadPartGuidelineStatus = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_8__["GenericPropertyConstants"].GUIDELINE_STATUS_MAP).subscribe(function (results) {
    ...
    DeaDiaFormComponent.prototype.saveBireDocPug = function () {
        var _this = this;
        var addedList = this.documentsTableDataSource.getAddedList().map(function (elt) { return _this.toDocumentDto(elt); });
        var updatedList = this.documentsTableDataSource.getUpdatedList().map(function (elt) { return _this.toDocumentDto(elt); });
        var deletedList = this.documentsTableDataSource.getDeletedList().map(function (elt) { return _this.toDocumentDtoId(elt); });
        if (!_shared_utils_list_utils__WEBPACK_IMPORTED_MODULE_21__["ListUtils"].isNullOrEmpty(addedList) ||
    ...
    DeaDiaFormComponent.prototype.getSaveGuidelineObservable = function () {
        if (!!this.guideline.pugType) {
            var guidelineToSave = __assign({}, this.guideline, { 
                ...
                requesterName: this.guideline.requesterName ? this.guideline.requesterName : this.user.lastname, creationDate: this.guideline.creationDate ? this.guideline.creationDate : moment__WEBPACK_IMPORTED_MODULE_2__().toDate(), pugStatus: this.guideline.pugStatus ? this.guideline.pugStatus : _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].DEA_DIA_STATUS_DRAFT });
            var saveInput = {
    ...
    DeaDiaFormComponent.prototype.transmitToContol = function () {
        this.guideline = __assign({}, this.guideline, { controlTransmissionDate: moment__WEBPACK_IMPORTED_MODULE_2__().toDate(), pugStatus: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].DEA_DIA_STATUS_PENDING_CONTOL });
        this.defaultSaveBehaviour(this.getSaveGuidelineObservable());
    };
    DeaDiaFormComponent.prototype.transmitToCentral = function () {
        ...
        this.guideline = __assign({}, this.guideline, { centralTransmissionDate: moment__WEBPACK_IMPORTED_MODULE_2__().toDate(), 
        ...
        if (!!saveGuidelineObs) {
            saveGuidelineObs.subscribe(function () {
                ...
                _this.deadiaFormService.submitDeaDiaToDmae(pugCodeDtoId).subscribe(function () {
                    _this.refresh();
    ...
    DeaDiaFormComponent.prototype.transmitToCentralOnWaitinForInfo = function () {
        ...
        if (!!saveGuidelineObs) {
            saveGuidelineObs.subscribe(function () {
                _this.deadiaFormService.submitUpdatedDeaDiaToDmae(pugCodeDtoId).subscribe(function () {
                    _this.refresh();
    ...
    DeaDiaFormComponent.prototype.refuse = function () {
        this.guideline = __assign({}, this.guideline, { pugStatus: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].DEA_DIA_STATUS_REFUSED });
        this.defaultSaveBehaviour(this.getSaveGuidelineObservable());
    };
    DeaDiaFormComponent.prototype.close = function () {
        this.guideline = __assign({}, this.guideline, { pugStatus: _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].DEA_DIA_STATUS_CLOSED, closureDate: moment__WEBPACK_IMPORTED_MODULE_2__().toDate() });
        this.defaultSaveBehaviour(this.getSaveGuidelineObservable());
    };
    DeaDiaFormComponent.prototype.initDocumentsTableDataSource = function () {
        this.documentsTableDataSource = new _modules_purchase_contract_utils_table_data_source_with_history__WEBPACK_IMPORTED_MODULE_3__["TableDataSourceWithHistory"]({
    ...
    DeaDiaFormComponent.prototype.toDocumentRow = function (documentDTO) {
        if (!!documentDTO.bireDocumentDto) {
            return {
                ...
                docExtension: _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_20__["FileUtils"].getExtension(documentDTO.bireDocumentDto.docName).toUpperCase(),
                docSize: !!documentDTO.bireDocumentDto.docFile
                    ? _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_20__["FileUtils"].getFormattedSize(documentDTO.bireDocumentDto.docFile.length)
                    : '',
                docPublicationDate: moment__WEBPACK_IMPORTED_MODULE_2__(documentDTO.bireDocumentDto.docPublicationDate).format(this._sessionService.dateTimeFormatMomentJS),
    ...
    DeaDiaFormComponent.prototype.downloadFile = function (document) {
        if (!!document._obj) {
            _shared_utils_file_utils__WEBPACK_IMPORTED_MODULE_20__["FileUtils"].downloadFile(document._obj.bireDocumentDto.docFile, document.docName);
        }
    };
    DeaDiaFormComponent.prototype.loadBireDocPugs = function () {
        ...
        this.deadiaFormService.findBireDocPugs(guidelineDTOId).subscribe(function (elt) {
            _this.documentsTableDataSource.setData(elt.map(function (bireDocPugDTO) { return _this.toDocumentRow(bireDocPugDTO); }));
        });
    };
    ...
    Object.defineProperty(DeaDiaFormComponent.prototype, "enableRequesterComment", {
        get: function () {
            ...
            if (!!this.guideline &&
                ...
                (this.guideline.pugStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].DEA_DIA_STATUS_DRAFT ||
                    this.guideline.pugStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].DEA_DIA_STATUS_WAINTING_FOR_FURTHER_INFORMATION ||
                    this.guideline.pugStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].DEA_DIA_STATUS_CLOSED_BY_CENTRAL)) {
    ...
    Object.defineProperty(DeaDiaFormComponent.prototype, "enableControllerComment", {
        get: function () {
            ...
            if (!!this.guideline &&
                !!this.guideline.pugStatus &&
                this.guideline.pugStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].DEA_DIA_STATUS_PENDING_CONTOL &&
                this.isController) {
    ...
    Object.defineProperty(DeaDiaFormComponent.prototype, "enableSave", {
        get: function () {
            ...
            if ((!!this.guideline &&
                ...
                (this.guideline.pugStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].DEA_DIA_STATUS_PENDING_CONTOL && this.isController) ||
                (this.guideline.pugStatus === _shared_constants_aw_properties_constants__WEBPACK_IMPORTED_MODULE_5__["AWPropertiesConstants"].DEA_DIA_STATUS_WAINTING_FOR_FURTHER_INFORMATION &&
                    (this.isCreator || this.isController))) {
                enableSave = true;
            }
    ...
    DeaDiaFormComponent = DeaDiaFormComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./dea-dia-form.component.html */ "./src/app/main/engineering-management/dea-dia/dea-dia-form/dea-dia-form.component.html")
        }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeaDiaSearchComponent", function() { return DeaDiaSearchComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @ngx-translate/core */ "./node_modules/@ngx-translate/core/fesm5/ngx-translate-core.js");
...
/* harmony import */ var _dea_dia_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../dea-dia.service */ "./src/app/main/engineering-management/dea-dia/dea-dia.service.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var DeaDiaSearchComponent = /** @class */ (function (_super) {
    ...
    function DeaDiaSearchComponent(favoriteService, loaderService, messageService, serializationService, tabService, pageTocService, translateService, propertiesService, deadiaService) {
        var _this = _super.call(this, _shared_enums_component_open_mode_enum__WEBPACK_IMPORTED_MODULE_8__["ComponentOpenMode"].Read, favoriteService, loaderService, messageService, serializationService, tabService, pageTocService) || this;
        _this.translateService = translateService;
        _this.propertiesService = propertiesService;
    ...
    DeaDiaSearchComponent.prototype.getComponentName = function () {
        return _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_6__["ComponentConstants"].LOG_DEA_DIA_SEARCH;
    };
    ...
    DeaDiaSearchComponent.prototype.openSelectedPartNumber = function () {
        var _this = this;
        this.guidelineTableDataSource.dataSelection.forEach(function (row) { return _this.openPartNumber(row.pnCode); });
    };
    DeaDiaSearchComponent.prototype.openGuideline = function (rowData) {
        var labelKey = 'transaction.DeaDiaFormComponent';
        var data = {
            id: this.tabService.generateId(),
            componentId: _shared_constants_component_constants__WEBPACK_IMPORTED_MODULE_6__["ComponentConstants"].ENG_DEA_DIA_FORM,
    ...
    DeaDiaSearchComponent.prototype.initGuidelineTableDataSource = function () {
        this.guidelineTableDataSource = new _shared_components_table_table_data_source__WEBPACK_IMPORTED_MODULE_5__["TableDataSource"]({
            allowMultiSelect: true,
            columns: [
                {
                    field: 'pnCode',
    ...
    DeaDiaSearchComponent.prototype.search = function () {
        ...
        this.deadiaService
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (birePartUpdateGuidelineDTOArray) {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(birePartUpdateGuidelineDTOArray).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])(function (birePartUpdateGuidelineDTO) {
                return _this.deadiaService.findBirePn({ pnCode: birePartUpdateGuidelineDTO.pnCode }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (birePnDTO) {
                    ...
                    var pugStatus = !!birePartUpdateGuidelineDTO.pugStatus
                        ? _this.getLabelValueByValue(_this.partGuidelineStatus, birePartUpdateGuidelineDTO.pugStatus)
                        : undefined;
                    var rowData = __assign({}, birePartUpdateGuidelineDTO, { pugTypeLabel: !!pugType ? pugType.label : '', pugStatusLabel: !!pugStatus ? pugStatus.label : '', articleDesignation: birePnDTO.articleDesignation });
                    return rowData;
                }));
            }));
        }))
    ...
    DeaDiaSearchComponent.prototype.loadPartGuidelineTypes = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_7__["GenericPropertyConstants"].PART_GUIDELINE_TYPE_MAP).subscribe(function (results) {
            _this.partGuidelineTypes = results;
        }, function () {
    ...
    DeaDiaSearchComponent.prototype.loadPartGuidelineStatus = function () {
        var _this = this;
        this.propertiesService.getValue(_shared_constants_generic_property_constants__WEBPACK_IMPORTED_MODULE_7__["GenericPropertyConstants"].GUIDELINE_STATUS_MAP).subscribe(function (results) {
            _this.partGuidelineStatus = results;
        }, function () {
    ...
    DeaDiaSearchComponent = DeaDiaSearchComponent_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./dea-dia-search.component.html */ "./src/app/main/engineering-management/dea-dia/dea-dia-search/dea-dia-search.component.html")
        }),
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeaDiaModule", function() { return DeaDiaModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _shared_api_bonita_bonita_api__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../shared/api/bonita/bonita.api */ "./src/app/shared/api/bonita/bonita.api.ts");
/* harmony import */ var _shared_api_product_structure_management_api__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../shared/api/product-structure-management.api */ "./src/app/shared/api/product-structure-management.api.ts");
/* harmony import */ var _shared_api_user_profile_management_api__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../shared/api/user-profile-management.api */ "./src/app/shared/api/user-profile-management.api.ts");
...
/* harmony import */ var _shared_components_component_sidebar_page_toc_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../shared/components/component-sidebar/page-toc.service */ "./src/app/shared/components/component-sidebar/page-toc.service.ts");
...
/* harmony import */ var _dea_dia_form_dea_dia_form_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./dea-dia-form/dea-dia-form.component */ "./src/app/main/engineering-management/dea-dia/dea-dia-form/dea-dia-form.component.ts");
/* harmony import */ var _dea_dia_search_dea_dia_search_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./dea-dia-search/dea-dia-search.component */ "./src/app/main/engineering-management/dea-dia/dea-dia-search/dea-dia-search.component.ts");
/* harmony import */ var _dea_dia_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./dea-dia.service */ "./src/app/main/engineering-management/dea-dia/dea-dia.service.ts");
/* harmony import */ var _dialog_bire_document_dialog_bire_doc_pug_module__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./dialog-bire-document/dialog-bire-doc-pug.module */ "./src/app/main/engineering-management/dea-dia/dialog-bire-document/dialog-bire-doc-pug.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var INTERNAL_MODULES = [_dialog_bire_document_dialog_bire_doc_pug_module__WEBPACK_IMPORTED_MODULE_22__["DialogBireDocPugModule"]];
/******************************************************************************
 * Components
 *************************************************************************** */
var COMPONENTS = [];
var DYNAMIC_COMPONENTS = [_dea_dia_form_dea_dia_form_component__WEBPACK_IMPORTED_MODULE_19__["DeaDiaFormComponent"], _dea_dia_search_dea_dia_search_component__WEBPACK_IMPORTED_MODULE_20__["DeaDiaSearchComponent"]];
/******************************************************************************
 * Services
 *************************************************************************** */
var SERVICES = [_dea_dia_service__WEBPACK_IMPORTED_MODULE_21__["DeaDiaService"], _shared_components_component_sidebar_page_toc_service__WEBPACK_IMPORTED_MODULE_16__["PageTocService"]];
var API_PROVIDERS = [_shared_api_user_profile_management_api__WEBPACK_IMPORTED_MODULE_14__["UserProfileManagementApi"], _shared_api_product_structure_management_api__WEBPACK_IMPORTED_MODULE_13__["ProductStructureManagementApi"], _shared_api_bonita_bonita_api__WEBPACK_IMPORTED_MODULE_12__["BonitaApi"]];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeaDiaService", function() { return DeaDiaService; });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _shared_api_bonita_bonita_api__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../shared/api/bonita/bonita.api */ "./src/app/shared/api/bonita/bonita.api.ts");
...
var DeaDiaService = /** @class */ (function (_super) {
    ...
    function DeaDiaService(http, appConfigService, userProfileManagementApi, productStructureManagementApi, bonitaApi) {
    ...
    DeaDiaService.prototype.findPartUpdateGuidelineById = function (guidelineDTOId) {
        return _super.prototype.post.call(this, this.productStructureManagementApi.findBirePartUpdateGuidelineById, guidelineDTOId);
    };
    ...
    DeaDiaService.prototype.findBirePartUpdateGuidelinesBySearchCriteria = function (input) {
        return _super.prototype.post.call(this, this.productStructureManagementApi.findBirePartUpdateGuidelinesBySearchCriteria, input);
    };
